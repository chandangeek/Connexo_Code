...
public enum ViewPrivilege {
    LEVEL_1(Privileges.Constants.VIEW_CUSTOM_PROPERTIES_1),
    LEVEL_2(Privileges.Constants.VIEW_CUSTOM_PROPERTIES_2),
    LEVEL_3(Privileges.Constants.VIEW_CUSTOM_PROPERTIES_3),
    LEVEL_4(Privileges.Constants.VIEW_CUSTOM_PROPERTIES_4);
    ...
    public static Optional<ViewPrivilege> from(String privilege) {
