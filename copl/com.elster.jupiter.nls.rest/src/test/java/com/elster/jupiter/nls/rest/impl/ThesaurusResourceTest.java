...
public class ThesaurusResourceTest {
    ...
    public void setUp() {
        ...
        when(thesaurus1.getTranslations()).thenReturn(ImmutableMap.of("key1", "value1", "key2", "value2"));
        when(thesaurus2.getTranslations()).thenReturn(ImmutableMap.of("key3", "value3"));
