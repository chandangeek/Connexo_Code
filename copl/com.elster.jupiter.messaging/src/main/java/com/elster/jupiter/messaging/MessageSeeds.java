...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    UNDERLYING_JMS_EXCEPTION(1004, "jms.failed", "Underlying JMS Exception", Level.SEVERE),
    UNDERLYING_AQ_EXCEPTION(1005, "aq.failed", "Underlying AQ Exception", Level.SEVERE);
