...
public class EventTypeResource {
	  ...
	  public EventTypeInfos getEventTypes(@Context UriInfo uriInfo) {
	      ...
	      List<EventType> list = getEventTypeRestQuery().select(queryParameters);
	  ...
	  private RestQuery<EventType> getEventTypeRestQuery() {
	      Query<EventType> query = Bus.getEventService().getEventTypeQuery();
