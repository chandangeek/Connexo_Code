...
Ext.define('Uni.view.widget.HistoryGraph', {
    ...
    refresh: function (data) {
        ...
        if ((me.fields == null) || (me.fields.length == 0)) {
            if (me.sortGrophFields) {
                data.fields = me.sortGrophFields(data.fields);
            }
                        ...
                        renderer: function (record, item) {
                            ...
                            if (sumPerDay != 0) {
                                html = '<table>' +
                                    ...
                                    '<tr><td>' + Ext.String.format(me.totalItemsRaisedMsg, sumPerDay) + '</td></tr>' +
                                    '<tr><td>&nbsp</td></tr>' +
                                    html +
                                    '</table>';
                                tooltip.update(html);
