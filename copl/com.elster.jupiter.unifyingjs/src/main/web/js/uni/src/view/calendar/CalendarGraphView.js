...
Ext.define('Uni.view.calendar.CalendarGraphView', {
    ...
    colors: ['#BEE64B', '#5E8C31', '#7BA05B', '#4D8C57', '#3AA655', '#93DFB8', '#33CC99', '#1AB385', '#29AB87', '#00CC99', '#00755E',
        '#8DD9CC', '#01786F', '#30BFBF', '#00CCCC', '#008080', '#8FD8D8',
        '#95E0E8', '#6CDAE7', '#2D383A', '#76D7EA', '#7ED4E6', '#0095B7', '#009DC4', '#02A4D3', '#47ABCC', '#4997D0', '#339ACC',
        '#93CCEA', '#2887C8', '#00468C', '#0066CC', '#1560BD', '#0066FF', '#A9B2C3', '#C3CDE6', '#4570E6', '#7A89B8', '#4F69C6',
        '#8D90A1', '#8C90C8', '#7070CC', '#9999CC', '#ACACE6', '#766EC8', '#6456B7', '#3F26BF', '#8B72BE', '#652DC1', '#6B3FA0',
        '#8359A3', '#8F47B3', '#C9A0DC', '#BF8FCC', '#803790', '#733380', '#D6AEDD', '#C154C1', '#FC74FD', '#C5E17A', '#9DE093', '#63B76C', '#6CA67C', '#5FA777'],
