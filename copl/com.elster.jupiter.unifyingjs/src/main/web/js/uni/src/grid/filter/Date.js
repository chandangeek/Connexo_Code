            ...
            items: [
                {
                    ...
                    maxValue: 23,
                    editable: false,
                    emptyText: Uni.I18n.translate('grid.filter.date.hourfield.emptytext', 'UNI', 'Hour'),
                    flex: 1,
                ...
                },
                {
                    ...
                    maxValue: 59,
                    editable: false,
                    emptyText: Uni.I18n.translate('grid.filter.date.minutefield.emptytext', 'UNI', 'Minute'),
                    flex: 1,
                    valueToRaw: function (value) {
                        if (!Ext.isDefined(value)) {
                            return null;
