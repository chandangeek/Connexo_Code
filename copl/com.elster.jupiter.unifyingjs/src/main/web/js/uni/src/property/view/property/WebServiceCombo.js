...
Ext.define('Uni.property.view.property.WebServiceCombo', {
    ...
    getEditCmp: function () {
        ...
        return !me.getProperty().getPossibleValues() || (me.getProperty().getPossibleValues() && me.getProperty().getPossibleValues().length === 0) ?
            {
                xtype: 'displayfield',
                value: Uni.I18n.translate('Uni.property.combobox.noItemsDefined', 'UNI', 'No {0} have been defined yet.', 'web services'),
