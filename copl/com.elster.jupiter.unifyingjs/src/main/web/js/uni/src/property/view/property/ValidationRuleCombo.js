...
Ext.define('Uni.property.view.property.ValidationRuleCombo', {
    ...
    getEditCmp: function () {
        ...
        return !me.getProperty().getPossibleValues() || (me.getProperty().getPossibleValues() && me.getProperty().getPossibleValues().length === 0) ?
            {
                xtype: 'displayfield',
                value: Uni.I18n.translate('Uni.property.combobox.noItemsDefinedOrActivated', 'UNI', 'No {0} have been defined or activated yet.', 'validation rules'),
            ...
            } :
            {
                ...
                itemId: 'validation-rule-combobox',
                name: this.getName(),
                fieldLabel: '&nbsp',
                editable: false,
                labelWidth: -100,
                ...
                multiSelect: true,
                msgTarget: 'under',
                emptyText: Uni.I18n.translate('general.validation.rule.empty', 'UNI', 'Select a validation rule...')
            };
    },
