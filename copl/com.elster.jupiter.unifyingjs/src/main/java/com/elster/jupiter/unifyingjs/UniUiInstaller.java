...
public class UniUiInstaller implements TranslationKeyProvider {
    ...
    //    HttpResource resource = new HttpResource(HTTP_RESOURCE_ALIAS, HTTP_RESOURCE_LOCAL_NAME, new BundleResolver(context));
      ...
      HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "C:\\Development\\code\\connexo102\\copl\\com.elster.jupiter.unifyingjs\\src\\main\\web\\js\\uni", new FileResolver());
