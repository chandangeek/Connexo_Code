...
public class TimeZoneNeutralTestWithGivenTimeZone {
    ...
    public void testJodaWinterTime() {
        ...
        assertThat(DateTimeZone.getDefault().getOffset(someTimeInWinter)).isEqualTo(4 * DateTimeConstants.MILLIS_PER_HOUR);
    }

    @Test
    public void testJodaSummerTime() {
        DateTime someTimeInSummer = new DateTime(2014, 8, 1, 0, 0);
        assertThat(DateTimeZone.getDefault().getOffset(someTimeInSummer)).isEqualTo(4 * DateTimeConstants.MILLIS_PER_HOUR);
    }

    @Test
    public void testWinterTime() {
        Date someTimeInWinter = new DateTime(2014, 1, 1, 0, 0).toDate();
        assertThat(TimeZone.getDefault().getOffset(someTimeInWinter.getTime())).isEqualTo(4 * DateTimeConstants.MILLIS_PER_HOUR);
    }

    @Test
    public void testSummerTime() {
        Date someTimeInSummer = new DateTime(2014, 8, 1, 0, 0).toDate();
        assertThat(TimeZone.getDefault().getOffset(someTimeInSummer.getTime())).isEqualTo(4 * DateTimeConstants.MILLIS_PER_HOUR);
    }
