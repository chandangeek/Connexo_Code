        ...
        try {
            ...
            if (singleSortDirection != null && sort != null) {
                ...
                for (int index = 0; index < jsonArray.length(); index++) {
                    ...
                    sortingColumns.add(EXTJS_ASCENDING.equalsIgnoreCase(object.getString(EXTJS_DIRECTION)) ? Order.ascending(object.getString(EXTJS_FIELD)) : Order.descending(object
                            .getString(EXTJS_FIELD)));
                }
            }
