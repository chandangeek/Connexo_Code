...
class MultiColumnContainsFragment extends MultiColumnFragment {
	
	private final Contains contains;
	
	MultiColumnContainsFragment(MultiColumnMapping fieldMapping , Contains contains , String alias) {
