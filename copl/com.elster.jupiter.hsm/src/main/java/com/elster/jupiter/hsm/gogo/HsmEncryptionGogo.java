...
public class HsmEncryptionGogo {
    ...
    public EncryptResponse jssEncrypt(String keyLabel, String stringToEncrypt) throws EncryptBaseException {
        return this.encService.encrypt(new EncryptRequest(keyLabel, stringToEncrypt, SymmetricAlgorithm.AES_256_CBC));
    }

    public DecryptResponse jssDecrypt(String keyLabel, String encryptedString) throws EncryptBaseException {
