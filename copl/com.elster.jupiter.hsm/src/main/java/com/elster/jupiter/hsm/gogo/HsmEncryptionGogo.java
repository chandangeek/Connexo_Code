...
public class HsmEncryptionGogo {
    ...
    public EncryptResponse jssEncrypt(String keyLabel, String stringToEncrypt, String encryptionType) throws EncryptBaseException {
        return this.encService.encrypt(new EncryptRequest(keyLabel, EncryptionType.valueOf(encryptionType), stringToEncrypt, AsymmetricPaddingAlgorithm.ANSI_X9_23, ChainingMode.CBC));
    }
    ...
    public DecryptResponse jssDecrypt(String keyLabel, String encryptedString, String encryptionType) throws EncryptBaseException {
        return this.encService.decrypt(new DecryptRequest(keyLabel, EncryptionType.valueOf(encryptionType), encryptedString, AsymmetricPaddingAlgorithm.ANSI_X9_23, ChainingMode.CBC));
    }
