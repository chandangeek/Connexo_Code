...
public class RecurrentTaskIT {
    ...
    private final Date now = Date.from(ZonedDateTime.of(2017, 8, 14, 18, 0, 0, 0, ZoneId.of(murdo.getSubstitute())).toInstant());
    private final Date nextExecution = Date.from(ZonedDateTime.of(2017, 8, 15, 18, 0, 0, 0, ZoneId.of(murdo.getSubstitute())).toInstant());
