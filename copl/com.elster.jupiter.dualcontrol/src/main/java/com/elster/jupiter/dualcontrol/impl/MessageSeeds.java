...
public enum MessageSeeds implements MessageSeed {
    ...
    CANT_COMBINE_ROLES_WITH_PRIVILEGES_X_AND_Y(3, Constants.CANT_COMBINE_ROLES_WITH_PRIVILEGES_X_AND_Y, "For security reasons you can''t combine user roles with respectively ''{0}'' and ''{1}'' privileges"),
