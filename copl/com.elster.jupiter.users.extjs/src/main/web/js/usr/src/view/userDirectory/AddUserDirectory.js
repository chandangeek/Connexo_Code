...
Ext.define('Usr.view.userDirectory.AddUserDirectory', {
    ...
    loadRecord: function (record) {
        var me = this,
			...
			groupDBTextbox = me.down('#txt-groupDN'),
		...
		groupDBTextbox.setVisible(record.get('dnType') === 'GDN');
