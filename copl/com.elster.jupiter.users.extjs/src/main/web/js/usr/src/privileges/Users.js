...
Ext.define('Usr.privileges.Users', {
    ...
    singleton: true,
    view : ['privilege.administrate.userAndRole', 'privilege.view.userAndRole', 'dualcontrol.grant.approval'],
    admin : ['privilege.administrate.userAndRole', 'dualcontrol.grant.approval'],
    all: function() {
