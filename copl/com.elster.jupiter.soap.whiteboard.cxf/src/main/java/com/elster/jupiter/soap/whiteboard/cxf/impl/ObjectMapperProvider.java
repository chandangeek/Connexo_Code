...
public class ObjectMapperProvider implements ContextResolver<ObjectMapper> {
    ...
    public ObjectMapperProvider() {
        ...
        mapper.registerModule(new SimpleModule("Instant", new Version(1, 0, 0, null, "com.elster.jupiter", "soap.whiteboard"))
    ...
    private static class InstantSerializer extends StdSerializer<Instant> {
        ...
        @Override
        public void serialize(Instant instant, JsonGenerator generator, SerializerProvider provider) throws
                IOException {
