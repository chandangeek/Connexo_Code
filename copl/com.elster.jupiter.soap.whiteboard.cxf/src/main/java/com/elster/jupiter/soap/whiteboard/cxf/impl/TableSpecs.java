...
public enum TableSpecs {
    ...
    WS_CALL_OCCURRENCE {
        ...
        void addTo(DataModel dataModel) {
            ...
            // table.index("IX_WS_CALL_START").on(desc(startTimeColumn)).add().since(Version.version(10, 7, 5)); // done in UpgraderV10_7_5 and 10_9_1
            // table.index("IX_WS_CALL_END").on(desc(endTimeColumn)).add().since(Version.version(10, 7, 5)); // done in UpgraderV10_7_5 and 10_9_1
    ...
    WS_OCC_RELATED_ATTR {
        ...
        void addTo(DataModel dataModel) {
            ...
            table.unique("WS_UQ_KEY_VALUE").on(keyColumn, valueColumn)
                    // .compressIndex(1) // done in UpgraderV10_7_5 and 10_9_1
                    .add();
            // table.index("IX_WS_CALL_ATTR_VALUE").on(upper(valueColumn)).add().since(Version.version(10, 7, 5)); // done in UpgraderV10_7_5 and 10_9_1
