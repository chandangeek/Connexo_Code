 ...
 */
@ProviderType
public interface EndPointConfiguration extends HasId, HasName, HasDynamicProperties {
    @Override
    long getId();
    ...
    void retryOccurrence(String method, String payload, WebServiceCallOccurrence occurrence);
}
