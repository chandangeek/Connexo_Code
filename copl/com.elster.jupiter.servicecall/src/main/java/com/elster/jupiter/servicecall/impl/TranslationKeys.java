...
public enum TranslationKeys implements TranslationKey {
    ...
    TRANSITION_FROM_ONGOING_TO_SUCCESS(DefaultState.ONGOING.getKey()+DefaultCustomStateTransitionEventType.SUCCESSFUL.getSymbol(), "Successful"),
    ...
    TRANSITION_FROM_CANCELLED_TO_SCHEDULED(DefaultState.CANCELLED.getKey()+DefaultCustomStateTransitionEventType.SCHEDULED.getSymbol(), "Reschedule"),
