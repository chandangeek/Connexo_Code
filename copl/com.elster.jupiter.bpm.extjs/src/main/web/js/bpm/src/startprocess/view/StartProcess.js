...
Ext.define('Bpm.startprocess.view.StartProcess', {
    ...
    initComponent: function () {
        ...
        me.items = [
            {
                xtype: 'panel',
                ui: 'large',
                title: me.hideTitle ? '' : Uni.I18n.translate('bpm.startProcess.title', 'BPM', 'Start process'),
        ...
        me.availableStore = availableStore;
    ...
    loadAvailableProcessesStore: function(callback){
        var me = this,
            viewport = Ext.ComponentQuery.query('viewport')[0];

        viewport.setLoading();
        me.availableStore.load(function (records) {
