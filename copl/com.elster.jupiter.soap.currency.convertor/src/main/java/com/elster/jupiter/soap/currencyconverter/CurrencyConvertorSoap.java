...
public interface CurrencyConvertorSoap {
    ...
    @RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "com.elster.jupiter.soap.service.cxf.impl.ConversionRate")
    @ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "com.elster.jupiter.soap.service.cxf.impl.ConversionRateResponse")
