...
@Component(name = "com.elster.jupiter.test.regression.bootstrap", immediate = true, property = Constants.SERVICE_RANKING + "=100000")
public class H2BootStrapServiceComponent implements BootstrapService {
    ...
    @Inject
    public H2BootStrapServiceComponent() {
    }
