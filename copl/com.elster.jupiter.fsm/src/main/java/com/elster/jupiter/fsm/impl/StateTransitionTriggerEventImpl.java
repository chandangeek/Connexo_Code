 ...
 */
class StateTransitionTriggerEventImpl implements StateTransitionTriggerEvent {
    ...
    @Inject
    StateTransitionTriggerEventImpl(EventService eventService) {
        super();
        this.eventService = eventService;
    }

    StateTransitionTriggerEventImpl initialize(StateTransitionEventType eventType, FiniteStateMachine finiteStateMachine, String sourceId, String sourceType, Instant effectiveTimestamp, Map<String, Object> properties, String sourceCurrentStateName) {
