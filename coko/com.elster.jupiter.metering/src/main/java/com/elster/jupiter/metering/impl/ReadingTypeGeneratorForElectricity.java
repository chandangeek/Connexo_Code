...
class ReadingTypeGeneratorForElectricity extends AbstractReadingTypeGenerator {
    ...
    private enum ReadingTypesForPossibleDailyMonthlyLoadProfileUsage implements ReadingTypeTemplate {
        ...
        DAILY_ACTIVE_IMPORT("Daily A+", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.FORWARD).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.WATTHOUR)),
        DAILY_ACTIVE_EXPORT("Daily A-", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.REVERSE).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.WATTHOUR)),
        MONTHLY_ACTIVE_IMPORT("Monthly A+", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.FORWARD).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.WATTHOUR)),
        MONTHLY_ACTIVE_EXPORT("Monthly A-", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.REVERSE).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.WATTHOUR)),

        DAILY_INDUCTIVE_ENERGY_Q1("Daily inductive energy Q1", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.Q1).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        DAILY_INDUCTIVE_ENERGY_Q2("Daily inductive energy Q2", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.Q2).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        DAILY_INDUCTIVE_ENERGY_Q3("Daily inductive energy Q3", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.Q3).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        DAILY_INDUCTIVE_ENERGY_Q4("Daily inductive energy Q4", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.Q4).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        MONTHLY_INDUCTIVE_ENERGY_Q1("Monthly inductive energy Q1", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.Q1).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        MONTHLY_INDUCTIVE_ENERGY_Q2("Monthly inductive energy Q2", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.Q2).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        MONTHLY_INDUCTIVE_ENERGY_Q3("Monthly inductive energy Q3", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.Q3).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        MONTHLY_INDUCTIVE_ENERGY_Q4("Monthly inductive energy Q4", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.Q4).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),

        DAILY_REACTIVE_IMPORT("Daily reactive energy+", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.LAGGING).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        DAILY_REACTIVE_EXPORT("Daily reactive energy-", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).flow(FlowDirection.LEADING).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        MONTHLY_REACTIVE_IMPORT("Monthly reactive energy+", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.LAGGING).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),
        MONTHLY_REACTIVE_EXPORT("Monthly reactive energy-", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).flow(FlowDirection.LEADING).measure(MeasurementKind.ENERGY).in(ReadingTypeUnit.VOLTAMPEREREACTIVEHOUR)),;
    ...
    private enum ReadingTypesForDemands implements ReadingTypeTemplate {
        ...
        DAILY_ACTIVE_ENERGY_MAX_DEMAND("Daily active energy max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.FORWARD).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        MONTHLY_ACTIVE_ENERGY_MAX_DEMAND("Monthly active energy max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.FORWARD).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        BILLING_ACTIVE_ENERGY_MAX_DEMAND("Billing active energy max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.BILLINGPERIOD).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.FORWARD).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),

        DAILY_ACTIVE_ENERGY_MAX_SUPPLY("Daily active energy max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.REVERSE).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        MONTHLY_ACTIVE_ENERGY_MAX_SUPPLY("Monthly active energy max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.REVERSE).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        BILLING_ACTIVE_ENERGY_MAX_SUPPLY("Billing active energy max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.BILLINGPERIOD).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.REVERSE).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),

        DAILY_REACTIVE_ENERGY_MAX_DEMAND("Daily reactive energy max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.LAGGING).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.VOLTAMPEREREACTIVE)),
        MONTHLY_REACTIVE_ENERGY_MAX_DEMAND("Monthly reactive energy max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.LAGGING).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.VOLTAMPEREREACTIVE)),
        BILLING_REACTIVE_ENERGY_MAX_DEMAND("Billing reactive energy max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.BILLINGPERIOD).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.LAGGING).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.VOLTAMPEREREACTIVE)),

        DAILY_REACTIVE_ENERGY_MAX_SUPPLY("Daily reactive energy max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.LEADING).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.VOLTAMPEREREACTIVE)),
        MONTHLY_REACTIVE_ENERGY_MAX_SUPPLY("Monthly reactive energy max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.LEADING).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.VOLTAMPEREREACTIVE)),
        BILLING_REACTIVE_ENERGY_MAX_SUPPLY("Billing reactive energy max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.BILLINGPERIOD).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.LATCHINGQUANTITY).flow(FlowDirection.LEADING).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.VOLTAMPEREREACTIVE)),

        DAILY_ACTIVE_ENERGY_CUM_MAX_DEMAND("Daily active energy cum. max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.CUMULATIVE).flow(FlowDirection.FORWARD).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        MONTHLY_ACTIVE_ENERGY_CUM_MAX_DEMAND("Monthly active energy cum. max demand", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.CUMULATIVE).flow(FlowDirection.FORWARD).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        ...
        DAILY_ACTIVE_ENERGY_CUM_MAX_SUPPLY("Daily active energy cum. max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.DAILY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.CUMULATIVE).flow(FlowDirection.REVERSE).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
        MONTHLY_ACTIVE_ENERGY_CUM_MAX_SUPPLY("Monthly active energy cum. max supply", ReadingTypeCodeBuilder.of(Commodity.ELECTRICITY_SECONDARY_METERED).period(MacroPeriod.MONTHLY).aggregate(Aggregate.MAXIMUM).accumulate(Accumulation.CUMULATIVE).flow(FlowDirection.REVERSE).measure(MeasurementKind.DEMAND).in(ReadingTypeUnit.WATT)),
