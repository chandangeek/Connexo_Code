...
public class GasDetailImpl extends UsagePointDetailImpl implements GasDetail {
    ...
    @HasQuantityUnit(units =  {Unit.PASCAL}, groups = {Save.Create.class, Save.Update.class}, message = "{" + MessageSeeds.Constants.ILLEGAL_UNIT + "}")
    private Quantity pressure;
    @HasQuantityUnit(units =  {Unit.CUBIC_METER_PER_HOUR}, groups = {Save.Create.class, Save.Update.class}, message = "{" + MessageSeeds.Constants.ILLEGAL_UNIT + "}")
