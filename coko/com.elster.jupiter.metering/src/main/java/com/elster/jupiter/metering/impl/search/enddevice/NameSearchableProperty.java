...
public class NameSearchableProperty implements SearchableEndDeviceProperty {
    ...
    public NameSearchableProperty(EndDeviceSearchDomain domain, PropertySpecService propertySpecService, Thesaurus thesaurus) {
        super();
        this.domain = domain;
    ...
    public String getDisplayName() {
        return PropertyTranslationKeys.ENDDEVICE_NAME.getDisplayName(this.thesaurus);
    }
    ...
    public PropertySpec getSpecification() {
        return this.propertySpecService
                .stringSpec()
                .named(FIELDNAME, PropertyTranslationKeys.ENDDEVICE_NAME)
