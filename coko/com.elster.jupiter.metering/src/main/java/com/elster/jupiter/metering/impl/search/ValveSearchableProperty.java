...
class ValveSearchableProperty implements SearchableUsagePointProperty {
    ...
    public ValveSearchableProperty init(SearchDomain domain, ServiceKindAwareSearchablePropertyGroup group, Clock clock) {
        this.domain = domain;
        this.group = group;
        this.clock = clock;
    ...
    public String getDisplayName() {
        return PropertyTranslationKeys.USAGEPOINT_VALVE.getDisplayName(this.thesaurus);
    }
