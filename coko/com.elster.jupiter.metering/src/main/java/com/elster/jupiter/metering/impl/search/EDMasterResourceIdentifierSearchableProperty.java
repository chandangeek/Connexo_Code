 ...
 */
public class EDMasterResourceIdentifierSearchableProperty implements SearchableEndDeviceProperty {
    ...
    public EDMasterResourceIdentifierSearchableProperty(EndDeviceSearchDomain domain, PropertySpecService propertySpecService, Thesaurus thesaurus) {
        super();
        this.domain = domain;
    ...
    public String getDisplayName() {
        return EDPropertyTranslationKeys.ENDDEVICE_MRID.getDisplayName(this.thesaurus);
    }
