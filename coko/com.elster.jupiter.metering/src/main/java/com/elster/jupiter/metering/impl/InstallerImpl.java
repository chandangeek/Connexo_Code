...
public class InstallerImpl {
    ...
    public InstallerImpl(DataModel dataModel, IdsService idsService, PartyService partyService, UserService userService, EventService eventService, Thesaurus thesaurus) {
