...
public class EDNameSearchableProperty implements SearchableEndDeviceProperty {
    ...
    public EDNameSearchableProperty(EndDeviceSearchDomain domain, PropertySpecService propertySpecService, Thesaurus thesaurus) {
        super();
        this.domain = domain;
    ...
    public String getDisplayName() {
        return EDPropertyTranslationKeys.ENDDEVICE_NAME.getDisplayName(this.thesaurus);
    }
