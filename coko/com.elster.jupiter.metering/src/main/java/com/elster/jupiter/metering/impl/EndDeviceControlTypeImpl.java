...
public final class EndDeviceControlTypeImpl implements EndDeviceControlType, PersistenceAware {
    ...
    @Inject
    EndDeviceControlTypeImpl(DataModel dataModel, Thesaurus thesaurus) {
        this.dataModel = dataModel;
        this.thesaurus = thesaurus;
    }

    EndDeviceControlTypeImpl init(String mRID) {
        this.mRID = mRID;
        setTransientFields();
        return this;
    }
    ...
    public void persist() {
        dataModel.mapper(EndDeviceControlType.class).persist(this);
    }
