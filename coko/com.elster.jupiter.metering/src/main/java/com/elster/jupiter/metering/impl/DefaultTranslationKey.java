...
public enum DefaultTranslationKey implements TranslationKey{
    ...
    PRIVILEGE_READING_TYPE_DESCRIPTION("metering.reading.types.description", "Administrate reading types"),
    PRIVILEGE_SERVICE_CATEGORY_NAME("metering.service.category", "Service categories"),
    PRIVILEGE_SERVICE_CATEGORY_DESCRIPTION("metering.service.category.description", "Administrate service categories"),
