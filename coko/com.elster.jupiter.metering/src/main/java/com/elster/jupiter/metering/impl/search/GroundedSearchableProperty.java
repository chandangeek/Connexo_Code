...
class GroundedSearchableProperty implements SearchableUsagePointProperty {
    ...
    @Inject
    GroundedSearchableProperty(PropertySpecService propertySpecService, MeteringTranslationService meteringTranslationService, Thesaurus thesaurus) {
    ...
    public PropertySpec getSpecification() {
        return this.propertySpecService
                ...
                .named(uniqueName, PropertyTranslationKeys.USAGEPOINT_GROUNDED)
