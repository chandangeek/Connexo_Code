...
public class EstimatedLoadSearchableProperty implements SearchableUsagePointProperty {
    ...
    private static final String FIELDNAME = "detail.estimatedLoad";

    public EstimatedLoadSearchableProperty(SearchDomain domain, PropertySpecService propertySpecService, SearchablePropertyGroup group, Thesaurus thesaurus) {
        super();
        this.domain = domain;
        this.group = group;
    ...
    public PropertySpec getSpecification() {
        return this.propertySpecService
                ...
                .named(FIELDNAME, PropertyTranslationKeys.USAGEPOINT_ESTIMATEDLOAD)
