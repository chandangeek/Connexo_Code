...
public enum MessageSeeds implements MessageSeed {
    ...
    CUSTOM_PROPERTY_MUST_BE_NUMERICAL(6022, Constants.CUSTOM_PROPERTY_MUST_BE_NUMERICAL, "The property ''{0}'' of custom property set ''{1}'' must be numerical."),
    ...
    VERSION_START_SHOULD_BE_GREATER_THAN_UP_CREATION_DATE(7014, Constants.VERSION_START_SHOULD_BE_GREATER_THAN_UP_CREATION_DATE, "Version must be after usage point creation date")
    ;
    ...
    public enum Constants {
        ...
        public static final String VERSION_START_SHOULD_BE_GREATER_THAN_UP_CREATION_DATE = "version.start.should.be.greater.than.up.creation.date";
    }
