...
public enum MessageSeeds implements MessageSeed {
    ...
    CUSTOM_PROPERTY_MUST_BE_NUMERICAL_OR_SYNTHETIC_LOAD_PROFILE(5028, Constants.CUSTOM_PROPERTY_MUST_BE_NUMERICAL_OR_SYNTHETIC_LOAD_PROFILE, "The property ''{0}'' of custom property set ''{1}'' must be numerical or synthetic load profile."),
    ...
    DUPLICATE_SLP_NAME(10001, Constants.DUPLICATE_SLP_NAME, "Synthetic load profile name must be unique", Level.SEVERE)
    ;
    ...
    public enum Constants {
        ...
        public static final String CUSTOM_PROPERTY_MUST_BE_NUMERICAL_OR_SYNTHETIC_LOAD_PROFILE = "cps.property.not.numerical.or.slp";
