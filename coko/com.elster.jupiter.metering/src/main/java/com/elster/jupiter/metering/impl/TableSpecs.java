...
public enum TableSpecs {
    ...
    MTR_LOCATION_TEMPLATE {
        ...
        void addTo(DataModel dataModel) {
            ...
            Column idColumn = table.addAutoIdColumn();
            Column templateColumn = table.column("LOCATIONTEMPLATE").varChar(Table.NAME_LENGTH).map("locationTemplate").add();
    ...
    MTR_LOCATIONMEMBER {
        ...
        void addTo(DataModel dataModel) {
            ...
            Column locationIdColumn = table.column("LOCATIONID").number().notNull().conversion(ColumnConversion.NUMBER2LONG).add();
