...
public class ReadingStorerImplIT {
    ...
    public void testWriteBulkData() {
        ...
        transactionService.run(() -> {
            ...
            intervalBlock.addIntervalReading(IntervalReadingImpl.of(BASE.plusMinutes(15).toInstant(), BigDecimal.valueOf(11000, 2), ProfileStatus.of(ProfileStatus.Flag.BATTERY_LOW)));
    ...
    public void testWritePulseDataWithMultiplier() {
        ...
        transactionService.run(() -> {
            ...
            intervalBlock.addIntervalReading(IntervalReadingImpl.of(BASE.plusMinutes(15).toInstant(), BigDecimal.valueOf(11, 0), ProfileStatus.of(ProfileStatus.Flag.BATTERY_LOW)));
    ...
    public void testWriteBulkDataWithBackflowUnderflowAndOverflowForMdcAndMdm() {
        ...
        intervalBlock.addIntervalReading(IntervalReadingImpl.of(BASE.plusMinutes(30).toInstant(), BigDecimal.valueOf(100, 0), ProfileStatus.of()));
