...
public class ValveSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        ValveSearchableProperty property = this.getTestInstance();
    ...
    private ValveSearchableProperty getTestInstance() {
        return new ValveSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new WaterAttributesSearchablePropertyGroup(this.thesaurus), this.clock);
    }
}
