    ...
    public void generateTest() {
        getTransactionService().execute(new VoidTransaction(){
            ...
            protected void doPerform() {
                ...
                ReadingTypeGeneratorForElectricity readingTypeGeneratorForElectricity = new ReadingTypeGeneratorForElectricity(getMeteringService());
                readingTypeGeneratorForElectricity.generateReadingTypes();
