...
public class PhysicalCapacityGasSearchablePropertyTest {
    ...
    public void testGetDomain() {
        PhysicalCapacityGasSearchableProperty property = this.getTestInstance();
    ...
    private PhysicalCapacityGasSearchableProperty getTestInstance() {
        return new PhysicalCapacityGasSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
