...
public class ChannelImplTest extends EqualsContractTest {
    ...
    public void setUp() {
        ...
        channel = createChannel().init(channelsContainer, ImmutableList.of(readingType1, readingType2), Optional.empty());
    }
    ...
    public void testInitWithInconsistentIntervalLength() {
        createChannel().init(channelsContainer, ImmutableList.of(readingType1, readingType3), Optional.empty());
    }
    ...
    public void testInitIrregularTimeSeriesWithAdditionalReadingTypes() {
        ...
        channel = createChannel().init(channelsContainer, ImmutableList.of(readingType1, readingType2, readingType4), Optional.empty());
    ...
    public void testValidateBillingReadingWithTimestampLessThanStart() {
        ...
        channel = createChannel().init(channelsContainer, ImmutableList.of(readingType1), Optional.empty());
