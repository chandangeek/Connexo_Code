...
public class CollarElectricitySearchablePropertyTest {
    ...
    public void testGetDomain() {
        CollarElectricitySearchableProperty property = this.getTestInstance();
    ...
    private CollarElectricitySearchableProperty getTestInstance() {
        return new CollarElectricitySearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
