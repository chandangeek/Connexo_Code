...
public class ClampedWaterSearchablePropertyTest {
    ...
    public void testGetDomain() {
        ClampedWaterSearchableProperty property = this.getTestInstance();
    ...
    private ClampedWaterSearchableProperty getTestInstance() {
        return new ClampedWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
