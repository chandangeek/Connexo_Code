...
public class PressureGasSearchablePropertyTest {
    ...
    public void testGetDomain() {
        PressureGasSearchableProperty property = this.getTestInstance();
    ...
    private PressureGasSearchableProperty getTestInstance() {
        return new PressureGasSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
