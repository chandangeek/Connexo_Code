...
public class DataAggregationServiceImplCalculateWithVolumeToFlowConversionIT {
    ...
    public void simplestNetConsumptionOfProsumer() {
        ...
        ReadingTypeRequirement consumption = this.configuration.newReadingTypeRequirement("A-").withMeterRole(METER_ROLE).withReadingType(fifteenMinuteskWhForward);
        this.consumptionRequirementId = consumption.getId();
        ReadingTypeRequirement production = this.configuration.newReadingTypeRequirement("A+").withMeterRole(METER_ROLE).withReadingType(fifteenMinuteskWReverse);
    ...
    public void monthlyNetConsumptionBasedOn15And60MinValuesOfProsumer() {
        ...
        ReadingTypeRequirement consumption = this.configuration.newReadingTypeRequirement("A-").withMeterRole(METER_ROLE).withReadingType(fifteenMinuteskWhForward);
        this.consumptionRequirementId = consumption.getId();
        ReadingTypeRequirement production = this.configuration.newReadingTypeRequirement("A+").withMeterRole(METER_ROLE).withReadingType(hourlykWReverse);
        this.productionRequirementId = production.getId();
