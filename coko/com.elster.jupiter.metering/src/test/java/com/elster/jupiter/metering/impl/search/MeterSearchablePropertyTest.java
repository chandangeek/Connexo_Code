...
public class MeterSearchablePropertyTest {
    @Mock
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getString(eq(PropertyTranslationKeys.USAGEPOINT_METER.getKey()), anyString());
    }
    ...
    private MeterSearchableProperty getTestInstance() {
        return new MeterSearchableProperty(this.domain, this.propertySpecService, this.meteringService);
    }
}