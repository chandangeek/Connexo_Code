...
/**
 * Tests the {@link RecordTimeFromExpressionNode} component.
 */
@RunWith(MockitoJUnitRunner.class)
public class RecordTimeFromExpressionNodeTest {
    ...
    public void unvisitedReturnsNull() {
        RecordTimeFromExpressionNode visitor = getInstance();
    ...
    public void deliverableNodeOnlyReturnsDeliverableSqlName() {
        ...
        // Asserts
        assertThat(visitor.getSqlName()).isEqualTo("deliverable." + SqlConstants.TimeSeriesColumnNames.RECORDTIME.sqlName());
    }
    ...
    public void twoDeliverableNodesReturnsFirstDeliverableSqlName() {
        ...
        // Asserts
        assertThat(visitor.getSqlName()).isEqualTo("deliverable1." + SqlConstants.TimeSeriesColumnNames.RECORDTIME.sqlName());
    }
    ...
    public void requirementNodeOnlyReturnsDeliverableSqlName() {
        ...
        // Asserts
        assertThat(visitor.getSqlName()).isEqualTo("requirement." + SqlConstants.TimeSeriesColumnNames.RECORDTIME.sqlName());
    }
    ...
    private RecordTimeFromExpressionNode getInstance() {
        return new RecordTimeFromExpressionNode();
    }
}