...
public class PhysicalCapacityWaterSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        PhysicalCapacityWaterSearchableProperty property = this.getTestInstance();
    ...
    private PhysicalCapacityWaterSearchableProperty getTestInstance() {
        return new PhysicalCapacityWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
