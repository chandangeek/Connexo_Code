...
public class LoadLimitGasSearchablePropertyTest {
    ...
    public void testGetDomain() {
        LoadLimitGasSearchableProperty property = this.getTestInstance();
    ...
    private LoadLimitGasSearchableProperty getTestInstance() {
        return new LoadLimitGasSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
