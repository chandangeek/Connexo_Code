...
public class LoadLimitSearchablePropertyTest {
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.USAGEPOINT_LOADLIMIT);
    }
    ...
    private LoadLimitSearchableProperty getTestInstance() {
        return new LoadLimitSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(this.thesaurus), this.clock);
    }
}
