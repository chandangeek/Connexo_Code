...
public class CollarWaterSearchablePropertyTest {
    ...
    public void testGetDomain() {
        CollarWaterSearchableProperty property = this.getTestInstance();
    ...
    private CollarWaterSearchableProperty getTestInstance() {
        return new CollarWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
