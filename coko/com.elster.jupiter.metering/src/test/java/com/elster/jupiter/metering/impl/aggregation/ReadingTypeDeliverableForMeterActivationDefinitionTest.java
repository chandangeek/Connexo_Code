...
public class ReadingTypeDeliverableForMeterActivationDefinitionTest {
    ...
    public void appendDefinitionTo() {
        ...
        assertThat(selectClause).isEqualTo("'ReadingTypeDeliverableForMeterActivationDefinitionTest', rod97_1.value, rod97_1.localdate, rod97_1.timestamp, rod97_1.readingQuality, 1   FROM rod97_1");
    }
    ...
    public void appendDefinitionToWithAutoTimeBasedAggregation() {
        ...
        // Asserts
        String selectClause = this.selectClauseSqlBuilder.getText().replace("\n", " ");
        assertThat(selectClause).isEqualToIgnoringCase("'ReadingTypeDeliverableForMeterActivationDefinitionTest', SUM(rod97_1.value), TRUNC(rod97_1.localdate, 'MONTH'), MAX(rod97_1.timestamp), max(rod97_1.readingQuality), count(*)   FROM rod97_1 GROUP BY TRUNC(rod97_1.localdate, 'MONTH')");
    }
