...
public class GroundedSearchablePropertyTest {
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.USAGEPOINT_GROUNDED);
    }
    ...
    private GroundedSearchableProperty getTestInstance() {
        return new GroundedSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(this.thesaurus), this.clock);
    }
}
