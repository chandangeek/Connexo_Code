...
public class CollarGasSearchablePropertyTest {
    ...
    public void testGetDomain() {
        CollarGasSearchableProperty property = this.getTestInstance();
    ...
    private CollarGasSearchableProperty getTestInstance() {
        return new CollarGasSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
