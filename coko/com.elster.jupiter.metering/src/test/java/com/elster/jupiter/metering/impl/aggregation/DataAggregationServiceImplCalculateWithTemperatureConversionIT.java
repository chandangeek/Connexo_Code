...
public class DataAggregationServiceImplCalculateWithTemperatureConversionIT {
    ...
    public void initializeMocks() {
        when(this.usagePoint.getName()).thenReturn("DataAggregationServiceImplCalculateWithTemperatureConversionIT");
        when(this.metrologyPurpose.getName()).thenReturn("DataAggregationServiceImplCalculateWithTemperatureConversionIT");
