...
public class NominalServiceVoltageSearchablePropertyTest {
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.USAGEPOINT_NOMINALVOLTAGE);
    }
    ...
    private NominalServiceVoltageSearchableProperty getTestInstance() {
        return new NominalServiceVoltageSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(thesaurus), this.clock);
    }
}
