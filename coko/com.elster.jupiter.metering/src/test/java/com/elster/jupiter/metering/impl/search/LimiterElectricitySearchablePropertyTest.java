...
public class LimiterElectricitySearchablePropertyTest {
    ...
    public void testGetDomain() {
        LimiterElectricitySearchableProperty property = this.getTestInstance();
    ...
    private LimiterElectricitySearchableProperty getTestInstance() {
        return new LimiterElectricitySearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
