...
public class PhysicalCapacityThermalSearchablePropertyTest {
    ...
    public void testGetDomain() {
        PhysicalCapacityThermalSearchableProperty property = this.getTestInstance();
    ...
    private PhysicalCapacityThermalSearchableProperty getTestInstance() {
        return new PhysicalCapacityThermalSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
