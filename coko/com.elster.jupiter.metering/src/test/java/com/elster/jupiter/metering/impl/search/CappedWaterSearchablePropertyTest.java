...
public class CappedWaterSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        CappedWaterSearchableProperty property = this.getTestInstance();
    ...
    private CappedWaterSearchableProperty getTestInstance() {
        return new CappedWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
