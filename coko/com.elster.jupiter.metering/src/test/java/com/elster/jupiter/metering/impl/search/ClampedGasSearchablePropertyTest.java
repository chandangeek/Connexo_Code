...
public class ClampedGasSearchablePropertyTest {
    ...
    public void testGetDomain() {
        ClampedGasSearchableProperty property = this.getTestInstance();
    ...
    private ClampedGasSearchableProperty getTestInstance() {
        return new ClampedGasSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
