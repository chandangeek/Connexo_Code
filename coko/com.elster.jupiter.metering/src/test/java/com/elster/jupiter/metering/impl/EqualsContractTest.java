...
public abstract class EqualsContractTest {
    ...
    public void testEquality() {
        ...
        assertThat(a.equals(getInstanceNotEqualToA())).isFalse();
    }
    ...
    public void testSymmetry() {
        ...
        Object b = getInstanceNotEqualToA();
    ...
    public void testDifferentHashCodesForDifferentInstances() {
        ...
        assertThat(getInstanceNotEqualToA().hashCode()).describedAs("hashCode() is strongly recommended to be different for different objects").isNotEqualTo(hash);
    }
     ...
     * @return an instance of the class under test equal to getInstanceA(), yet not the same, this method should return a new instance each time.
     */
    protected abstract Object getInstanceNotEqualToA();
