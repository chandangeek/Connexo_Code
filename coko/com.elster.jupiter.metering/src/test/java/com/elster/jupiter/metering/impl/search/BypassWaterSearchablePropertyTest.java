...
public class BypassWaterSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        BypassWaterSearchableProperty property = this.getTestInstance();
    ...
    private BypassWaterSearchableProperty getTestInstance() {
        return new BypassWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
