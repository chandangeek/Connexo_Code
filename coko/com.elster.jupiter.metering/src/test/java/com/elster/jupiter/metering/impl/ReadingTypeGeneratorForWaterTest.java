    ...
    public void generateTest() {
        getTransactionService().execute(new VoidTransaction() {
            ...
            protected void doPerform() {
                ...
                ReadingTypeGeneratorForWater readingTypeGeneratorForWater = new ReadingTypeGeneratorForWater(getMeteringService());
                readingTypeGeneratorForWater.generateReadingTypes();
