    ...
    public void generateTest() {
        getTransactionService().execute(new VoidTransaction() {
            ...
            protected void doPerform() {
                ...
                ReadingTypeGeneratorForWater readingTypeGeneratorForWater = new ReadingTypeGeneratorForWater();
                List<Pair<String, String>> readingTypes = readingTypeGeneratorForWater.generateReadingTypes();
