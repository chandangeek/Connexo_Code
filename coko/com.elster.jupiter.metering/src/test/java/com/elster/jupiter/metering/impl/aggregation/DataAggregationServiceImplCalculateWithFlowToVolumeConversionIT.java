...
public class DataAggregationServiceImplCalculateWithFlowToVolumeConversionIT {
    ...
    private static MeteringDataModelService meteringDataModelService;
    ...
    public static void setUp() {
        meteringDataModelService = mock(MeteringDataModelService.class);
        setupThesaurus();
        setupServices();
        setupReadingTypes();
    ...
    private static void setupThesaurus() {
        ...
        when(meteringDataModelService.getThesaurus()).thenReturn(thesaurus);
    }
    ...
    public void monthlyNetConsumptionBasedOn15MinValuesOfProsumer() {
        ...
        try {
            ...
            assertThat(this.netConsumptionWithClauseBuilder.getText())
                    .matches(".*[sum|SUM]\\(realrod" + netConsumptionDeliverableId + "_1\\.value\\).*");
            assertThat(this.netConsumptionWithClauseBuilder.getText())
