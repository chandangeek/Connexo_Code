...
public class GroundedElectricitySearchablePropertyTest {
    @Mock
    ...
    private GroundedElectricitySearchableProperty getTestInstance() {
        return new GroundedElectricitySearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
