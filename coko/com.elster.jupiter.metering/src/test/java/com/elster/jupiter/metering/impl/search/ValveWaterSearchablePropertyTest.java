...
public class ValveWaterSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        ValveWaterSearchableProperty property = this.getTestInstance();
    ...
    private ValveWaterSearchableProperty getTestInstance() {
        return new ValveWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
