...
public class GroundedGasSearchablePropertyTest {
    ...
    public void testGetDomain() {
        GroundedGasSearchableProperty property = this.getTestInstance();
    ...
    private GroundedGasSearchableProperty getTestInstance() {
        return new GroundedGasSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
