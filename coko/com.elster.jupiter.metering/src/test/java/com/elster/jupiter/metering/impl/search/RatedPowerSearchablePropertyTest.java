...
public class RatedPowerSearchablePropertyTest {
    ...
    public void testGetDomain() {
        RatedPowerSearchableProperty property = this.getTestInstance();
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getString(eq(PropertyTranslationKeys.USAGEPOINT_RATEDPOWER.getKey()), anyString());
    }
    ...
    private RatedPowerSearchableProperty getTestInstance() {
        return new RatedPowerSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(thesaurus), this.clock);
    }
