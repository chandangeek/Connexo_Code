...
public class RatedPowerSearchablePropertyTest {
    ...
    private RatedPowerSearchableProperty getTestInstance() {
        return new RatedPowerSearchableProperty(this.propertySpecService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(thesaurus), this.clock);
    }
