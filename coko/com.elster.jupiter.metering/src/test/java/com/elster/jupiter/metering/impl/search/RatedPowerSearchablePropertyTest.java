...
public class RatedPowerSearchablePropertyTest {
    ...
    private RatedPowerSearchableProperty getTestInstance() {
        return new RatedPowerSearchableProperty(this.domain, this.propertySpecService, new ElectricityAttributesSearchablePropertyGroup(thesaurus), this.thesaurus);
    }
