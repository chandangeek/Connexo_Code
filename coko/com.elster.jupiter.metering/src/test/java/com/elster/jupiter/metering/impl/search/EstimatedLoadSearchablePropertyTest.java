...
public class EstimatedLoadSearchablePropertyTest {
    ...
    private EstimatedLoadSearchableProperty getTestInstance() {
        return new EstimatedLoadSearchableProperty(this.propertySpecService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(this.thesaurus), this.clock);
    }
}
