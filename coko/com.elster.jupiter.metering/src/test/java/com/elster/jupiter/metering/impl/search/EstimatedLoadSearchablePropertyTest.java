...
public class EstimatedLoadSearchablePropertyTest {
    ...
    private EstimatedLoadSearchableProperty getTestInstance() {
        return new EstimatedLoadSearchableProperty(this.domain, this.propertySpecService, new ElectricityAttributesSearchablePropertyGroup(thesaurus), this.thesaurus);
    }
}
