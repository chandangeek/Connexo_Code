...
public class EstimatedLoadSearchablePropertyTest {
    ...
    public void testGetDomain() {
        EstimatedLoadSearchableProperty property = this.getTestInstance();
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getString(eq(PropertyTranslationKeys.USAGEPOINT_ESTIMATEDLOAD.getKey()), anyString());
    }
    ...
    private EstimatedLoadSearchableProperty getTestInstance() {
        return new EstimatedLoadSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(this.thesaurus), this.clock);
    }
}
