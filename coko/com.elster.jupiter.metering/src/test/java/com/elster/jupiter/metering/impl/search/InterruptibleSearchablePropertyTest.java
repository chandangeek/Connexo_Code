...
public class InterruptibleSearchablePropertyTest {
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.USAGEPOINT_INTERRUPTABLE);
    }
    ...
    private InterruptibleSearchableProperty getTestInstance() {
        return new InterruptibleSearchableProperty(this.propertySpecService, this.meteringTranslationService, this.thesaurus).init(this.domain, new ElectricityAttributesSearchablePropertyGroup(this.thesaurus), this.clock);
    }
}
