...
public class LoadLimitWaterSearchablePropertyTest {
    ...
    public void testGetDomain() {
        LoadLimitWaterSearchableProperty property = this.getTestInstance();
    ...
    private LoadLimitWaterSearchableProperty getTestInstance() {
        return new LoadLimitWaterSearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
