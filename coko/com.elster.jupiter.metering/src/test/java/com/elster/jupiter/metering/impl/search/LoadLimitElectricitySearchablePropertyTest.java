...
public class LoadLimitElectricitySearchablePropertyTest {
    ...
    public void testGetDomain() {
        LoadLimitElectricitySearchableProperty property = this.getTestInstance();
    ...
    private LoadLimitElectricitySearchableProperty getTestInstance() {
        return new LoadLimitElectricitySearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
