...
public class ReadingTypeDeliverableForMeterActivationSetDefinitionTest {
    ...
    public void appendDefinitionTo() {
        ...
        assertThat(selectClause).isEqualTo("'ReadingTypeDeliverableForMeterActivationSetDefinitionTest', rod97_1.value, rod97_1.localdate, rod97_1.timestamp, rod97_1.readingQuality, 1, MAX(rod97_1.sourceChannels)   FROM rod97_1");
    }
