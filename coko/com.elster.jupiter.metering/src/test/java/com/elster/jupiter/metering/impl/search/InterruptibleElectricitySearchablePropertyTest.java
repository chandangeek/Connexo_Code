...
public class InterruptibleElectricitySearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        InterruptibleElectricitySearchableProperty property = this.getTestInstance();
    ...
    private InterruptibleElectricitySearchableProperty getTestInstance() {
        return new InterruptibleElectricitySearchableProperty(this.domain, this.propertySpecService, this.thesaurus);
    }
}
