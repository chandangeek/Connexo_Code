...
public class ReadingConfirmTest {
    ...
    public void test() {
        ...
        try (TransactionContext ctx = transactionService.getContext()) {
            ...
            channel.confirmReadings(QualityCodeSystem.MDC, ImmutableSet.of(QualityCodeSystem.MDC), ImmutableList.of(reading1, reading2));
            // existDate qualities
            assertQualities(channel, existDate, new ReadingQualityType[] {
        ...
        try (TransactionContext ctx = transactionService.getContext()) {
            ...
            channel.confirmReadings(QualityCodeSystem.MDM, Collections.emptySet(), ImmutableList.of(reading1, reading2));
            // existDate qualities
            assertQualities(channel, existDate, new ReadingQualityType[] {
