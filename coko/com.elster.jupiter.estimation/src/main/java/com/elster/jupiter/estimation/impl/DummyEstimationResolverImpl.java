...
@Component(name = "com.elster.jupiter.estimation.dummyresolver", service = {EstimationResolver.class}, property = "name=" + EstimationService.COMPONENTNAME, immediate = true)
