...
public class ComponentResourceTest extends SystemApplicationJerseyTest {
    ...
    public void testGetComponentsList() {
        ...
        assertThat(model.<Number>get("$.components[0].id")).isEqualTo(4);
        ...
        assertThat(model.<Number>get("$.components[1].id")).isEqualTo(2);
        ...
        assertThat(model.<Number>get("$.components[2].id")).isEqualTo(3);
        ...
        assertThat(model.<Number>get("$.components[3].id")).isEqualTo(5);
        ...
        assertThat(model.<Number>get("$.components[4].id")).isEqualTo(1);
    ...
    public void testGetComponentsListFilterByApplication() throws UnsupportedEncodingException {
        ...
        assertThat(model.<List<Number>>get("$.components[*].id")).containsExactly(5, 1);
    }
    ...
    public void testGetComponentsListFilterByBundleType() throws UnsupportedEncodingException {
        ...
        assertThat(model.<List<Number>>get("$.components[*].id")).containsExactly(2, 3, 1);
    }
    ...
    private RuntimeComponent mockRuntimeComponent(long id, String name, String application, BundleType bundleType) {
        RuntimeComponent runtimeComponent = mock(RuntimeComponent.class);
        when(runtimeComponent.getId()).thenReturn(id);
