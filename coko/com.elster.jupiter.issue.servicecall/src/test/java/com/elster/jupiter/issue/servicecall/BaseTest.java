...
import com.elster.jupiter.issue.servicecall.impl.ServiceCallIssueActionsFactory;
import com.elster.jupiter.issue.servicecall.impl.ServiceCallIssueModule;
import com.elster.jupiter.issue.servicecall.impl.ServiceCallIssueServiceImpl;
...
public abstract class BaseTest {
    ...
    public static void setEnvironment() {
        ...
        try (TransactionContext ctx = injector.getInstance(TransactionService.class).getContext()) {
            ...
            injector.getInstance(ServiceCallIssueService.class);
    ...
    protected ServiceCallIssueService getServiceCallIssueService() {
        return injector.getInstance(ServiceCallIssueService.class);
    }
    ...
    protected CreationRule getCreationRule(String name, String reason) {
        ...
        builder.setIssueType(getIssueService().findIssueType(ServiceCallIssueService.ISSUE_TYPE_NAME).get());
...
//            }));
    ...
    protected DataModel getDataModel() {
        return ((ServiceCallIssueServiceImpl) getServiceCallIssueService()).getDataModel();
    }
    ...
    protected ServiceCallIssueActionsFactory getDefaultActionsFactory() {
        return injector.getInstance(ServiceCallIssueActionsFactory.class);
    }
