...
public class CloseIssueAction extends AbstractIssueAction {
    ...
    public boolean isApplicable(Issue issue) {
        return super.isApplicable(issue) && (IssueStatus.OPEN.equals(issue.getStatus().getKey()) || IssueStatus.SNOOZED.equals(issue.getStatus().getKey()) || IssueStatus.IN_PROGRESS.equals(issue.getStatus().getKey()));
    }
