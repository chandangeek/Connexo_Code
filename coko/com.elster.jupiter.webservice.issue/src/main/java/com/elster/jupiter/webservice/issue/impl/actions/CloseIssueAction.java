...
public class CloseIssueAction extends AbstractIssueAction {
    ...
    @Inject
    protected CloseIssueAction(DataModel dataModel, Thesaurus thesaurus,
    ...
    public IssueActionResult execute(Issue issue) {
        ...
        if (!closeStatus.isPresent()) {
            result.fail(getThesaurus().getSimpleFormat(MessageSeeds.CLOSE_ACTION_WRONG_STATUS).format());
            return result;
        }
    ...
    public List<PropertySpec> getPropertySpecs() {
        ...
        builder.add(
                getPropertySpecService()
                        ...
                        .named(CLOSE_STATUS, TranslationKeys.ACTION_CLOSE_PROPERTY_CLOSE_STATUS)
        ...
        builder.add(getPropertySpecService()
                ...
                .named(COMMENT, TranslationKeys.ACTION_CLOSE_PROPERTY_COMMENT)
                .fromThesaurus(getThesaurus())
                .finish());
    ...
    public String getDisplayName() {
        return getThesaurus().getFormat(TranslationKeys.ACTION_CLOSE_ISSUE).format();
    }
