...
public enum MessageSeeds implements MessageSeed {
    ...
    APP_SERVER_FAIL_DEACTIVATE_BODY(3, "AppServerDeActivateBody", "{0} has changed since the page was last updated."),
    INVALIDCHARS_EXCEPTION(1017, "InvalidChars", "Characters {0} are not allowed."),
