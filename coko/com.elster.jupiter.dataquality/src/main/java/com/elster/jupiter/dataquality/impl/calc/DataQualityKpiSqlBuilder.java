...
abstract class  DataQualityKpiSqlBuilder {
    ...
    private void appendAllReadingQualitiesWithClause() {
        ...
        sqlBuilder.append(" SELECT q.channelid, utc2date(q.readingtimestamp, t.timezonename), q.type, CASE WHEN q.channelid IS NULL THEN 'Y' ELSE 'N' END");
        sqlBuilder.append(" FROM MTR_READINGQUALITY q");
