...
Ext.define('Dxp.view.tasks.AddReadingTypesNoItemsFoundPanel', {
        ...
        me.items = [
                ...
                items: [
                    {
                        ...
                        html: Uni.I18n.translate('readingType.noReadingType', 'DES', 'No reading types selected'),
                        margin: '0 8 0 0',
                        ...
                        items: [
                            {
                                ...
                                text: Uni.I18n.translate('readingType.uncheckAll', 'DES', 'Uncheck all'),
                                action: 'checkAll',
                                margin: '0 0 0 8',
                                listeners: {
                                    click: me.uncheckAll,
            ...
            },
            {
                ...
                reasons: [
                    ...
                    Uni.I18n.translate('validation.readingType.empty.list.item2', 'DES', 'No reading types comply with the filter.'),
                    Uni.I18n.translate('validation.readingType.empty.list.item3', 'DES', 'All reading types have been already added to rule.')
                ]
            }
        ];
