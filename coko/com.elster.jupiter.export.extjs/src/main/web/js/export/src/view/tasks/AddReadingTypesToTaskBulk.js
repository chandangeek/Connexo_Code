...
Ext.define('Dxp.view.tasks.AddReadingTypesToTaskBulk', {
    ...
    initComponent: function () {
        ...
        me.getTopToolbarContainer().add(1,{
            ...
            tooltip: Uni.I18n.translate('readingType.tooltip', 'DES', 'Click for more information'),
    ...
    overriddenOnSelectionChange: function () {
        ...
        me.up('#AddReadingTypesToTaskSetup').down('[action=addReadingTypes]').setDisabled(me.hiddenSelection.length === 0);
    },
    ...
    onSelectionChange: function () {
        var me =this,
            ...
            selectedStore =  Ext.getStore('Dxp.store.SelectedReadingTypes');
