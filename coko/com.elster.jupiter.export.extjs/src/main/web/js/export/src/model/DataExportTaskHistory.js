...
Ext.define('Dxp.model.DataExportTaskHistory', {
    ...
    fields: [
        ...
        {name: 'updatePeriodFrom', type: 'number'},
        {name: 'updatePeriodTo', type: 'number'},
        {
            name: 'name',
            persist:false,
            mapping: 'task.name'
        ...
        },
        {
            ...
            mapping: function (data) {
                if (data.task.standardDataSelector && data.task.standardDataSelector.usagePointGroup) {
                    return data.task.standardDataSelector.usagePointGroup.id;
                } else {
                    return '-';
                }
            }
        },
        {
            ...
            persist: false,
            mapping: function (data) {
                if (data.task.standardDataSelector && data.task.standardDataSelector.purpose) {
                    return data.task.standardDataSelector.purpose.name;
                } else {
                    return null;
                }
            }
