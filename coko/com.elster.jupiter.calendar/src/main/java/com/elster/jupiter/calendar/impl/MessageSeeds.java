...
public enum MessageSeeds implements MessageSeed {
    ...
    IMPORT_FAILED_CANT_CHANGE_START_DATE(2037, "ImportFailedCantChangeStartDate", "Can''t change start of calculations date in {0} calendar because it is active.", Level.SEVERE),
