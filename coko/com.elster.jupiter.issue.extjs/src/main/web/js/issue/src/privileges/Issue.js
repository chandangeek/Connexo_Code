...
Ext.define('Isu.privileges.Issue', {
    ...
    commentOrAssing: ['privilege.assign.issue', 'privilege.close.issue'],
    closeOrAssing: ['privilege.close.issue', 'privilege.close.issue'],
    ...
    all: function() {
        return Ext.Array.merge(Isu.privileges.Issue.createRule, Isu.privileges.Issue.comment,Isu.privileges.Issue.adminRule,
            ...
            Isu.privileges.Issue.adminDevice,Isu.privileges.Issue.viewAdminDevice, Isu.privileges.Issue.createManualIssue);
