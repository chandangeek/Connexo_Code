...
Ext.define('Isu.view.devicegroupfromissues.step.SelectDevices', {

    extend: 'Ext.panel.Panel',

    alias: 'widget.select-devices-step',
    ...
    requires: [
        ...
        'Isu.view.devicegroupfromissues.grid.util.DevicesNotFoundPanel',
        'Isu.view.devicegroupfromissues.grid.DevicesGrid'
    ],
        ...
        me.items = [
            {
                ...
                emptyComponent: {
                    xtype: 'devices-not-found-panel',
                    itemId: 'devices-not-found-panel'
                }
            }
        ];
        ...
        me.tbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    html: Uni.I18n.translate('devicegroupfromissues.wizard.step.selectDevices.grid.validationMsg', 'ISU', 'Select at least one device'),
                    hidden: true
                }
            ]
        };
