/**
 * @class Mtr.widget.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Mtr.widget.PortalPanel}.
 */
Ext.define('Mtr.widget.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function (portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Mtr.widget.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
