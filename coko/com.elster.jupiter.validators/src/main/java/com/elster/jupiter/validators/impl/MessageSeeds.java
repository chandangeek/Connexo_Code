...
public enum MessageSeeds implements MessageSeed {
    ...
    MAIN_CHECK_MISC_NO_PURPOSE(2001, "maincheck.validator.misc.no.purpose", "Failed to validate period {0} using method \"{1}\" on {2} since the specified purpose doesn''t exist on the {3}"),
    MAIN_CHECK_MISC_PURPOSE_NEVER_ACTIVATED(2002, "maincheck.validator.misc.purpose.never.activated", "Failed to validate period {0} using method \"{1}\" on {2} since the specified purpose is never activated on effective metrology configuration on the {4}"),
    MAIN_CHECK_MISC_NO_CHECK_OUTPUT(2003, "maincheck.validator.misc.no.check.output", "Failed to validate period {0} using method \"{1}\" on {2} since 'check' output with matching reading type on the specified purpose doesn''t exist on {3}"),
    MAIN_CHECK_MISC_CHECK_OUTPUT_MISSING_OR_NOT_VALID(2004, "maincheck.validator.misc.check.output.missing.or.not.valid", "Failed to validate period {0} using method \"{1}\" on {2}/{3} since data from 'check' output is missing or not validated"),
    ...
    REFERENCE_VALIDATE_PROPS_NO_PURPOSE_ON_USAGE_POINT(3008,"reference.validator.validate.props.no.purpose","Purpose not found on the usage point"),
