...
public class ReferenceValidatorValidatedCheckTest extends ReferenceValidatorTest {
    @Test
    public void test(){
    ...
    private void validateWithIdenticalReadings(ReferenceValidatorRule rule){
        ...
        checkReadings.setReadingValue(1, BIG_DECIMAL_20, INSTANT_2016_FEB_02, ValidationResult.VALID);
        checkReadings.setReadingValue(2, BIG_DECIMAL_30, INSTANT_2016_FEB_03, ValidationResult.VALID);
        ...
        assertEquals(0L, validationConfiguration.validatingChannelReadings.readings.stream()
