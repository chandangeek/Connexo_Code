...
public enum MessageSeeds implements MessageSeed {
    ...
    CORRECTIONFACTOR_WRONG_FIRST_TIMESTAMP(16, "WrongFirstTimestamp", "Can''t process line ''{0}'': wrong first timestamp. First timestamp in the file should match with month, day and hour of ''Start time'' of all of the correction factors specified in the file. Expected date and time: ''{1}'', actual date and time: ''{2}''"),
