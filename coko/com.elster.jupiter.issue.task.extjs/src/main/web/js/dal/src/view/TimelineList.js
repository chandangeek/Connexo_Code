...
Ext.define('Itk.view.TimelineList', {
    ...
    items: [
        {
            ...
            text: Uni.I18n.translate('general.noActivity', 'ITK', 'No activity yet on this issue'),
            hidden: true
        },
        {
            xtype: 'dataview',
            itemId: 'issue-timeline-view',
            title: Uni.I18n.translate('issue.userImages', 'ITK', 'User Images'),
