Ext.define('Itk.view.bulk.Wizard', {
    ...
    listeners: {
        render: function () {
            if (this.includeSubTitle) {
                this.setTitle(Uni.I18n.translate('issue.title.steps', 'ITK', 'Step {0}', 1) + ': ' + this.getActiveItem().title);
            } else {
                this.setTitle(Uni.I18n.translate('issue.title.steps', 'ITK', 'Step {0}', 1));
            }
            this.inWizard = true;
    ...
    onWizardPageChangeEvent: function (wizard) {
        if (this.includeSubTitle) {
            ...
            wizard.setTitle(Uni.I18n.translate('issue.title.steps', 'ITK', 'Step {0}', wizard.activeItemId + 1) + ': ' + this.getActiveItem().title);
        } else {
            wizard.setTitle(Uni.I18n.translate('issue.title.steps', 'ITK', 'Step {0}', wizard.activeItemId + 1));
        }
    ...
    onConfirmButtonClick: function (finish) {
        ...
        if (!wizard.getForm().isValid()) {
            var invalidFields = Uni.I18n.translate('issue.correctErrors.beforeResume','ITK','Please correct the following errors before resumitting<br>');
            ...
            Ext.Msg.show({
                scope: this,
                title: Uni.I18n.translate('issue.wizardInvalid','ITK','Wizard Invalid'),
                msg: invalidFields,
                buttons: Ext.Msg.OK,
                icon: Ext.Msg.ERROR
            });
    ...
    onCancelButtonClick: function (cancel) {
        ...
        if (wizard.getForm().isDirty()) {
            Ext.Msg.show({
                scope: this,
                title: Uni.I18n.translate('issue.cancellingWizard','ITK','Cancelling Wizard'),
                msg: Uni.I18n.translate('issue.cancellingWizard.msg', 'ITK', 'All changes will be lost. Are you sure you want to cancel?'),
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        {
                            xtype: 'button',
                            text: Uni.I18n.translate('general.back', 'ITK', 'Back'),
                            itemId: 'prev',
                            action: 'prevWizard',
                            scope: this,
                        ...
                        {
                            xtype: 'button',
                            text: Uni.I18n.translate('general.next', 'ITK', 'Next'),
                            itemId: 'next',
                            action: 'nextWizard',
                            scope: this,
                        ...
                        {
                            xtype: 'button',
                            text: Uni.I18n.translate('general.confirm', 'ITK', 'Confirm'),
                            itemId: 'finish',
                            action: 'finishWizard',
                            hidden: true,
                            scope: this,
