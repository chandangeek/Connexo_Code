Ext.define('Itk.view.creationrules.EditForm', {
    extend: 'Ext.form.Panel',
    requires: [
        'Itk.view.creationrules.ActionsList',
    ...
    initComponent: function () {
        ...
        me.title = me.isEdit ? ' ' : Uni.I18n.translate('general.issueCreationRules.add', 'ITK', 'Add issue creation rule');
        me.items = [
            {
                itemId: 'form-errors',
            ...
            },
            {
                ...
                fieldLabel: Uni.I18n.translate('general.title.ruleTemplate', 'ITK', 'Rule template'),
                required: true,
                layout: 'hbox',
                width: 650,
                items: [
                    {
                        ...
                        xtype: 'combobox',
                        name: 'template',
                        store: 'Itk.store.CreationRuleTemplates',
                        queryMode: 'local',
            ...
            {
                xtype: 'fieldcontainer',
                fieldLabel: Uni.I18n.translate('general.priority', 'ITK', 'Priority'),
                margin: '0 0 20 0',
                layout: 'hbox',
                items: [
                    {
            ...
            },
            {
                ...
                fieldLabel: Uni.I18n.translate('general.urgency', 'ITK', 'Urgency'),
                layout: 'hbox',
                items: [
                    {
                        xtype: 'numberfield',
                    ...
                    },
                    {
                        ...
                        fieldLabel: Uni.I18n.translate('general.impact', 'ITK', 'Impact'),
                        value: 5,
                        minValue: 1,
                        maxValue: 50,
                        margin: '0 0 0 20',
                        ...
                        items: [
                            {
                                itemId: 'noDueDate',
                                width: 300,
                                boxLabel: Uni.I18n.translate('issueCreationRules.noDueDate', 'ITK', 'No due date'),
                                inputValue: false
                            },
                            {
                                itemId: 'dueIn',
                                boxLabel: Uni.I18n.translate('general.title.dueIn', 'ITK', 'Due in'),
                                inputValue: true,
                                margin: '7 0 0 0'
                            }
                        ],
            ...
            },
            {
                ...
                xtype: 'textareafield',
                name: 'comment',
                fieldLabel: Uni.I18n.translate('general.comment', 'ITK', 'Comment'),
                emptyText: Uni.I18n.translate('general.provideComment','ITK','Provide a comment (optionally)'),
                height: 160
            },
            {
                xtype: 'fieldcontainer',
                fieldLabel: Uni.I18n.translate('general.actions', 'ITK', 'Actions'),
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        value: Uni.I18n.translate('issueCreationRules.noActionsAddedYet', 'ITK', 'There are no actions added yet to this rule')
                    },
                    {
                        xtype: 'button',
                        itemId: 'addAction',
                        text: Uni.I18n.translate('general.addAction', 'ITK', 'Add action'),
                        action: 'addAction',
                        margin: '0 0 0 10'
                    }
                ]
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        ui: 'link',
                        href: me.router.getRoute('administration/issuecreationrules').buildUrl()
                    }
                ]
            }
        ];
    ...
    loadRecord: function (record) {
        ...
        Ext.suspendLayouts();
        if (me.isEdit) {
            me.setTitle(Uni.I18n.translate('administration.issueCreationRules.title.editIssueCreationRule', 'ITK', "Edit '{0}'", [record.get('name')]));
        }
    ...
    changePriority: function()
    {
        ...
        priorityLabel = (priority <= 2) ? Uni.I18n.translate('issue.priority.veryLow', 'ITK', 'Very low') :
            (priority <= 4) ? Uni.I18n.translate('issue.priority.low', 'ITK', 'Low') :
                (priority <= 6) ? Uni.I18n.translate('issue.priority.medium', 'ITK', 'Medium') :
                    (priority <= 8) ? Uni.I18n.translate('issue.priority.high', 'ITK', 'High') :
