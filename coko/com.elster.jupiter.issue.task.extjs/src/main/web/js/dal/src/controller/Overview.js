Ext.define('Itk.controller.Overview', {
    ...
    constructor: function () {
        ...
        me.refs = [
            ...
            {
                ref: 'filterToolbar',
                selector: 'overview-panel view-issues-filter'
            },
            {
                ref: 'noPanelFound',
                selector: 'overview-panel #overview-no-issues-found-panel'
            },
            {
                ref: 'historyOverview',
            ...
            {
                ref: 'noHistoryIssuesFoundPanel',
                selector: 'history-panel #overview-no-history-issues-found-panel'
            },
            {
                ref: 'graphsPanel',
    ...
    showIssueOverview: function (history) {
        var me = this,
    ...
    updateHistorySections: function (btn) {
        var me = this,
            ...
            noHistoryIssuesFoundPanel = me.getNoHistoryIssuesFoundPanel(),
            graphsPanel = me.getGraphsPanel();

        noHistoryIssuesFoundPanel.setVisible(false);
        ...
        Ext.Array.each(me.historySections, function (historySection) {
            ...
            Ext.Ajax.request({
                ...
                success: function (response) {
                    ...
                    noHistoryIssuesFoundPanel.setVisible(decoded.fields.length == 0);
