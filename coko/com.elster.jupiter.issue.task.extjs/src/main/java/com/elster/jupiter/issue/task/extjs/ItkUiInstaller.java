...
@Component(name = "com.elster.jupiter.issue.extjs", service = TranslationKeyProvider.class,
        property = {"name=" + ItkUiInstaller.COMPONENT_NAME + "-UI", "app="+ItkUiInstaller.APP_KEY,}, immediate = true)
public class ItkUiInstaller implements TranslationKeyProvider {
    ...
    public void activate(BundleContext context) {
        ...
        //HttpResource resource = new HttpResource(HTTP_RESOURCE_ALIAS, "c:\\git\\Connexo_nou_10_4_1\\comu\\com.elster.jupiter.issue.task.extjs\\src\\main\\web\\js\\itk", new FileResolver());
