...
Ext.define('Mtr.controller.readingtypes.ReadingTypes', {
    extend: 'Ext.app.Controller',

    views: [
        'Mtr.view.readingtypes.Overview',
        'Mtr.view.readingtypes.Grid',
        'Mtr.view.readingtypes.EditAliasWindow',
    ...
    showOverview: function () {
        var me = this, widget,
            sorting = me.getController('Mtr.controller.readingtypes.OverviewSorting'),
    ...
    browseAdd: function () {
        var router = this.getController('Uni.controller.history.Router'),
            addController = this.getController('Mtr.controller.readingtypes.AddReadingTypes');
