...
Ext.define('Mtr.controller.readingtypes.BulkAction', {
    extend: 'Ext.app.Controller',

    views: [
        'Mtr.view.readingtypes.bulk.Browse',
        'Mtr.view.readingtypes.bulk.Wizard'
    ],
    ...
    stores: [
        ...
        'Mtr.store.readingtypes.ReadingTypesBulk'
    ...
    showOverview: function () {
        var me = this,
            readingTypesStore = Ext.getStore('Mtr.store.readingtypes.ReadingTypes'),
            readingTypesStoreBulk = Ext.getStore('Mtr.store.readingtypes.ReadingTypesBulk'),
    ...
    saveReadingType: function () {
        ...
        if (!me.AllreadingTypes) {
            ...
            params = me.getStore('Mtr.store.readingtypes.ReadingTypesBulk').getProxy().extraParams;
        }
