...
Ext.define('Mtr.view.readingtypes.bulk.Wizard', {
    extend: 'Ext.panel.Panel',
    requires: [
        'Mtr.view.readingtypes.bulk.Step1',
        'Mtr.view.readingtypes.bulk.Step2',
        'Mtr.view.readingtypes.bulk.Step3',
        'Mtr.view.readingtypes.bulk.Step4',
        'Mtr.view.readingtypes.bulk.Step5'
    ],
