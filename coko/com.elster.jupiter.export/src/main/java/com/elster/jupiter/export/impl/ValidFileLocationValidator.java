 ...
 */
public class ValidFileLocationValidator implements ConstraintValidator<ValidFileLocation, String> {

    @Override
    public void initialize(ValidFileLocation constraintAnnotation) {
    }
