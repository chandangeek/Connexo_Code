...
/**
 * Tests that all {@link TranslationKey}s that are defined in {@link DataExportServiceImpl} are acceptable and unique.
 */
public class TranslationKeysTest {
    ...
    public void testTranslationKeys() {
        ...
        for (TranslationKey entry : new DataExportServiceImpl().getKeys()) {
