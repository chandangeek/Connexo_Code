...
public class DataExportTaskHistoryInfo {
    ...
    public DataExportTaskHistoryInfo(History<ReadingTypeDataExportTask> history, DataExportOccurrence dataExportOccurrence, Thesaurus thesaurus, TimeService timeService, PropertyUtils propertyUtils) {
        populate(history, dataExportOccurrence, thesaurus, timeService, propertyUtils);
    }

    private void populate(History<ReadingTypeDataExportTask> history, DataExportOccurrence dataExportOccurrence, Thesaurus thesaurus, TimeService timeService, PropertyUtils propertyUtils) {
