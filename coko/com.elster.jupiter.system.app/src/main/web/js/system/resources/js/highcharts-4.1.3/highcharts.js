...
(function () {
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length)f = f.join(":"), g = /\.([0-9])/, h = S.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Oa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Cb() {
        ...
        gb = function (a, c, d, h, i, j) {
            var k;
            b ? (k = ya.UTC.apply(0, arguments), k +=
                Wa(k)) : k = (new ya(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0))).getTime();
            return k
        };
        qb = c + "Minutes";
        rb = c + "Hours";
    ...
    var u, C = document, O = window, V = Math, x = V.round, U = V.floor, ra = V.ceil, t = V.max, H = V.min, P = V.abs, W = V.cos, Z = V.sin, la = V.PI, ga = la * 2 / 360, za = navigator.userAgent, Gb = O.opera, wa = /(msie|trident)/i.test(za) && !Gb, hb = C.documentMode === 8, wb = /AppleWebKit/.test(za), La = /Firefox/.test(za), Hb = /(Mobile|Android|Windows Phone)/.test(za), Aa =
        "http://www.w3.org/2000/svg", ba = !!C.createElementNS && !!C.createElementNS(Aa, "svg").createSVGRect, Lb = La && parseInt(za.split("Firefox/")[1], 10) < 4, ea = !ba && !wa && !!C.createElement("canvas").getContext, $a, ab, Ib = {}, xb = 0, fb, S, Oa, xa, yb, F, ma = function () {
        return u
    }, $ = [], bb = 0, Ka = "div", M = "none", Mb = /^[0-9]+$/, ib = ["plotTop", "marginRight", "marginBottom", "plotLeft"], Nb = "stroke-width", ya, gb, mb, eb, qb, rb, sb, Xa, Ya, Za, Db, Eb, tb, ub, vb, N = {}, z;
    z = O.Highcharts = O.Highcharts ? ka(16, !0) : {};
    z.seriesTypes = N;
    var q = z.extend = function (a,
                                 b) {
        var c;
        a || (a = {});
        for (c in b)a[c] = b[c];
    ...
    Oa = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new ya(b - Wa(b)), e, f = d[rb](), g = d[sb](), h = d[Xa](), i = d[Ya](), j = d[Za](), k = S.lang, l = k.weekdays, d = q({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Ia(h),
            e: h,
    ...
    z.numberFormat = function (a, b,
                               c, d) {
        var e = S.lang, a = +a || 0, f = b === -1 ? H((a.toString().split(".")[1] || "").length, 20) : isNaN(b = P(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(B(a = P(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    (function (a) {
        O.HighchartsAdapter = O.HighchartsAdapter || a && {
                init: function (b) {
                    ...
                    a.fn.highcharts = function () {
                        ...
                        if (this[0]) {
                            ...
                            c = b[0];
                            if (c !== u)c.chart = c.chart || {}, c.chart.renderTo = this[0], new z[a](c, b[1]), g = this;
                ...
                addEvent: function (b, c, d) {
                    ...
                    !wa && d && (delete d.layerX, delete d.layerY, delete d.returnValue);
                    q(f, d);
    ...
    Q && Q.init.call(Q, yb);
    var jb = A.adapterRun, Ob = A.getScript, Ma = A.inArray, n = z.each = A.each,
        zb = A.grep, Pb = A.offset, Ua = A.map, K = A.addEvent, X = A.removeEvent, G = A.fireEvent, Qb = A.washMouseEvent, kb = A.animate, db = A.stop;
    S = {
    ...
    L.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, j, k, l, m, o, s = [];
            ...
            if (f) {
                ...
                s = s.join(",");
                h[s] ? a = h[s].attr("id") : (g.id = a = "highcharts-" + xb++, h[s] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], n(j, function (a) {
        ...
        applyTextShadow: function (a) {
            var b =
                this.element, c, d = a.indexOf("contrast") !== -1, e = this.renderer.forExport || b.style.textShadow !== u && !wa;
            d && (a = a.replace(/contrast/g, this.renderer.getContrast(b.style.fill)));
            e ? d && J(b, {textShadow: a}) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), n(a.split(/\s?,\s?/g), function (a) {
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (wa && !ba)J(this.element, a); else {
                    b =
                        function (a, b) {
        ...
        getBBox: function (a) {
            ...
            if (!b) {
                ...
                if (c.isSVG) {
                    ...
                    if (e)b.width = P(d * Z(h)) + P(a * W(h)), b.height = P(d * W(h)) + P(a * Z(h))
                }
                c.cache[l] = b
            }
            return b
        ...
        show: function (a) {
            a && this.element.namespaceURI === Aa ? this.element.removeAttribute("visibility") : this.attr({visibility: a ? "inherit" : "visible"});
            return this
        },
        hide: function () {
        ...
        zIndexSetter: function (a, b) {
            ...
            if (this.added) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = I(e, "zIndex"), e !== g && (B(f) >
                    a || !r(a) && r(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    L.prototype["stroke-widthSetter"] = L.prototype.strokeSetter = function (a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"])this.strokeWidth =
    ...
    sa.prototype = {
        Element: L, init: function (a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && I(g,
                "xmlns", Aa);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            ...
            if (La && a.getBoundingClientRect)this.subPixelFix = b = function () {
                ...
                J(a, {left: ra(h.left) - h.left + "px", top: ra(h.top) - h.top + "px"})
            }, b(), K(O, "resize", b)
        }, getStyle: function (a) {
            return this.style = q({
            ...
            !f && !o && !s && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, T && T.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) :
                ...
                n(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        i.test(e) && !d && (I(w, "onclick", 'location.href="' + e.match(i)[1] + '"'), J(w, {cursor: "pointer"}));
                        e = v(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            I(w, o);
                            b.appendChild(w);
                            !m && f && (!ba && d && J(w, {display: "block"}), I(w, "dy", D(w)));
                            if (l) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", T, r, u, Ba = [], t = D(w), x = 1, q = a.rotation, y = e, z = y.length; (n || s) && (o.length || Ba.length);)a.rotation = 0, T = a.getBBox(!0), u = T.width, !ba && c.forExport && (u = c.measureSpanWidth(w.firstChild.data, a.styles)), T = u > l, r === void 0 && (r = T), s && r ? (z /= 2, y === "" || !T && z < 0.5 ? o = [] : (T && (r = !0), y = e.substring(0, y.length + (T ?
                                        -1 : 1) * ra(z)), o = [y + "…"], w.removeChild(w.firstChild))) : !T || o.length === 1 ? (o = Ba, Ba = [], o.length && (x++, w = C.createElementNS(Aa, "tspan"), I(w, {
                                    dy: t,
                                    x: j
                                }), p && I(w, "style", p), b.appendChild(w)), u > l && (l = u)) : (w.removeChild(w.firstChild), Ba.unshift(o.pop())), o.length && w.appendChild(C.createTextNode(o.join(" ").replace(/- /g, "-")));
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, o, s, w, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            p = h.style;
            delete h.style;
            K(j.element, wa ? "mouseover" : "mouseenter", function () {
                k !== 3 && j.attr(f).css(s)
            });
            K(j.element, wa ? "mouseout" : "mouseleave", function () {
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = W(f), j = Z(f), k = W(g), g = Z(g), e = e.end - f < la ? 0 : 1;
                return ["M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
            }, callout: function (a,
                                  b, c, d, e) {
                var f = H(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX, i = e && e.anchorY, e = x(e.strokeWidth || 0) % 2 / 2;
                a += e;
                b += e;
            ...
            function j() {
                ...
                if (A) {
                    if (!w)a = x(-D * v), b = h ? -H : 0, o.box = w = d ? m.symbol(d, a, b, o.width, o.height, E) : m.rect(a, b, o.width, o.height, 0, E[Nb]), w.attr("fill", M).add(o);
                    w.isImg || w.attr(q({width: x(o.width), height: x(o.height)}, E));
                    E = null
                }
            }
            ...
            function k() {
                ...
                if (b !== s.x || c !== s.y)s.attr("x", b), c !== u && s.attr("y", c);
                s.x = b;
                s.y = c
            }
            ...
            var m = this, o = m.g(i), s = m.text("", 0, 0, g).attr({zIndex: 1}), w, p, D = 0, v = 3, Ba = 0, fa, t, z, C, B = 0, E = {}, H, A;
            o.onAdd = function () {
                s.add(o);
    ...
    q(L.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation, l, m = B(this.textWidth), o = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (o !== this.cTT) {
            ...
            var d = {}, e = wa ? "-ms-transform" : wb ? "-webkit-transform" : La ? "MozTransform" : Gb ? "-o-transform" : "";
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        n(j.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || Y(Ka, {className: I(a.element, "class")}, {
                                    position: "absolute",
    ...
    if (!ba && !ea) {
        A = {
            init: function (a, b) {
                ...
                var a = this.rotation, b = W(a * ga), c = Z(a * ga);
                J(this.element, {
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        h = Y(g.prepVML(j), null, {left: B(i.left) + p(a.offsetX, 1), top: B(i.top) + p(a.offsetY, 1)});
                        if (c)h.cutOff = l + 1;
        ...
        var Na = {
            ...
            isHidden: function () {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, o, s, w, p, D, v = "", a = a.stops, r, fa = [], u = function () {
                    ...
                    if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, v = 'angle="' + (90 - V.atan((m - a) / (o - c)) * 180 / la) + '"', u(); else {
                        var j = m.r, t = j * 2, x = j * 2, q = m.cx, E = m.cy, y = b.radialReference, z, j = function () {
                            ...
                            v = 'src="' + S.global.VMLRadialGradientURL +
                                '" size="' + t + "," + x + '" origin="0.5,0.5" position="' + q + "," + E + '" color2="' + D + '" ';
                            u()
                        };
                        d.added ? j() : d.onAdd = j;
                        j = p
                    } else j = k
                } else if (g.test(a) && b.tagName !== "IMG")f = na(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Y(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
                ...
                arc: function (a, b, c, d, e) {
                    var f = e.start, g = e.end, h = e.r || c ||
                        d, c = e.innerR, d = W(f), i = Z(f), j = W(g), k = Z(g);
                    if (g - f === 0)return ["x"];
    ...
    Ta.prototype = {
        addLabel: function () {
            ...
            r(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(y(g.style)).add(a.labelGroup) :
            ...
            if (h)h < 0 && c - i * j < f ? k = x(c / W(h * ga) - f) : h > 0 && c + i * j > e && (k = x((d - c) / W(h * ga))); else {
                d = c - i * j;
                c += i * j;
            ...
            var i = this.axis, j = i.transA, k = i.reversed,
                l = i.staggerLines, m = i.tickRotCorr || {
                        x: 0,
                        y: 0
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", s = e[m + "LineWidth"],
                w = e[m + "LineColor"], n = e[m + "LineDashStyle"], D = e[o + "Length"], m = e[o + "Width"] || 0, v = e[o + "Color"], r = e[o + "Position"], o = this.mark, fa = k.step, t = !0, x = d.tickmarkOffset, q = this.getPosition(g, j, x, b), z = q.x, q = q.y, y = g && z === d.pos + d.len || !g && q === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (s) {
                j = d.getPlotLinePath(j + x, s * y, b, !0);
                if (l === u) {
                    l = {stroke: w, "stroke-width": s};
                    if (n)l.dashstyle = n;
                    if (!h)l.zIndex = 1;
                    if (b)l.opacity = 0;
            ...
            if (m && D)r === "inside" && (D = -D), d.opposite && (D = -D), h = this.getMarkPath(z, q, D, m * y, g, f), o ? o.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: v, "stroke-width": m, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(z))i.xy = q = this.getLabelPosition(z, q, i, g, k, x, a, fa), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? t = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(q), fa && a % fa && (t = !1), t && !isNaN(q.y) ? (q.opacity = c, i[this.isNew ?
    ...
    z.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = r(i) && r(h), k = d.value, l = d.dashStyle, m = a.svgElem, o = [], s, w = d.color, p = d.zIndex, n = d.events, v = {}, t = b.chart.renderer;
    ...
    ta.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = Oa(d, b); else if (f && a >= 1E3)for (; f-- && g === u;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
        ...
        getLinearTickPositions: function (a,
                                          b, c) {
            var d, e = da(U(b / a) * a), f = da(ra(c / a) * a), g = [];
        ...
        adjustForMinRange: function () {
            ...
            if (this.isXAxis && this.minRange === u && !this.isLog)r(a.min) || r(a.max) ? this.minRange = null : (n(this.series, function (a) {
                i = a.xData;
        ...
        setAxisTranslation: function (a) {
            ...
            if (b.isXAxis || i || d)h ? (f = h.minPointOffset, g = h.pointRangePadding) : n(b.series, function (a) {
                ...
                !a.noSharedTooltip && r(o) && (e = r(e) ? H(e, o) : o)
            }), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = H(d, c), b.closestPointRange = e;
            if (a)b.oldTransA = j;
        ...
        setTickInterval: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, j = d.minPadding,
                k = d.tickInterval, l = d.tickPixelInterval, m = b.categories;
            ...
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !k && l === b.linkedParent.options.tickPixelInterval ? b.linkedParent.tickInterval :
                p(k, this.tickAmount ? (b.max - b.min) / t(this.tickAmount - 1, 1) : void 0, m ? 1 : (b.max - b.min) * l / t(b.len, l));
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation,
                i = this.chart.renderer.fontMetrics(b.style.fontSize, a[0] && a[0].label), j, k = Number.MAX_VALUE, l, m = function (a) {
                    a /= f || 1;
                    a = a > 1 ? ra(a) : 1;
                    return a * d
                };
            c ? (l = r(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && n(l, function (a) {
                var b;
        ...
        renderUnsquish: function () {
            var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.slotWidth =
                f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / c.length || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), i = t(1, x(h - 2 * (e.padding || 5))), j = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), k, l = 0;
            ...
            if (this.autoRotation)n(c, function (a) {
                ...
                for (h = c.length; !f && h--;)if (i = c[h], (i = d[i].label) && this.len /
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options,
                e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, o = 0, s = d.title, w = d.labels, T = 0, D = b.axisOffset, b = b.clipOffset, v = [-1, 1, 1, -1][h], q;
            a.hasData = j = a.hasVisibleSeries || r(a.min) && r(a.max) && !!e;
            a.showAxis = k = j || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && w.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: w.zIndex || 7}).addClass("highcharts-" +
            ...
            if (s && s.text && s.enabled !== !1) {
                ...
                if (k)l = a.axisTitle.getBBox()[g ? "height" : "width"], m = s.offset, o = r(m) ? 0 : p(s.margin, g ? 5 : 10);
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, l = d.stackLabels, m = d.alternateGridColor, o = a.tickmarkOffset, s = d.lineWidth, w, p = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin);
            w = a.hasData;
            var D = a.showAxis, v, q;
            ...
            if (s)w =
                a.getLinePath(s), a.axisLine ? a.axisLine.animate({d: w}) : a.axisLine = c.path(w).attr({
                stroke: d.lineColor,
                "stroke-width": s,
                zIndex: 7
            }).add(a.axisGroup), a.axisLine[D ? "show" : "hide"]();
            if (h && D)h[h.isNew ? "attr" : "animate"](a.getTitlePosition()), h.isNew = !1;
    ...
    ta.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (r(b)) {
            ...
            b = 1;
            if (mb || eb)i = i.getTime(), i = new ya(i + Wa(i));
            h = i[Za]();
            for (var d = i.getTime(), l = i[Ya](), m = i[Xa](), o = (F.day + (g ? Wa(i) : i.getTimezoneOffset() *
                6E4)) % F.day; d < c;)e.push(d), j === F.year ? d = gb(h + b * k, 0) : j === F.month ? d = gb(h, l + b * k) : !g && (j === F.day || j === F.week) ? d = gb(h, l, m + b * k * (j === F.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(zb(e, function (a) {
    ...
    ta.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = x(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = U(b), h,
    ...
    Kb.prototype = {
        init: function (a, b) {
            ...
            var c, d = this.chart, e = d.inverted, f = d.plotTop, g = d.plotLeft, h = 0, i = 0, j, k, a = qa(a);
            c = a[0].tooltipPos;
    ...
    Va.prototype = {
        init: function (a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (z.Tooltip && b.tooltip.enabled)a.tooltip = new Kb(a, b.tooltip), this.followTouchMove =
            ...
            var b = this, c = b.chart, d = c.series, e = c.tooltip, f = e ? e.shared : !1, g, h = c.hoverPoint, i = c.hoverSeries, j = c.chartWidth, k = c.chartWidth, l, m = [], o, s;
            ...
            if (o && o !== h)if (f && !o.series.noSharedTooltip) {
                g = m.length;
                for (d = o.clientX; g--;)i = m[g].clientX, (m[g].x !== o.x || i !== d || !r(m[g].y) || m[g].series.noSharedTooltip) && m.splice(g, 1);
                e && e.refresh(m, a);
                n(m, function (b) {
                    b.onMouseOver(a)
                })
            ...
            if (a)f.refresh(g), e && (e.setState(e.state, !0), n(c.axes, function (b) {
                ...
                if (d)d.onMouseOut();
                f && f.hide(b);
                if (this._onDocumentMouseMove)X(C, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                n(c.axes, function (a) {
                    a.hideCrosshair()
                });
                this.hoverX = null
        ...
        dragStart: function (a) {
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, m = this.mouseDownX, o = this.mouseDownY, s = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || d)n(c.axes, function (c) {
                    if (c.zoomEnabled && r(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        var f = c.horiz, o = a.type === "touchend" ? c.minPixelPadding : 0, s = c.toValue((f ? g : h) + o), f = c.toValue((f ? g + i : h + j) - o);
                        e[c.coll].push({
                            axis: c,
                            min: H(s, f), max: t(s, f)
                        });
    ...
    q(z.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", o = i["plot" + (a ? "Left" : "Top")], s, p, n = h || 1, D = i.inverted, v = i.bounds[a ? "h" : "v"], r = b.length === 1, q = b[0][l], t = c[0][l], u = !r && b[1][l], x = !r && c[1][l], z, c = function () {
                !r && P(q - u) > 20 && (n = h || P(t - x) / P(q - u));
                p = (o - t) / n + q;
            ...
            if (a.type === "touchstart")n(e, function (a, b) {
                ...
                if (!i)b.selectionMarker = i = q({destroy: ma}, c.plotBox);
    ...
    if (O.PointerEvent || O.MSPointerEvent) {
        var ua = {}, Ab = !!O.PointerEvent, Ub = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
            ...
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && $[Ca])d(a), d = $[Ca].pointer, d[b]({
                type: c,
        ...
        q(Va.prototype, {
            onContainerPointerDown: function (a) {
                ...
                a(this.chart.container,
                    Ab ? "pointerdown" : "MSPointerDown", this.onContainerPointerDown);
    ...
    lb.prototype = {
        init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled)c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), K(c.chart, "endResize", function () {
            ...
            if (!n) {
                ...
                if (!this.baseline)this.baseline = c.fontMetrics(h.fontSize, n).f + 3 + s, n.attr("y", this.baseline);
            ...
            if (e && this.itemX - w + f > (m || b.chartWidth - 2 * j - w - d.x))this.itemX = w, this.itemY += s + this.lastLineHeight + o;
            ...
            var a =
                this, b = a.chart, c = b.renderer, d = a.group, e, f, g, h, i = a.box, j = a.options, k = a.padding, l = j.borderWidth, m = j.backgroundColor;
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, m = this.nav, o = this.pages, s, w = this.allItems;
            ...
            if (a > f && !e.useHTML) {
                ...
                if (!m)this.nav = m = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click", function () {
                    ...
                    d.text("", 15, 10).css(j.style).add(m), this.down = d.symbol("triangle-down", 0, 0, l, l).on("click", function () {
                    b.scroll(1, k)
                }).add(m);
                b.scroll(0);
                a = f
    ...
    (/Trident\/7\.0/.test(za) || La) && cb(lb.prototype, "positionItem", function (a, b) {
    ...
    A.prototype = {
        callbacks: [], init: function (a, b) {
            ...
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, l = k, m = this.renderer, o = m.isHidden(), s = [];
            Sa(a, this);
            ...
            d && (d.css({width: (e.width || h) + "px"}).align(q({y: b + (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = ra(b + d.getBBox().height)));
            ...
            a || ka(13, !0);
            c = B(I(a, "data-highcharts-chart"));
            !isNaN(c) && $[c] && $[c].hasRendered &&
            $[c].destroy();
            ...
            this.renderer =
                b.forExport ? new sa(a, c, d, b.style, !0) : new $a(a, c, d, b.style);
            ...
            if (r(a))d.chartWidth = e = t(0, x(a)), d.hasUserSize = !!e;
            if (r(b))d.chartHeight = f = t(0, x(b));
            (xa ? kb : J)(d.container, {width: e + "px", height: f + "px"}, xa);
            d.setChartSize(!0);
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, j = a.backgroundColor, k = a.plotBackgroundColor, l = a.plotBackgroundImage, m = a.plotBorderWidth ||
                0, o, s = this.plotLeft, p = this.plotTop, n = this.plotWidth, r = this.plotHeight, v = this.plotBox, q = this.clipRect, t = this.clipBox;
            o = i + (a.shadow ? 8 : 0);
            ...
            if (k)f ? f.animate(v) : this.plotBackground = b.rect(s, p, n, r, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (l)h ? h.animate(v) :
                this.plotBGImage = b.image(l, s, p, n, r).add();
            ...
            b.items && n(b.items, function (c) {
                var d = q(b.style, c.style), e = B(d.left) +
                    a.plotLeft, f = B(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    R.prototype = {
        ...
        autoIncrement: function () {
            ...
            if (d === "month" || d === "year")a = new ya(b), a = d === "month" ? +a[ub](a[Ya]() + c) : +a[vb](a[Za]() + c), c = a - b;
            this.xIncrement = b + c;
            return b
        },
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l && !!l.categories, o = i.turboThreshold, s = this.xData, w = this.yData, r = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)n(a, function (a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (pa(k)) {
                        ...
                        for (c = 0; c < h; c++)s[c] = m, w[c] = a[c], m += i;
                        e.xIncrement = m
                    } else if (Ha(k))if (r)for (c = 0; c < h; c++)i = a[c], s[c] = i[0], w[c] = i.slice(1, r + 1); else for (c = 0; c < h; c++)i = a[c], s[c] = i[0], w[c] = i[1]; else ka(12)
                } else for (c = 0; c < h; c++)if (a[c] !== u && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name))l.names[i.x] =
                    i.name;
                Da(w[0]) && ka(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        processData: function (a) {
            ...
            if (k && this.sorted && (!i || d > i || this.forceCrop))if (b[d -
                1] < l || b[0] > m)b = [], c = []; else if (b[0] < l || b[d - 1] > m)e = this.cropData(this.xData, this.yData, l, m), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        generatePoints: function () {
            ...
            for (m = 0; m < g; m++)i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(qa(e[m]))) : (b[i] ? k = b[i] : a[i] !== u && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k), l[m].index = i;
            if (b && (g !== (c = b.length) || j))for (m =
                                                          0; m < c; m++)if (m === h && !j && (m += g), b[m])b[m].destroyElements(), b[m].plotX = u;
            this.data = b;
            this.points = l
        },
        ...
        translate: function () {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || pa(i), k = a.threshold, l, m, o, s = Number.MAX_VALUE, a = 0; a < g; a++) {
                var n = f[a], q = n.x, D = n.y;
                m = n.low;
                var v = b && e.stacks[(this.negStacks && D < k ? "-" : "") + this.stackKey];
                if (e.isLog && D !== null && D <= 0)n.y = D = null, ka(10);
                n.plotX =
                    l = c.translate(q, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible && v && v[q])v = v[q], D = v.points[this.index + "," + a], m = D[0], D = D[1], m === 0 && (m = p(k, e.min)), e.isLog && m <= 0 && (m = null), n.total = n.stackTotal = v.total, n.percentage = v.total && n.y / v.total * 100, n.stackY = D, v.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, m = this.pointAttr[""], o, n, w, r = this.markerGroup, t = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, n = !!g.marker, a = t && o.enabled === u || o.enabled, w = g.isInside, a && e !== u && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(o.symbol,
                    this.symbol), j = i.indexOf("url") === 0, k)k[w ? "show" : "hide"](!0).animate(q({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            var o = c.lineColor, p = c.fillColor;
            j = b.turboThreshold;
            var w = a.zones, t = a.zoneAxis || "y", u;
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph,
                j = this.area, k = t(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m = l.reversed, o = l.horiz, s = !1;
        ...
        searchKDTree: function (a) {
            function b(a, h, i, j) {
                ...
                var n = r(a[f]) && r(k[f]) ? Math.pow(a[f] - k[f], 2) : null, p = (m || 0) + (n || 0);
                m = {
                ...
                l = a[l] - k[l];
                m = l < 0 ? "left" : "right";
                h[m] && (m = b(a, h[m], i + 1, j), o = m.dist[d] < o.dist[d] ? m : k, k = l < 0 ? "right" :
    ...
    Fb.prototype = {
        destroy: function () {
            ...
            if (e = this.label)e.align(this.alignOptions, null, f), f = e.alignAttr, e[this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? "show" :
                "hide"](!0)
        }
    };
    ...
    R.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, j = this.negStacks, k = this.yAxis, l = k.stacks, m = k.oldStacks, o, n, p, r, q, v;
            for (r = 0; r < d; r++) {
                q = a[r];
                v = b[r];
                p = this.index + "," + r;
                ...
                l[n] || (l[n] = {});
                if (!l[n][q])m[n] &&
                m[n][q] ? (l[n][q] = m[n][q], l[n][q].total = null) : l[n][q] = new Fb(k, k.options.stackLabels, o, q, g);
                n = l[n][q];
                n.points[p] = [n.cum || 0];
    ...
    q(A.prototype, {
        addSeries: function (a, b, c) {
            ...
            new ta(this, y(a, {index: this[e].length, isX: b}));
            f[e] =
                qa(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
            ...
            if (!d)b.loadingDiv = d = Y(Ka, {className: "highcharts-loading"}, q(e.style, {
                zIndex: 10,
                display: M
            }), b.container), b.loadingSpan = Y("span", null, e.labelStyle, d), K(b, "redraw", f);
            b.loadingSpan.innerHTML = a || c.lang.loading;
            if (!b.loadingShown)J(d, {opacity: 0, display: ""}), kb(d, {opacity: e.style.opacity},
    ...
    var va = ja(R);
    N.line = va;
    aa.area = y(Q, {threshold: 0});
    var oa = ja(R, {
        type: "area", getSegments: function () {
            var a = this, b = [], c = [], d = [], e = this.xAxis, f = this.yAxis, g =
                f.stacks[this.stackKey], h = {}, i, j, k = this.points, l = this.options.connectNulls, m, o;
    ...
    va = ja(R, {
        ...
        getColumnMetrics: function () {
            var a = this, b = a.options, c = a.xAxis,
                d = a.yAxis, e = c.reversed, f, g = {}, h, i = 0;
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = t(i, 1 + 2 * d), k = a.pointXOffset = h.offset, l = -(d % 2 ? 0.5 : 0), m = d % 2 ? 0.5 : 1;
            b.renderer.isVML && b.inverted && (m += 1);
            c.pointPadding && (j = ra(j));
            R.prototype.translate.apply(a);
            n(a.points, function (c) {
                var d =
                    p(c.yBottom, f), h = H(t(-999 - d, c.plotY), e.len + 999 + d), n = c.plotX + k, r = j, q = H(h, d), u;
                u = t(h, d) - q;
                ...
                d && (q -= 1, u += 1);
                c.shapeType = "rect";
                c.shapeArgs = {x: n, y: q, width: r, height: u}
            })
        },
        getSymbol: ma,
        drawLegendSymbol: Na.drawRectangle,
    ...
    Q = {
        ...
        pointClass: ja(Ga, {
            init: function () {
                ...
                var a = this, b;
                q(a, {
                    visible: a.visible !== !1, name: p(a.name, "Slice")
                });
                b = function (b) {
                ...
                b.legendItem && (d.hasRendered && (c.updateTotals(), d.legend.clearItems(), e || d.legend.render()), d.legend.colorizeItem(b,
                    a));
        ...
        translate: function (a) {
            ...
            var b = 0, c = this.options, d = c.slicedOffset,
                e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = la / 180 * (i - 90), i = (this.endAngleRad = la / 180 * (p(c.endAngle, i + 360) - 90)) - j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, o = k.length, n;
            ...
            for (m = 0; m < o; m++) {
                ...
                n.slicedTranslation = {translateX: x(W(h) * d), translateY: x(Z(h) * d)};
                f = W(h) * a[2] / 2;
                g = Z(h) * a[2] / 2;
    ...
    R.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || K(a, "afterAnimate", function () {
            a.visible &&
            j.show();
            j[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
        })), g = d, n(e, function (e) {
            var h, o = e.dataLabel, n, t, x = e.connector, z = !0, v, C = {};
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart,
            g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible && (a.series.forceDL || f.isInsidePlot(h, x(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (l)d = q({
            x: g ? f.plotWidth - i : h,
        ...
        }).attr({align: c.align})) : (b.align(c, null, d), g = b.alignAttr,
            p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape && b.attr({
            anchorX: a.plotX,
            anchorY: a.plotY
        }));
    ...
    if (N.pie)N.pie.prototype.drawDataLabels = function () {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (M) {
                    ...
                    if (m > 0) {
                        ...
                        for (E = 0; E < M; E++) {
                            ...
                            c = 9999;
                            var S, Q;
                            for (Q = 0; Q < v; Q++)S = P(K[Q] - y[1]), S < c && (c = S, L = Q);
                            if (L < E && K[E] !== null)L = E; else for (v < M - E + L && K[E] !== null && (L = v - M + E); K[L] === null;)L++;
                            O.push({i: L, y: K[L]});
                            K[L] = null
                        }
                        O.sort(N)
                    ...
                    for (E = 0; E < M; E++) {
                        ...
                        z._attr =
                        {visibility: F, align: y[6]};
                        z._pos = {x: B + e.x + ({left: f, right: -f}[y[6]] || 0), y: A + e.y - 10};
                        z.connX = B;
                        z.connY = A;
                        if (this.options.size === null)v = z.width, B - v < f ? G[3] = t(x(v - B + f), G[3]) : B + v > h - f && (G[1] = t(x(B + v - h + f), G[1])), A - b / 2 < 0 ? G[0] = t(x(-A + b / 2), G[0]) : A + b / 2 > i && (G[2] = t(x(A + b / 2 - i), G[2]))
                    }
                }
            }
            if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))this.placeDataLabels(), u && g && n(this.points, function (b) {
                j = b.connector;
                y = b.labelPos;
                if ((z = b.dataLabel) && z._pos)F = z._attr.visibility, B = z.connX, A = z.connY, k = l ? ["M", B + (y[6] === "left" ? 5 : -5), A,
                    "C", B, A, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", B + (y[6] === "left" ? 5 : -5), A, "L", y[2], y[3], "L", y[4], y[5]], j ? (j.animate({d: k}), j.attr("visibility", F)) : b.connector = j = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
    ...
    Q = z.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            if (e && !c)for (m = e + 1; m--;)d[m] === "M" && d.splice(m + 1, 0, d[m + 1] - i, d[m +
            2], "L"), (m && d[m] === "M" || m === e) && d.splice(m, 0, "L", d[m - 2] + i, d[m - 1]);
        ...
        showResetZoom: function () {
            ...
            n(b === "xy" ? [1, 0] : [1], function (b) {
                var d = a[b ? "chartX" : "chartY"], h = c[b ? "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" : "mouseDownY"], j = (h.pointRange || 0) / 2, k = h.getExtremes(), l = h.toValue(i - d, !0) + j, j = h.toValue(i +
                        c[b ? "plotWidth" : "plotHeight"] - d, !0) - j, i = i > d;
    ...
    q(Ga.prototype, {
        select: function (a, b) {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = aa[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, o = e.halo, n, a = a || "";
            ...
            if (!(a ===
                ...
                if (this.graphic)g = g && this.graphic.symbolName && n.r, this.graphic.attr(y(n, g ? {
                    x: c - g,
                    y: d - g,
                    width: 2 * g,
                    height: 2 * g
                    ...
                    if (a && i)if (g = i.radius, l = l.symbol || e.symbol, k && k.currentSymbol !== l && (k = k.destroy()), k)k[b ? "animate" : "attr"]({
                        x: c - g,
                        y: d - g
                    }); else if (l)e.stateMarkerGraphic = k = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(n).add(e.markerGroup), k.currentSymbol =
                        l;
            ...
            return c.renderer.symbols.circle(d.translateX + (e ? b.yAxis.len - this.plotY : this.plotX) - a, d.translateY + (e ? b.xAxis.len -
