...
public enum MessageSeeds implements MessageSeed {
    ...
    REFERENCE_ESTIMATOR_FAIL_NO_OUTPUTS_ON_PURPOSE_WITH_READING_TYPE(3006, "reference.estimator.fail.no.output.on.purpose", "Failed to estimate period \"{0}\" using method {1} on {2} since '\''check'\'' output with matching reading type on the specified purpose doesn'\''t exist on {3}"),
    REFERENCE_ESTIMATOR_FAIL_DATA_SUSPECT_OR_MISSING(3007, "reference.estimator.fail.data.suspect.or.missing", "Failed to estimate period \"{0}\" using method {1} on {2}/{3}/{4} since data from 'check' output is suspect or missing"),


    INVALID_NUMBER(1015, "property.error", "This value should be positive"),
    REQUIRED_FIELD(1016, "property.required", "This field is required"),
