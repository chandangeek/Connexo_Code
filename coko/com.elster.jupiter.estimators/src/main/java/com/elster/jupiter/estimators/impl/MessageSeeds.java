...
public enum MessageSeeds implements MessageSeed {
    ...
    NEAREST_AVG_VALUE_DAY_ESTIMATOR_FAIL_NOT_ENOUGH_SAMPLES(10017,"nearestavgvalueday.estimator.fail.not.enough.samples","Failed to estimate period ''{0}'' using method {1} on {2} due to insufficient (valid) number of sample values found on {3}"),
    NEAREST_AVG_VALUE_DAY_ESTIMATOR_FAIL_ESTIMATED_DAY_DISCARDED(10018,"nearestavgvalueday.estimator.fail.estimated.day.is.discarded","Failed to estimate period ''{0}'' using method {1} on {2} because the values to estimate belong to a day configured to be discarded on {3}");
