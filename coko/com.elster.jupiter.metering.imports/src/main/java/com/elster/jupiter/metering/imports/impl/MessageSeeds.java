...
public enum MessageSeeds implements MessageSeed {
    ...
    IMPORT_USAGEPOINT_NO_SUCH_SERVICEKIND(1014, Constants.IMPORT_USAGEPOINT_NO_SUCH_SERVICEKIND, " Can''t process line {0}: Invalid service kind", Level.SEVERE),
    IMPORT_USAGEPOINT_SERVICEKIND_INVALID(1015, Constants.IMPORT_USAGEPOINT_INVALID_SERVICEKIND, " Can''t process line {0}: No service kind found with name: {1}", Level.SEVERE),
    ...
    IMPORT_USAGEPOINT_METROLOGY_CONFIGURATION_ALREADY_SET(1024, Constants.IMPORT_USAGEPOINT_METROLOGY_CONFIGURATION_ALREADY_SET, "Metrology configuration on usage point ''{0}'' is already set", Level.SEVERE),
    IMPORT_USAGEPOINT_NO_METROLOGYCONFIG_FOR_ID(18, Constants.IMPORT_USAGEPOINT_NO_METROLOGYCONFIG_FOR_ID, "Metrology configuration with id ''{0}'' is inactive or not applicable to usage point ''{1}'' or doesn''t exist", Level.SEVERE),
    ...
    public enum Constants {
        ...
        public static final String IMPORT_USAGEPOINT_NO_SUCH_SERVICEKIND = "up.no.service.kind";
        ...
        public static final String IMPORT_USAGEPOINT_METROLOGY_CONFIGURATION_ALREADY_SET = "UsagePointMetrologyConfigurationAlreadySetExceptionMsg";
