...
public enum MessageSeeds implements MessageSeed {
    ...
    IMPORT_USAGEPOINT_SERVICEKIND_INVALID(1014, Constants.IMPORT_USAGEPOINT_INVALID_SERVICEKIND, " Can''t process line {0}: Invalid service kind", Level.SEVERE),
    ...
    IMPORT_USAGEPOINT_MRID_INVALID(1016, Constants.IMPORT_USAGEPOINT_INVALID_MRID, " Can''t process line {0}: Invalid MRID", Level.SEVERE),
    IMPORT_USAGEPOINT_PARSER_INVALID(1017, Constants.IMPORT_PARSER_INVALID, "Can''t process line {0}: Parser not found for {0}", Level.SEVERE),
    IMPORT_USAGEPOINT_NOT_FOUND(1018, Constants.IMPORT_USAGEPOINT_NOT_FOUND, "Can''t process line {0}: No such usage point for {1}", Level.SEVERE),
    IMPORT_USAGEPOINT_CONSTRAINT_VOLATION(1019, Constants.IMPORT_USAGEPOINT_CONSTRAINT_VOLATION, " Can''t process line {0}: {1} - {2}", Level.SEVERE),
    IMPORT_QUANITITY_OUT_OF_BOUNDS(1020, Constants.IMPORT_QUANITITY_OUT_OF_BOUNDS, " Can''t process line {0}: Invalid data. Multiplier out of bounds", Level.SEVERE),
