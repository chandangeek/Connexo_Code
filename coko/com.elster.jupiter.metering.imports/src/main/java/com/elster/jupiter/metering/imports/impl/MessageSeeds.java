...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_SUCH_MANDATORY_CPS_VALUE(2006, Constants.NO_SUCH_MANDATORY_CPS_VALUE, "Can''t process line {0}: Missing mandatory value {1} for custom property set {2}"),
    CALENDAR_DOES_NOT_EXIST(2007, Constants.CALENDAR_DOES_NOT_EXIST, "Can''t process line {0}: No such {1} calendar"),
    ;
