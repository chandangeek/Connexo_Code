...
@Component(name = "com.elster.jupiter.systemadmin.extjs", service = {TranslationKeyProvider.class},
        property = {"name=" + SamUiInstaller.COMPONENT_NAME + "-UI"}, immediate = true)
public class SamUiInstaller implements TranslationKeyProvider {
    ...
    private static final Logger LOGGER = Logger.getLogger(SamUiInstaller.class.getName());
