Ext.define('Sam.view.about.Static', {
    ...
    html:
      ...
      + '<p>' + Uni.I18n.translate('about.static.part.4', 'SAM', 'In the event of a conflict between the terms of the relevant Honeywell Software License Agreement and the licensing and warranty information contained in any third party licence, the provisions of such third party license will take precedence with respect to the relevant third party component.', false) + '</p>'
});