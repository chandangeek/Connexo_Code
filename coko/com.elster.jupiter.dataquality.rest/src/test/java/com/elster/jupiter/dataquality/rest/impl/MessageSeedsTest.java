...
import com.elster.jupiter.dataquality.impl.MessageSeeds;
...
public class MessageSeedsTest {
    ...
    public void testAllMessageSeedsHaveUniqueId() {
        ...
        for (com.elster.jupiter.dataquality.impl.MessageSeeds messageSeed : com.elster.jupiter.dataquality.impl.MessageSeeds.values()) {
    ...
    public void testAllMessageSeedKeysAreWithinLengthLimit() {
        for (com.elster.jupiter.dataquality.impl.MessageSeeds messageSeed : MessageSeeds.values()) {
