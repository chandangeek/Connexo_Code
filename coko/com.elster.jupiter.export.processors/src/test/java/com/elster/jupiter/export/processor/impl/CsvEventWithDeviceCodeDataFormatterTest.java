...
public class CsvEventWithDeviceCodeDataFormatterTest {

    @Rule
    public TestRule mcMurdo = Using.timeZoneOfMcMurdo();

    private static final ZonedDateTime time1 = ZonedDateTime.of(2020, 2, 13, 15, 42, 0, 0, TimeZoneNeutral.getMcMurdo());
    private static final ZonedDateTime time2 = ZonedDateTime.of(2020, 3, 13, 15, 42, 0, 0, TimeZoneNeutral.getMcMurdo());
    private static final ZonedDateTime time3 = ZonedDateTime.of(2020, 4, 13, 15, 42, 0, 0, TimeZoneNeutral.getMcMurdo());
    ...
    public void test() {
        ...
        CsvEventWithDeviceCodeDataFormatter csvEventWithDeviceCodeDataFormatter = CsvEventWithDeviceCodeDataFormatter.from(dataExportService, translatablePropertyValueInfo, "Tag");
        ...
        FormattedData formattedData = csvEventWithDeviceCodeDataFormatter.processData(Stream.of(meterEventData1, meterEventData2));
        ...
        assertThat(textLine1.getAppendablePayload()).isEqualTo("2020-02-13T15:42:00.000+13:00,1.2.3.4,10,MRID1,Device1\n");
        ...
        assertThat(textLine2.getAppendablePayload()).isEqualTo("2020-03-13T15:42:00.000+13:00,2.2.3.4,20,MRID1,Device1\n");
        ...
        assertThat(textLine3.getAppendablePayload()).isEqualTo("2020-04-13T15:42:00.000+12:00,3.2.3.4,30,MRID2,Device2\n");
