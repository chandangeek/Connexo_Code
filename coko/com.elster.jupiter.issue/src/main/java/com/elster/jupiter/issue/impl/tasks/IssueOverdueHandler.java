...
public class IssueOverdueHandler implements TaskExecutor {
    ...
    public IssueOverdueHandler(IssueService issueService, Thesaurus thesaurus, IssueActionService issueActionService, Clock clock) {
    ...
    public void execute(TaskOccurrence occurrence) {
        Condition overdueCondition = where("overdue").isEqualTo(false).and(where("dueDate").isLessThan(Instant.now(clock).toEpochMilli()));
