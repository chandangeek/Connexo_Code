...
// 9001 - ... All messages
    ...
    ISSUE_ACTION_FAIL(9004, "issue.action.fail", "Exception occurred during action ''{0}'' for issue ''{1}'': {2}", Level.SEVERE),
    ISSUE_ACTION_CLASS_LOAD_FAIL(9005, "issue.action.class.load.fail", "Unable to load issue action class ''{0}''.", Level.SEVERE),
