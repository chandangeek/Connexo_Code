...
// 9001 - ... All messages
    ...
    ISSUE_DEVICE_GROUP_NOT_FOUND(9017, "issue.devicegroup.find.falled", "Couldn't find device group with id \"{0}\"", Level.SEVERE),
    ISSUE_USAGE_POINT_GROUP_NOT_FOUND(9018, "issue.usagepointgroup.find.falled", "Couldn't find usage point group with id \"{0}\"", Level.SEVERE)
    ;
