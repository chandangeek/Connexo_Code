                ...
                filter.getStringList(IssueRestModuleConst.APPLICATION).isEmpty() ?
                        ...
                        filter.getString(IssueRestModuleConst.APPLICATION).equalsIgnoreCase("INS") ?
                                ...
                                filter.getString(IssueRestModuleConst.APPLICATION).equalsIgnoreCase("MultiSense") ?
                                        Stream.of(IssueTypes.DATA_COLLECTION.getName(), IssueTypes.DATA_VALIDATION.getName(), IssueTypes.DEVICE_LIFECYCLE.getName(), IssueTypes.TASK.getName(), IssueTypes.SERVICE_CALL_ISSUE.getName(), IssueTypes.WEB_SERVICE.getName()).collect(Collectors.toList()) :
                                        Collections.emptyList();
    }
}
