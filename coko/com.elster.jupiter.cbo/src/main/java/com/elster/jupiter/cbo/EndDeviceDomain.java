...
public enum EndDeviceDomain implements HasNumericCode {
    ...
    ELSTER_DEFINED_SCHEDULER1("Scheduler1", 51,  ""),
    ELSTER_DEFINED_SCHEDULER2("Scheduler2", 52,  ""),
    ELSTER_DEFINED_SCHEDULER3("Scheduler3", 53,  ""),
    ELSTER_DEFINED_SCHEDULER4("Scheduler4", 54,  "");
