...
public enum EndDeviceDomain {
    ...
    GAS_SUPPLY("GasSupply", 4, "Events or controls related to the supply of natural gas or propane."),
    INSTALLATION("Installation", 6, "Events or controls related to device installation."),
    LOAD_CONTROL("LoadControl", 15, "Events or controls related to the automatic restriction or control of a customer’s energy consumption."),
    LOAD_PROFILE("LoadProfile", 16, "Events or controls related to the energy consumption (ie. “load”) over time on a device."),
    ...
    MOBILE_SECURITY("MobileSecurity", 14, "Events or controls related to device security when the device is accessed via a mobile tool or device."),
    MODEM("Modem", 19, "Events or controls related to a device’s modem."),
    MODULE_FIRMWARE("ModuleFirmware", 9, "Events or controls related to firmware on a module contained by a device."),
    ...
    RCD_SWITCH("RCDSwitch", 31, "Events or controls related to device remote connect/disconnect activities."),
    ...
    VIDEO_DISPLAY("VideoDisplay", 13, "Events or controls related to device CRT/display."),
    WATER_SUPPLY("WaterSupply", 5, "Events or controls related to the supply of water.");
