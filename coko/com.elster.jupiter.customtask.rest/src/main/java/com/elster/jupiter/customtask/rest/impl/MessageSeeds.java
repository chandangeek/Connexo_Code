...
public enum MessageSeeds implements MessageSeed {
    DELETE_TASK_STATUS_BUSY(1, Keys.DELETE_TASK_STATUS_BUSY, "The task cannot be removed because the task is running at this moment.", Level.SEVERE),
    DELETE_TASK_SQL_EXCEPTION(2, Keys.DELETE_TASK_SQL_EXCEPTION, "Data task {0} could not be removed. There was a problem accessing the database", Level.SEVERE),
    ...
    public enum Keys {
        ;
        private static final String KEY_PREFIX = CustomTaskService.COMPONENTNAME + '.';
