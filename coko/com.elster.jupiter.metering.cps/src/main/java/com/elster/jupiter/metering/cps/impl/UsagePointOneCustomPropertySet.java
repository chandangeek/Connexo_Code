...
public class UsagePointOneCustomPropertySet implements CustomPropertySet<UsagePoint, UsagePointOneDomainExtension> {
    ...
    public List<PropertySpec> getPropertySpecs() {
        return Arrays.asList(
                this.propertySpecService
                        .bigDecimalSpec()
                        .named(UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_NUMBER.javaName(), UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_NUMBER
                                .javaName())
                        .describedAs("kw")
                ...
                this.propertySpecService
                        .stringSpec()
                        .named(UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_STRING.javaName(), UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_STRING
                                .javaName())
                ...
                this.propertySpecService
                        .bigDecimalSpec()
                        .named(UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_ENUM_NUMBER.javaName(), UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_ENUM_NUMBER
                                .javaName())
                        .describedAs("A")
                ...
                this.propertySpecService
                        .stringSpec()
                        .named(UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_ENUM_STRING.javaName(), UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_ENUM_STRING
                                .javaName())
                ...
                this.propertySpecService
                        .booleanSpec()
                        .named(UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_BOOLEAN.javaName(), UsagePointOneDomainExtension.FieldNames.TEST_ATTRIBUTE_BOOLEAN
                                .javaName())
                        .describedAs("flag")
    ...
    private static class UsagePointOnePeristenceSupport implements PersistenceSupport<UsagePoint, UsagePointOneDomainExtension> {
        ...
        public UsagePointOnePeristenceSupport(Thesaurus thesaurus) {
            this.thesaurus = thesaurus;
        }
