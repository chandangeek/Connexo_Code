...
@Component(name = "com.energyict.mdc.prepayment.rest",
...
public class PrepaymentApplication extends Application implements TranslationKeyProvider {
    ...
    private final ConsumptionExportGenerator consumptionExportGenerator = new ConsumptionExportGenerator();
