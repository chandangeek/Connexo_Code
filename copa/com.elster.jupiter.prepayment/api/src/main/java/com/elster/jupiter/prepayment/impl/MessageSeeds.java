...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_CURRENT_METER_ACTIVATION(1003, "NoCurrentMeterActivation", "The requested meter does not seem to be active at the moment (no current meter activation)."),
    NO_METER_IN_ACTIVATION(1004, "NoMeterInActivation", "The meter activation does not seem to contain a meter."),
    NO_DEVICE_FOR_METER(1005, "NoDeviceForMeter", "The meter activation of the usage point contains a meter, but the device counterpoint with MRID {0} could not be found."),
    NO_COMTASK_FOR_COMMAND(1006, "NoComTaskForCommand", "A comtask to execute the device messages could not be located."),
    UNKNOWN_STATUS(1007, "UnknownStatus", "The requested contactor status is not supported at this time."),
    UNKNOWN_UNIT_CODE(1008, "UnknownUnitCode", "The requested load limit unit is not supported at this time."),
    ...
    NO_COMTASK_FOR_STATUS_INFORMATION(1011, "NoComTaskForStatusInformation", "A comtask to verify the status information could not be located."),
    ...
    CALL_BACK_URI_NOT_SPECIFIED(1019, "CallBackURINotSpecified", "Not possible to send back the response, as the callback uri was not specified."),
    FIELD_TOO_LONG(1020, Keys.FIELD_TOO_LONG, "Field must not exceed {max} characters."),
    ;
