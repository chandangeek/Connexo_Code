 ...
 * designed to support translation.
 * The preferred way is to use the API with
 * {@link com.energyict.mdc.upl.nls.TranslationKey}s but
 ...
 * are backed by the {@link com.energyict.mdc.upl.nls.NlsService}
...
public interface PropertySpecBuilder<T> {
    ...
    /**
     * Marks the list of possible values of the {@link PropertySpec} as editable.
     *
     * @return This PropertySpecBuilder to support method chaining while constructing
     */
