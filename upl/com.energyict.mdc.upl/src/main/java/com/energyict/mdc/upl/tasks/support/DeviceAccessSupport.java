...
public interface DeviceAccessSupport {
     ...
     * The idea is that after his call, the meter is aware that we will not make any new request
     * and later on the actual connection with the meter will be closed.
     */
    void logOff();
