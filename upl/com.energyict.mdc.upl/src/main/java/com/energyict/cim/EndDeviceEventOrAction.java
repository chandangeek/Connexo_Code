...
public enum EndDeviceEventOrAction  implements CimMnemonicProvider {
    ...
    ERRORCLEARED(279,"ErrorCleared"),
    READYFORACTIVATION(280,"ReadyForActivation"),
    CORRUPTIONCLEARED(281,"CorruptionCleared"),
    WRITEFAILED(282,"WriteFailed"),
    ALMOSTFULL(283,"AlmostFull"),
    CHANGEDOUT(284,"ChangedOut"),
    MISSING(285,"Missing"),
    LIMITREACHED(286,"LimitReached"),
    EVENTSTARTED(287,"EventStarted"),
    EVENTSTOPPED(288,"EventStopped"),
    SWITCHPOSITIONCHANGED(289,"SwitchPositionChanged"),
    NOTARMED(290,"NotArmed"),
    TAMPERCLEARED(291,"TamperCleared"),
    MINLIMITCLEARED(292,"MinLimitCleared"),
    MAXLIMITCLEARED(293,"MaxLimitCleared"),
    MINLIMITCHANGED(294,"MinLimitChanged"),
    MAXLIMITCHANGED(295,"MaxLimitChanged"),
    LIMITCHANGED(296,"LimitChanged"),
    CREATEFAILED(297,"CreateFailed"),
    OPEN(298,"Open"),
    CLOSE(299,"Close"),
    SCHEDULE(300,"Schedule"),
    SCHEDULEFAILED(301,"ScheduleFailed"),
    TERMINATE(302,"Terminate"),
    TERMINATEFAILED(303,"TerminateFailed");
