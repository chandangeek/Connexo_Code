...
public enum EndDeviceSubdomain  implements CimMnemonicProvider {
    ...
    SOME_NOT_STANDARD_SUBDOMAIN11(311, "SNSSD11"),
    SOME_NOT_STANDARD_SUBDOMAIN12(312, "SNSSD12"),
    SOME_NOT_STANDARD_SUBDOMAIN13(313, "SNSSD13"),
    SOME_NOT_STANDARD_SUBDOMAIN14(314, "SNSSD14"),
    SOME_NOT_STANDARD_SUBDOMAIN15(315, "SNSSD15");
