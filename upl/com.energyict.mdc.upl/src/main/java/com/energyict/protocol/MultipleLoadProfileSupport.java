 ...
 * The framework should first call the {@link #fetchLoadProfileConfiguration(java.util.List)} to determine whether the profiles
 * are correctly configured in the meter, afterwards the {@link #getLoadProfileData(java.util.List)} can be called to return one or multiple
 * {@link com.energyict.protocol.ProfileData} objects.
 */
