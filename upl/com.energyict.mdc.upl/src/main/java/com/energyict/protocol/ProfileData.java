...
public class ProfileData implements Serializable {
    ...
    /**
     * Indication whether all {@link #intervalDatas}, including those before the device's last reading timestamp, should be stored.
     * If set to false, all IntervalData before the device's last reading timestamp will not be stored.
     */
