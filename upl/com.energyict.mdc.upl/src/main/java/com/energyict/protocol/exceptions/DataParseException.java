...
public class DataParseException extends ProtocolRuntimeException {
    ...
    public DataParseException(MessageSeed messageSeed, Object... messageArguments) {
        super(messageSeed, messageArguments);
    }

    public DataParseException(Throwable cause, MessageSeed messageSeed, Object... messageArguments) {
