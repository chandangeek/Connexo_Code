...
public class CryptoT210CatM extends T210CatM {
    ...
    public String getProtocolDescription() {
        return "Sagemcom T210 CatM Crypto Protocol DLMS (NTA ESMR5.0) V2";
    }

    @Override
    public String getVersion() {
        return "Crypto version: 2020-07-14";
    }

    @Override
    public void init(OfflineDevice offlineDevice, ComChannel comChannel) {
        journal("Sagemcom T210 CatM crypto protocol");
