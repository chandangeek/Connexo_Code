 ...
 * Author: khe
 */
public class CryptoDSMR40MessageExecutor extends Dsmr40MessageExecutor {

    private final CommonCryptoMessageExecutor commonCryptoMessageExecutor;

    public CryptoDSMR40MessageExecutor(AbstractDlmsProtocol protocol, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory, KeyAccessorTypeExtractor keyAccessorTypeExtractor) {
