...
public class ClockObject extends AbstractObject {
	...
	protected static String getRawData(Calendar newCalendar) {
		...
		strBuilder.append(convertToTwoDigits(newCalendar.get(Calendar.MONTH) + 1));
		strBuilder.append(DATE_SEPARATOR);
		strBuilder.append(convertToTwoDigits(newCalendar.get(Calendar.DAY_OF_MONTH)));
		strBuilder.append(DATE_TIME_SEPARATOR);
		strBuilder.append(convertToTwoDigits(newCalendar.get(Calendar.HOUR_OF_DAY)));
		strBuilder.append(TIME_SEPARATOR);
		strBuilder.append(convertToTwoDigits(newCalendar.get(Calendar.MINUTE)));
		strBuilder.append(TIME_SEPARATOR);
		strBuilder.append(convertToTwoDigits(newCalendar.get(Calendar.SECOND)));
