...
import com.elster.utils.lis200.events.Ek220EventInterpreter;
...
public class EK220 extends LIS200 implements IRegisterReadable {
    ...
    private static final RegisterDefinition[] registersE1N = {
            ...
            new HistoricRegisterDefinition(Lis200ObisCode.VOLUME_MEAS_COND_TOTAL_HIST, 1, "VAL4"),
            new HistoricRegisterDefinition(Lis200ObisCode.VOLUME_MEAS_COND_CORR_HIST, 1, "VAL2"),
    ...
    public EK220(PropertySpecService propertySpecService, NlsService nlsService) {
        super(propertySpecService, nlsService);
        setMaxMeterIndex(1);
        setEventInterpreter(new Ek220EventInterpreter());
    }
