...
/**
 * This class interprets all EK230 specific lis200 events.
 *
 * User: heuckeg
 * Date: 09.07.2010
 * Time: 09:04:40
 */
public class Ek230EventInterpreter extends EventInterpreter {
    ...
    public MeterEvent interpretEvent(Date timeStamp, int event) {
        ...
        switch (event) {
        case 0x8003:
            msg = "Change of time (new day) backwards";
            break;
        case 0x8004:
        ...
        case 0x0009:
            ...
            break;
        case 0x0101:
            msg = "Message 'no valid data from input 1' gone";
            break;
        case 0x0105:
        ...
        case 0x2009:
            ...
            break;
        case 0x2101:
            msg = "Message 'no valid data from input 1' raised";
