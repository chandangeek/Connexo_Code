...
public class AgrReader
{
   ...
   * @param in  An input stream for reading the file contents.
   * @param combineStatusColumns If {@code true} the status column will be combined with the value columns (if possible)
   * @param dateTimeFormat The DateFormat for decoding timestamps in AGR files (usually created by {@link AgrReaderUtils#createDateFormat(String, String, String, String, String)}).
   ...
   * @throws java.io.UnsupportedEncodingException - in case of error
   */
