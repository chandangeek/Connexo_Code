 ...
 * @author heuckeg
 */
public class GprsConfigurationV1 implements IReadWriteObject
{
  private static final ObisCode obisCode = new ObisCode(0, 128, 96, 194, 1, 255);

  public GprsConfigurationV1()
  {
  }
  ...
  public void write(CosemApplicationLayer layer, Object param[]) throws IOException
  {
    ...
    descriptor = new CosemAttributeDescriptor(obisCode, 9136, 3);
    result = layer.setAttribute(descriptor, new DlmsDataVisibleString((String)param[0]));
    ...
    descriptor = new CosemAttributeDescriptor(obisCode, 9136, 4);
    ...
    descriptor = new CosemAttributeDescriptor(obisCode, 9136, 5);
