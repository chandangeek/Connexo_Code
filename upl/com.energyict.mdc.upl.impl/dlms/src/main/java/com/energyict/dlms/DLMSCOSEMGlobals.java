...
public interface DLMSCOSEMGlobals {
    ...
    static final byte CONFIRMEDSERVICEERROR_GETSTATUS_TAG=2;
    static final byte CONFIRMEDSERVICEERROR_GETNAMELIST_TAG=3;
    static final byte CONFIRMEDSERVICEERROR_GETVARIABLEATTRIBUTE_TAG=4;
    static final byte CONFIRMEDSERVICEERROR_READ_TAG=5;
    static final byte CONFIRMEDSERVICEERROR_WRITE_TAG=6;
    static final byte CONFIRMEDSERVICEERROR_GETDATASETATTRIBUTE_TAG=7;
    static final byte CONFIRMEDSERVICEERROR_GETTIATTRIBUTE_TAG=8;
    static final byte CONFIRMEDSERVICEERROR_CHANGESCOPE_TAG=9;
    static final byte CONFIRMEDSERVICEERROR_START_TAG=10;
    static final byte CONFIRMEDSERVICEERROR_STOP_TAG=11;
    static final byte CONFIRMEDSERVICEERROR_RESUME_TAG=12;
    static final byte CONFIRMEDSERVICEERROR_MAKEUSABLE_TAG=13;
    static final byte CONFIRMEDSERVICEERROR_INITIATELOAD_TAG=14;
    static final byte CONFIRMEDSERVICEERROR_LOADSEGMENT_TAG=15;
    static final byte CONFIRMEDSERVICEERROR_TERMINATELOAD_TAG=16;
    static final byte CONFIRMEDSERVICEERROR_INITIATEUPLOAD_TAG=17;
    static final byte CONFIRMEDSERVICEERROR_UPLOADSEGMENT£_TAG=18;
