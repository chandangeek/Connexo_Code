...
public class LookupResourcesCustomCosem extends Data {
	...
	static final byte[] LN=new byte[]{0,0,96,122,0,0};
	
	public LookupResourcesCustomCosem(AbstractDataType dataType) {
		super(null,new ObjectReference(LN));
		this.dataType=dataType;
	}
	
	public LookupResourcesCustomCosem() {
		super(new CompoundDataBuilderConnection(),new ObjectReference(LN));
	}
	
	public LookupResourcesCustomCosem(ProtocolLink protocolLink) {
