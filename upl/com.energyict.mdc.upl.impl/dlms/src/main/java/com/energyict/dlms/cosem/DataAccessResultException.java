...
public final class DataAccessResultException extends IOException {
    ...
    public DataAccessResultException(int dataAccessResult) {
        this(dataAccessResult, "");
    }

    public DataAccessResultException(int dataAccessResult, String objectDescription) {
        super("Cosem Data-Access-Result exception " + evalDataAccessResult(dataAccessResult) + ((objectDescription == null || objectDescription.isEmpty()) ? "" : (" for: " + objectDescription)));
