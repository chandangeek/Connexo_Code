...
/**
 * Definable load profile attributes
 */
public enum DefinableLoadProfileAttributes implements DLMSClassAttributes{
     ...
     */
    private DefinableLoadProfileAttributes(int lnAttribute) {
