...
public class AesGcm128 {
	...
	/** Logger instance. */
	private static final Logger logger = Logger.getLogger(AesGcm128.class.getName());
	 ...
	 */
	private AesGcm128(final byte[] key, final byte[] iv, final byte[] plainText, final byte[] aad, final byte[] cipherText, final byte[] tag, final int tagSize) {
	 ...
	 */
	public AesGcm128() {
		this(new byte[KEY_SIZE], new byte[KEY_SIZE], new byte[0], new byte[0], new byte[0], new byte[0], DEFAULT_TAG_SIZE);
	}
	 ...
	 */
	public AesGcm128(final BitVector key) {
	 ...
	 */
	public AesGcm128(final byte[] globalKey, final int tagSize) {
