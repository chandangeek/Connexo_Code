...
public class MBusClient extends AbstractCosemObject {
    ...
    public void setIdentificationNumber(Unsigned32 identificationNumber) throws IOException {
        write(MbusClientAttributes.IDENTIFICATION_NUMBER.forVersion(getUsedVersion()), identificationNumber.getBEREncodedByteArray());
    }
    ...
    public void setManufacturerID(Unsigned16 manufacturerID) throws IOException {
        write(MbusClientAttributes.MANUFACTURER_ID.forVersion(getUsedVersion()), manufacturerID.getBEREncodedByteArray());
    }
