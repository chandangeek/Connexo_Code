...
public class ChangeOfTenantManagement extends AbstractCosemObject {
    ...
    public Unsigned32 readValue() throws IOException {
        this.value = new Unsigned32(getResponseData(ChangeOfTenantManagementAttributes.VALUE), 0);
        return this.value;
    }
    ...
    public Unsigned32 readPassiveValue() throws IOException {
        this.passiveValue = new Unsigned32(getResponseData(ChangeOfTenantManagementAttributes.PASSIVE_VALUE), 0);
        return passiveValue;
    }
    ...
    public DateTime readActivationDate() throws IOException {
        this.activationDate = new DateTime(getResponseData(ChangeOfTenantManagementAttributes.ACTIVATION_TIME), 0);
