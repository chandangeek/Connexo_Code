...
import com.energyict.mdc.channel.ip.datagrams.AbstractUdpSession;
 ...
 */
public class UDPIPConnection implements DlmsV2Connection, RetryRequestV2PreparationConsumer {
    ...
    public UDPIPConnection(ComChannel comChannel, CommunicationSessionProperties properties) {
