...
public class SupplierName extends AbstractCosemObject {
    ...
    public OctetString readValue() throws IOException {
        this.value = new OctetString(getResponseData(SupplierNameAttributes.VALUE), 0);
        return this.value;
    }
    ...
    public void writeValue(final OctetString value) throws IOException {
        write(SupplierNameAttributes.VALUE, value.getBEREncodedByteArray());
        this.value = value;
    }
    ...
    public ScalerUnit readScalerUnit() throws IOException {
        this.scalerUnit = new ScalerUnit(getResponseData(SupplierNameAttributes.SCALER_UNIT), 0);
        return scalerUnit;
    }
    ...
    public OctetString readPassiveValue() throws IOException {
        this.passiveValue = new OctetString(getResponseData(SupplierNameAttributes.PASSIVE_VALUE), 0);
        return passiveValue;
    }
    ...
    public void writePassiveValue(final OctetString passiveValue) throws IOException {
        write(SupplierNameAttributes.PASSIVE_VALUE, passiveValue.getBEREncodedByteArray());
    ...
    public ScalerUnit readPassiveScalerUnit() throws IOException {
        this.passiveScalerUnit = new ScalerUnit(getResponseData(SupplierNameAttributes.PASSIVE_SCALER_UNIT), 0);
    ...
    public void writeActivationDate(final DateTime activationDate) throws IOException {
        write(SupplierNameAttributes.ACTIVATION_TIME, activationDate.getBEREncodedByteArray());
