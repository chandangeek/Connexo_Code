...
public class NBIOTModemSetup extends AbstractCosemObject {
    ...
    private static final ObisCode DEFAULT_OBIS_CODE = ObisCode.fromString("0.1.25.4.0.255");

    /**
     * @param protocolLink
     * @param objectReference
     */
    public NBIOTModemSetup(ProtocolLink protocolLink, ObjectReference objectReference) {
