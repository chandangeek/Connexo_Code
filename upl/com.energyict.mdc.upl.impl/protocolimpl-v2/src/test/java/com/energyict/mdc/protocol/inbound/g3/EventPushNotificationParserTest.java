...
public class EventPushNotificationParserTest extends TestCase {
    ...
    public void testExceptionLogging() throws IOException, SQLException, BusinessException {
        ...
        assertEquals(pushEventNotification.getLoggingMessage(), "Received inbound event notification from [660-00545D-1125].  Message: 'G3 : Node [0223:7EFF:FEFD:AAE9] [0x0006] has registered on the network', protocol code: '194'");
    }
