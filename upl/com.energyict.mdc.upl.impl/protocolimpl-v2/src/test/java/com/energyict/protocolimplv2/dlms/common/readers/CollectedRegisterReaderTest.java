...
public class CollectedRegisterReaderTest {
    ...
    @Mock
    private CollectedRegisterReaderFinder<AbstractDlmsProtocol> collectedRegisterReaderFinder;
    @Mock
    ...
    @Mock
    private ObisReader<CollectedRegister, OfflineRegister, ?, AbstractDlmsProtocol> reader;

    @Test
    public void noOfflineRegisters() {
        CollectedRegisterReader<AbstractDlmsProtocol> collectedRegisterReader = new CollectedRegisterReader<>(collectedRegisterReaderFinder, dlmsProtocol, collectedRegisterBuilder);
    ...
    public void foundReader() {
        Mockito.<Optional<? extends ObisReader<CollectedRegister, OfflineRegister, ?, AbstractDlmsProtocol>>>when(collectedRegisterReaderFinder.find(dlmsProtocol, offlineRegister)).thenReturn(Optional.of(reader));
