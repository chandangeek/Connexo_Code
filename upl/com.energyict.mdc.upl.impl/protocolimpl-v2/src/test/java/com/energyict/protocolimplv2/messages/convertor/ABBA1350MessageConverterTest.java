...
/**
 * Test that creates OfflineDeviceMessages (the attributes are all filled with dummy values) and converts them to the legacy XML message, testing the {@link ABBA1350MessageConverter} component.
 *
 * @author sva
 * @since 25/10/13 - 9:40
 */
