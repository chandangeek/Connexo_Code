...
public class Beacon3100ClientTypeTest {
    ...
    public void testEquals() throws Exception {
        ...
        Beacon3100ClientType beacon3100ClientType1 = new Beacon3100ClientType(1,1,5,3);
        Beacon3100ClientType beacon3100ClientType2 = new Beacon3100ClientType(1,1,3,0);
        Beacon3100ClientType beacon3100ClientType3 = new Beacon3100ClientType(1,1,3,0);
        Beacon3100ClientType beacon3100ClientType4 = new Beacon3100ClientType(1,1,5,3);
