...
public class EIWebMessageConverterTest {
    ...
    public void mockMessages() {
        ...
        setInputChannel = createMessage(EventsConfigurationDeviceMessage.SetInputChannel);
        setOutputChannel = createMessage(EventsConfigurationDeviceMessage.SetOutputChannel);
