package com.energyict.protocolimplv2.coronis.waveflow.core;

import com.energyict.protocol.MeterEvent;
import com.energyict.protocolimplv2.coronis.waveflow.WaveFlow;
import com.energyict.protocolimplv2.coronis.waveflow.core.radiocommand.LeakageEvent;
...
public class EventStatusAndDescription {
    ...
    public int getEventCode(int bit) {
        int deviceType = waveFlow.getWaveFlowProperties().getApplicationStatusVariant();
        switch (bit) {
            case 0x02:
