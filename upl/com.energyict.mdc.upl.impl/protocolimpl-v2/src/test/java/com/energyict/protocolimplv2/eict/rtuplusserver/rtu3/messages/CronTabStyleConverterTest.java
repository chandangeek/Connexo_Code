...
import com.energyict.protocolimplv2.eict.rtu3.beacon3100.messages.syncobjects.CronTabStyleConverter;
...
public class CronTabStyleConverterTest {
    ...
    public void test() {
        ...
        String convert = CronTabStyleConverter.convert(nextExecutionSpecs, timeZone, timeZone);
