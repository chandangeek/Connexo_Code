...
import test.com.energyict.protocolimplV2.edmi.mk10.eventsurvey.Event;
import test.com.energyict.protocolimplV2.edmi.mk10.eventsurvey.EventSurvey;
import test.com.energyict.protocolimplV2.edmi.mk10.loadsurvey.LoadSurvey;
import test.com.energyict.protocolimplV2.edmi.mk10.loadsurvey.LoadSurveyData;
...
public class MK10Profile {
	...
	public MK10Profile(MK10Generic mk10) {
		this.mk10=mk10;
	}
