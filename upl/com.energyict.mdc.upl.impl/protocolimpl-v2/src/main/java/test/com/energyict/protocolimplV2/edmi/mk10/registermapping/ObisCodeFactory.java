...
package test.com.energyict.protocolimplV2.edmi.mk10.registermapping;
...
import test.com.energyict.protocolimplV2.edmi.mk10.command.ReadCommand;
import test.com.energyict.protocolimplV2.edmi.mk10.core.TOUChannelTypeParser;
...
public class ObisCodeFactory {
	...
	public ObisCodeFactory(MK10Generic mk10) throws IOException {
		this.mk10=mk10;
