package com.energyict.protocolimplv2.dlms.idis.hs3300s.plc.pp;
...
/**
 * Supported device type(s): HS3300SIxxxTx PP PLC
 * Protocol release notes: https://confluence.honeywell.com/display/PRTCL/Honeywell+HS3300S+Polyphase+PLC
 */
public class HS3300SPlcPP extends HS3300 {

    public HS3300SPlcPP(PropertySpecService propertySpecService, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory,
    ...
    public String getProtocolDescription() {
        return "Honeywell HS3300S Poly-phase PLC DLMS Meter";
    }
