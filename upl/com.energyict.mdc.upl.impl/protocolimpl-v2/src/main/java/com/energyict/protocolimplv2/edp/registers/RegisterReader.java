...
public class RegisterReader implements DeviceRegisterSupport {
    ...
    public List<CollectedRegister> readRegisters(List<OfflineRegister> registers) {
        ...
        for (OfflineRegister register : registers) {
            ...
            if (obisCode.getF() != 255) {
                ...
                try {
                    historicalValue = protocol.getStoredValues().getHistoricalValue(obisCode);
                    RegisterValue registerValue = new RegisterValue(obisCode, historicalValue.getQuantityValue(), historicalValue
                            .getEventTime());
    ...
    private CollectedRegister createFailureCollectedRegister(OfflineRegister register, ResultType
