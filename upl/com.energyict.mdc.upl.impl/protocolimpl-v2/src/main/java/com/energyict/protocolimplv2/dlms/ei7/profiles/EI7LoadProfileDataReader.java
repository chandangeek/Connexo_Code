...
public class EI7LoadProfileDataReader extends A2ProfileDataReader {
    ...
    public EI7LoadProfileDataReader(A2 protocol, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory,
        ...
        this.dataVolumeUnitScalar = Unit.get(
                offlineDevice.getAllProperties().getTypedProperty(DATA_VOLUME_UNIT_PROPERTY, EI7_DEFAULT_DATA_VOLUME_UNIT_PROPERTY),
                offlineDevice.getAllProperties().getTypedProperty(DATA_VOLUME_SCALAR_PROPERTY, EI7_DEFAULT_DATA_VOLUME_SCALAR_PROPERTY));
    ...
    private List<ChannelInfo> createChannelInfo() {
        ...
        ChannelInfo channelInfo0 = new ChannelInfo(0, "7.0.13.2.0.255", getDataVolumeUnitScalar(), offlineDevice.getSerialNumber(), false);
        channelInfo0.setMultiplier(new BigDecimal(1));
        channelInfos.add(channelInfo0);
        ChannelInfo channelInfo1 = new ChannelInfo(1, "7.0.12.2.0.255", getDataVolumeUnitScalar(), offlineDevice.getSerialNumber(), false);
    ...
    private List<ChannelInfo> createMonthlyChannelInfo() {
        ...
        ChannelInfo channelInfo1 = new ChannelInfo(1, "7.0.13.2.1.255", getDataVolumeUnitScalar(), offlineDevice.getSerialNumber(), false);
        channelInfo1.setMultiplier(new BigDecimal(1));
        channelInfos.add(channelInfo1);

        ChannelInfo channelInfo2 = new ChannelInfo(2, "7.0.13.2.2.255", getDataVolumeUnitScalar(), offlineDevice.getSerialNumber(), false);
        channelInfo2.setMultiplier(new BigDecimal(1));
        channelInfos.add(channelInfo2);

        ChannelInfo channelInfo3 = new ChannelInfo(3, "7.0.13.2.3.255", getDataVolumeUnitScalar(), offlineDevice.getSerialNumber(), false);
        channelInfo3.setMultiplier(new BigDecimal(1));
        channelInfos.add(channelInfo3);

        ChannelInfo channelInfo4 = new ChannelInfo(4, "7.0.12.2.0.255", getDataVolumeUnitScalar(), offlineDevice.getSerialNumber(), false);
