...
public class AS300NStoredValues implements StoredValues {

    public static final ObisCode OBISCODE_BILLING_PROFILE = ObisCode.fromString("0.0.98.1.0.255");

    protected final AS300N as300n;
    private final CosemObjectFactory cosemObjectFactory;
    protected DataContainer buffer = null;
    private ProfileGeneric profileGeneric = null;

    public AS300NStoredValues(AS300N as300n) {
        this.cosemObjectFactory = as300n.getDlmsSession().getCosemObjectFactory();
        this.as300n = as300n;
    }
    ...
    private Unit getUnit(ObisCode baseObisCode) throws IOException {
        Map<ObisCode, Unit> unitMap = as300n.getProfileDataReader().readUnits(null, Arrays.asList(baseObisCode));
    ...
    private boolean isValidBillingPoint(int billingPoint) {
        try {
            ...
            throw DLMSIOExceptionHandler.handle(e, as300n.getDlmsSession().getProperties().getRetries()+1);
        }
    }
