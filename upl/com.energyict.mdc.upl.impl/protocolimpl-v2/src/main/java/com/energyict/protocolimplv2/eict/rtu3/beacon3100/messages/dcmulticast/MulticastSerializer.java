...
public class MulticastSerializer {
    ...
    public static String serialize(OfflineDevice offlineDevice, DeviceMessage deviceMessage) {
        ...
        for (String deviceId : split) {
            ...
            final byte[] dlmsMeterKEK = MasterDataSerializer.parseKey(Beacon3100ConfigurationSupport.DLMS_METER_KEK, beaconDevice.getProtocolProperties().getStringProperty(Beacon3100ConfigurationSupport.DLMS_METER_KEK));
