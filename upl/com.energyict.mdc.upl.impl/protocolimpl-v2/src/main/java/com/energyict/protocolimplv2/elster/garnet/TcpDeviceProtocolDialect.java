...
public class TcpDeviceProtocolDialect extends AbstractDeviceProtocolDialect {
    ...
    public String getDeviceProtocolDialectName() {
        return DeviceProtocolDialectTranslationKeys.GARNET_TCP_DIALECT_NAME.getName();
    }

    @Override
    public String getDeviceProtocolDialectDisplayName() {
        return getThesaurus().getFormat(DeviceProtocolDialectTranslationKeys.GARNET_TCP_DIALECT_NAME).format();
    }
