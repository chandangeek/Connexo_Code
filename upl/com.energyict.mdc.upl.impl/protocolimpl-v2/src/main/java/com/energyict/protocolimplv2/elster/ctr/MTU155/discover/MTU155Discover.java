...
//     *
//     * @throws com.energyict.cbo.BusinessException If there was an error while creating the InfoType
//     * @throws java.sql.SQLException      If there was an SQL error while creating the InfoType
//     */
