...
public class Messaging implements DeviceMessageSupport {
    ...
    private CollectedMessage writeExchangeStatus(OfflineDeviceMessage pendingMessage) throws IOException {
        ...
        try {
            ...
            collectedMessage.setFailureInformation(ResultType.NotSupported, MdcManager.getIssueCollector().addProblem(pendingMessage, "WriteWavecardParameters.writeExchangeStatusFailed", e.getMessage()));
        }
    ...
    private CollectedMessage witeRadioAcknowledge(OfflineDeviceMessage pendingMessage) throws IOException {
        ...
        try {
            ...
            collectedMessage.setNewDeviceMessageStatus(DeviceMessageStatus.FAILED);
            collectedMessage.setFailureInformation(ResultType.NotSupported, MdcManager.getIssueCollector().addProblem(pendingMessage, "WriteWavecardParameters.writeRadioAcknowledgeFailed", e.getMessage()));
        }
        return collectedMessage;
    }
    ...
    private CollectedMessage writeRadioUserTimeout(OfflineDeviceMessage pendingMessage) throws IOException {
        ...
        try {
            ...
            collectedMessage.setNewDeviceMessageStatus(DeviceMessageStatus.FAILED);
            collectedMessage.setFailureInformation(ResultType.NotSupported, MdcManager.getIssueCollector().addProblem(pendingMessage, "WriteWavecardParameters.writeRadioUserTimeoutFailed", e.getMessage()));
        }
        return collectedMessage;
    }
