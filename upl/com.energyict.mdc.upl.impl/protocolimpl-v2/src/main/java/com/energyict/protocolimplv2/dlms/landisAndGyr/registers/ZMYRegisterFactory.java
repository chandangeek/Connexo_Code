package com.energyict.protocolimplv2.dlms.landisAndGyr.registers;
...
public class ZMYRegisterFactory implements DeviceRegisterSupport {
	...
	private static final String ALARM_REGISTER1             = "0.0.97.98.0.255"; // ok
	private static final String ALARM_REGISTER2             = "0.0.97.98.1.255"; // ok
	private static final String ERROR_REGISTER              = "0.0.97.97.0.255"; // ok
	private static final String ACTIVE_FIRMWARE_SIGNATURE   = "1.0.0.2.8.255";   // MID Checksum (of metering part)
