...
public class A2 extends AbstractDlmsProtocol {
    ...
    public A2(PropertySpecService propertySpecService, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory, NlsService nlsService) {
    ...
    private A2Messaging getA2Messaging() {
        if (messaging == null) {
            messaging = new A2Messaging(this);
        }
        return messaging;
    }
