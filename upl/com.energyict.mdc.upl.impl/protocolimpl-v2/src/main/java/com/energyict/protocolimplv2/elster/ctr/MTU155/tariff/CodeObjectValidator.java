...
public class CodeObjectValidator {
    ...
    private static void validateBasicDayType(CodeDayTypeObject dayType) throws IllegalArgumentException {
    ...
    private static void validateForcedDayType(CodeDayTypeObject dayType) throws IllegalArgumentException {
        List<CodeDayTypeDefObject> defs = dayType.getDayTypeDefs();
    ...
    private static void validateDefaultDayType(CodeDayTypeObject dayType) throws IllegalArgumentException {
        List<CodeDayTypeDefObject> defs = dayType.getDayTypeDefs();
        if (defs.size() != 1) {
