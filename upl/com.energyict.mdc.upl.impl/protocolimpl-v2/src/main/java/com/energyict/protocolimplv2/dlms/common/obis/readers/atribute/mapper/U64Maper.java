...
public class U64Maper implements AttributeMapper<Unsigned64> {
    ...
    public RegisterValue map(AbstractDataType attribute, ObisCode obisCode) throws MappingException {
        ...
        if (attribute.isUnsigned64() && unsigned64 != null) {
            return new RegisterValue(obisCode, new Quantity(unsigned64.toBigDecimal(), unit));
        } else {
            throw new MappingException("Developed obis code:" + obisCode + " as an unsigned64 yet reading tells otherwise");
        }
    }
