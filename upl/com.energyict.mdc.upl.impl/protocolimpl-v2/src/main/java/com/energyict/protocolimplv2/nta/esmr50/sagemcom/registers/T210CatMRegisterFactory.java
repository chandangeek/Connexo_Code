    ...
    protected RegisterValue convertCustomAbstractObjectsToRegisterValues(final OfflineRegister register, AbstractDataType abstractDataType) throws UnsupportedException {
        try {
            ...
            if (rObisCode.equals(LTE_MONITORING_BASE)) {
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getT3402(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getT3412(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getT3412ext2(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getT3324(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getTeDrx(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getTptw(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getRsrq(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
            } else if (rObisCode.equals(LTE_MONITORING_LTE_QUALITY_OF_SERVICE_RSRQ)) {
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getRsrp(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getqRxlevMin(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getqRxlevMinCEr13(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                LTEMonitoringWrapperVersion1 lteMonitoringWrapper = new LTEMonitoringWrapperVersion1(abstractDataType);
                if (lteMonitoringWrapper.isDecoded()) {
                    return new RegisterValue(register, new Quantity(lteMonitoringWrapper.getqRxlevMinCE1r13(), Unit.getUndefined()), null, null, null, new Date(), 0, lteMonitoringWrapper.toString());
                } else {
                    return new RegisterValue(register, abstractDataType.toString());
                }
                ...
                return new RegisterValue(register, new Quantity(id, Unit.getUndefined()), null, null, null, new Date(), 0, desc);
            }

            protocol.journal(FINEST, " > register " + register.getObisCode() + " for " + register.getSerialNumber() + " was translated as " + rObisCode.toString() + " and could not be handled by ESMR5 register factory. Asking ancestors.");
        } catch (Exception ex) {
