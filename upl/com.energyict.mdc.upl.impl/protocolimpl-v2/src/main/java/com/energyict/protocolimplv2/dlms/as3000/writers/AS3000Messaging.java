...
import com.energyict.protocolimplv2.dlms.common.writers.converters.AXRDateTimeConverter;
import com.energyict.protocolimplv2.dlms.common.writers.converters.OctetStringConverter;
import com.energyict.protocolimplv2.dlms.common.writers.converters.U16Converter;
...
public class AS3000Messaging  {
    ...
    public MessageHandler getMessageHandler() {
        ...
        messages.add(new GenericAttributeWrite(collectedDataFactory, issueFactory, dlmsProtocol, propSpecService, nlsService, converter,
                new DLMSAttribute(ObisCode.fromString("1.1.132.1.2.255"), 2, DLMSClassId.DATA),new OctetStringConverter(DeviceMessageConstants.limitationMeasurementQuantity, 1), DeviceActionMessage.LimitationQuantityMeasure));
        messages.add(new GenericAttributeWrite(collectedDataFactory, issueFactory, dlmsProtocol, propSpecService, nlsService, converter,
                new DLMSAttribute(ObisCode.fromString("1.1.134.1.0.255"), 2, DLMSClassId.DATA),new U16Converter(DeviceMessageConstants.engineerPin), ConfigurationChangeDeviceMessage.SET_ENGINEER_PIN_4DIGITS_NO_TIMEOUT));
