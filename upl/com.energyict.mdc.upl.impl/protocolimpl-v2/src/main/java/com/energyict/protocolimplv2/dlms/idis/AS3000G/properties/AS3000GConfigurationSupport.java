...
public class AS3000GConfigurationSupport extends AM540ConfigurationSupport {
    ...
    private PropertySpec shortAddressPan() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.SHORT_ADDRESS_PAN, false, PropertyTranslationKeys.V2_SHORT_ADDRESS_PAN, getPropertySpecService()::bigDecimalSpec).finish();
    }

    private PropertySpec ipV6Address() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.IP_V6_ADDRESS, false, PropertyTranslationKeys.V2_IP_V6_ADDRESS, this.getPropertySpecService()::stringSpec).finish();
    }

    private PropertySpec ipV4Address() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.IP_V4_ADDRESS, false, PropertyTranslationKeys.V2_IP_V4_ADDRESS, this.getPropertySpecService()::stringSpec).finish();
    }

    private PropertySpec frameCounterRecoveryRetries() {
        return this.bigDecimalSpec(AS3000GConfigurationSupport.FRAME_COUNTER_RECOVERY_RETRIES, false, PropertyTranslationKeys.V2_DLMS_FRAME_COUNTER_RECOVERY_RETRIES, BigDecimal.valueOf(100));
    }
    private PropertySpec frameCounterRecoveryStep() {
        return this.bigDecimalSpec(AS3000GConfigurationSupport.FRAME_COUNTER_RECOVERY_STEP, false, PropertyTranslationKeys.V2_DLMS_FRAME_COUNTER_RECOVERY_STEP, BigDecimal.ONE);
    }

    private PropertySpec validateCachedFrameCounter() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.VALIDATE_CACHED_FRAMECOUNTER, false, PropertyTranslationKeys.V2_DLMS_VALIDATE_CACHED_FRAMECOUNTER, getPropertySpecService()::booleanSpec)
                .finish();
    }
    ...
    private final PropertySpec supportsHundrethsTimeField() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.SUPPORTS_HUNDRETHS_TIMEFIELD, false, PropertyTranslationKeys.V2_SUPPORTS_HUNDRETHS_TIMEFIELD, getPropertySpecService()::booleanSpec)
    ...
    private final PropertySpec skipFramecounterAuthenticationTagValidation() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.SKIP_FC_AUTH_TAG_VALIDATION, false, PropertyTranslationKeys.V2_SKIP_FC_AUTH_TAG_VALIDATION, getPropertySpecService()::booleanSpec)
                .setDefaultValue(false)
                .finish();
    }
    ...
    private final PropertySpec skipSlaveDevices() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.SKIP_SLAVE_DEVICES, false, PropertyTranslationKeys.V2_SKIP_SLAVE_DEVICES, getPropertySpecService()::booleanSpec)
    ...
    private final PropertySpec useUndefinedForClockStatus() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.USE_UNDEFINED_AS_CLOCK_STATUS, false, PropertyTranslationKeys.V2_USE_UNDEFINED_AS_CLOCK_STATUS, getPropertySpecService()::booleanSpec)
                .setDefaultValue(true)
                .finish();
    }
    ...
    private final PropertySpec useUndefinedForTimeDeviation() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.USE_UNDEFINED_AS_TIME_DEVIATION, false, PropertyTranslationKeys.V2_USE_UNDEFINED_AS_TIME_DEVIATION, getPropertySpecService()::booleanSpec)
                .setDefaultValue(true)
                .finish();
    }
    ...
    private final PropertySpec useFixedObjectList() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.USE_FIXED_OBJECT_LIST, false, PropertyTranslationKeys.V2_USE_FIXED_OBJECT_LIST, getPropertySpecService()::booleanSpec)
                .setDefaultValue(false)
                .finish();
    }
    ...
    private PropertySpec useCachedFrameCounter() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.USE_CACHED_FRAME_COUNTER, false, PropertyTranslationKeys.V2_DLMS_USE_CACHED_FRAMECOUNTER, getPropertySpecService()::booleanSpec)
                .finish();
    }

    private PropertySpec requestAuthenticatedFrameCounter() {
        return UPLPropertySpecFactory.specBuilder(AS3000GConfigurationSupport.REQUEST_AUTHENTICATED_FRAME_COUNTER, false, PropertyTranslationKeys.V2_DLMS_REQUEST_AUTHENTICATE_FRAME_COUNTER, getPropertySpecService()::booleanSpec)
                .finish();
    }
    ...
    protected PropertySpec serverUpperMacAddressPropertySpec() {
        return this.bigDecimalSpec(DlmsProtocolProperties.SERVER_UPPER_MAC_ADDRESS, false, PropertyTranslationKeys.V2_DLMS_SERVER_UPPER_MAC_ADDRESS, DEFAULT_UPPER_SERVER_MAC_ADDRESS);
    }
