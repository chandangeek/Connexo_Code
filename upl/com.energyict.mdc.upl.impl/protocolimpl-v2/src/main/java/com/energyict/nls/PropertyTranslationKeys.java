...
public enum PropertyTranslationKeys implements TranslationKey {
    ...
    V2_DLMS_DATA_VOLUME_UNIT("upl.property.v2.dlms.dataVolumeUnit", "Data volume unit"),
    V2_DLMS_DATA_VOLUME_SCALAR("upl.property.v2.dlms.dataVolumeScalar", "Data volume scalar"),
    ...
    V2_COMMUNICATION_TYPE("upl.property.v2.nta.CommunicationType", "Communication type (GPRS/NB-IoT)"),
    V2_COMMUNICATION_TYPE_DESCRIPTION("upl.property.v2.nta.CommunicationType.description", "Communication type (GPRS/NB-IoT)"),
