...
public class T210DMessageExecutor extends AM540MessageExecutor {
    ...
    protected CollectedMessage executeMessage(OfflineDeviceMessage pendingMessage, CollectedMessage collectedMessage) throws IOException {
        ...
        if (pendingMessage.getSpecification().equals(AlarmConfigurationMessage.RESET_DESCRIPTOR_FOR_ALARM_REGISTER)) {
            ...
            firmwareUpgrade(pendingMessage, false);
            ...
            firmwareUpgrade(pendingMessage, true);
            ...
            timedAction(pendingMessage, Integer.parseInt(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.scriptNumber).getValue()));
    ...
    private void writeSpecialDaysForGivenTableObis() throws IOException {
        ObisCode specialDaysTableObisCode = ObisCode.fromString(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.specialDaysTableObiscodeAttributeName).getValue());
        String specialDaysTable = MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.specialDaysXmlUserFileAttributeName).getValue();
    ...
    private void writeActivityCalendarOverconsumptions() throws IOException {
        ObisCode activityCalendarObisCode = ObisCode.fromString(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.activityCalendarObiscodeAttributeName).getValue());
        String dayProfileTable = MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.dayProfileXmlUserFileAttributeName).getValue();
        String weekProfileTable = MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.weekProfileXmlUserFileAttributeName).getValue();
        String seasonProfileTable = MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.seasonProfileXmlUserFileAttributeName).getValue();
        Long epoch = Long.valueOf(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.activityCalendarActivationDateAttributeName).getValue());
    ...
    */
    ...
    private void configureSuperVisionMonitor() throws IOException {
        int phase = new BigDecimal(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, phaseAttributeName).getValue()).intValue();
        int positiveThreshold = new BigDecimal(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, positiveThresholdInAmpereAttributeName).getValue()).intValue();
        int negativeThreshold = new BigDecimal(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, negativeThresholdInAmpereAttributeName).getValue()).intValue();
    ...
    private void firmwareUpgrade(OfflineDeviceMessage offlineDeviceMessage, boolean doActivation) throws IOException {
    ...
    private void installWirelessMbusDevices() throws IOException {
        ...
        String meterIdentification = MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.gMeterIdentificationAttributeName).getValue();
    ...
    */
    ...
    private void setDataProtectionRequiredProtection() throws IOException {
        int requiredProtection = Integer.valueOf(MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.requiredProtection).getValue());
    ...
    private void remoteDisconnectWithDataProtectionAndActivationDate() throws IOException {
        String activationDate = MessageConverterTools.getDeviceMessageAttribute(pendingMessage, DeviceMessageConstants.contactorActivationDateAttributeName).getValue();
