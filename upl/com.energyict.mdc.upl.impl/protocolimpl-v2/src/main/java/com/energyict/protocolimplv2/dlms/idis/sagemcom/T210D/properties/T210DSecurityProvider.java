...
public class T210DSecurityProvider extends NTASecurityProvider implements GeneralCipheringSecurityProvider {
    ...
    public T210DSecurityProvider(TypedProperties properties, int authenticationDeviceAccessLevel, CertificateWrapperExtractor certificateWrapperExtractor, int securitySuite) {
