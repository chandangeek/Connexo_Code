package com.energyict.protocolimplv2.dlms.idis.am122.registers;
...
public class AM122RegisterFactory extends AM130RegisterFactory {
    public AM122RegisterFactory(AM130 am130, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory) {
