 ...
 */
public class DisconnectEvent extends AbstractField<DisconnectEvent> implements  LogBookEvent{
    ...
    private BitMapCollection<ContactorShutdownStatus> contactorStatusMask;
    ...
    public DisconnectEvent() {
        ...
        this.contactorStatusMask = new BitMapCollection<ContactorShutdownStatus>(LENGTH_OF_CONTACTOR_STATUSES, NR_OF_METERS, ContactorShutdownStatus.class);
        this.paddingData = new PaddingData(11);
    }

    public DisconnectEvent(BitMapCollection<AffectedMeterMask> affectedMetersMask, BitMapCollection<ContactorShutdownStatus> contactorStatusMask) {
    ...
    @Override
    public DisconnectEvent parse(byte[] rawData, int offset) throws ParsingException {
        int ptr = offset;
    ...
    public BitMapCollection<ContactorShutdownStatus> getContactorStatusMask() {
