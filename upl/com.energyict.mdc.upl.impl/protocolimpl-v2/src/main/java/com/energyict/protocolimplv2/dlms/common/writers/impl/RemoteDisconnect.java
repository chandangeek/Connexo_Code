...
public class RemoteDisconnect extends AbstractMessage {
    ...
    public RemoteDisconnect(CollectedDataFactory collectedDataFactory, IssueFactory issueFactory, AbstractDlmsProtocol dlmsProtocol, PropertySpecService propSpecService, NlsService nlsService, Converter converter) {
    ...
    public DeviceMessageSpec asMessageSpec() {
        return ContactorDeviceMessage.CONTACTOR_OPEN.get(propSpecService, nlsService, converter);
    }
