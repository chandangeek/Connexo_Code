 ...
 */
public class Beacon3100FraudDetectionLog extends Beacon3100AbstractEventLog {

    public Beacon3100FraudDetectionLog(DataContainer dc, TimeZone timeZone) {
        super(dc, timeZone);
    }

    @Override
    protected String getLogBookName() {
        return "Fraud detection log";
    }
    @Override
