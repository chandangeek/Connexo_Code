...
public class A2Inbound implements BinaryInboundDeviceProtocol {
    ...
    private void readFrameCounter(ComChannel comChannel) {
        ...
        publicClientProperties.setSecurityPropertySet(
                new DeviceProtocolSecurityPropertySetImpl(0, 0, 0, 0, 0, clone)
        );  // SecurityLevel 0:0
    ...
    @Override
    public void provideDeviceInformation(List<DeviceProtocolInformation> deviceInformationList) {
    }
    ...
    @Override
    public boolean shouldHandOverToDeviceProtocolAfterDataPush() {
        return true;
    }
    ...
    public DeviceProtocolSecurityPropertySet getSecurityPropertySet(DeviceIdentifier anyDeviceIdentifier) {
        if (deviceProtocolSecurityPropertySet == null) {
            List<DeviceMasterDataExtractor.SecurityProperty> securityProperties = inboundDAO.getDeviceProtocolSecurityProperties(anyDeviceIdentifier, inboundComPort);
            if (securityProperties != null && !securityProperties.isEmpty()) {
                deviceProtocolSecurityPropertySet = new DeviceProtocolSecurityPropertySetImpl(securityProperties);
            } else {
