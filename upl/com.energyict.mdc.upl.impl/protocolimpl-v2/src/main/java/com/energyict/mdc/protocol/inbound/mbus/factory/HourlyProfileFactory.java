 ...
 */
public class HourlyProfileFactory extends AbstractMerlinFactory{
    ...
    private void setStartIndex(TelegramVariableDataRecord indexRecord) {
        ...
        this.midnight = toMidnight(getTelegramDateTime());
        getInboundContext().getLogger().log("Starting load profile calculation backwards from midnight: " + midnight) ;
    }
