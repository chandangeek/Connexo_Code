...
public class UnitField extends AbstractField<UnitField> {
    ...
    public enum UnitMapping {
        ...
        V2H(4, BaseUnit.VOLTSQUARE, NO_SCALE, ObisCode.fromString("1.0.89.0.0.255")),
        I2H(5, BaseUnit.AMPERESQUARE, NO_SCALE, ObisCode.fromString("1.0.88.0.0.255")),
        ...
        VH(8, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.92.0.0.255")),
        IH(9, BaseUnit.AMPERE, NO_SCALE, ObisCode.fromString("1.0.90.0.0.255")),
        ...
        VH_PHASE_A(17, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.32.0.0.255")),
        VH_PHASE_B(18, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.52.0.0.255")),
        VH_PHASE_C(19, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.72.0.0.255")),
        IH_PHASE_A(20, BaseUnit.AMPERE, NO_SCALE, ObisCode.fromString("1.0.31.0.0.255")),
        IH_PHASE_B(21, BaseUnit.AMPERE, NO_SCALE, ObisCode.fromString("1.0.51.0.0.255")),
        IH_PHASE_C(22, BaseUnit.AMPERE, NO_SCALE, ObisCode.fromString("1.0.71.0.0.255")),
        PFH(23, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.13.0.0.255")),
        HARMONIC_DISTORTION_HOUR(24, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.92.4.124.255")),
        KVAH_ALL_PHASES(25, BaseUnit.VOLTAMPEREHOUR, KILO_SCALE_FACTOR, ObisCode.fromString("1.0.9.8.0.255")),
        PFH_REVERSE(26, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.84.0.0.255")),
        PFH_PHASE_A(27, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.33.0.0.255")),
        PFH_PHASE_B(28, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.53.0.0.255")),
        PFH_PHASE_C(29, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.73.0.0.255")),
        THDH_VOLTAGE_PHASE_A(30, BaseUnit.TOTALHARMONICDISTORTIONV_IEEE, NO_SCALE, ObisCode.fromString("1.0.32.4.124.255")),
        THDH_VOLTAGE_PHASE_B(31, BaseUnit.TOTALHARMONICDISTORTIONV_IEEE, NO_SCALE, ObisCode.fromString("1.0.52.4.124.255")),
        THDH_VOLTAGE_PHASE_C(32, BaseUnit.TOTALHARMONICDISTORTIONV_IEEE, NO_SCALE, ObisCode.fromString("1.0.72.4.124.255")),
        THDH_CURRENT_PHASE_A(33, BaseUnit.TOTALHARMONICDISTORTIONI_IEEE, NO_SCALE, ObisCode.fromString("1.0.31.4.124.255")),
        THDH_CURRENT_PHASE_B(34, BaseUnit.TOTALHARMONICDISTORTIONI_IEEE, NO_SCALE, ObisCode.fromString("1.0.51.4.124.255")),
        THDH_CURRENT_PHASE_C(35, BaseUnit.TOTALHARMONICDISTORTIONI_IEEE, NO_SCALE, ObisCode.fromString("1.0.71.4.124.255")),
        MAX_VH_PHASE_A(36, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.32.6.0.255")),
        MAX_VH_PHASE_B(37, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.52.6.0.255")),
        MAX_VH_PHASE_C(38, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.72.6.0.255")),
        MIN_VH_PHASE_A(39, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.32.3.0.255")),
        MIN_VH_PHASE_B(40, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.52.3.0.255")),
        MIN_VH_PHASE_C(41, BaseUnit.VOLT, NO_SCALE, ObisCode.fromString("1.0.72.3.0.255")),
