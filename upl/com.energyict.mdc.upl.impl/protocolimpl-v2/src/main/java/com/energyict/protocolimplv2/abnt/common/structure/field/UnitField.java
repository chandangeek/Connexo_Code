...
public class UnitField extends AbstractField<UnitField> {
    ...
    public enum UnitMapping {
        ...
        THDH_VOLTAGE_PHASE_A(30, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.32.4.124.255")),
        THDH_VOLTAGE_PHASE_B(31, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.52.4.124.255")),
        THDH_VOLTAGE_PHASE_C(32, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.72.4.124.255")),
        THDH_CURRENT_PHASE_A(33, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.31.4.124.255")),
        THDH_CURRENT_PHASE_B(34, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.51.4.124.255")),
        THDH_CURRENT_PHASE_C(35, BaseUnit.UNITLESS, NO_SCALE, ObisCode.fromString("1.0.71.4.124.255")),
