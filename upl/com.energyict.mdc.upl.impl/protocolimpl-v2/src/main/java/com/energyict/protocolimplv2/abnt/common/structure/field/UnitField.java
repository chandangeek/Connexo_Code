...
public class UnitField extends AbstractField<UnitField> {
    ...
    public enum UnitMapping {
        ...
        KVARH_IND_RECEIVED(15, BaseUnit.VOLTAMPEREREACTIVEHOUR, KILO_SCALE_FACTOR, ObisCode.fromString("1.2.4.8.0.255")),
        KVARH_CAP_RECEIVED(16, BaseUnit.VOLTAMPEREREACTIVEHOUR, KILO_SCALE_FACTOR, ObisCode.fromString("1.3.4.8.0.255")),
