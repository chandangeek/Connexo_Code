...
public class A253DlmsSession extends DlmsSession {

    A253DlmsSession(ComChannel comChannel, DlmsSessionProperties properties, HHUSignOnV2 hhuSignOn, String deviceId) {
