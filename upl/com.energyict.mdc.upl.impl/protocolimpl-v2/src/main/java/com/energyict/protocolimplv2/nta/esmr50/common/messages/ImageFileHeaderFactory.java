...
public class ImageFileHeaderFactory {
    ...
    public void setImageVersion(byte[] imageVersion) throws ProtocolException {
        getLogger().finest(" - setting imageVersion [bytes]:"+ProtocolTools.getHexStringFromBytes(imageVersion));
        this.imageVersion = ProtocolUtils.getLongFromBytes(imageVersion, 0, imageVersion.length).longValue();
