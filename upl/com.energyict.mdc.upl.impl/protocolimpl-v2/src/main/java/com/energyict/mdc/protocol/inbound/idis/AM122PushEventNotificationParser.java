...
public class AM122PushEventNotificationParser extends EventPushNotificationParser {
    ...
    public AM122PushEventNotificationParser(ComChannel comChannel, InboundDiscoveryContext context) {
