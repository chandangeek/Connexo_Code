...
public class AcudMessaging extends AbstractDlmsMessaging implements DeviceMessageSupport {
    ...
    public List<DeviceMessageSpec> getSupportedMessages() {
        return Arrays.asList(
                ...
                ChargeDeviceMessage.CHANGE_CHARGE_MODE.get(this.propertySpecService, this.nlsService, this.converter),
    ...
    public String format(OfflineDevice offlineDevice, OfflineDeviceMessage offlineDeviceMessage, PropertySpec propertySpec, Object messageAttribute) {
        if (propertySpec.getName().equals(DeviceMessageConstants.modeActivationDateAttributeName))
