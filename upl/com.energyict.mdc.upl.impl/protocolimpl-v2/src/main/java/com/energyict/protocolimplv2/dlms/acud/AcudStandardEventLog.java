...
public class AcudStandardEventLog {

    private List<AcudLogBookFactory.BasicEvent> basicEvents;

    AcudStandardEventLog(List<AcudLogBookFactory.BasicEvent> basicEvents){
    ...
    List<MeterProtocolEvent> buildMeterEvent() throws IOException {
        ...
        Date eventTimeStamp;
        int eventId;
        for(AcudLogBookFactory.BasicEvent basicEvent : basicEvents){
