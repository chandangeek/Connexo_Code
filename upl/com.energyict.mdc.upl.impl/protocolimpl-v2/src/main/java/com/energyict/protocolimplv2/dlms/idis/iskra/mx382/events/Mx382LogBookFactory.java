 ...
 */
public final class Mx382LogBookFactory extends AM130LogBookFactory<Mx382> {

    private static ObisCode CERTIFICATION_LOG = ObisCode.fromString("1.0.99.99.0.255");

    public Mx382LogBookFactory(Mx382 protocol, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory) {
