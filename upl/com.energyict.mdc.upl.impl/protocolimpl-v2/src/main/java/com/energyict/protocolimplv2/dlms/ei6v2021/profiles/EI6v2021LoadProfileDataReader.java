...
public class EI6v2021LoadProfileDataReader extends A2ProfileDataReader {
    ...
    public EI6v2021LoadProfileDataReader(A2 protocol, CollectedDataFactory collectedDataFactory, IssueFactory issueFactory,
        ...
        this.dataVolumeUnitScalar = Unit.get(
                offlineDevice.getAllProperties().getTypedProperty(DATA_VOLUME_UNIT_PROPERTY, EI6_DEFAULT_DATA_VOLUME_UNIT_PROPERTY),
                offlineDevice.getAllProperties().getTypedProperty(DATA_VOLUME_SCALAR_PROPERTY, EI6_DEFAULT_DATA_VOLUME_SCALAR_PROPERTY));
