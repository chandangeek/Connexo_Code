...
public class NonFatalOperationStatus extends DefaultRegister<ObisCode, ActarisSl7000> {

    public NonFatalOperationStatus(Matcher<ObisCode> matcher, CollectedRegisterBuilder collectedRegisterBuilder) {
    ...
    protected RegisterValue map(AbstractDataType attributeValue, Unit unit, Date captureTime, OfflineRegister offlineRegister)  {
        ...
        return new RegisterValue(offlineRegister, "0x" + ProtocolTools.getHexStringFromBytes(ProtocolTools.getBytesFromLong(bitString.longValue(), 5), " "));
    }
}
