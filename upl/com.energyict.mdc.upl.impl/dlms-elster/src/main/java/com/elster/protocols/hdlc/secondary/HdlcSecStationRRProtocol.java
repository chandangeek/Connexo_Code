/* File:        
 * $HeadURL: https://deosn1-svnvm1.kromschroeder.elster-group.com/svn/eWorkPad/branches/EICT_DLMS_Driver_V2.3/Libraries/ElsterDlmsE2/src/com/elster/protocols/hdlc/secondary/HdlcSecStationRRProtocol.java $
 * Version:     
 * $Id: HdlcSecStationRRProtocol.java 3665 2011-10-04 17:34:41Z osse $
 ...
 * It answers every I-Frame with an RR-Frame, which indicates that the I-Frame was received correctly
 * <P>
 *
 *
 *
 * @author osse
 */
public class HdlcSecStationRRProtocol
{
  //private static final Logger LOGGER = Logger.getLogger(HdlcSecStationRRProtocol.class.getName());
  ...
  int recSeqNo = 0;
  int sendSeqNo = 0;
  long receivedRRCounter=0;

  public HdlcSecStationRRProtocol(IStreamProtocol sublayer, HdlcAddress address)
  {
...
//            }
  ...
  public long getReceivedRRCounter()
  {
    return receivedRRCounter;
  }
