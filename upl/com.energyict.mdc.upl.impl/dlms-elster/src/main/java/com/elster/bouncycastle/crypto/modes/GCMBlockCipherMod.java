package com.elster.bouncycastle.crypto.modes;
...
public class GCMBlockCipherMod implements AEADBlockCipher {
    ...
    public GCMBlockCipherMod(BlockCipher var1) {
        this(var1, (GCMMultiplier)null);
    }

    public GCMBlockCipherMod(BlockCipher var1, GCMMultiplier var2) {
...
//            if (var6 < 32 || var6 > 128 || var6 % 8 != 0) {
    ...
    public void changeIvAndAad(byte[] initializationVector, byte[] aad) {
        ...
        this.nonce = initializationVector;
        this.initialAssociatedText = aad;
        if (this.initialAssociatedText == null) {
            this.initialAssociatedText = new byte[0];
        }
