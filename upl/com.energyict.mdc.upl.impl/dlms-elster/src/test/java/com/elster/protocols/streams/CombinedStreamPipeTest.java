...
/**
 * Tests the combination of a  {@code IntervalInputStreamPipe} and a {@code IntervalInputStreamPipe).<P>
 * The combination of these two should nealy show the same behaviour as the {@code TimeoutableInputStreamPipe }
 *
 * 
 * @author osse
 */
public class CombinedStreamPipeTest
{
  public CombinedStreamPipeTest()
  {
  }
  ...
  public void testRead_int() throws IOException
  {
    ...
    IntervalInputStreamPipe intervallIn = new IntervalInputStreamPipe(100);
    TimeoutInputStream instance = new TimeoutInputStream(intervallIn);
    try
    {
...
//    PipedOutputStream pipedOutputStream= new PipedOutputStream(pipedInputStream);
    ...
    final IntervalInputStreamPipe intervallIn = new IntervalInputStreamPipe(100);
    final TimeoutInputStream instance = new TimeoutInputStream(intervallIn);
    try
    {
...
//    assertTrue("method returned to slow", end - start < (timeoutMillis / 2));
  ...
  /**
   * Writing a large amount of data in the buffer by a <b>separate thread</b>.<br>
   * Concurrent reading and checking of the data.
   *
   */
  @Test
  public void testRead_int_2a() throws IOException
  {
    System.out.println("read");
  ...
  public void testRead_int_2b() throws IOException
  {
    System.out.println("read");

    final IntervalInputStreamPipe intervallIn = new IntervalInputStreamPipe(25);
    final TimeoutInputStream instance = new TimeoutInputStream(intervallIn);
    try
    {
...
//    assertTrue("method returned to slow", end - start < (timeoutMillis / 2));
    ...
    try
    {
      ...
      Thread putter = new Thread(new Runnable()
      {
        ...
        public void run()
        {
          ...
          {
            Thread.sleep(2000);
            intervallIn.put((byte)250);
            intervallIn.flush();
          }
          catch (InterruptedException ex)
          {
            Logger.getLogger(CombinedStreamPipeTest.class.getName()).log(Level.SEVERE, null, ex);
          }
        }
  ...
  public void testRead_5args() throws Exception
  {
    ...
    try
    {
      ...
      for (int i = 0; i < 256; i++)
      {
        ...
        int readCount = instance.readTO(readBuffer, 99, 201, 1000);
  ...
  public void testRead_5args_3() throws Exception
  {
    ...
    try
    {
      ...
      long start = System.currentTimeMillis();
      int readCount = instance.readTO(readBuffer, 99, 250, 100 * 2000);
      long end = System.currentTimeMillis();
