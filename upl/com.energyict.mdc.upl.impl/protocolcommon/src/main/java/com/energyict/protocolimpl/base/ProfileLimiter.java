...
public class ProfileLimiter {
    ...
    /**
     * For protocols with small memory for LoadProfile entries, "LimitMaxNrOfDays" property should be used<p>
     * This property is optional, and if exists, it must contain a integer (positive or negative) describing a number of days.
     * <p>
