...
public class IskraME37XMessageConverter extends AbstractMessageConverter {
    ...
    public IskraME37XMessageConverter(Messaging messagingProtocol, PropertySpecService propertySpecService, NlsService nlsService, Converter converter, Extractor extractor) {
