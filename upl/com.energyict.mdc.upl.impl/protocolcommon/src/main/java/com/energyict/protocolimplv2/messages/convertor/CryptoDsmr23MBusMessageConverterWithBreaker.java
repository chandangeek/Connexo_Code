...
public class CryptoDsmr23MBusMessageConverterWithBreaker extends CryptoDsmr23MBusMessageConverter {
    ...
    private static Map<DeviceMessageSpec, MessageEntryCreator> registry = new HashMap<>(CryptoDsmr23MBusMessageConverter.registry);  //Clone the messages of the super class
    ...
    public CryptoDsmr23MBusMessageConverterWithBreaker() {
        super();
    }
}