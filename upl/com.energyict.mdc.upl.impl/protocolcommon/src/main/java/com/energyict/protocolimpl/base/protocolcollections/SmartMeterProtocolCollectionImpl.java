...
public class SmartMeterProtocolCollectionImpl implements ProtocolCollection {
    ...
    private void buildDefaultProtocols() {
        ...
        this.protocolClasses.add("com.energyict.smartmeterprotocolimpl.eict.ukhub.UkHub");  this.protocolNames.add("Elster AM110R DLMS (SSWG IC)");
        this.protocolClasses.add("com.energyict.smartmeterprotocolimpl.eict.ukhub.zigbee.ihd.InHomeDisplay");  this.protocolNames.add("Elster AM110R DLMS (SSWG IC) Zigbee IHD");
        ...
        this.protocolClasses.add("com.energyict.smartmeterprotocolimpl.eict.webrtuz3.SlaveMeter");  this.protocolNames.add("EnergyICT WebRTU Z3 DLMS TIC Slave");
        ...
        this.protocolClasses.add("com.energyict.smartmeterprotocolimpl.iskra.mt880.IskraMT880");  this.protocolNames.add("Iskraemeco MT880 DLMS");
        ...
        this.protocolClasses.add("com.energyict.smartmeterprotocolimpl.nta.dsmr40.xemex.REMIDatalogger");  this.protocolNames.add("XEMEX ReMI Datalogger DLMS");
        this.protocolClasses.add("com.energyict.smartmeterprotocolimpl.nta.dsmr40.xemex.MbusDevice");  this.protocolNames.add("XEMEX ReMI Datalogger DLMS Mbus Slave");
    }
