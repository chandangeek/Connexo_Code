...
public class Dsmr50MessageConverter extends Dsmr40MessageConverter {
    ...
    public Dsmr50MessageConverter(Messaging messagingProtocol, PropertySpecService propertySpecService, NlsService nlsService, Converter converter, Extractor extractor) {
