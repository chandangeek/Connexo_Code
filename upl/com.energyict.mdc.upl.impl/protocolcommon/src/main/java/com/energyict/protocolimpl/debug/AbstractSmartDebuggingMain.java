 ...
 * Time: 8:07:53
 */
public abstract class AbstractSmartDebuggingMain<P extends SmartMeterProtocol> {
    ...
    protected abstract void doDebug() throws LinkException, IOException;

    protected abstract P getMeterProtocol();
    ...
    public Dialer getDialer() throws LinkException, IOException {
        if (dialer == null) {
            ...
            if (phoneNumber == null) {
                ...
                dialer = DebugUtils.getConnectedIPDialer(phoneNumber, debuggingObserver);
            } else {
