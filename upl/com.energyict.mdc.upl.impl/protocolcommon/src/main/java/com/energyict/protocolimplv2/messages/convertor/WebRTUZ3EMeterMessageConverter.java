...
public class WebRTUZ3EMeterMessageConverter extends AbstractMessageConverter {
    ...
    public WebRTUZ3EMeterMessageConverter(Messaging messagingProtocol, PropertySpecService propertySpecService, NlsService nlsService, Converter converter, Extractor extractor) {
