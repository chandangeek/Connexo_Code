...
public class CryptoDsmr23MessageConverterWithBreaker extends CryptoDsmr23MessageConverter {
    ...
    public CryptoDsmr23MessageConverterWithBreaker(Messaging messagingProtocol, PropertySpecService propertySpecService, NlsService nlsService, Converter converter) {
