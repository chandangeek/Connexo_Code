...
public class ProtocolUtils {
    ...
    public static void debugMessage(int index, String message) {
        if (index == -1) {
            logger.debug(new Date() + " KV_DEBUG> " + message);
        } else {
            logger.debug(new Date() + " KV_DEBUG> index " + index + ", " + message);
        }
    }
     ...
     * @result concatenation of data1 and data2
     */
     ...
     */
    public static void delayProtocol(int iProtocolDelayAfterFail) {
        try {
     ...
     * @return int value
     * @throws ProtocolException thrown if input byte is no BCD presentation
     */
    public static int BCD2hex(byte bBCDVal) throws ProtocolException {
        if (!isBCD(bBCDVal)) {
    ...
    private static boolean isBCD(byte bBCDVal) {
        ...
        return !(((val / 16) > 9) || ((val % 16) > 9));
    }

    private static byte toBCD(byte data) throws ProtocolException {
        if (data - 0x30 > 9) {
     ...
     * @throws ProtocolException thrown when data length is not even
     */
    public static byte[] convert2ascii(byte[] data) throws ProtocolException {
        if ((data.length % 2) != 0) {
     ...
     * @param data byte array
     * @return converted byte array
     * @throws ProtocolException Thrown when datalength is not even or a byte is no BCD presentation
     */
    public static byte[] convertBCD2ascii(byte[] data) throws ProtocolException {
        if ((data.length % 2) != 0) {
            throw new ProtocolException("ProtocolUtils, convert2ascii, data length not even!");
        }
        byte[] converted = new byte[data.length / 2];
     ...
     * @return byte value
     * @throws ProtocolException when an exception happens
     */
    public static byte bcd2byte(byte[] data, int iOffset) throws ProtocolException {
     ...
     * @param iOffset offety in the array where to start processing
     * @return int value
     * @throws ProtocolException Thrown when an exception happens
     */
    public static int bcd2int(byte[] data, int iOffset) throws ProtocolException {
     ...
     * @param iOffset offety in the array where to start processing
     * @return byte value
     * @throws ProtocolException thrown when data is invalid hex
     */
    public static byte hex2byte(byte[] data, int iOffset) throws ProtocolException {
     ...
     * @throws ProtocolException thrown when data is invalid hex
     */
    public static byte hex2nibble(byte data) throws ProtocolException {
        int nibble = 0;
     ...
     * @throws ProtocolException Thrown when trying to read at the end of the stream
     */
    public static int getVal(ByteArrayInputStream bai) throws ProtocolException {
        int val = bai.read();
        if (val == -1) {
     ...
     * @throws ProtocolException thrown when an exception happens
     */
    public static int getIntLE(ByteArrayInputStream bai) throws ProtocolException {
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static short getShortLE(ByteArrayInputStream bai) throws ProtocolException {
     ...
     * @throws ProtocolException thrown when an exception happens
     */
    public static short getShort(ByteArrayInputStream bai) throws ProtocolException {
     ...
     * @throws ProtocolException thrown when an exception happens
     */
    public static int getIntLE(byte[] byteBuffer, int offset, int length) throws ProtocolException {
        int retval = 0;
        int shift;
        try {
            if ((length > 4) || (length < 1)) {
     ...
     * @throws ProtocolException thrown when an exception happens
     */
    public static int getBCD2IntLE(byte[] byteBuffer, int offset, int length) throws ProtocolException {
        int val = 0;
        int multiplier = 1;
        try {
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static int getBCD2Int(byte[] byteBuffer, int offset, int length) throws ProtocolException {
        int val = 0;
        int multiplier = 1;
        try {
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static long getExtendedLong(byte[] byteBuffer, int offset, int length) throws ProtocolException {
        byte[] extendedByteBuffer = signExtend2Long(byteBuffer, offset, length);

//System.out.println("offset="+offset+", "+getResponseData(extendedByteBuffer));
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static long getLong(byte[] byteBuffer, int offset, int length) throws ProtocolException {
        long retval = 0;
        int shift;
        try {
            if (length > 8) {
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static long getLong(ByteArrayInputStream bai, int length) throws ProtocolException {
        long retval = 0;
        int shift;
        if (length > 8) {
            throw new ProtocolException("ProtocolUtils, getLong, invalid length");
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static long getLongLE(byte[] byteBuffer, int offset, int length) throws ProtocolException {
        long retval = 0;
        int shift;
        try {
            if (length > 8) {
     ...
     * @throws ProtocolException Thrown when an exception happens
     */
    public static long getLongLE(ByteArrayInputStream bai, int length) throws ProtocolException {
        long retval = 0;
        int shift;
        if (length > 8) {
            throw new ProtocolException("ProtocolUtils, getLongLE, invalid length");
     ...
     * @throws ProtocolException thrown when an incorrect size is passed
     */
    public static Number getLongFromNibblesLE(byte[] data, int offset, int size) throws ProtocolException {
        long lVal = 0;
        long lNibbleVal;
        int i;
        if (size > 16) {
     ...
     * @throws ProtocolException thrown when an incorrect size is passed
     */
    public static Number getLongFromBytesLE(byte[] data, int offset, int size) throws ProtocolException {
        long lVal = 0;
        long lByteVal;
        int i;
        if (size > 8) {
     ...
     * @throws ProtocolException thrown when an incorrect size is passed
     */
    public static Number getLongFromBytes(byte[] data, int offset, int size) throws ProtocolException {
        long lVal = 0;
        long lByteVal;
        int i;
        if (size > 8) {
     ...
     * @throws ProtocolException Thrown when the object is none of the supported.
     */
    public static String obj2String(Object obj) throws ProtocolException {
        if (obj.getClass().getName().contains("Integer")) {
            ...
            throw new ProtocolException("ProtocolUtils, obj2String, class " + obj.getClass().getName() + " not supported");
        }
    }
     ...
     * @throws ProtocolException Thrown when the object is none of the supported.
     */
    public static int obj2int(Object obj) throws ProtocolException {
        if (obj.getClass().getName().contains("Integer")) {
            ...
            throw new ProtocolException("ProtocolUtils, obj2int, class " + obj.getClass().getName() + " not supported");
        }
    }
     ...
     * @throws ProtocolException Thrown when the source array length > dest array length - offset
     */
    public static int arrayCopy(byte[] src, byte[] dest, int offset) throws ProtocolException {
    ...
    /**
     * Create a midnight date from one month ago. If no timeZone is given, then the {@link TimeZone#getDefault()} will be used.
     *
    ...
    /**
     * Create a midnight date from one day ago. If no timeZone is given, then the {@link TimeZone#getDefault()} will be used.
     *
     * @param deviceTimeZone the timezone to use in the <CODE>Calendar</CODE>
    ...
    public static String getStringArray(byte[] byteArray) {
        ...
        for(int i = 0; i < byteArray.length; i++){
            strByteArray.append(byteArray[i]);
        }
