...
public class ModbusMessageConverter extends AbstractMessageConverter {
    ...
    public ModbusMessageConverter(Messaging messagingProtocol, PropertySpecService propertySpecService, NlsService nlsService, Converter converter, Extractor extractor) {
