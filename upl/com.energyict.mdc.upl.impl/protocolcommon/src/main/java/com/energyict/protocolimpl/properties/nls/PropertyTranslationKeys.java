...
public enum PropertyTranslationKeys implements TranslationKey {
    ...
    SDKSAMPLE_CREDIT_AMOUNT("upl.property.sdksample.creditAmount", "Credit Amount"),
    SDKSAMPLE_CREDIT_AMOUNT_DESCRIPTION("upl.property.sdksample.creditAmount.description", "Credit Amount"),
    SDKSAMPLE_CREDIT_TYPE("upl.property.sdksample.creditType", "Credit Type"),
    SDKSAMPLE_CREDIT_TYPE_DESCRIPTION("upl.property.sdksample.creditType.description", "Credit Type"),
