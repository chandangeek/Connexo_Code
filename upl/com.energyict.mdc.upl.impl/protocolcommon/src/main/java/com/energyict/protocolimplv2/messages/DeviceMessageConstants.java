...
public final class DeviceMessageConstants {
    ...
    public static final String DisplayLeadingZeroTranslation = "Leading zero";
    ...
    public static final String DisplayEOB_ConfirmTranslation = "EOB confirm";
    public static final String DisplayString_EOB_Confirm = "DisplayMessage.StringEOBConfirm";
    public static final String DisplayString_EOB_ConfirmTranslation = "String EOB confirm";
    public static final String DisplaySeparators_Display = "DisplayMessage.SeparatorsDisplay";
    public static final String DisplaySeparators_DisplayTranslation = "Separators display";
    public static final String DisplayTime_Format = "DisplayMessage.TimeFormat";
    public static final String DisplayTime_FormatTranslation = "Time format";
    public static final String DisplayDate_Format = "DisplayMessage.DateFormat";
    public static final String DisplayDate_FormatTranslation = "Date format";
    public static final String DisplayTimeOut_For_Set_Mode = "DisplayMessage.TimeOutForSetMode";
    public static final String DisplayTimeOut_For_Set_ModeTranslation = "Timeout for set mode";
    public static final String Display_On_TimeOut = "DisplayMessage.DisplayOnTimeOut";
    public static final String Display_On_TimeOutTranslation = "Display on timeout";
    public static final String Display_Off_TimeOut = "DisplayMessage.DisplayOffTimeOut";
    public static final String Display_Off_TimeOutTranslation = "Display off timeout";
    public static final String DisplayNb_DisplayedHisto_Sets_Normal_Mode = "DisplayMessage.NbDisplayedHistoSetsNormalMode";
    public static final String DisplayNb_DisplayedHisto_Sets_Normal_ModeTranslation = "Number of displayed history sets normal mode";
    public static final String DisplayExistence_Of_EndOfText = "DisplayMessage.ExistenceOfEndOfText";
    public static final String DisplayExistence_Of_EndOfTextTranslation = "Existence of end of text string";
    public static final String DisplayEndOfTextString = "DisplayMessage.EndOfTextString";
    public static final String DisplayEndOfTextStringTranslation = "End of text string";
    public static final String DisplayNb_DisplayedHisto_Sets_Altmode1 = "DisplayMessage.NbDisplayedHistoSetsAltMode1";
    public static final String DisplayNb_DisplayedHisto_Sets_Altmode1Translation = "Number of displayed history sets alternative short mode";
    public static final String DisplayNb_DisplayedHisto_Sets_Altmode2 = "DisplayMessage.NbDisplayedHistoSetsAltMode2";
    public static final String DisplayNb_DisplayedHisto_Sets_Altmode2Translation = "Number of displayed history sets alternative long mode";
    public static final String DisplayTimeout_For_AltMode = "DisplayMessage.TimeoutForAltMode";
    public static final String DisplayTimeout_For_AltModeTranslation = "Timeout for alt mode";
    public static final String DisplayAutorized_EOB = "DisplayMessage.AutorizedEOB";
    public static final String DisplayAutorized_EOBTranslation = "Authorized EOB";
    public static final String DisplayTimeout_Load_Profile = "DisplayMessage.TimeoutLoadProfile";
    public static final String DisplayTimeout_Load_ProfileTranslation = "Timeout Load Profile";
    public static final String Displaying_Of_LPMenus = "DisplayMessage.DisplayingOfLPMenus";
    public static final String Displaying_Of_LPMenusTranslation = "Displaying of LP menus";
    public static final String Display_ButtonEmulation_By_Optical_Head = "DisplayMessage.DisplayButtonEmulationByOpticalHead";
    public static final String Display_ButtonEmulation_By_Optical_HeadTranslation = "Display button emulation by optical head";
    public static final String DisplayInternal_Identifier = "Display.InternalIdentifier";
    public static final String DisplayInternal_IdentifierTranslation = "Internal identifier";
    public static final String DisplaySequence_Indicator = "Display.SequenceIndicator";
    public static final String DisplaySequence_IndicatorTranslation = "Sequence indicator";
    public static final String DisplayIdentification_Code = "Display.IdentificationCode";
    public static final String DisplayIdentification_CodeTranslation = "Identification code";
    ...
    public static final String DisplayNumber_Of_DecimalTranslation = "Number of decimal";
    public static final String DisplayNumber_Of_Display_Historical_Data = "Display.NumberOfDisplayHistoricalData";
    public static final String DisplayNumber_Of_Display_Historical_DataTranslation = "Number of displayed historical data";
    public static final String DisplayNumber_Of_Displayable_Digit = "Display.NumberOfDisplayableDigit";
    public static final String DisplayNumber_Of_Displayable_DigitTranslation = "Number of displayable digits";
    ...
    /*public static final String communicationWindowStartDate1 = "communicationWindowStartDate1";
    public static final String communicationWindowStartDateDefaultTranslation1 = "Communication Window Start Date 1";
    public static final String communicationWindowStopDate1 = "communicationWindowStopDate1";
    public static final String communicationWindowStopDateDefaultTranslation1 = "Communication Window Stop Date 1";*/
    public static final String communicationWindowStartTime1 = "communicationWindowStartTime1";
    public static final String communicationWindowStartTimeDefaultTranslation1 = "Communication Window Start Time 1";
    public static final String communicationWindowStopTime1 = "communicationWindowStopTime1";
    public static final String communicationWindowStopTimeDefaultTranslation1 = "Communication Window Stop Time 1";
    /*public static final String communicationWindowStartDate2IsIgnored = "communicationWindowStartDate2IsIgnored";
    public static final String communicationWindowStartDate2IsIgnoredTranslation = "Ignore communication window 2";*/
    /*public static final String communicationWindowStartDate2 = "communicationWindowStartDate2";
    public static final String communicationWindowStartDateDefaultTranslation2 = "Communication Window Start Date 2";
    public static final String communicationWindowStopDate2 = "communicationWindowStopDate2";
    public static final String communicationWindowStopDateDefaultTranslation2 = "Communication Window Stop Date 2";*/
    public static final String communicationWindowStartTime2 = "communicationWindowStartTime2";
    public static final String communicationWindowStartTimeDefaultTranslation2 = "Communication Window Start Time 2";
    public static final String communicationWindowStopTime2 = "communicationWindowStopTime2";
    public static final String communicationWindowStopTimeDefaultTranslation2 = "Communication Window Stop Time 2";
/*    public static final String communicationWindowStartDate3IsIgnored = "communicationWindowStartDate3IsIgnored";
    public static final String communicationWindowStartDate3IsIgnoredTranslation = "Ignore communication window 3";*/
    /*public static final String communicationWindowStartDate3 = "communicationWindowStartDate3";
    public static final String communicationWindowStartDateDefaultTranslation3 = "Communication Window Start Date 3";
    public static final String communicationWindowStopDate3 = "communicationWindowStopDate3";
    public static final String communicationWindowStopDateDefaultTranslation3 = "Communication Window Stop Date 3";*/
    public static final String communicationWindowStartTime3 = "communicationWindowStartTime3";
    public static final String communicationWindowStartTimeDefaultTranslation3 = "Communication Window Start Time 3";
    public static final String communicationWindowStopTime3 = "communicationWindowStopTime3";
    public static final String communicationWindowStopTimeDefaultTranslation3 = "Communication Window Stop Time 3";
    /*public static final String communicationWindowStartDate4IsIgnored = "communicationWindowStartDate4IsIgnored";
    public static final String communicationWindowStartDate4IsIgnoredTranslation = "Ignore communication window 4";*/
    /*public static final String communicationWindowStartDate4 = "communicationWindowStartDate4";
    public static final String communicationWindowStartDateDefaultTranslation4 = "Communication Window Start Date 4";
    public static final String communicationWindowStopDate4 = "communicationWindowStopDate4";
    public static final String communicationWindowStopDateDefaultTranslation4 = "Communication Window Stop Date 4";*/
    public static final String communicationWindowStartTime4 = "communicationWindowStartTime4";
    public static final String communicationWindowStartTimeDefaultTranslation4 = "Communication Window Start Time 4";
    public static final String communicationWindowStopTime4 = "communicationWindowStopTime4";
    public static final String communicationWindowStopTimeDefaultTranslation4 = "Communication Window Stop Time 4";
    ...
    public static final String autoConnectDestionation = "NetworkConnectivityMessage.destination";
    public static final String autoConnectDestionationDefaultTranslation = "Destionation";
