...
public class RemoteContentSummaries  implements java.io.Serializable {
    private com.energyict.messaging.confluence.messagesync.client.RemoteContentSummary[] content;
    private int offset;
    ...
    public RemoteContentSummaries(
           com.energyict.messaging.confluence.messagesync.client.RemoteContentSummary[] content,
           int offset,
           int totalAvailable) {
     ...
     * @return content
     */
    public com.energyict.messaging.confluence.messagesync.client.RemoteContentSummary[] getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(com.energyict.messaging.confluence.messagesync.client.RemoteContentSummary[] content) {
        this.content = content;
    }
