...
class Util {
     ...
     * @return the value of the first node found with the tag name within scope of the parent element. Null otherwise.
     */
     ...
     * @param tagName name of the tag to find
     * @return the value of the first node found with the tag name. Null otherwise.
     */
    ...
    /**
     * utility method for getting nodeValue as a Date
     *
     * @param e       parent element
     * @param tagName name of the tag to find
     * @return the date value of the first node found with the tag name within scope of the parent element. Null otherwise.
     * @throws ParseException when the node value can not be parsed into a Date object.
     */
    ...
    static NodeList xPathNodeList(Document d, String expression)
            throws TransformerException {
        return XPathAPI.selectNodeList(d, expression);
    }

    static NodeIterator xPathNodeIterator(Document d, String expression)
            throws TransformerException {
        return XPathAPI.selectNodeIterator(d, expression);
    }
