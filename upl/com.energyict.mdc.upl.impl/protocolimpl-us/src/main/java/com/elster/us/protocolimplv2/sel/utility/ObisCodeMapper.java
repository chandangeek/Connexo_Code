...
public class ObisCodeMapper {
    ...
    private static Map<ObisCode, String> channelNameToObisMap = new HashMap<ObisCode, String>();
    ...
    static {
        ...
        // register mappings for SEL734 with EOI - use when obtaining register data from cumulative lp reads
        channelNameToObisMap.put(ObisCode.fromString(OBIS_KWH_DELIVERED), OBJECT_INTERVAL_MWH3I);
        channelNameToObisMap.put(ObisCode.fromString(OBIS_KVARH_DELIVERED), OBJECT_INTERVAL_MVRH3I);
        channelNameToObisMap.put(ObisCode.fromString(OBIS_KWH_RECEIVED), OBJECT_INTERVAL_MWH3O);
        channelNameToObisMap.put(ObisCode.fromString(OBIS_KVARH_RECEIVED), OBJECT_INTERVAL_MVRH3O);
...
//      channelToObisMap.put(OBJECT_INTERVAL_MWH3O, ObisCode.fromString(OBIS_CHANNEL_6));   // Mega-Watt-Hours-Out
    ...
    public static String getChannelNameByObis(ObisCode obis) {
        return channelNameToObisMap.get(obis);
    }
