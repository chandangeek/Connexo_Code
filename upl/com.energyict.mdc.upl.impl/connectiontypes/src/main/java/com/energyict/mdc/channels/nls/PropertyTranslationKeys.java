...
public enum PropertyTranslationKeys implements TranslationKey {
    ...
    OUTBOUND_IP_WAKEUP_POOL_RETRIES("upl.property.ip.outbound.vfwakeup.poolRetries", "Host update pooling retries"),
    OUTBOUND_IP_WAKEUP_WAITING_TIME("upl.property.ip.outbound.vfwakeup.waitingTime", "Waiting time after request before pooling"),
    OUTBOUND_IP_WAKEUP_CONNECT_TIMEOUT("upl.property.ip.outbound.vfwakeup.connectTimeout", "Host property pool timeout"),
