...
public class SioAtModemConnectionType extends SioSerialConnectionType {
    ...
    protected AtModemComponent getAtModemComponent() {
        return atModemComponent;
    }

    protected void setAtModemComponent(AtModemComponent atModemComponent) {
        this.atModemComponent = atModemComponent;
    }
}