...
public class LogicalAddressFactory {
    ...
    private IndigoPlus indigoPlus=null;
    ...
    public LogicalAddressFactory(IndigoPlus indigoPlus,MeterExceptionInfo meterExceptionInfo) {
