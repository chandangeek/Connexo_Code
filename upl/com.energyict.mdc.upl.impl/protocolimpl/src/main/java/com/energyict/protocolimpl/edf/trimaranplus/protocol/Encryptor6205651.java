...
public class Encryptor6205651 {
    ...
    private final int POLY_CRYPTAGE=0xD008; /* 4 bits à 1 ==> 16 sommes possibles */
    ...
    public byte[] getEncryptedData(byte[] data,int key) {
        ...
        // Tantque (il reste au moins deux octets à crypter) Faire Former une séquence de 16 bits à crypter Crypter cette séquence (XOR avec la clé = somme bit à bit) Ranger la séquence cryptée à la place de la séquence source 
...
//System.out.println(Integer.toHexString(key));
            ...
            // Mettre à jour la clé de cryptage F tantque
        ...
        // Si (il reste un octet à crypter) Alors Former la séquence de 16 bits à crypter Crypter cette séquence Ranger la séquence de 8 bits cryptée Fsi
