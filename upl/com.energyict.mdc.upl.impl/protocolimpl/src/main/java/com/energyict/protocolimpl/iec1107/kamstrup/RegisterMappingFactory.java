...
public class RegisterMappingFactory {
    ...
    private final List<RegisterMapping> registerMappings = new ArrayList<>();

    RegisterMappingFactory() {
        initRegisterMapping();
    }
    ...
    List<RegisterMapping> getRegisterMappings() {
        return registerMappings;
    }

    String findRegisterCode(ObisCode obisCode) throws IOException {
        for (RegisterMapping rm : getRegisterMappings()) {
    ...
    RegisterMapping findRegisterMapping(ObisCode obisCode) throws IOException {
        for (RegisterMapping rm : getRegisterMappings()) {
            if (rm.getObisCode().equals(obisCode)) {
                return rm;
            }
