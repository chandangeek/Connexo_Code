...
import com.energyict.genericprotocolimpl.lgadvantis.Constant;
import com.energyict.genericprotocolimpl.lgadvantis.Task;
import com.energyict.genericprotocolimpl.lgadvantis.XmlTag;
...
public class ProfileParser extends AbstractParser implements Parser {
	...
	public static boolean isProfileCompressed(Rtu rtu){
		String compressed = rtu.getProperties().getProperty(Constant.PK_LOAD_PROFILE_COMPRESSED);
