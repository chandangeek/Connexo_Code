...
class ZMDProperties extends DlmsProtocolProperties {
    ...
    public List<PropertySpec> getUPLPropertySpecs() {
        return Arrays.asList(
                UPLPropertySpecFactory.specBuilder(SECURITY_LEVEL, false, PropertyTranslationKeys.EICT_SECURITY_LEVEL, this.propertySpecService::stringSpec).finish(),
                ...
                UPLPropertySpecFactory.specBuilder(CONFORMANCE_BLOCK_VALUE, false, PropertyTranslationKeys.DLMS_CONFORMANCE_BLOCK_VALUE, this.propertySpecService::longSpec).finish(),
