...
public class SmartMeteringSampleProtocol extends AbstractProtocol implements Messaging, FirmwareUpdateMessaging, ConnectMessaging, DisconnectMessaging, CosemAttributeMessaging, CosemMethodMessaging, TimeOfUseMessaging{
	...
	public List getCosemClasses() {
		...
		data.addAttribute(new CosemAttribute(1, "Logical name", CosemDataType.STRING));
		data.addAttribute(new CosemAttribute(2, "Value", CosemDataType.INTEGER));
		classes.add(data);
		CosemClass register = new CosemClass(3, "Register");
		register.addAttribute(new CosemAttribute(1, "Logical name", CosemDataType.STRING));
		register.addAttribute(new CosemAttribute(2, "Value", CosemDataType.INTEGER));
		register.addAttribute(new CosemAttribute(3, "Scaler Unit", CosemDataType.OTHER));
		CosemMethod reset = new CosemMethod(1, "Reset");
		reset.addParameter(new CosemParameter("value", CosemDataType.INTEGER));
		data.addMethod(reset);
		classes.add(register);
		CosemClass demandRegister = new CosemClass(5, "Demand Register");
		demandRegister.addAttribute(new CosemAttribute(1, "Logical name", CosemDataType.STRING));
		demandRegister.addAttribute(new CosemAttribute(2, "Current average value", CosemDataType.INTEGER));
		demandRegister.addAttribute(new CosemAttribute(3, "Last average value", CosemDataType.INTEGER));
		demandRegister.addAttribute(new CosemAttribute(4, "Scaler Unit", CosemDataType.OTHER));
		demandRegister.addAttribute(new CosemAttribute(5, "Status", CosemDataType.INTEGER));
		demandRegister.addAttribute(new CosemAttribute(6, "Capture time", CosemDataType.DATE));
		demandRegister.addAttribute(new CosemAttribute(7, "Start time current", CosemDataType.DATE));
		demandRegister.addAttribute(new CosemAttribute(8, "Period", CosemDataType.INTEGER));
		demandRegister.addAttribute(new CosemAttribute(9, "Number of periods", CosemDataType.INTEGER));
		CosemMethod reset2 = new CosemMethod(1, "Reset");
		reset2.addParameter(new CosemParameter("value", CosemDataType.INTEGER));
		data.addMethod(reset2);
		CosemMethod nextPeriod = new CosemMethod(1, "Next period");
		nextPeriod.addParameter(new CosemParameter("value", CosemDataType.INTEGER));
