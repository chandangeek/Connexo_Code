...
public interface Constant {
	...
	public final static ObisCode digitalOutputObisCode[] = {ObisCode.fromString("0.129.0.0.1.255"), ObisCode.fromString("0.129.0.0.2.255")};	// BOOLEANS
...
//	public final static ScalerUnit prepaidBudgetScalerUnit = new ScalerUnit(3, Unit.get(BaseUnit.WATTHOUR)); //kWh
	...
	public final static ObisCode prepaidThresholdObisCode = ObisCode.fromString("1.0.96.51.20.255");	// Unsigned32
//	public final static ScalerUnit prepaidThresholdScalerUnit = new ScalerUnit(3, Unit.get(BaseUnit.WATTHOUR)); //kWh
	
	public final static ObisCode prepaidMultiplierObisCode[] = {ObisCode.fromString("1.0.96.51.1.255"),		// All are Signed32
...
//	public final static ScalerUnit prepaidMultiplierScalerUnit = new ScalerUnit(1, Unit.get(BaseUnit.UNITLESS)); //Just unitless
	...
	public final static ObisCode prepaidReadFrequencyObisCode = ObisCode.fromString("1.0.96.51.16.255"); 	// Unsigned32
//	public final static ScalerUnit prepaidReadFrequencyScalerUnit = new ScalerUnit(1, Unit.get(BaseUnit.MINUTE)); //minutes
	
	public final static ObisCode loadLimitStateObisCode = ObisCode.fromString("1.0.96.51.30.255");		// BOOLEAN
	
	public final static ObisCode loadLimitReadFrequencyObisCode = ObisCode.fromString("1.0.96.51.31.255");		// Unsigned32
//	public final static ScalerUnit loadLimitReadFrequencyScalerUnit = new ScalerUnit(1, Unit.get(BaseUnit.MINUTE));	//minutes
	
	public final static ObisCode loadLimitThresholdObisCode = ObisCode.fromString("1.0.96.51.32.255");	// Unsigned32
//	public final static ScalerUnit loadLimitThresholdScalerUnit = new ScalerUnit(3, Unit.get(BaseUnit.WATT));	//kW
	
	public final static ObisCode loadLimitDurationObisCode = ObisCode.fromString("1.0.96.51.33.255"); 	//Unsigned32
//	public final static ScalerUnit loadLimitDurationScalerUnit = new ScalerUnit(1, Unit.get(BaseUnit.SECOND)); 	// Seconds
	
	public final static ObisCode loadLimitOutputLogicObisCode[] = {ObisCode.fromString("1.0.96.51.40.255"), ObisCode.fromString("1.0.96.51.41.255")}; 	//BOOLEANS
