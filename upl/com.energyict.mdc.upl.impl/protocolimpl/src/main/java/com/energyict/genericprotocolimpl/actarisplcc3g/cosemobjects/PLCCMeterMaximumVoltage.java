 ...
 * @author kvds
 */
public class PLCCMeterMaximumVoltage extends AbstractPLCCObject {
    
    private ScalerUnit scalerUnit = new ScalerUnit(0, Unit.get("V"));
    private BigDecimal value=null;
    
    /** Creates a new instance of PLCCTemplateObject */
    public PLCCMeterMaximumVoltage(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    
    protected ObjectIdentification getId() {
        return new ObjectIdentification(ObisCode.fromString("1.0.12.38.0.255"), AbstractCosemObject.CLASSID_REGISTER);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterMaximumVoltage:\n");
