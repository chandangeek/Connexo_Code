...
public interface PlcOfdmMacSetupMessages {
    ...
    @RtuMessageDescription(category = G3_PLC_OFDM_MAC_SETUP_CATEGORY, description = "Reset PLC G3 MAC counters", tag = "ResetPlcOfdmMacCounters")
    interface ResetPlcOfdmMacCountersMessage extends AnnotatedMessage {
        // No attributes, just the reset command
    }


    @RtuMessageDescription(category = G3_PLC_OFDM_MAC_SETUP_CATEGORY, description = "Set PAN id", tag = "SetPanId")
    ...
    @RtuMessageDescription(category = G3_PLC_OFDM_MAC_SETUP_CATEGORY, description = "Set maximum orphan timer", tag = "SetMaxOrphanTimer")
