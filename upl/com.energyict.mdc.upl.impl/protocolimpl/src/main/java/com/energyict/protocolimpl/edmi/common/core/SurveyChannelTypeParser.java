...
import com.energyict.protocolcommon.Range;
...
public class SurveyChannelTypeParser {
    ...
    private void constructChannelObisCode(int baseObisC, Type type, int eField) {
        this.obisCode = ObisCode.fromString(ProtocolTools.format("1.1.{0}.{1}.{2}.255", new Object[]{baseObisC, type.getType(), eField}));
    }

    private void constructChannelObisCode(int baseObisC, Phase phase, Type type, int eField) {
        this.obisCode = ObisCode.fromString(ProtocolTools.format("1.1.{0}.{1}.{2}.255", new Object[]{baseObisC + phase.getOffset(), type.getType(), eField}));
    }

    private void constructPulseChannelObisCode(int bField, Type type) {
        this.obisCode = ObisCode.fromString(ProtocolTools.format("1.{0}.82.{1}.0.255", new Object[]{bField, type.getType()}));
    }
