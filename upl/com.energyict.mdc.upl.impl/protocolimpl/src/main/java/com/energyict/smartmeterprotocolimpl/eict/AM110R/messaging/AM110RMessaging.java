...
public class AM110RMessaging extends GenericMessaging implements MessageProtocol {
    ...
    private MessageCategorySpec getHanManagementMessageCategorySpec() {
        ...
        hanManagement.addMessageSpec(addMsgWithValuesAndOptionalValue("Join ZigBee slave device", RtuMessageConstant.JOIN_ZIGBEE_SLAVE_FROM_DEVICE_TYPE, false, null, RtuMessageConstant.JOIN_ZIGBEE_SLAVE_IEEE_ADDRESS, RtuMessageConstant.JOIN_ZIGBEE_SLAVE_DEVICE_TYPE));
