...
public class BatteryVoltageLowEventLog extends AbstractEventLog {

	int mostRecent;
	int count;
	Date[] date = new Date[10];
	
	public BatteryVoltageLowEventLog(TimeZone timeZone) throws IOException {
		super(timeZone);
	}
	...
	public void parse(byte[] data) throws IOException {
        ...
        for( int i = 0; i < 10; i ++ ) {
    		...
    		if (shift > 0) {
	            ...
	            addMeterEvent(new MeterEvent(date[i], MeterEvent.OTHER, "battery voltage low "+" ("+count+")"));
    		}
        }
	}
