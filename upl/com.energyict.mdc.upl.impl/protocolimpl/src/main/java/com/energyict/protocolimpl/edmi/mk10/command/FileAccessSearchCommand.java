...
//    } 
    ...
    protected byte[] prepareBuild() {
        ...
        byte[] dateData = DateTimeBuilder.getDDMMYYHHMMSSDataFromDate(getDate(), getCommandFactory().getMk10().getTimeZone());
    ...
    protected void parse(byte[] data) throws IOException {
        ...
        offset+=4;
        setDate(DateTimeBuilder.getDateFromDDMMYYHHMMSS(getCommandFactory().getMk10().getTimeZone(),data,offset));
