...
public class AlarmFrameParser {
    ...
    public List<MeterEvent> getMeterEvents() {
        ...
        if ((alarmStatus & 0x0800) == 0x0800) {
            ...
            meterEvents.add(new MeterEvent(eventTimeStamp, MeterEvent.OTHER, EventStatusAndDescription.EVENTCODE_LEAKAGE_RESIDUAL_START_A, "Leakage detected. Current level value is " + currentLevelValue + ", current spread value is " + currentSpreadValue + "." + ORIGIN_SAF));
        }
