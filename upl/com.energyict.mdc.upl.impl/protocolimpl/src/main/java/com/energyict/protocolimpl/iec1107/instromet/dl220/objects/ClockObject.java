 ...
 * <b>1:4A8</b> The details must be given in the format: <i>"yyyy-MM-DD,hh:mm:ss"</i>.<br><br>
...
public class ClockObject extends AbstractObject {
     ...
     */
    public Calendar getDateTime() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressDateTime;
	return parseCalendar(getValue());
    }

    public void getSecondsSince() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressSecondsSinse;
	System.out.println("Seconds since : " + getValue());
    }

    public void getDateAffectedByDST() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressDateAffectedByDST;
	System.out.println("Date affected by DST : " + getValue());
    }

    public void getTimeAffectedByDST() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressTimeAffectedByDST;
	System.out.println("Time affected by DST : " + getValue());
    }

    public void getMinutesFreeOfDST() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressMinutesFreeOfDST;
	System.out.println("Minutes free of DST : " + getValue());
    }

    public void getHoursFreeOfDST() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressHoursFreeOfDST;
	System.out.println("Hours free of DST : " + getValue());
    }

    public void getTimeZone() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
	startAddressIndex = startAddressTimeZone;
	System.out.println("TimeZone : " + getValue());
    }

    public void getDLSChangeOver() throws FlagIEC1107ConnectionException, ConnectionException, IOException {
