...
import com.energyict.protocolimpl.coronis.waveflowDLMS.SimpleDataParser.ObisCodeAndInfo;
...
public class TransparentObjectListRead {
	...
	private final int MAX_LIST_MULTIFRAME_LENGTH=135;
	private final int LIST_TAG=0xB6;
	private final int MAX_NR_OF_OBISCODES=16;
