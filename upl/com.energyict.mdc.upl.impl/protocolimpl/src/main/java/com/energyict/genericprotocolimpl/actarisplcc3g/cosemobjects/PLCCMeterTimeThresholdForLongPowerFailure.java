 ...
 * @author kvds
 */
public class PLCCMeterTimeThresholdForLongPowerFailure extends AbstractPLCCObject {
    
    private ScalerUnit scalerUnit = new ScalerUnit(0, Unit.get("s"));
    private BigDecimal value=BigDecimal.valueOf(180);    
    
    /** Creates a new instance of PLCCTemplateObject */
    public PLCCMeterTimeThresholdForLongPowerFailure(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterTimeThresholdForLongPowerFailure:\n");
