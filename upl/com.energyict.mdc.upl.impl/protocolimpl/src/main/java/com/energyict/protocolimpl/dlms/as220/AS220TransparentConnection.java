...
public class AS220TransparentConnection extends FlagIEC1107Connection implements HHUSignOn, HHUEnabler {
     ...
     */
    public AS220TransparentConnection(SerialCommunicationChannel commChannel, int transparentConnectTime, int transparentBaudrate, int transparentDataBits,
	    int transparentStopbits, int transparentParity, int securityLevel, String password) throws ConnectionException {
	...
	this.commChannel.setParamsAndFlush(300, SerialCommunicationChannel.DATABITS_8, SerialCommunicationChannel.PARITY_NONE,
	...
	MeterType metertype = super.connectMAC("", this.password, securityLevel, "", baudrate);
