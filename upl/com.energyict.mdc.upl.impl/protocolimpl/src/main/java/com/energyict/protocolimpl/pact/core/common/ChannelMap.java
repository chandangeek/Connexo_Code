...
public class ChannelMap {
    ...
    public static final int FUNCTION_SURVEY_ADVANCE = 1;
    public static final int FUNCTION_ACTUAL_ADVANCE = 2;
    public static final int FUNCTION_DEMAND = 3;
    public static final int FUNCTION_CUMULATIVE = 4; // do the differentiation in mdw

    private int[] channelFunctions = null;
