...
// Below is the correct length calculation for A-XDR (BER??) encoding of the ASN.1 notations.        
//       if ((byteBuffer[iOffset] & (byte)0x80) != 0) {
...
// Trimaran+ uses another way of encoding the length of an A-XDR (BER??) encoded ASN.1 notation       
       if ((byteBuffer[iOffset] & (byte)0x80) != 0)
           lLength = ((long)(byteBuffer[iOffset]&0x7F)<<7) | ((long)(byteBuffer[iOffset+1]&0x7F));
       else
