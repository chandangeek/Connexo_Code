...
class ErrorMessage {
    ...
    static Map messages = new LinkedHashMap();
    
    static private void put(int id, int meterEvent, String description ){
    ...
    static {
        ...
        put(10, MeterEvent.VOLTAGE_SAG,     
                "R_Phase has dropped below 80% of nom. voltage.");
        put(11, MeterEvent.VOLTAGE_SAG,
                "S_Phase has dropped below 80% of nom. voltage.");
        put(12, MeterEvent.VOLTAGE_SAG,
                "T_Phase has dropped below 80% of nom. voltage.");
        put(13, MeterEvent.POWERDOWN,       "Power fail.");
        put(14, MeterEvent.WATCHDOGRESET,   "Bus_exception. Reset by watchdog");
        put(15, MeterEvent.OTHER,
                "Calibration Led rate too high, disabled");
        put(16, MeterEvent.OTHER,
                "Real_Time_Clock initialised after stop (low battery?)");
        put(17, MeterEvent.OTHER,
                "Too early Demand_Reset_Pulse through input");
        put(18, MeterEvent.OTHER,
                "Too early End_Of_Billing_Pulse through input");
        ...
        put(27, MeterEvent.HARDWARE_ERROR, 
                "Factory-option RS232 is disabled due to bad UART");
        ...
        put(50, MeterEvent.CONFIGURATIONCHANGE, 
                "Relay #1 allocated to aSum with SUB-operator");
        put(51, MeterEvent.CONFIGURATIONCHANGE, 
                "Relay #2 allocated to aSum with SUB-operator");
        put(52, MeterEvent.CONFIGURATIONCHANGE, 
                "Relay #3 allocated to aSum with SUB-operator");
        put(53, MeterEvent.CONFIGURATIONCHANGE, 
                "Relay #4 allocated to aSum with SUB-operator");
        put(54, MeterEvent.CONFIGURATIONCHANGE, 
                "Relay #5 allocated to aSum with SUB-operator");
        put(55, MeterEvent.CONFIGURATIONCHANGE, 
                "Relay #6 allocated to aSum with SUB-operator");
        ...
        put(72, MeterEvent.OTHER,
                "Illegal Date_time in logg_file.Detected in Partition_Logging_Memory().");
        ...
        put(76, MeterEvent.OTHER,
                "Real-time clock has been restarted to preset time.");
    ...
    static ErrorMessage get(int id){
        return (ErrorMessage)messages.get(new Integer(id));
    }
