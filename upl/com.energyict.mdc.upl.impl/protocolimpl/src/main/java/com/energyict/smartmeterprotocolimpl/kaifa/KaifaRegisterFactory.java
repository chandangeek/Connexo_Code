...
public class KaifaRegisterFactory implements BulkRegisterProtocol {
    ...
    public KaifaRegisterFactory(AM110R meterProtocol) {
     ...
     * If the {@link Register} is a DLMS {@link com.energyict.dlms.cosem.Register}, {@link com.energyict.dlms.cosem.ExtendedRegister} or {@link com.energyict.dlms.cosem.DemandRegister},
     ...
     * ObjectList, then we just add it to the {@link #registerMap}. The handling of the <CODE>registerMap</CODE> should be done by the {@link #readRegisters(List)}
