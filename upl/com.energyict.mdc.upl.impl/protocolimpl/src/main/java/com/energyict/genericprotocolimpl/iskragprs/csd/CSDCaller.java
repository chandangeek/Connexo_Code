...
public class CSDCaller {
	...
	public CSDCaller(Rtu rtu){
		this.rtu = rtu;
		this.timeOut = Integer.parseInt(this.rtu.getProperties().getProperty("PollTimeOut", "900000"));
		this.pollFreq = Integer.parseInt(this.rtu.getProperties().getProperty("CsdPollFrequency", "20000"));
		this.csdCallTimeout = Integer.parseInt(this.rtu.getProperties().getProperty("CsdCallTimeOut", "900000"));
		this.phone = this.rtu.getPhoneNumber();
		this.fixedIp = this.rtu.getProperties().getProperty("FixedIpAddress", "0").equalsIgnoreCase("1");
	}
