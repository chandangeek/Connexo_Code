...
public class SswgEvents {
    ...
    static {
        ...
        EVENTS.add(new SswgEvent(0x0000, MeterEvent.OTHER, "Meter cover removed"));
        EVENTS.add(new SswgEvent(0x0001, MeterEvent.OTHER, "Meter cover closed"));
        EVENTS.add(new SswgEvent(0x0002, MeterEvent.OTHER, "Strong Magnetic field"));
        EVENTS.add(new SswgEvent(0x0003, MeterEvent.OTHER, "No Strong Magnetic field"));
        EVENTS.add(new SswgEvent(0x0004, MeterEvent.OTHER, "Battery Failure"));
        EVENTS.add(new SswgEvent(0x0005, MeterEvent.OTHER, "Low Battery"));
        EVENTS.add(new SswgEvent(0x0006, MeterEvent.OTHER, "Program Memory Error"));
        EVENTS.add(new SswgEvent(0x0007, MeterEvent.OTHER, "RAM Error"));
        EVENTS.add(new SswgEvent(0x0008, MeterEvent.OTHER, "NV Memory Error"));
        EVENTS.add(new SswgEvent(0x0009, MeterEvent.OTHER, "Measurement System Error"));
        EVENTS.add(new SswgEvent(0x000A, MeterEvent.OTHER, "Watchdog Error"));
        EVENTS.add(new SswgEvent(0x000B, MeterEvent.OTHER, "Supply Disconnect Failure"));
        EVENTS.add(new SswgEvent(0x000C, MeterEvent.OTHER, "Supply Connect Failure"));
        EVENTS.add(new SswgEvent(0x000D, MeterEvent.OTHER, "Measurement Software Changed"));
        EVENTS.add(new SswgEvent(0x000E, MeterEvent.OTHER, "DST Enabled"));
        EVENTS.add(new SswgEvent(0x000F, MeterEvent.OTHER, "DST Disabled"));
        EVENTS.add(new SswgEvent(0x0010, MeterEvent.OTHER, "Clock Adjust Backward"));
        EVENTS.add(new SswgEvent(0x0011, MeterEvent.OTHER, "Clock Adjust Forward"));
        EVENTS.add(new SswgEvent(0x0012, MeterEvent.OTHER, "Clock Invalid"));
        EVENTS.add(new SswgEvent(0x0013, MeterEvent.OTHER, "Comms Error HAN"));
        EVENTS.add(new SswgEvent(0x0014, MeterEvent.OTHER, "Comms OK HAN"));
        EVENTS.add(new SswgEvent(0x0015, MeterEvent.OTHER, "Fraud Attempt"));
        EVENTS.add(new SswgEvent(0x0016, MeterEvent.OTHER, "Power Loss"));
        ...
        EVENTS.add(new SswgEvent(0x0019, MeterEvent.OTHER, "Unexpected Clock Change"));
        EVENTS.add(new SswgEvent(0x001A, MeterEvent.OTHER, "Comms Using Unauthenticated Component"));
        EVENTS.add(new SswgEvent(0x001B, MeterEvent.OTHER, "Error Reg Clear"));
        EVENTS.add(new SswgEvent(0x001C, MeterEvent.OTHER, "Alarm Reg Clear"));
        EVENTS.add(new SswgEvent(0x001D, MeterEvent.OTHER, "UnexpectedHWReset"));
        EVENTS.add(new SswgEvent(0x001E, MeterEvent.OTHER, "UnexpectedProgramExecution"));
        EVENTS.add(new SswgEvent(0x001F, MeterEvent.OTHER, "Event Log Cleared"));
        EVENTS.add(new SswgEvent(0x0020, MeterEvent.OTHER, "Manual Disconnect"));
        EVENTS.add(new SswgEvent(0x0021, MeterEvent.OTHER, "Manual Connect"));
        EVENTS.add(new SswgEvent(0x0022, MeterEvent.OTHER, "Remote Disconnection"));
        EVENTS.add(new SswgEvent(0x0023, MeterEvent.OTHER, "Local Disconnection"));
        EVENTS.add(new SswgEvent(0x0024, MeterEvent.OTHER, "Limit Threshold Exceeded"));
        EVENTS.add(new SswgEvent(0x0025, MeterEvent.OTHER, "Limit Threshold OK"));
        EVENTS.add(new SswgEvent(0x0026, MeterEvent.OTHER, "Limit Threshold Changed"));
        EVENTS.add(new SswgEvent(0x0027, MeterEvent.OTHER, "Maximum Demand Exceeded"));
        EVENTS.add(new SswgEvent(0x0028, MeterEvent.OTHER, "Profile Cleared"));
        EVENTS.add(new SswgEvent(0x0029, MeterEvent.OTHER, "Firmware Ready For Activation"));
        EVENTS.add(new SswgEvent(0x002A, MeterEvent.OTHER, "Firmware Activated"));
        EVENTS.add(new SswgEvent(0x002B, MeterEvent.OTHER, "PatchFailure"));
        EVENTS.add(new SswgEvent(0x002C, MeterEvent.OTHER, "TOU Tariff Activation"));
        EVENTS.add(new SswgEvent(0x002D, MeterEvent.OTHER, "8 x 8 Tariff Activated"));
        EVENTS.add(new SswgEvent(0x002E, MeterEvent.OTHER, "Single Rate Tariff Activated"));
        EVENTS.add(new SswgEvent(0x002F, MeterEvent.OTHER, "AsynchronousBillingOccurred"));
        EVENTS.add(new SswgEvent(0x0030, MeterEvent.OTHER, "SynchronousBillingOccurred"));
        EVENTS.add(new SswgEvent(0x0031, MeterEvent.OTHER, "Strong DC field detected"));
        EVENTS.add(new SswgEvent(0x0032, MeterEvent.OTHER, "No strong DC field anymore [restored]"));
        EVENTS.add(new SswgEvent(0x0033, MeterEvent.OTHER, "n' times wrong password"));
        EVENTS.add(new SswgEvent(0x0034, MeterEvent.OTHER, "Power Up"));
        EVENTS.add(new SswgEvent(0x0035, MeterEvent.OTHER, "Valve alarm"));
        EVENTS.add(new SswgEvent(0x0036, MeterEvent.OTHER, "Communication error when reading the meter"));
        EVENTS.add(new SswgEvent(0x0037, MeterEvent.OTHER, "Communication ok [restored]"));
        EVENTS.add(new SswgEvent(0x0038, MeterEvent.OTHER, "Communications error remote"));
        EVENTS.add(new SswgEvent(0x0039, MeterEvent.OTHER, "Communications ok Remote Com [restored]"));
        EVENTS.add(new SswgEvent(0x003A, MeterEvent.OTHER, "Remote Arm Disconnector"));
        EVENTS.add(new SswgEvent(0x003B, MeterEvent.OTHER, "Scheduled Disconnection"));
        EVENTS.add(new SswgEvent(0x003C, MeterEvent.OTHER, "Local Arm Disconnector"));

        EVENTS.add(new SswgEvent(0x0080, MeterEvent.OTHER, "Incorrect Polarity / Rervers Run"));
        EVENTS.add(new SswgEvent(0x0081, MeterEvent.OTHER, "Current No Voltage"));
        EVENTS.add(new SswgEvent(0x0082, MeterEvent.OTHER, "Under Voltage"));
        EVENTS.add(new SswgEvent(0x0083, MeterEvent.OTHER, "Over Voltage"));
        ...
        EVENTS.add(new SswgEvent(0x0087, MeterEvent.OTHER, "Under Voltage 2"));
        EVENTS.add(new SswgEvent(0x0088, MeterEvent.OTHER, "Over Voltage 2"));
        ...
        EVENTS.add(new SswgEvent(0x0097, MeterEvent.OTHER, "Password Change #1"));
        EVENTS.add(new SswgEvent(0x0098, MeterEvent.OTHER, "Password Change #2"));
        EVENTS.add(new SswgEvent(0x0099, MeterEvent.OTHER, "Password Change #3"));
        EVENTS.add(new SswgEvent(0x009A, MeterEvent.OTHER, "Password Change #4"));
        EVENTS.add(new SswgEvent(0x009B, MeterEvent.OTHER, "Terminal Cover Removed"));
        EVENTS.add(new SswgEvent(0x009C, MeterEvent.OTHER, "Terminal Cover Closed"));
        EVENTS.add(new SswgEvent(0x009D, MeterEvent.OTHER, "Limiter Enabled #1"));
        EVENTS.add(new SswgEvent(0x009E, MeterEvent.OTHER, "Limiter Enabled #2"));
        EVENTS.add(new SswgEvent(0x009F, MeterEvent.OTHER, "Limiter Enabled #3"));
        EVENTS.add(new SswgEvent(0x00A0, MeterEvent.OTHER, "Limiter Enabled #4"));
        EVENTS.add(new SswgEvent(0x00A1, MeterEvent.OTHER, "Limiter Enabled #5"));
        EVENTS.add(new SswgEvent(0x00A2, MeterEvent.OTHER, "Limiter Enabled #6"));
        EVENTS.add(new SswgEvent(0x00A3, MeterEvent.OTHER, "Limiter Over Threshold #1"));
        EVENTS.add(new SswgEvent(0x00A4, MeterEvent.OTHER, "Limiter Over Threshold #2"));
        EVENTS.add(new SswgEvent(0x00A5, MeterEvent.OTHER, "Limiter Over Threshold #3"));
        EVENTS.add(new SswgEvent(0x00A6, MeterEvent.OTHER, "Limiter Over Threshold #4"));
        EVENTS.add(new SswgEvent(0x00A7, MeterEvent.OTHER, "Limiter Over Threshold #5"));
        EVENTS.add(new SswgEvent(0x00A8, MeterEvent.OTHER, "Limiter Over Threshold #6"));
        EVENTS.add(new SswgEvent(0x00A9, MeterEvent.OTHER, "Limiter Under Threshold #1"));
        EVENTS.add(new SswgEvent(0x00AA, MeterEvent.OTHER, "Limiter Under Threshold #2"));
        EVENTS.add(new SswgEvent(0x00AB, MeterEvent.OTHER, "Limiter Under Threshold #3"));
        EVENTS.add(new SswgEvent(0x00AC, MeterEvent.OTHER, "Limiter Under Threshold #4"));
        EVENTS.add(new SswgEvent(0x00AD, MeterEvent.OTHER, "Limiter Under Threshold #5"));
        EVENTS.add(new SswgEvent(0x00AE, MeterEvent.OTHER, "Limiter Under Threshold #6"));
        EVENTS.add(new SswgEvent(0x00AF, MeterEvent.OTHER, "Limiter Disabled #1"));
        EVENTS.add(new SswgEvent(0x00B0, MeterEvent.OTHER, "Limiter Disabled #2"));
        EVENTS.add(new SswgEvent(0x00B1, MeterEvent.OTHER, "Limiter Disabled #3"));
        EVENTS.add(new SswgEvent(0x00B2, MeterEvent.OTHER, "Limiter Disabled #4"));
        EVENTS.add(new SswgEvent(0x00B3, MeterEvent.OTHER, "Limiter Disabled #5"));
        EVENTS.add(new SswgEvent(0x00B4, MeterEvent.OTHER, "Limiter Disabled #6"));
        EVENTS.add(new SswgEvent(0x00B5, MeterEvent.OTHER, "Super Vision Monitor Enabled"));
        EVENTS.add(new SswgEvent(0x00B6, MeterEvent.OTHER, "Super Vision Monitor Over Threshold"));
        EVENTS.add(new SswgEvent(0x00B7, MeterEvent.OTHER, "Super Vision Monitor under Threshold"));
        EVENTS.add(new SswgEvent(0x00B8, MeterEvent.OTHER, "Super Vision Monitor Disabled"));
        EVENTS.add(new SswgEvent(0x00B9, MeterEvent.OTHER, "Limiter Threshold Change #1"));
        EVENTS.add(new SswgEvent(0x00BA, MeterEvent.OTHER, "Limiter Threshold Change #2"));
        EVENTS.add(new SswgEvent(0x00BB, MeterEvent.OTHER, "Limiter Threshold Change #3"));
        EVENTS.add(new SswgEvent(0x00BC, MeterEvent.OTHER, "Limiter Threshold Change #4"));
        EVENTS.add(new SswgEvent(0x00BD, MeterEvent.OTHER, "Limiter Threshold Change #5"));
        EVENTS.add(new SswgEvent(0x00BE, MeterEvent.OTHER, "Limiter Threshold Change #6"));
        ...
        EVENTS.add(new SswgEvent(0x0130, MeterEvent.OTHER, "Aysn Billing CoT"));
        ...
        EVENTS.add(new SswgEvent(0x0136, MeterEvent.OTHER, "Aysn Billing CoS"));
        ...
        EVENTS.add(new SswgEvent(0x013C, MeterEvent.OTHER, "DLMS Key/Password Auth Client Public Change"));
        EVENTS.add(new SswgEvent(0x013D, MeterEvent.OTHER, "DLMS Key/Password Auth Client Data Collection Change"));
        EVENTS.add(new SswgEvent(0x013E, MeterEvent.OTHER, "DLMS Key/Password Auth Client Extended Data Collection Change"));
        EVENTS.add(new SswgEvent(0x013F, MeterEvent.OTHER, "DLMS Key/Password Auth Client Managment Change"));
        EVENTS.add(new SswgEvent(0x0140, MeterEvent.OTHER, "DLMS Key/Password Auth Client Firmware Change"));

        EVENTS.add(new SswgEvent(0x0143, MeterEvent.OTHER, "DLMS Key/Password Encryption Client Public Change"));
        EVENTS.add(new SswgEvent(0x0144, MeterEvent.OTHER, "DLMS Key/Password Encryption Client Data Collection Change"));
        EVENTS.add(new SswgEvent(0x0145, MeterEvent.OTHER, "DLMS Key/Password Encryption Client Extended Data Collection Change"));
        EVENTS.add(new SswgEvent(0x0146, MeterEvent.OTHER, "DLMS Key/Password Encryption Client Managment Change"));
        EVENTS.add(new SswgEvent(0x0147, MeterEvent.OTHER, "DLMS Key/Password Encryption Client Firmware Change"));
        ...
        EVENTS.add(new SswgEvent(0x0186, MeterEvent.OTHER, "New OTA Firmware "));
        EVENTS.add(new SswgEvent(0x0187, MeterEvent.OTHER, "CBKE Update Request"));
        EVENTS.add(new SswgEvent(0x0188, MeterEvent.OTHER, "Time Sync"));
        EVENTS.add(new SswgEvent(0x0189, MeterEvent.OTHER, "New Password"));
