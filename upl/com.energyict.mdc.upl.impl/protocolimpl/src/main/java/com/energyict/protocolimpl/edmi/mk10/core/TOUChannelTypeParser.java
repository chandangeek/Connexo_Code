...
public class TOUChannelTypeParser {
	...
	private int parseNameToObisC(String name) {
        ...
        if (name.indexOf("apparent") != -1) {
            ...
            if (name.indexOf("q4") != -1) obisc = 146;
        }
        ...
        if (name.indexOf("apparent q") != -1) {
	        if (name.indexOf("l1") != -1) obisc += 0;
	        if (name.indexOf("l2") != -1) obisc += 1;
	        if (name.indexOf("l3") != -1) obisc += 2;
        	if (name.indexOf("total") != -1) obisc += 3;
        } 
        else {
	        if (name.indexOf("l1") != -1) obisc += 20;
	        if (name.indexOf("l2") != -1) obisc += 40;
	        if (name.indexOf("l3") != -1) obisc += 60;
			if (name.indexOf("total") != -1) obisc += 0;
        }
