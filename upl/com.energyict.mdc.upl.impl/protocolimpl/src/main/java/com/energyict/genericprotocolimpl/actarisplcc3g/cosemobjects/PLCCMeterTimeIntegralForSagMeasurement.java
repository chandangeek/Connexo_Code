 ...
 * @author kvds
 */
public class PLCCMeterTimeIntegralForSagMeasurement extends AbstractPLCCObject {
    ...
    public PLCCMeterTimeIntegralForSagMeasurement(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterTimeIntegralForSagMeasurement:\n");
