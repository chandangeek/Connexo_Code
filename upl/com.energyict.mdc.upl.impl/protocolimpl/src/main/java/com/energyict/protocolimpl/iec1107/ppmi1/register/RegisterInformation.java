...
public class RegisterInformation {
    ...
    public MetaRegister importWh = cr("Import",
    RegisterFactory.R_TOTAL_IMPORT_WH, wattHour);
    public MetaRegister exportWh = cr("Export",
    RegisterFactory.R_TOTAL_EXPORT_WH, wattHour);
    public MetaRegister importVarh = cr("Import",
    RegisterFactory.R_TOTAL_IMPORT_VARH, varhHour);
    public MetaRegister exportVarh = cr("Export",
    RegisterFactory.R_TOTAL_EXPORT_VARH, varhHour);
    public MetaRegister vAh = cr("VAh", RegisterFactory.R_TOTAL_VAH, vAHour);
    
    public MetaRegister[] energyDefinition = {importWh, exportWh, importVarh,
    exportVarh, vAh};
    ...
    public MetaRegister[] demandDefinition = {importW, exportW, importVar,
    exportVar, vA};
    
    public MetaRegister tou1 = cr("Time Of Use 1",
    RegisterFactory.R_TIME_OF_USE_1);
    public MetaRegister tou2 = cr("Time Of Use 2",
    RegisterFactory.R_TIME_OF_USE_2);
    public MetaRegister tou3 = cr("Time Of Use 3",
    RegisterFactory.R_TIME_OF_USE_3);
    public MetaRegister tou4 = cr("Time Of Use 4",
    RegisterFactory.R_TIME_OF_USE_4);
    public MetaRegister tou5 = cr("Time Of Use 5",
    RegisterFactory.R_TIME_OF_USE_5);
    public MetaRegister tou6 = cr("Time Of Use 6",
    RegisterFactory.R_TIME_OF_USE_6);
    public MetaRegister tou7 = cr("Time Of Use 7",
    RegisterFactory.R_TIME_OF_USE_7);
    public MetaRegister tou8 = cr("Time Of Use 8",
    RegisterFactory.R_TIME_OF_USE_8);
    
    public MetaRegister touRegister[] = {tou1, tou2, tou3, tou4, tou5, tou6,
    tou7, tou8};
    public List touRegisterList = Arrays.asList( touRegister );
    
    public MetaRegister mdTou1 = cr("Maximum Demand 1",
    RegisterFactory.R_MAXIMUM_DEMAND_1);
    public MetaRegister mdTou2 = cr("Maximum Demand 2",
    RegisterFactory.R_MAXIMUM_DEMAND_2);
    public MetaRegister mdTou3 = cr("Maximum Demand 3",
    RegisterFactory.R_MAXIMUM_DEMAND_3);
    public MetaRegister mdTou4 = cr("Maximum Demand 4",
    RegisterFactory.R_MAXIMUM_DEMAND_4);
        ...
        for( int ei = 0; ei < energyDefinition.length; ei ++ ) {
            for( int i = 0; i < 8; i++) {
                if( energyDefinition[ei].equals( touRegister[i].getSourceRegister() ) ) {
                    String code = "1.1." + (ei+1) + ".8." + (i+1) + ".255";
    ...
    public String toString() {
        ...
        sb.append(cmdTou1.toString() + "\n");
        sb.append(cmdTou2.toString() + "\n");
        sb.append(cmdTou3.toString() + "\n");
        sb.append(cmdTou4.toString() + "\n\n");
...
// (scrapbook)
//        r.append( "1.1.1.8.0.255 =" + ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.1.8.0.255") ) + "\n" );
//        r.append( "1.1.2.8.0.255 =" + ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.2.8.0.255") ) + "\n" );
//        r.append( "1.1.3.8.0.255 =" + ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.3.8.0.255") ) + "\n" );
//        r.append( "1.1.4.8.0.255 =" + ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.4.8.0.255") ) + "\n" );
//        r.append( "1.1.9.8.0.255 =" + ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.9.8.0.255") ) + "\n" );
//
//        for( int i = 0; i < 8;  i++ ) {
//            if( importWh.equals(touRegister[i].getSourceRegister() )  )
//                r.append( 	"1.1.1.8." + ( i + 1 ) + ".255 =" +
//							ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.1.8." + ( i + 1 ) + ".255") ) + "\n" );;
//        }
//
//        for( int i = 0; i < 8;  i++ ) {
//            if( exportWh.equals(touRegister[i].getSourceRegister() ) )
//                r.append( 	"1.1.2.8." + ( i + 1 )+ ".255 =" +
//							ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.2.8." + ( i + 1 ) + ".255") ) + "\n" );;
//        }
//
//        for( int i = 0; i < 8;  i++ ) {
//            if( importVarh.equals( touRegister[i].getSourceRegister() ) )
//                r.append( 	"1.1.3.8." + ( i + 1 ) + ".255 =" +
//							ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.3.8." + ( i + 1 ) + ".255") ) + "\n" );;
//        }
//
//        for( int i = 0; i < 8;  i++ ) {
//            if( exportVarh.equals( touRegister[i].getSourceRegister() ) )
//                r.append( 	"1.1.4.8." + ( i + 1 ) + ".255 =" +
//							ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.4.8." + ( i + 1 ) + ".255") ) + "\n" );;
//        }
//
//        for( int i = 0; i < 8;  i++ ) {
//            if( vAh.equals( touRegister[i].getSourceRegister() ) )
//                r.append( 	"1.1.9.8." + ( i + 1 ) + ".255 =" +
//							ObisCodeMapper.getRegisterInfo(ObisCode.fromString("1.1.9.8." + ( i + 1 ) + ".255") ) + "\n" );;
//        }
//
//
//        for( int i = 0; i < 4; i++) {
//            if( importW.equals( mdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.6." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( exportW.equals( mdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.6." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( importVar.equals( mdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.6." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( exportVar.equals( mdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.6." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( vA.equals( mdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.6." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( importW.equals( cmdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.2." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( exportW.equals( cmdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.2." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( importVar.equals( cmdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.2." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( exportVar.equals( cmdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.2." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }
//
//        for( int i = 0; i < 4; i++) {
//            if( vA.equals( cmdRegister[i].getSourceRegister() ) ) {
//                String code = "1.1.1.2." + (i+1) + ".255";
//                r.append(  code + " = " + ObisCodeMapper.getRegisterInfo(ObisCode.fromString( code ) ) + "\n" );
//            }
//        }