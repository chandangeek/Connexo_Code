...
public class ObisCodeMapper {
    ...
    private Map<Integer, MetaRegister> energyMap = new HashMap<Integer, MetaRegister>() {
        {
    ...
    private MetaRegister getEnergy(ObisCode o) {
        return this.energyMap.get(new Integer(o.getC()));
    }

    /* In the case of power: map the obiscode to the MetaRegister */
    private Map<Integer, MetaRegister> powerMap = new HashMap<Integer, MetaRegister>() {
        {
    ...
    private MetaRegister getPower(ObisCode o) {
        return this.powerMap.get(new Integer(o.getC()));
    }
    ...
    private void getBillingPoint(ObisCode obisCode) throws NoSuchRegisterException {
    ...
    private Map<MetaRegister, String> metaRegToString = new HashMap<MetaRegister, String>() {
        {
    ...
    private RegisterValue getMD(ObisCode obisCode) throws IOException {
        ...
        if (obisCode.getE() == 0) {
            ...
            if (this.billingPoint == -1) {
                Date d = new Date();
                List<RegisterValue> r = new ArrayList<>();
                ...
                return getMax(r.toArray(new RegisterValue[0]));
