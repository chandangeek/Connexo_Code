...
public class EnergyTypeCode {
    ...
    static {
        // data identity 507
        list.add(new EnergyTypeCode(0, Unit.get(BaseUnit.UNITLESS, -3), 0, "no source"));
    ...
    static public int getObisCFromRegSource(int regSource) throws NoSuchRegisterException {
        ...
        throw new NoSuchRegisterException("EnergyTypeCode, getObisCFromRegSource, invalid register source code, "+regSource);
    }
