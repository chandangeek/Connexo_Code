...
public class G3RegisterMapper {
    ...
    private DLMSStoredValues dailyStoredValues;
    private DLMSStoredValues monthlyStoredValues;
    ...
    public G3RegisterMapper(AS330D as330D) {
        ...
        dailyStoredValues = new DLMSStoredValues(as330D.getSession(), G3ProfileType.DAILY_PROFILE.getObisCode());
        monthlyStoredValues = new DLMSStoredValues(as330D.getSession(), G3ProfileType.MONTHLY_PROFILE.getObisCode());
    }
