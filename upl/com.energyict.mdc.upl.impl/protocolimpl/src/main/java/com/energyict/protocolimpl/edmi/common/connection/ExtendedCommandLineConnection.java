...
public class ExtendedCommandLineConnection extends Connection implements ProtocolConnection, CommandLineConnection {
    ...
    public byte[] dataReadout(String strID, String nodeId) throws com.energyict.mdc.upl.io.NestedIOException, ProtocolConnectionException {
        return null;
    }

    public void disconnectMAC() throws com.energyict.mdc.upl.io.NestedIOException, ProtocolConnectionException {
    }
