...
public class AS220ContactorController {
	...
	public AS220ContactorController(AS220Registry rFactory, Logger logger) {
		this.as220Registry = rFactory;
		this.logger = logger;
	}
	...
	private int armContactor() throws IOException {
		...
		this.as220Registry.setRegister("ContactorStatus",new byte[]{0}); // arm the contactor for closing
	...
	private int connectContactor() throws IOException {
		...
		this.as220Registry.setRegister("ContactorCloser",new byte[]{0}); // close the armed contactor
	...
	private int disconnectContactor() throws IOException {
		...
		this.as220Registry.setRegister("ContactorStatus",new byte[]{1}); // open the contactor
	...
	private int readContactorState() throws IOException {
		long val = ((Long)this.as220Registry.getRegister("ContactorStatus")).longValue();
		if (DEBUG > 0) {
	...
	public void doArm() throws IOException {
		...
		this.as220Registry.setRegister("ContactorStatus",new byte[]{0});
