 ...
 * @author  Koen
 */
public abstract class AbstractIEC1107Protocol implements MeterProtocol, ProtocolLink, HHUEnabler, SerialNumber, MeterExceptionInfo, RegisterProtocol {
    ...
    int iec1107TimeoutProperty; // protocol timeout in ms (default=10000)
    int protocolRetriesProperty; // nr of retries for the protocol (default=5)
    ...
    int iec1107Compatible; // 0=protocol has IEC1107 incompatible features (e.g. the A1700 has data streaming mode), 1=protocol is fully compatible with IEC1107 (default=1)
    ...
    ChannelMap channelMap; // null=unused configuration info of the meter's channels (default=null)
    ...
    int forcedDelay; // Delay before sending data
    FlagIEC1107Connection flagIEC1107Connection; // lower layer IEC1107 communication
...
//        result.add("Scaler"));
     ...
     *******************************************************************************************/
    /* 
     *  Default implementation of the HHU interfacing. These cklasses can be overridden by
    ...
    public void enableHHUSignOn(SerialCommunicationChannel commChannel,boolean datareadout) throws ConnectionException {
        HHUSignOn hhuSignOn =
        (HHUSignOn)new IEC1107HHUConnection(commChannel,iec1107TimeoutProperty,protocolRetriesProperty,300,echoCancelling);
