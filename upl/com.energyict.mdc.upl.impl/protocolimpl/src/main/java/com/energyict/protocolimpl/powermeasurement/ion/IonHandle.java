...
public class IonHandle {
    ...
    private static final Map<Integer, IonHandle> KNOWN_HANDLES = new HashMap<>();
    ...
    static IonHandle get( int key ) {
        return KNOWN_HANDLES.get( new Integer(key) );
    }
    ...
    static Collection<IonHandle> getMax( ){
        return max;
    }

    static Collection<IonHandle> getMin( ){
        return min;
    }

    static Collection<IonHandle> getInt( ){
        return integrator;
    }

    public String toString( ){
        return "IonHandle [ " +
                byteArray.toHexaString(true) +
                ", " +
                description +
                "]";
    }
    ...
    private static final Collection<IonHandle> max = Arrays.asList(
    ...
    private static final Collection<IonHandle> min = Arrays.asList(
    ...
    private static final Collection<IonHandle> integrator = Arrays.asList(
