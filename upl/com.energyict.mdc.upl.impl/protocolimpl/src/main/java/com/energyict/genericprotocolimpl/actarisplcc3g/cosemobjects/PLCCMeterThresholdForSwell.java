 ...
 * @author kvds
 */
public class PLCCMeterThresholdForSwell extends AbstractPLCCObject {
    
    private ScalerUnit scalerUnit = new ScalerUnit(0, Unit.get("V"));
    private BigDecimal value=BigDecimal.valueOf(257);    
    
    /** Creates a new instance of PLCCTemplateObject */
    public PLCCMeterThresholdForSwell(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    
    protected ObjectIdentification getId() {
        return new ObjectIdentification(ObisCode.fromString("1.0.12.35.0.255"), AbstractCosemObject.CLASSID_REGISTER);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterThresholdForSwell:\n");
