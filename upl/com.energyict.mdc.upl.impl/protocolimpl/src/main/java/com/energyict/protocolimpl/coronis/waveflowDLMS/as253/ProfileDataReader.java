...
public class ProfileDataReader {
	...
	public ProfileData getProfileData(Date lastReading, boolean includeEvents) throws IOException {
		...
		AbstractDataType adt = as253.getTransparantObjectAccessFactory().readObjectAttributeRange(as253.getLoadProfileObisCode(), TransparantObjectAccessFactory.ATTRIBUTE_VALUE,lastReading);
...
//				if (as253.getNumberOfChannels() != nrOfchannels) {
//					as253.getLogger().warning("Number of channels in the meter load profile does not match with the configured nr of channels in EIServer!");
//				}
