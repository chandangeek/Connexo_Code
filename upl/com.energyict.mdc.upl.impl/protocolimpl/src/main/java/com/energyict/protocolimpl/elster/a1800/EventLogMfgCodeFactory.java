...
public class EventLogMfgCodeFactory extends EventLogCodeFactory {
    ...
    static {
        ...
        getMfgList().add(new EventLogCode(2,"Terminal Cover tamper event",""));
        getMfgList().add(new EventLogCode(3,"Main Cover tamper event",""));
        ...
        getMfgList().add(new EventLogCode(8,"Ph A OFF event",""));
        getMfgList().add(new EventLogCode(9,"Ph A ON event",""));
        getMfgList().add(new EventLogCode(10,"Ph B OFF event",""));
        getMfgList().add(new EventLogCode(11,"Ph B ON event",""));
        getMfgList().add(new EventLogCode(12,"Ph C OFF event",""));
