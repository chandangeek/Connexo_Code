 ...
 * Fbo Note: 
 * 
 * ProtocolChannel and ProtocolChannelMap are to be deleted from this package.
 * Only the classes from the protocolimpl may be used.  But for the moment 
 * there is a packaging problem: ProtocolChannel and ProtocolChannelMap are 
 * part of the obfuscated protocolimpl.jar ...
 * 
 * 
 *
 * @author  Koen
