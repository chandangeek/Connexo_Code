...
public abstract class AbstractProtocol implements MeterProtocol, HHUEnabler, SerialNumber, MeterExceptionInfo, RegisterProtocol, HalfDuplexEnabler, DialinScheduleProtocol, DemandResetProtocol {
     ...
     * @throws java.io.IOException thrown when something goes wrong
     * @throws com.energyict.protocol.UnsupportedException Thrown when that method is not supported
...
//    }
     ...
     * @throws com.energyict.protocol.NoSuchRegisterException  For debugging only
     * @throws com.energyict.protocol.UnsupportedException  For debugging only
     */
     ...
     * @throws com.energyict.protocol.InvalidPropertyException Thrown when a particular property has an invalid value.
     * @throws com.energyict.protocol.MissingPropertyException Thrown when a particular proiperty is mandatory.
     */
...
//        result.add("Scaler"));
     ...
     * @throws com.energyict.cbo.BusinessException thrown when something goes wrong in the caching businesslogic
     */
