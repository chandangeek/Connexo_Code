 ...
 */
public class ZmdDisplayController {
    ...
    public void writeMessage(String message) throws IOException {
        ...
        getZmd().setRegister(DISPLAY_MESSAGE_REGISTER, getPacketFromString(message));
    }
...
//        getZmd().setRegister(ZmdRegistry.DISPLAY_MESSAGE_REGISTER, CLEAR_MESSAGE);
//    }
