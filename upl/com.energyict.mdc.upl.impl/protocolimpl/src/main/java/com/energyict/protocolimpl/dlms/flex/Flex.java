...
//        return "UNAVAILABLE";
    ...
    protected void validateProperties(Properties properties) throws MissingPropertyException, InvalidPropertyException
    {
        try {
            ...
            else throw new InvalidPropertyException("Flex, validateProperties, invalid LoadProfileId, "+Integer.parseInt(properties.getProperty("LoadProfileId","1"))); 
    ...
    private String doGetRegister(String name) throws IOException {
        ...
        else throw new NoSuchRegisterException("Flex_GSM_GPRS,getRegister, register "+name+" does not exist.");
    }
...
//    private AXDRDecoder axdrDecoder = AXDRDecoder();
    ...
    public static void main(String[] args) throws IOException{
    	...
    	System.out.println("MAIN*MAIN*MAIN*MAIN*MAIN*MAIN*MAIN*MAIN*MAIN*MAIN*MAIN");System.out.println("");
    	...
    	adt = decode(abstractDataByte);
    	System.out.println(adt);
    	System.out.println("******************************************************");
    	adt = decode(abstractDataByte2);
    	System.out.println(adt);
    	System.out.println("******************************************************");
