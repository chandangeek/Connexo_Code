 ...
 * Time: 9:53:09
 */
public class RegisterReader implements BulkRegisterProtocol {

    private final AS300P meterProtocol;

    public RegisterReader(AS300P meterProtocol) {
    ...
    public RegisterInfo translateRegister(Register register) throws IOException {
        return new RegisterInfo("AS300P register " + register.getObisCode());
    }
