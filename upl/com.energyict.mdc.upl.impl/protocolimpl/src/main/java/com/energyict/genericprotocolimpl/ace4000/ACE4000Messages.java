...
public class ACE4000Messages extends GenericMessageExecutor implements MessageProtocol {
    ...
    @Override
    public void doMessage(OldDeviceMessage messageEntry) throws BusinessException, SQLException, IOException {
        try {
    ...
    private void sendTariffConfiguration(OldDeviceMessage messageEntry) throws IOException, BusinessException, SQLException {
    ...
    private void sendLoadProfileConfigurationRequest(OldDeviceMessage messageEntry) throws IOException, BusinessException, SQLException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void readProfileData(OldDeviceMessage messageEntry) throws IOException, BusinessException, SQLException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void sendContactorCommand(OldDeviceMessage messageEntry, int cmd) throws IOException, BusinessException, SQLException {
        String[] parts = messageEntry.getContents().split("=");
        Date date = null;
    ...
    private void sendDisplayMessage(OldDeviceMessage messageEntry, int mode) throws IOException, BusinessException, SQLException {
        String message = "";
        if (mode != 0) {
    ...
    private void sendDisplayConfigRequest(OldDeviceMessage messageEntry) throws IOException, BusinessException, SQLException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void sendFirmwareUpgradeRequest(OldDeviceMessage messageEntry) throws IOException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void sendMaxDemandConfigurationRequest(OldDeviceMessage messageEntry) throws IOException, BusinessException, SQLException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void sendConsumptionLimitationConfiguration(OldDeviceMessage messageEntry) throws BusinessException, SQLException, IOException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void sendEmergencyConsumptionLimitationConfiguration(OldDeviceMessage messageEntry) throws BusinessException, SQLException, IOException {
        String[] parts = messageEntry.getContents().split("=");
    ...
    private void sendSDMConfigurationRequest(OldDeviceMessage messageEntry) throws BusinessException, SQLException, IOException {
    ...
    private void failMessage(OldDeviceMessage messageEntry, String msg) throws BusinessException, SQLException {
    ...
    public void setMessageResult(boolean end, List<OldDeviceMessage> messages) throws BusinessException, SQLException {
        for (OldDeviceMessage messageEntry : messages) {
            if (messageEntry.getContents().contains(READ_EVENTS)) {
    ...
    private void setMessage(OldDeviceMessage messageEntry, Boolean success, String failMsg) throws BusinessException, SQLException {
        if (!(success == null)) {
            if (success) {
    ...
    public boolean shouldRetry(List<OldDeviceMessage> messages) {
        for (OldDeviceMessage messageEntry : messages) {
            if (messageEntry.getContents().contains(READ_EVENTS)) {
                if (ace4000.getObjectFactory().shouldRetryEvents()) {
                    return true;
    ...
    public void logTimeoutMessages(List<OldDeviceMessage> messages, int retries) throws BusinessException, SQLException {
        for (OldDeviceMessage messageEntry : messages) {
            if (messageEntry.getContents().contains(READ_EVENTS)) {
                if (ace4000.getObjectFactory().shouldRetryEvents()) {
