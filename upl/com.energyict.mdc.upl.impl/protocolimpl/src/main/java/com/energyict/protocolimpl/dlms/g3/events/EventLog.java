...
public interface EventLog {
     ...
     * @return A list of {@link MeterEvent}. This should never return 'null'.
     * @throws IOException If there occured an error while reading the events (timeout, parsing error, ...)
     */
