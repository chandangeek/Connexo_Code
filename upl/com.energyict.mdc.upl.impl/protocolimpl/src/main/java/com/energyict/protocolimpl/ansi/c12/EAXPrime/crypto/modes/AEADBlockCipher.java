 ...
 * @see com.energyict.protocolimpl.ansi.c12.EAXPrime.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @exception com.energyict.protocolimpl.ansi.c12.EAXPrime.crypto.DataLengthException if the output buffer is too small.
     */
     ...
     * @throws com.energyict.protocolimpl.ansi.c12.EAXPrime.crypto.InvalidCipherTextException if the MAC fails to match.
     */
