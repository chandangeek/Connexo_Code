...
public class ApplicationStateMachine {
    ...
    private boolean supportsIdentifyCommand;

    /** Creates a new instance of ApplicationStateMachine */
    public ApplicationStateMachine(ProtocolLink protocolLink, boolean supportsIdentifyCommand) {
