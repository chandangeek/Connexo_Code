...
public class ACE6000Properties extends DlmsProtocolProperties {
    ...
    public List<PropertySpec> getUPLPropertySpecs() {
        return Arrays.asList(
                UPLPropertySpecFactory.specBuilder(TIMEOUT.getName(), false, PropertyTranslationKeys.DLMS_TIMEOUT, this.propertySpecService::stringSpec).finish(),
                UPLPropertySpecFactory.specBuilder(RETRIES.getName(), false, PropertyTranslationKeys.DLMS_RETRIES, this.propertySpecService::stringSpec).finish(),
                ...
                UPLPropertySpecFactory.specBuilder(EXTENDED_LOGGING.getName(), false, PropertyTranslationKeys.DLMS_EXTENDED_LOGGING, this.propertySpecService::stringSpec).finish(),
