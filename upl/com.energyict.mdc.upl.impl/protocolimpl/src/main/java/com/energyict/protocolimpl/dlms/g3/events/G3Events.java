...
public class G3Events {
     ...
     *
     * @param session The {@link DlmsSession} used to read the events
     */
    ...
    /**
     * Read all the events from the meter between the two given dates, and return them as a list of {@link MeterEvent}
