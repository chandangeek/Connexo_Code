...
public abstract class AbstractVDEWRegistry {
    ...
    protected String billingDateFormat;
    ...
    public AbstractVDEWRegistry(MeterExceptionInfo meterExceptionInfo, ProtocolLink protocolLink) {
        this(meterExceptionInfo, protocolLink, -1, "yy/mm/dd", null);
    }

    public AbstractVDEWRegistry(MeterExceptionInfo meterExceptionInfo, ProtocolLink protocolLink, int registerSet) {
        this(meterExceptionInfo, protocolLink, registerSet, "yy/mm/dd", null);
    }

    public AbstractVDEWRegistry(MeterExceptionInfo meterExceptionInfo, ProtocolLink protocolLink, int registerSet, String dateFormat, String billingDateFormat) {
        this.registerSet = registerSet;
        this.protocolLink = protocolLink;
        this.meterExceptionInfo = meterExceptionInfo;
        this.dateFormat = dateFormat;
        this.billingDateFormat = billingDateFormat;
        initRegisters();
        initLocals();
    }
}
