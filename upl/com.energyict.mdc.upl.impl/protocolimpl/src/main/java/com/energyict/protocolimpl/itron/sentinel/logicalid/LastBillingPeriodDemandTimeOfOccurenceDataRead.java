 ...
 * @author Koen
 */
public class LastBillingPeriodDemandTimeOfOccurenceDataRead extends AbstractDataRead {
    ...
    public LastBillingPeriodDemandTimeOfOccurenceDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("LastBillingPeriodDemandTimeOfOccurenceDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_DEMAND_TOO_RATE_G").getId()};
