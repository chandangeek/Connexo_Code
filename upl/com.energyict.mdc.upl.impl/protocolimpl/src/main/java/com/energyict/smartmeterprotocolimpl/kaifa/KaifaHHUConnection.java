...
public class KaifaHHUConnection extends IEC1107HHUConnection {
    ...
    protected void switchBaudrate(int Z, int protocol) throws ConnectionException {
        try {
    ...
    protected void sendProtocolAckAndSwitchBaudrate(MeterType meterType, int mode, int protocol) throws IOException {
