...
public class ESMR50LoadProfileBuilder extends Dsmr40LoadProfileBuilder {
    ...
    */
     ...
     */
    public ESMR50LoadProfileBuilder(AbstractSmartNtaProtocol meterProtocol) {
        super(meterProtocol);
    }
...
//                    } todo Find replacement service for MeteringWarehouse
    ...
    public List<LoadProfileConfiguration> fetchLoadProfileConfiguration(List<LoadProfileReader> loadProfileReaders) throws IOException {
        List<LoadProfileConfiguration> loadProfileConfigurationList = super.fetchLoadProfileConfiguration(loadProfileReaders);

        for (LoadProfileConfiguration lpc : loadProfileConfigurationList){
    ...
    public boolean getIgnoreDstStatusCode() {
        return ((ESMR50Properties)(((ESMR50Protocol) getMeterProtocol()).getProperties())).getIgnoreDstStatusBit();
    }
