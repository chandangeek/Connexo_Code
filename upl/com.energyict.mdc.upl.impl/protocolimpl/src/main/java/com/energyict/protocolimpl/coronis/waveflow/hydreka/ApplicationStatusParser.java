...
public class ApplicationStatusParser {
    ...
    public List<MeterEvent> getMeterEvents(int status) throws IOException {
        ...
        if (applicationStatus.isLeakage()) {
            ...
            meterEvents.add(new MeterEvent(eventTimeStamp, MeterEvent.OTHER, EventStatusAndDescription.EVENTCODE_LEAKAGE_RESIDUAL_START_A, "Leakage detected" + addOriginNotion()));
        }
