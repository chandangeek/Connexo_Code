...
public class ResponseReceiver {
	...
	protected Response receiveResponse(Command command, long timeoutEnq) throws IOException {
		...
		//System.out.println("protocolTimeout = " + protocolTimeout);
        ...
        int kar;
        int commIdByteCount = 0, dataLength = 0, startAddressByteCount = 0, 
        datalengthByteCount = 0, datalengthValue = 0, dataBytesRead = 0, 
        crcByteCount = 0, statusAddressCount = 0;
