...
public class RadioCommandFactory {
    ...
    public RadioCommandFactory(RTM rtm, PropertySpecService propertySpecService, NlsService nlsService) {
        this.rtm = rtm;
    ...
    public final FirmwareVersion readFirmwareVersion() throws IOException {
        if (firmwareVersion == null) {
            firmwareVersion = new FirmwareVersion(this.propertySpecService, rtm, this.nlsService);
            firmwareVersion.set();
        }
    ...
    public ReadTOUBuckets readTOUBuckets() throws IOException {
        ReadTOUBuckets touBuckets = new ReadTOUBuckets(this.propertySpecService, rtm, this.nlsService);
        touBuckets.set();
        return touBuckets;
    }
    ...
    public ExtendedDataloggingTable getMostRecentRecord() throws IOException {
        ExtendedDataloggingTable mostRecentRecord = new ExtendedDataloggingTable(this.propertySpecService, rtm, 1, 1, 0, this.nlsService);
        mostRecentRecord.set();
        return mostRecentRecord;
    }

    public ReadEncoderInternalData readEncoderInternalData() throws IOException {
        ReadEncoderInternalData internalData = new ReadEncoderInternalData(this.propertySpecService, rtm, this.nlsService);
        internalData.set();
        return internalData;
    }
    ...
    public CurrentRegisterReading readCurrentRegister() throws IOException {
        if (registerReading == null) {
            registerReading = new CurrentRegisterReading(this.propertySpecService, rtm, this.nlsService);
            registerReading.set();
        }
    ...
    public void writeIndex(int value, int port) throws IOException {
        if (rtm.getParameterFactory().readProfileType().isPulse()) {
            WriteIndexes writeIndexes = new WriteIndexes(rtm, port, this.propertySpecService, this.nlsService);
    ...
    public final ExtendedDataloggingTable readExtendedDataloggingTable(int portNr, final int nrOfValues, final Date toDate) throws IOException {
        ExtendedDataloggingTable table = new ExtendedDataloggingTable(this.propertySpecService, rtm, portNr, nrOfValues, toDate, this.nlsService);
        table.set();
        return table;
    }
    ...
    public final ExtendedDataloggingTable readExtendedDataloggingTable(int portNr, final int nrOfValues, final int offset) throws IOException {
        ExtendedDataloggingTable table = new ExtendedDataloggingTable(this.propertySpecService, rtm, portNr, nrOfValues, offset, this.nlsService);
        table.set();
        return table;
    }
    ...
    public final ExtendedDataloggingTable readExtendedDataloggingTable(int portMask, int numberOfReadings) throws IOException {
        cachedExtendedDataloggingTable = new ExtendedDataloggingTable(this.propertySpecService, rtm, portMask, numberOfReadings, this.nlsService);
    ...
    public final LeakageEventTable readLeakageEventTable() throws IOException {
        LeakageEventTable leakageEventTable = new LeakageEventTable(this.propertySpecService, rtm, this.nlsService);
        leakageEventTable.set();
        return leakageEventTable;
    }

    public void configureRoute() throws IOException {
        RouteConfiguration routeConfiguration = new RouteConfiguration(this.propertySpecService, rtm, this.nlsService);
    ...
    public final DailyConsumption readDailyConsumption() throws IOException {
        DailyConsumption dailyConsumption = new DailyConsumption(this.propertySpecService, rtm, this.nlsService);
    ...
    public boolean openWaterValve() throws IOException {
        ...
        if (profileType.isValve()) {
            OpenWaterValveCommand openWaterValveCommand = new OpenWaterValveCommand(rtm, this.propertySpecService, this.nlsService);
    ...
    public boolean closeWaterValve() throws IOException {
        ProfileType profileType = rtm.getParameterFactory().readProfileType();
        if (profileType.isValve()) {
            CloseWaterValveCommand closeWaterValveCommand = new CloseWaterValveCommand(rtm, this.propertySpecService, this.nlsService);
    ...
    public boolean cleanWaterValve() throws IOException {
        ProfileType profileType = rtm.getParameterFactory().readProfileType();
        if (profileType.isValve()) {
            CleanWaterValveCommand cleanWaterValveCommand = new CleanWaterValveCommand(this.propertySpecService, rtm, this.nlsService);
    ...
    public ValveStatus readValveStatus() throws IOException {
        ValveStatus status = new ValveStatus(rtm, this.propertySpecService, this.nlsService);
        status.set();
        return status;
    }
    ...
    public RSSILevel readRSSI() throws IOException {
        if (rssiLevel == null) {
            rssiLevel = new RSSILevel(this.propertySpecService, rtm, this.nlsService);
            rssiLevel.set();
        }
        return rssiLevel;
    }
    ...
    public void detectEncoderModel() throws IOException {
        encoderModel = new EncoderModelDetection(this.propertySpecService, rtm, this.nlsService);
        encoderModel.set();
    }
