...
public class BasicEventLog {
    ...
    protected BasicEvent getBasicEvent(AbstractDataType abstractEventData) throws IOException {
        try {
    ...
    protected Array getEventArray(Calendar from) throws IOException {
