 ...
 * Time: 14:29:16
 */
public class MaintenanceCategory extends AbstractUnsignedBINObject {
    ...
    protected String parseSymbol(CTRObjectID id) {
        ...
        switch(id.getY()) {
            case 0: symbol = "Data";
            case 1: symbol = "Data_CV";
            case 2: symbol = "Data_DS";
            case 4: symbol = "Data_CN";
            case 5: switch(id.getZ()) {
                case 0: symbol = "TresBatt";
                case 1: symbol = "OuBatt";
                case 2: symbol = "VoltBatt";
            }
            case 6: symbol = "Data_MC";
        }
        return symbol;
    }
    ...
    public Unit parseUnit(CTRObjectID id, int valueNumber) {
        ...
        switch(id.getY()) {
            ...
            case 5:
                ...
                if (z == 2) {unit = Unit.get(BaseUnit.VOLT);}
        }
        return unit;
