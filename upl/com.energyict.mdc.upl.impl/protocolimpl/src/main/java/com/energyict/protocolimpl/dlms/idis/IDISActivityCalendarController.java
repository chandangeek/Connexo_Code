 ...
 * Time: 16:49
 */
public class IDISActivityCalendarController implements ActivityCalendarController {
    ...
    public IDISActivityCalendarController(IDIS idis) {
        this.protocol = idis;
    ...
    protected ActivityCalendar getActivityCalendar() throws IOException {
        return protocol.getCosemObjectFactory().getActivityCalendar(ACTIVITY_CALENDAR_OBISCODE);
    }


    protected SpecialDaysTable getSpecialDayTable() throws IOException {
        return protocol.getCosemObjectFactory().getSpecialDaysTable(SPECIAL_DAYS_TABLE_OBISCODE);
    }
