 ...
 * @author kvds
 */
public class PLCCMeterMinimumVoltage extends AbstractPLCCObject {
    
    private ScalerUnit scalerUnit = new ScalerUnit(0, Unit.get("V"));
    private BigDecimal value=null;
    
    /** Creates a new instance of PLCCMeterMinimumVoltage */
    public PLCCMeterMinimumVoltage(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    
    protected ObjectIdentification getId() {
        return new ObjectIdentification(ObisCode.fromString("1.0.12.34.0.255"), AbstractCosemObject.CLASSID_REGISTER);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterMinimumVoltage:\n");
