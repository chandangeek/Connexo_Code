...
public class LeakageFlowThreshold extends AbstractParameter {
    ...
    public LeakageFlowThreshold(PropertySpecService propertySpecService, RTM rtm, NlsService nlsService) {
        super(propertySpecService, rtm, nlsService);
    }

    public LeakageFlowThreshold(PropertySpecService propertySpecService, RTM rtm, int thresholdType, int input, NlsService nlsService) {
        super(propertySpecService, rtm, nlsService);
