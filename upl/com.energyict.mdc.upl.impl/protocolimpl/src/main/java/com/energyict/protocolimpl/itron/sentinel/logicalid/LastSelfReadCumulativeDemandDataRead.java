 ...
 * @author Koen
 */
public class LastSelfReadCumulativeDemandDataRead extends AbstractDataRead {
    ...
    public LastSelfReadCumulativeDemandDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("LastSelfReadCumulativeDemandDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_CUMS_RATE_G").getId()};
