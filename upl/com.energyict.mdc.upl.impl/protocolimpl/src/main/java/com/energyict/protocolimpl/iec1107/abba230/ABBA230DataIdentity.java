...
public class ABBA230DataIdentity {
    ...
    protected void writeRawRegister(int packet, String value) throws IOException {
    ...
    protected void writeRawRegisterHex(int packet, String value) throws IOException {
