...
public class ObisCodeMapper {
    ...
    public RegisterInfo getRegisterInfo(ObisCode obisCode) throws IOException {
    	...
    	if (obisCode.equals(ObisCode.fromString("0.0.96.1.0.255"))) return new RegisterInfo("firmware version");
    	if (obisCode.equals(ObisCode.fromString("0.0.96.2.0.255"))) return new RegisterInfo("operation mode");
    	if (obisCode.equals(ObisCode.fromString("0.0.96.3.0.255"))) return new RegisterInfo("application status");
    	if (obisCode.equals(ObisCode.fromString("0.0.96.4.0.255"))) return new RegisterInfo("alarm configuration");
    	if (obisCode.equals(ObisCode.fromString("0.0.96.5.0.255"))) return new RegisterInfo("RSSI level");

    	
		// special obis code to control the waveflow RTC
    	if (obisCode.equals(ObisCode.fromString("0.0.96.6.200.255"))) return new RegisterInfo("set the waveflow clock");    	
    	if (obisCode.equals(ObisCode.fromString("0.0.96.6.201.255"))) return new RegisterInfo("read the waveflow clock");    	
