 ...
 * @author kvds
 */
public class PLCCMeterTimeIntegralForSwellMeasurement extends AbstractPLCCObject {
    
    private ScalerUnit scalerUnit = new ScalerUnit(0, Unit.get("s"));
    private BigDecimal value=BigDecimal.valueOf(1);    
    
    /** Creates a new instance of PLCCTemplateObject */
    public PLCCMeterTimeIntegralForSwellMeasurement(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    
    protected ObjectIdentification getId() {
        return new ObjectIdentification(ObisCode.fromString("1.0.12.35.129.255"), AbstractCosemObject.CLASSID_REGISTER);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterTimeIntegralForSwellMeasurement:\n");
