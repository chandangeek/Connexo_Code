...
public class EventSurvey {
    ...
    private EventSurveyChannel[] loadSurveyChannels;
    ...
    public EventSurvey(CommandFactory commandFactory, int LoadSurveyNumber) throws IOException {
    ...
    private void init() throws IOException {
        ...
        setLoadSurveyChannels(new EventSurveyChannel[getNrOfChannels()]);
        ...
        for (int channel = 0; channel <  getLoadSurveyChannels().length; channel++) {
            EventSurveyChannel lsc = new EventSurveyChannel();
    ...
    public EventSurveyData readFile(Date from) throws IOException {
        EventSurveyData lsd = new EventSurveyData(this,from);
        return lsd;
    }
    ...
    public EventSurveyChannel[] getLoadSurveyChannels() {
        return loadSurveyChannels;
    }

    public void setLoadSurveyChannels(EventSurveyChannel[] loadSurveyChannels) {
