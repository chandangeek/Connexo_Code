...
import com.energyict.protocolimpl.modbus.flonidan.uniflo1200.parsers.UNIFLO1200EventInfoParser;
 ...
 *
 */
public class UNIFLO1200EventInfo {

	private static final int DEBUG 			= 1;
	
	private UNIFLO1200Profile loadProfile;
	private UNIFLO1200EventInfoParser profileInfoParser;
	...
	public UNIFLO1200EventInfo(UNIFLO1200Profile profile) throws IOException {
	...
	private void initProfileInfoParser() throws IOException {
		...
		profileInfoParser = new UNIFLO1200EventInfoParser(logIdxReg, logInfoReg, logSizeReg, logWidthReg, logEepromReg, this);
	...
	private UNIFLO1200EventInfoParser getProfileInfoParser() {
