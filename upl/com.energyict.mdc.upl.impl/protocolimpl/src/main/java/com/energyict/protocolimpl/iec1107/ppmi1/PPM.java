...
MeterExceptionInfo, RegisterProtocol {
    ...
    final static int PD_IEC1107_COMPAT = 0;
    final static String PD_OPUS = "1";
    final static String PD_PASSWORD = "--------";
    ...
    private final String[] REGISTERCONFIG = {"TotalImportKwh",
    "TotalExportKwh", "TotalImportKvarh", "TotalExportKvarh",
    "TotalKvah"};
    ...
    public void connect() throws IOException {
        try {
            ...
            rFactory = new RegisterFactory(this, this );
    ...
    public void setTime() throws IOException {
        ...
        if (isOpus()) {
            ...
            try {
                rFactory.setRegister(RegisterFactory.R_TIME_ADJUSTMENT_RS232, sysCalendar
                .getTime());
