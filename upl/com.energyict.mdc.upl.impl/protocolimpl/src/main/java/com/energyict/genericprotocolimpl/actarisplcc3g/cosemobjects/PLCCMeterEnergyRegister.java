 ...
 * @author kvds
 */
public class PLCCMeterEnergyRegister extends AbstractPLCCObject {
    
    private int tariff; // 0 = overall, 1..n = tariff
    private ScalerUnit scalerUnit = new ScalerUnit(1, Unit.get("Wh"));
    private BigDecimal value=null;
    
    /** Creates a new instance of PLCCTemplateObject */
    public PLCCMeterEnergyRegister(PLCCObjectFactory objectFactory) {
        super(objectFactory);
    }
    
    protected ObjectIdentification getId() {
        return new ObjectIdentification(ObisCode.fromString("1.0.1.8."+getTariff()+".255"), AbstractCosemObject.CLASSID_REGISTER);
    }
    ...
    public String toString() {
        ...
        strBuff.append("PLCCMeterEnergyRegister:\n");
