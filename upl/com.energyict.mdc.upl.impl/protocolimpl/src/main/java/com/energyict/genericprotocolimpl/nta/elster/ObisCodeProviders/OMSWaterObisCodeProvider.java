...
public class OMSWaterObisCodeProvider implements MbusObisCodeProvider{
    ...
    private static final ObisCode masterValue2 = ObisCode.fromString("8.1.1.0.2.255");
    private static final ObisCode masterValue3 = ObisCode.fromString("8.1.1.0.3.255");
    private static final ObisCode masterValue4 = ObisCode.fromString("8.1.1.0.4.255");
