...
public class Register {
    ...
    public Register(int address, ObisCode obisCode) {
        this(address, FORMAT_IEEE_32BIT_FP, obisCode, obisCode.toString());
    }
    ...
    public Register(int address, int format, ObisCode obisCode) {
        this(address, format, obisCode, obisCode.toString());
    }
    ...
    public String toString() {
        ...
        return ("Register: 0x" + Integer.toHexString(getAddress()) + ", " + getDescription() + ", " + getObisCode() + "\n");
    }
