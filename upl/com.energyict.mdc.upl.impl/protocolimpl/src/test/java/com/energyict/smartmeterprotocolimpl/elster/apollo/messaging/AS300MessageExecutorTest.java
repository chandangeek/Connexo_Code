...
public class AS300MessageExecutorTest {
    ...
    public void testExecuteMessageEntry() throws Exception {
        ...
        AS300 protocol = new AS300(messageFileFinder, messageFileExtractor, propertySpecService);
        ...
        AS300MessageExecutor mExecutor = new AS300MessageExecutor(protocol, messageFileFinder, messageFileExtractor);
