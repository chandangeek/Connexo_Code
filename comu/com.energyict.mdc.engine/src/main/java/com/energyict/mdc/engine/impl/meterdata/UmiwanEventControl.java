...
public class UmiwanEventControl extends CollectedDeviceData implements CollectedMessage {

    private MessageIdentifier messageIdentifier;
    private DeviceMessageStatus deviceMessageStatus;
    private Date startDate;
    private long controlFlags;
    private long acknowledgeFlags;
    private String deviceProtocolInformation;
    private DataCollectionConfiguration configuration;
    private Instant sentDate;

    public UmiwanEventControl(MessageIdentifier messageIdentifier, Date startDate, long controlFlags, long acknowledgeFlags) {
