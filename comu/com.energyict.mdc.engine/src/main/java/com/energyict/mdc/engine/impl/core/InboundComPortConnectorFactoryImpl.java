...
public class InboundComPortConnectorFactoryImpl implements InboundComPortConnectorFactory {
    ...
    public InboundComPortConnectorFactoryImpl(SerialComponentService serialComponentService, SocketService socketService) {
        super();
    ...
    public InboundComPortConnector connectorFor(InboundComPort inboundComPort) {
        if (inboundComPort instanceof ModemBasedInboundComPort) {
            return new SerialPortConnector((ModemBasedInboundComPort) inboundComPort, this.serialComponentService);
        }
