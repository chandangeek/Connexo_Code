...
public enum MessageSeeds implements MessageSeed {
    ...
    MAXIMUM_TIME_DIFFERENCE_EXCEEDED(5036, "maxTimeDiffExceeded", "Time difference of the device exceeds the configured maximum of {0}: The difference between the clock of the device and the clock of the communication server is {1}"),
