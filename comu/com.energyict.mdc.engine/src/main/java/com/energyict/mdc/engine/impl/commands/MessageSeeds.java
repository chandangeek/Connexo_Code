...
public enum MessageSeeds implements MessageSeed {
    ...
    COMMAND_FAILED_DUE_TO_CONNECTION_RELATED_ISSUE(5054, "commandFailedDueToConnectionRelatedIssue", "Communication task failed due to connection related error: {0}"),
    NOT_EXECUTED_DUE_TO_BASIC_CHECK_FAILURE(5055, "notExecutedDueToBasicCheckFailure", "Communication task will be rescheduled due to the failure of the BasicCheck task"),
