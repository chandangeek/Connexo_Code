...
public interface ComPortDiscoveryLogger {
     ...
     *
     * @param discoveryProtocolClassName The class name of the {@link InboundDeviceProtocol}
     * @param comPort The {@link InboundComPort} on which the communication was started
     */
