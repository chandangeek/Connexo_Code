...
public abstract class ComChannelBasedComPortListenerImpl extends ComPortListenerImpl {
    ...
    protected ComChannelBasedComPortListenerImpl(RunningComServer runningComServer, InboundComPort comPort, DeviceCommandExecutor deviceCommandExecutor, ServiceProvider serviceProvider) {
