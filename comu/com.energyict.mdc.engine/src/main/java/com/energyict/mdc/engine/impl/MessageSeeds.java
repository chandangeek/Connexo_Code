...
public enum MessageSeeds implements MessageSeed {
    ...
    LOG_ON_FAILED(112, Keys.LOG_ON_FAILED, "Could not log on the device", Level.SEVERE),
    INVALID_INBOUND_SERVLET_PROTOCOL(113, Keys.INVALID_INBOUND_SERVLET_PROTOCOL, "Inbound protocol ''{0}'', that is linked to the inbound servlet port, should support servlet communication", Level.SEVERE),
    FAILED_TO_FETCH_DEVICE_OWNING_SECURITY_PROPERTY_SET(114, Keys.FAILED_TO_FETCH_DEVICE_OWNING_SECURITY_PROPERTY_SET, "Failed to fetch the device owning security property set {0}", Level.SEVERE);
