...
public enum MessageSeeds implements MessageSeed, com.energyict.mdc.upl.nls.MessageSeed {
    ...
    WEBSOCKET_CLOSED(118, Keys.TIMEOUT_WEBSOCKET_ERROR, "Websocket closed. Reconnect, please.", Level.SEVERE);
    ...
    public static class Keys {
        ...
        public static final String TIMEOUT_WEBSOCKET_ERROR = "timeoutWebSocketError";
    }
}