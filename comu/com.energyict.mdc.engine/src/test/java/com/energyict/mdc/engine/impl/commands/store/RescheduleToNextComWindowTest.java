...
public class RescheduleToNextComWindowTest extends TestCase {
    private static final ComWindow COM_WINDOW = new ComWindow(PartialTime.fromSeconds(DateTimeConstants.SECONDS_PER_HOUR * 15),
            PartialTime.fromSeconds(DateTimeConstants.SECONDS_PER_HOUR * 20));
    @Mock
    private RescheduleToNextComWindow reschedule;
    ...
    public void testRescheduleWithStartingPointInThePast() {
        ...
        Instant scheduledTime = reschedule.getComWindowAppliedStartDate(COM_WINDOW, startPoint);
    ...
    public void testRescheduleWithStartingPointInWindowButInFuture() {
        ...
        assertEquals(startPoint, scheduledTime);
    }
}
