...
public class PreStoreLoadProfileTest extends AbstractCollectedDataIntegrationTest {
    ...
    public void setUp() {
        ...
        when(this.identificationService.createDeviceIdentifierForAlreadyKnownDevice(any(), "testmruID")).thenAnswer(invocationOnMock -> new DeviceIdentifierForAlreadyKnownDevice((Device) invocationOnMock.getArguments()[0] ));
    ...
    public void testLinkedDataLoggerWithTwoSlavesButFirstOnlyAtEnd() {
        ...
        Device slave2 = slaveDeviceCreator2
                ...
                .loadProfileTypes(loadProfileTypeSlave2)
                .create(Instant.ofEpochMilli(fromClock.getTime()));
        when(this.deviceService.findDeviceByIdentifier(new DeviceIdentifierForAlreadyKnownDevice(slave1))).thenReturn(Optional.of(slave2));
