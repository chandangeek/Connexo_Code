...
public class LogBookIdentifierByIdImplTest {
    ...
    public void testLogBookDoesNotExist() {
        ...
        // Business method
        new LogBookIdentifierById(LOGBOOK_ID, ObisCode.fromString("1.1.1.1.1.1")).getLogBook();
    ...
    public void testOnlyOneLogBook() {
        ...
        // Business method
        LogBook returnedLogBook = new LogBookIdentifierById(LOGBOOK_ID, ObisCode.fromString("1.1.1.1.1.1")).getLogBook();
    ...
    public void testEquals() {
        LogBookIdentifier identifier_A = new LogBookIdentifierById(LOGBOOK_ID, ObisCode.fromString("1.1.1.1.1.1"));
        LogBookIdentifier identifier_B = new LogBookIdentifierById(LOGBOOK_ID, ObisCode.fromString("1.1.1.1.1.1"));
    ...
    public void testNotEquals() {
        LogBookIdentifier identifier_A = new LogBookIdentifierById(LOGBOOK_ID, ObisCode.fromString("1.1.1.1.1.1"));
        LogBookIdentifier identifier_B = new LogBookIdentifierById(LOGBOOK_2_ID, ObisCode.fromString("1.1.1.1.1.1"));
