...
public class CollectedDeviceCacheCommandTest {
    ...
    public void updateWithoutChangeTest() throws BusinessException, SQLException {
        ...
        CollectedDeviceCacheCommand deviceCacheCommand = new CollectedDeviceCacheCommand(updatedDeviceCache, issueService);
    ...
    public void testToJournalMessageDescription() {
        ...
        CollectedDeviceCacheCommand command = new CollectedDeviceCacheCommand(updatedDeviceCache, issueService);
