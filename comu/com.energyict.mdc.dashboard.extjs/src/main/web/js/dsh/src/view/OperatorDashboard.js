        ...
        if (Isu.privileges.Issue.canViewAdminDevice() ||
            ...
            if (Dal.privileges.Alarm.canViewAdmimAlarm()) {
                var item = {
                    ...
                    assignedToMeLink: me.router.getRoute('workspace/alarms').buildUrl({}, {myopenalarms: true, status: ['status.open', 'status.in.progress']}),
                    myWorkgroupsLink: me.router.getRoute('workspace/alarms').buildUrl({}, {myworkgroupalarms: true, status: ['status.open', 'status.in.progress']}),
                    userProperty: 'userAssignee',
                    titleProperty: 'title',
                    workgroupProperty: 'workgroup',
                    tooltipProperties: [
