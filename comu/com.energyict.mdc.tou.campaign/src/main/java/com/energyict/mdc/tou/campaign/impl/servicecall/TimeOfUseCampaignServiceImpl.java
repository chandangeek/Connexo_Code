...
import com.energyict.mdc.tou.campaign.impl.ServiceCallTypeUpgrader;
...
public class TimeOfUseCampaignServiceImpl implements TimeOfUseCampaignService, MessageSeedProvider, TranslationKeyProvider {
    ...
    public void activate(BundleContext bundleContext) {
        ...
        upgradeService.register(InstallIdentifier.identifier("MultiSense", COMPONENT_NAME), dataModel, Installer.class, ImmutableMap.of(Version.version(10, 7), ServiceCallTypeUpgrader.class));
