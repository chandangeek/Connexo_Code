...
public enum MessageSeeds implements MessageSeed {
    ...
    DEVICES_HAVENT_ADDED_BECAUSE_DIFFERENT_TYPE(2004, "DevicesHaventAddedBecauseDifferentType", "''{0}'' devices haven''t added to the campaign because they are of a different type."),
    DEVICES_HAVENT_ADDED_BECAUSE_PART_OTHER_CAMPAIGN(2005, "DevicesHaventAddedBecausePartOtherCampaign", "''{0}'' devices haven''t added to the campaign because they are a part of another ongoing campaign."),
    DEVICES_HAVENT_ADDED_BECAUSE_HAVE_THIS_CALENDAR(2006, "DevicesHaventAddedBecauseHaveThisCalendar", "''{0}'' devices haven''t added to the campaign because they already have this calendar."),
