...
public enum MessageSeeds implements MessageSeed {
    ...
    DEVICE_GROUP_ISNT_FOUND(1004, "DeviceGroupIsntFound", "Device group ''{0}'' is''nt found."),
    DEVICE_WITH_METER_ID_ISNT_FOUND(1005, "DeviceWithMeterIdIsntFound", "Device with meter id ''{0}'' isn''t found."),
    DEVICE_WITH_ID_ISNT_FOUND(1006, "DeviceWithIdIsntFound", "Device with id ''{0}'' is''nt found."),
    ...
    DEVICE_DOESNT_CONTAIN_COMTASK_FOR_CALENDARS_OR_CONTAINS_ONLY_WRONG(2002, "DeviceDoesntContainsCommunicationTaskForCalendarsOrContainsOnlyWrong", "Device doesn''t contain a communication task for calendars or contains only wrong ones."),
    DEVICE_DOESNT_CONTAIN_VERIFICATION_TASK_FOR_CALENDARS_OR_CONTAINS_ONLY_WRONG(2003, "DeviceDoesntContainsVerificationTaskForCalendarsOrContainsOnlyWrong", "Device doesn''t contain verification task for calendars or contains only wrong."),
    ...
    ACTIVE_VERIFICATION_TASK_ISNT_FOUND(2016, "ActiveVerificationTaskIsntFound", "Active verification task is''nt found."),
    ...
    TOU_ITEM_WITH_ID_NOT_FOUND(2020, "TimeOfUseItemWithIdNotFound", "Time of use item with id {0} not found."),
