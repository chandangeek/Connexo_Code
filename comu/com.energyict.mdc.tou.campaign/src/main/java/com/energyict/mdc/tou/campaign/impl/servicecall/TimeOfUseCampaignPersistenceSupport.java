...
public class TimeOfUseCampaignPersistenceSupport implements PersistenceSupport<ServiceCall, TimeOfUseCampaignDomainExtension> {
    ...
    public void addCustomPropertyColumnsTo(Table table, List<Column> customPrimaryKeyColumns) {
        ...
        table.column(TimeOfUseCampaignDomainExtension.FieldNames.VALIDATION_COMTASK_ID.databaseName())
                ...
                .add();
        table.column(TimeOfUseCampaignDomainExtension.FieldNames.SEND_CALENDAR_CONNECTIONSTRATEGY_ID.databaseName())
                .number()
                .conversion(ColumnConversion.NUMBER2LONG)
                .map(TimeOfUseCampaignDomainExtension.FieldNames.SEND_CALENDAR_CONNECTIONSTRATEGY_ID.javaName())
                .add();
        table.column(TimeOfUseCampaignDomainExtension.FieldNames.VALIDATION_CONNECTIONSTRATEGY_ID.databaseName())
                .number()
                .conversion(ColumnConversion.NUMBER2LONG)
                .map(TimeOfUseCampaignDomainExtension.FieldNames.VALIDATION_CONNECTIONSTRATEGY_ID.javaName())
                .add();
