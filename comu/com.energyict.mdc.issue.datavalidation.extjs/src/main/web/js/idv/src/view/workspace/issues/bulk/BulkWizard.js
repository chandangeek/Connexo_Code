Ext.define('Idv.view.workspace.issues.bulk.BulkWizard', {
    extend: 'Idv.view.workspace.issues.bulk.Wizard',
    ...
    requires: [
        'Idv.view.workspace.issues.bulk.Step1',
        'Idv.view.workspace.issues.bulk.Step2',
        'Idv.view.workspace.issues.bulk.Step3',
        'Idv.view.workspace.issues.bulk.Step4',
        'Idv.view.workspace.issues.bulk.Step5'
    ],
