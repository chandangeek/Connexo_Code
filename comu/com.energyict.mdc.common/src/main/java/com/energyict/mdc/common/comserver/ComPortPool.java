...
/**
 * Models a collection of {@link ComPort}s with similar characteristics.
...
public interface ComPortPool extends HasId, HasName {
    ...
    /**
     * Gets the {@link ComPortType type} of {@link ComPort}s
    ...
    long getPctHighPrioTasks();
    void setPctHighPrioTasks(long pctHighPrioTask);
}