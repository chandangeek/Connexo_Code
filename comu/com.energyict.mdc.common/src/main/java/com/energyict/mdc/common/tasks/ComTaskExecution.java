...
public interface ComTaskExecution extends HasId, DataCollectionConfiguration {
     ...
     * {@link com.energyict.mdc.common.scheduling.ComSchedule}
    ...
    /**
     * Checks if this ComTaskExecution will be executed with regular or high priority</br>
     ...
     */
    boolean shouldExecuteWithPriority();
