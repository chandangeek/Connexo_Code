...
public enum DeviceMessageId {
    ...
    /* Full calendar = Combining an activity calendar with special day calendar */
    ACTIVITY_CALENDER_FULL_CALENDAR_SEND(19),
    ACTIVITY_CALENDER_FULL_CALENDAR_WITH_DATETIME(20),
    ACTIVITY_CALENDER_FULL_CALENDAR_WITH_DATETIME_AND_TYPE(21),
    ACTIVITY_CALENDER_FULL_CALENDAR_WITH_DATE(22),
    ACTIVITY_CALENDER_FULL_CALENDAR_WITH_DATETIME_AND_CONTRACT(23),
    ...
    PUSH_SETUP_NOTIFICATION_TYPE(2020),
    ...
    RENEW_GMK(3093),
    WRITE_GMK_SCHEDULE_EXECUTION_TIME(3094),
    WRITE_MAC_TONE_MASK(3095),
    WRITE_G3_PLC_BANDPLAN(3096),
    WRITE_ADP_LQI_RANGE(3097),
    ...
    ADD_ROUTING_ENTRY(4055),
    REMOVE_ROUTING_ENTRY(4056),
    RESET_ROUTER(4057),
    SET_VPN_ENABLED_OR_DISABLED(4058),
    SET_VPN_TYPE(4059),
    SET_VPN_GATEWAY_ADDRESS(4060),
    SET_VPN_AUTHENTICATION_TYPE(4061),
    SET_VPN_LOCAL_IDENTIFIER(4062),
    SET_VPN_REMOTE_IDENTIFIER(4063),
    //    SET_LOCAL_CERTIFICATE(4064) //THIS IS READ-ONLY ATM,
    SET_VPN_REMOTE_CERTIFICATE(4065),
    SET_VPN_SHARED_SECRET(4066),
    SET_VPN_VIRTUAL_IP_ENABLED_OR_DISABLED(4067),
    SET_VPN_IP_COMPRESSION_ENABLED_OR_DISABLED(4068),
    REFRESH_VPN_CONFIG(4069),
    ADD_ROUTING_ENTRY_USING_CONFIGURED_IPV6_IN_GENERAL_PROPERTIES(4070),
    CHANGE_SNMP_AGENT_CONFIGURATION(4071),
    CHANGE_SNMP_AGENT_USER_NAME(4072),
    CHANGE_SNMP_AGENT_USER_PASSPHRASES(4073),
    ENABLE_SNMP_USER_PROFILE(4074),
    ...
    CHANGE_SIM_PIN(4079),
    WRITE_PUSH_SCHEDULER(4080),
    WRITE_PUSH_SETUP(4081),
    WRITE_ORPHAN_STATE_THRESHOLD(4082),
    CHANGE_NETWORK_TIMEOUT(4083),
    NETWORK_CONNECTIVITY_CHANGE_NBIOT_APN_CREDENTIALS(4084),
    CHANGE_PPP_AUTHENTICATION_PAP(4085),
    CHANGE_PPP_AUTHENTICATION_PAP_TO_NULL(4086),
    ...
    FIRMWARE_UPGRADE_MULTICAST_FIRMWARE_UPGRADE_KSMW(5020),
    ...
    FIRMWARE_IMAGE_ACTIVATION_WITH_DATA_PROTECTION(5028),
    ...
    ENABLE_AND_INITIATE_IMAGE_TRANSFER(5033),
    CONFIGURABLE_IMAGE_TRANSFER_WITH_RESUME_OPTION(5034),
    ...
    IMPORT_CLIENT_END_DEVICE_CERTIFICATE(7051),
    ...
    SECURITY_KEY_RENEWAL(7064),
    UPDATE_CRL(7065),
    REMOVE_CRL(7066),
    UPDATE_DEVICE_CRL_USING_TRUSTED_CERT_CRL(7067),
    CHANGE_AUTHENTICATION_KEY_USING_SERVICE_KEY_AND_NEW_PLAIN_KEY_FOR_PREDEFINED_CLIENT(7068),
    CHANGE_ENCRYPTION_KEY_USING_SERVICE_KEY_AND_NEW_PLAIN_KEY_FOR_PREDEFINED_CLIENT(7069),
    CHANGE_AUTHENTICATION_KEY_USING_SERVICE_KEY_AND_NEW_PLAIN_KEY_FOR_CLIENT(7070),
    CHANGE_ENCRYPTION_KEY_USING_SERVICE_KEY_AND_NEW_PLAIN_KEY_FOR_CLIENT(7071),
    CHANGE_PSK_WITH_NEW_KEYS(7072),
    CHANGE_PSK_USING_SERVICE_KEY(7073),
    EXPORT_ALL_DEVICE_CERTIFICATES(7074),
    CHANGE_PSK_KEK(7075),
    MBUS_TRANSFER_FUAK(7076),
    CHANGE_HLS_SECRET_USING_SERVICE_KEY_PROCESS(7077),
    CHANGE_AUTHENTICATION_KEY_USING_SERVICE_KEY_PROCESS(7078),
    CHANGE_ENCRYPTION_KEY_USING_SERVICE_KEY_PROCESS(7079),
    KEY_RENEWAL_EI6_7(7080),
    ...
    ReadDLMSAttribute(8065),
    SetCTVTRatios(8066),
    ProgramPulseInputParametersAndConstants(8067),
    ResetLogicalDevice(8068),
    FETCH_LOGGING(8069),
    SET_REMOTE_SYSLOG_CONFIG(8070),
    BillingDateConfiguration(8071),
    SET_MODEM_RESET_SCHEDULE(8072),
    LimitationActionDelay(8073),
    LimitationQuanityMeasure(8074),
    ...
    DISPLAY_GENERAL_PARAMETERS(10007),
    DISPLAY_READOUT_TABLE_PARAMETERS(10008),

    GENERAL_WRITE_RAW_IEC1107_CLASS(11001),
    GENERAL_WRITE_FULL_CONFIGURATION(11002),
    GENERAL_SEND_XML_MESSAGE(11003),
    GENERAL_SET_PSK(11004),
    RESET_FOTA(11005),
    SWITCH_BACK_PREVIOUS_FIRMWARE(11006),
    ...
    SET_CURRENT_OVER_LIMIT_THRESHOLD(12024),
    SET_CURRENT_OVER_LIMIT_TIME_THRESHOLD(12025),
    SET_VOLTAGE_UNDER_LIMIT_THRESHOLD(12026),
    SET_VOLTAGE_UNDER_LIMIT_TIME_THRESHOLD(12027),
    SET_LIPF_UNDER_LIMIT_THRESHOLD(12028),
    SET_LIPF_UNDER_LIMIT_TIME_THRESHOLD(12029),
    UPDATE_LOAD_LIMITS(12030),
    ...
    CONFIGURE_CAPTURE_DEFINITION(13014),
    CONFIGURE_CAPTURE_PERIOD(13015),
    ...
    POWER_CONFIGURATION_SET_POWER_QUALITY_MEASURE_PERIOD(26009),
    POWER_CONFIGURATION_SET_VOLTAGE_AND_CURRENT(26010),
    POWER_CONFIGURATION_SET_VOLTAGE_RATIO_NUMERATOR(26011),
    POWER_CONFIGURATION_SET_CURRENT_RATIO_NUMERATOR(26012),
    ...
    SET_NTP_ACTIVATED(31091),
    SET_NTP_AUTHENTICATION_METHOD(31092),
    ADD_NTP_AUTHENTICATION_KEY(31093),
    DELETE_NTP_AUTHENTICATION_KEY(31094),
    IMPORT_CONFIGURATION(31095),
    EXPORT_CONFIGURATION(31096),
    SET_ENGINEER_PIN_4DIGITS_NO_TIMEOUT(31097),
    SPECIAL_DAY_CSV_STRING(31098),
    GAS_DAY_CONFIGURATION(31099),
    WRITE_CONFIGURATION_TEXT(31100),
    ...
    UPLINK_CONFIGURATION_WRITE_MAX_INACTIVE_UPLINK(36005),
    ...
    UPDATE_CREDIT_AMOUNT(40001),
    UPDATE_MONEY_CREDIT_THRESHOLD(40011),
    UPDATE_CONSUMPTION_CREDIT_THRESHOLD(40012),
    UPDATE_TIME_CREDIT_THRESHOLD(40013),
    UPDATE_CREDIT_DAYS_LIMIT(40014),

    ACTIVATE_PASSIVE_UNIT_CHARGE(41001),
    CHANGE_UNIT_CHARGE_PASSIVE_WITH_ACTIVATION(41002),
    CHANGE_UNIT_CHARGE_PASSIVE_WITH_ACTIVATION_DATE(41003),
    UPDATE_UNIT_CHARGE(41004),
    CHANGE_CHARGE_PERIOD(41005),
    CHANGE_CHARGE_PROPORTION(41006),
    CHANGE_STEP_TARIFF(41007),
    CHANGE_TAX_RATE(41008),
    SWITCH_CHARGE_MODE(41009),
    SWITCH_TAX_AND_STEP_TARIFF(41010),
    FRIENDLY_DAY_PERIOD_UPDATE(41011),
    FRIENDLY_WEEKDAYS_UPDATE(41012),

    SET_UMIWAN_CONFIGURATION(42001),
    SET_UMIWAN_PROFILE_CONTROL(42002),
    SET_UMIWAN_EVENT_CONTROL(42003),
