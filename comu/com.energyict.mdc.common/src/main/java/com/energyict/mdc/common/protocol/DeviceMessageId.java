...
//    SET_LOCAL_CERTIFICATE(4064) //THIS IS READ-ONLY ATM,
    ...
    ACTIVATE_PASSIVE_UNIT_CHARGE(39001),
    CHANGE_UNIT_CHARGE_PASSIVE_WITH_ACTIVATION(39002),
    CHANGE_UNIT_CHARGE_PASSIVE_WITH_ACTIVATION_DATE(39003),
    UPDATE_UNIT_CHARGE(39004),
    CHANGE_CHARGE_PERIOD(39005),
    CHANGE_CHARGE_PROPORTION(39006);
