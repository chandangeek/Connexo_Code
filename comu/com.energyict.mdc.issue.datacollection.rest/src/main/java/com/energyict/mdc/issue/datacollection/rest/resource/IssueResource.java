...
public class IssueResource extends BaseResource {
    ...
    public Response getAllIssues(@BeanParam StandardParametersBean params) {
        ...
        Class<? extends Issue> apiClass = getQueryApiClass(params);

        Query<? extends Issue> query = getIssueService().query(apiClass, EndDevice.class, User.class, IssueReason.class,
                IssueStatus.class, AssigneeRole.class, AssigneeTeam.class, IssueType.class);
        Condition condition = getQueryCondition(params);
        List<? extends Issue> list = query.select(condition, params.getFrom(), params.getTo(), params.getOrder());
    ...
    public Response getGroupedList(@BeanParam StandardParametersBean params) {
        ...
        try (TransactionContext context = getTransactionService().getContext()) {
            ...
            builder.onlyGroupWithKey(params.getFirstLong(ID)) // Reason id
                    ...
                    .setGroupBy(params.getFirst(FIELD)) // Main grouping column
...
//        return ok(new IssueInfo<DeviceInfo>(issue.get(), DeviceInfo.class)).build();
    ...
    private Class<? extends Issue> getQueryApiClass(StandardParametersBean params){
        ...
        Class<? extends Issue> apiClass = Issue.class;
        if (isActual && !isHistorical) {
            apiClass = OpenIssue.class;
