...
@Component(name = "IssueLifecycleProcessAssociationProvider",
        service = {ProcessAssociationProvider.class, TranslationKeyProvider.class},
        property = "name=IssueLifecycleProcessAssociationProvider", immediate = true)
public class IssueLifecycleProcessAssociationProvider implements ProcessAssociationProvider, TranslationKeyProvider {
    ...
    //For OSGI purposes
    public IssueLifecycleProcessAssociationProvider() {
    }
