...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_SUCH_DEVICE(1, "NoSuchDevice", "No device with id ''{0}''."),
    ...
    DEVICE_ID_ATTRIBUTE_IS_NOT_SET(3, "DeviceIdAttributeIsNotSet", "'Device id' attribute is not set on Device SAP info CAS."),
