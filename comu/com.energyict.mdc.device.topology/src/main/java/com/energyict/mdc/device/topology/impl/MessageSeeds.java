...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    VALUE_IS_REQUIRED_KEY(1, Keys.VALUE_IS_REQUIRED_KEY, "A value is required for attribute {0}", Level.SEVERE),
    FIELD_TOO_LONG(2, Keys.FIELD_TOO_LONG, "The value {0} provided for attribute {1} is too long", Level.SEVERE),
    DEVICE_IS_STILL_LINKED_AS_PHYSICAL_GATEWAY(100, Keys.DEVICE_IS_STILL_LINKED_AS_PHYSICAL_GATEWAY, "You can not remove device {0} because it is still used as a physical gateway for {1}", Level.SEVERE),
