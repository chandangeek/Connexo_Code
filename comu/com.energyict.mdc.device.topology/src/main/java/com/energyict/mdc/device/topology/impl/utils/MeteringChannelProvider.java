...
/**
 * Getting the {@link com.elster.jupiter.metering.Channel} for a {@link }given com.energyict.mdc.device.data.Channel} or {@link Register}
...
public class MeteringChannelProvider {
    ...
    public Optional<Channel> getMeteringChannel(final com.energyict.mdc.common.device.data.Channel channel) {
        return channel.getDevice().getCurrentMeterActivation().map(meterActivation -> getMeteringChannel(channel, meterActivation));
    }

    public com.elster.jupiter.metering.Channel getMeteringChannel(final com.energyict.mdc.common.device.data.Channel channel, final MeterActivation meterActivation) {
