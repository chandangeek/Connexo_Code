...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    MODEM_COULD_NOT_RESTORE_DEFAULT_PROFILE(10, "modemRestoreDefaultProfileError", "Could not restore the default modem profile settings on COM port with name {0}, request [{1}], response [{2}]", Level.SEVERE),
    MODEM_COULD_NOT_SEND_INIT_STRING(11, "modemSendInitStringError", "Failed to write init string [{1}] to modem on COM port {0}, meter response [{2}]", Level.SEVERE),
    MODEM_COULD_NOT_INITIALIZE_COMMAND_STATE(12, "modemInitCommandStateError", "Failed to initialize the command state for modem on COM port {0}, meter response [{1}]", Level.SEVERE),
    AT_MODEM_BUSY(13, "atModemBusy", "Receiver was currently busy, modem on COM port {0} returned BUSY command, last command send [{1}]", Level.SEVERE),
    AT_MODEM_ERROR(14, "atModemError", "Most likely an invalid command has been sent, modem on COM port {0} returned ERROR command, last command send [{1}]", Level.SEVERE),
    AT_MODEM_NO_ANSWER(15, "atModemNoAnswer", "Receiver was not reachable, modem on COM port {0} returned NO_ANSWER command, last command send [{1}]", Level.SEVERE),
