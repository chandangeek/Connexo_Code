...
@Component(name = "com.energyict.mdc.device.data.importers." + DeviceDecommissioningImportFactory.NAME,
        ...
        immediate = true)
public class DeviceDecommissioningImportFactory extends AbstractDeviceDataFileImporterFactory {
    public static final String NAME = "DeviceDecommissioningImportFactory";
