...
class SsiInstaller implements FullInstaller {
    ...
    private void createDestinationAndSubscriber() {
        ...
        destinationSpec.subscribe(SecureDeviceShipmentImporterMessageHandler.SECURE_SHIPMENT_IMPORT_SUBSCRIBER,
                SecureDeviceShipmentImporterMessageHandler.COMPONENT_NAME, Layer.DOMAIN);
    }
