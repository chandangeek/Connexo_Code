...
public class DeviceLoadProfileNextReadingImportLogger extends FileImportLoggerImpl<DeviceLoadProfileNextReadingRecord> {
    ...
    public DeviceLoadProfileNextReadingImportLogger(DeviceDataImporterContext context) {
        super(context);
    }

    @Override
    public void importLineFailed(DeviceLoadProfileNextReadingRecord data, Exception exception) {
        super.importLineFailed(data, exception);
       // addReadingsFailed(data.getDeviceIdentifier(), data.getReadingTypes().size());  //lori
    }

    @Override
    public void importLineFinished(DeviceLoadProfileNextReadingRecord data) {
        super.importLineFinished(data);
       // addReadingsSuccess(data.getDeviceIdentifier(), data.getReadingTypes().size());  // lori
    }
