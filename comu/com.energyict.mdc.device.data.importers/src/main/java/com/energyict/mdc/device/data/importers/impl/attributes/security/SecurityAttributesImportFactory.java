...
public class SecurityAttributesImportFactory extends AbstractDeviceDataFileImporterFactory {
    ...
    @Inject
    public SecurityAttributesImportFactory(DeviceDataImporterContext context, SecurityManagementService securityManagementService) {
        super();
    ...
    public FileImporter createImporter(Map<String, Object> properties) {
        ...
        FileImportProcessor<SecurityAttributesImportRecord> processor = new SecurityAttributesImportProcessor(getContext(), securityManagementService);
