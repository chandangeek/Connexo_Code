...
public enum MessageSeeds implements MessageSeed {
    ...
    SCHEMA_FAILED(509, "SchemaFailedException", "XSD schema for secure device import could not be read.", Level.SEVERE),
    ...
    SHIPMENT_CERTIFICATE_UNTRUSTED(516, "ShipmentCertificateUntrusted", "Can''t process file: the certificate in the shipment file could not be trusted: {0}", Level.SEVERE),
    ...
    INVALID_SIGNATURE(519, "InvalidSignatureOnShipment", "Can't process file: the signature on the shipment file is not valid", Level.SEVERE),
    SIGNATURE_VALIDATION_FAILED(520, "FailedToValidateSignatureOnShipment", "Can''t process file: the signature on the shipment file could not be validated: {0}", Level.SEVERE),
    ...
    NO_PUBLIC_KEY_FOUND_FOR_SIGNATURE_VALIDATION(522, "NoKeyInShipment", "Can''t process file: the signature on the shipment file could not be validated: public key could not be found in the shipment file", Level.SEVERE),
    NO_SUCH_DEVICE_TYPE(523, "DeviceTypeNotFound", "Can''t process file: the device type ''{0}'' required by the importer could not be found", Level.SEVERE),
    ...
    FAILED_TO_STORE_MAC_ADDRESS(529, "FailedToStoreMacAddress", "MAC Address value could not be stored on device ''{0}''", Level.WARNING),
    ...
    NO_SUCH_KEY_ACCESSOR_TYPE_ON_DEVICE_TYPE(531, "NoSuchKeyAccessorTypeOnDeviceType", "Can''t process device ''{0}'': Security accessor ''{1}'' is not available on the device type.", Level.WARNING),
