...
public enum MessageSeeds implements MessageSeed {
    ...
    FAILED_TO_CREATE_CERTIFICATE(514, "FailedToCreateCertificate", "Failed to extract certificate from shipment file: {0}", Level.FINE),
    SHIPMENT_CERTIFICATE_UNTRUSTED(515, "ShipmentCertificateUntrusted", "Can''t process file: the certificate in the shipment file could not be trusted: {0}", Level.SEVERE),
    FAILED_TO_VERIFY_CERTIFICATE(516, "FailedToValidateCertificate", "Failed to validate certificate", Level.SEVERE),
    FAILED_TO_CREATE_PUBLIC_KEY(517, "FailedToExtractPublicKeyFromShipment", "Can''t process file: failed to extract the public key from the shipment file", Level.SEVERE),
    INVALID_SIGNATURE(518, "InvalidSignatureOnShipment", "Can't process file: the signature on the shipment file is not valid", Level.SEVERE),
    SIGNATURE_VALIDATION_FAILED(519, "FailedToValidateSignatureOnShipment", "Can''t process file: the signature on the shipment file could not be validated: {0}", Level.SEVERE),
    ...
    NO_PUBLIC_KEY_FOUND_FOR_SIGNATURE_VALIDATION(521, "NoKeyInShipment", "Can''t process file: the signature on the shipment file could not be validated: public key could not be found in the shipment file", Level.SEVERE),
    NO_SUCH_DEVICE_TYPE(522, "DeviceTypeNotFound", "Can''t process file: the device type ''{0}'' required by the importer could not be found", Level.SEVERE),
    NO_DEFAULT_DEVICE_CONFIG_FOUND(523, "NoDefaultDeviceConfigOnDeviceType", "Can''t process file: no default device configuration could be found for the device type", Level.SEVERE),
    DEFAULT_DEVICE_CONFIG_FOUND_NOT_ACTIVE(524, "DefaultConfigNotActive", "Can''t process file: the default device configuration is not active", Level.SEVERE),
