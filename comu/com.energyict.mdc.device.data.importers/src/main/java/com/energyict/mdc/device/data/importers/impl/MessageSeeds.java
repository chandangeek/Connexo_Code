...
public enum MessageSeeds implements MessageSeed {
    ...
    READING_DATE_INCORRECT_FOR_15_MINUTES_CHANNEL(215, "ReadingDateIncorrectForYearlyChannel", "Can''t process line {0}: Reading date is incorrect for reading type {1}. Reading date of 15 minutes reading must be 00 or 15 or 30 or 45 ({2}).", Level.WARNING),
