 ...
 * that are defined in {@link DeviceDataImporterMessageHandler} are acceptable and unique.
 */
public class TranslationKeysTest {
    ...
    public void testTranslationKeys() {
        ...
        for (TranslationKey entry : new DeviceDataImporterMessageHandler().getKeys()) {
