...
public class DeviceDataQualityServiceImpl implements DeviceDataQualityService {
    ...
    private volatile DataModel dataQualityKpiDataModel;
    ...
    public void setOrmService(OrmService ormService) {
        this.dataQualityKpiDataModel = ormService.getDataModel(DataQualityKpiService.COMPONENTNAME).orElseThrow(IllegalStateException::new);
    }
    ...
    DataQualityOverviews queryWith(DataQualityOverviewSpecificationImpl specification) {
        ...
        try (Connection connection = this.dataQualityKpiDataModel.getConnection(true);
