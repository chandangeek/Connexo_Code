    ...
    private void createTranslations() {
        try {
            ...
            for (MessageSeeds messageSeed : MessageSeeds.values()) {
                SimpleNlsKey nlsKey = SimpleNlsKey.key(DeviceConfigurationApplication.COMPONENT_NAME, messageSeed.getLayer(), messageSeed.getKey()).defaultMessage(messageSeed.getDefaultFormat());
