...
public enum MessageSeeds implements MessageSeed {
    ...
    MULTI_ELEMENT_SUBMETER_AT_LEAST_ONE_DATASOURCE(226, Keys.MULTI_ELEMENT_SUBMETER_AT_LEAST_ONE_DATASOURCE, "You must define at least one channel configuration or register configuration before you can " +
            "activate a multi-element submeter configuration"),
    MULTI_ELEMENT_ENABLEMENTS_AT_LEAST_ONE_DATASOURCE(227, Keys.MULTI_ELEMENT_ENABLEMENTS_AT_LEAST_ONE_DATASOURCE, "You must define at least one channel configuration or register configuration before " +
            "you can activate a multi-elemennt device configuration")
    ;
