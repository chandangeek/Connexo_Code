...
public class DeviceConfigurationApplication extends Application implements MessageSeedProvider, TranslationKeyProvider {
    ...
    public Set<Class<?>> getClasses() {
        return ImmutableSet.of(
                ...
                SecurityAccessorTypeResource.class,
                SecurityAccessorTypeOnDeviceTypeResource.class,
    ...
    public void setNlsService(NlsService nlsService) {
        ...
        Thesaurus domainThesaurus = this.thesaurus.join(nlsService.getThesaurus(DeviceProtocolService.COMPONENT_NAME, Layer.DOMAIN))
