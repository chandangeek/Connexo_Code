...
public enum MessageSeeds implements MessageSeed {
    ...
    DUPLICATE_COMSERVER(101, Keys.MDC_DUPLICATE_COM_SERVER, "Name must be unique", Level.SEVERE),
    ...
    DUPLICATE_COMPORT(105, Keys.MDC_DUPLICATE_COM_PORT, "Name must be unique", Level.SEVERE),
    ...
    DUPLICATE_COMPORTPOOL(109, Keys.MDC_DUPLICATE_COM_PORT_POOL, "Name must be unique", Level.SEVERE),
