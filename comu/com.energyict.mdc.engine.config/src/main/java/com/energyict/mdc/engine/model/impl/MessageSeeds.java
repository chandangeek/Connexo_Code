...
public enum MessageSeeds implements MessageSeed {
    ...
    CAN_NOT_BE_EMPTY(2, "MDC.CanNotBeEmpty", "This field can not be empty", Level.SEVERE),
    ...
    INVALID_CHARS(5, "MDC.InvalidChars", "This field contains invalid chars, should obey {regex}", Level.SEVERE),
    REQUIRED_FOR_HTTPS(6, "MDC.CanNotBeEmptyIfHttps", "This field is mandatory in case https is chosen", Level.SEVERE),
