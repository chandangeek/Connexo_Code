...
public class PersistenceTest {
    ...
    protected InboundDeviceProtocolPluggableClass discoveryProtocolPluggableClass;
    ...
    @Before
    public void setUp() {
        discoveryProtocolPluggableClass = mock(InboundDeviceProtocolPluggableClass.class);
        when(discoveryProtocolPluggableClass.getId()).thenReturn(DISCOVERY_PROTOCOL_PLUGGABLE_CLASS_ID);
        when(getProtocolPluggableService().findInboundDeviceProtocolPluggableClass(DISCOVERY_PROTOCOL_PLUGGABLE_CLASS_ID)).thenReturn(discoveryProtocolPluggableClass);
    }
