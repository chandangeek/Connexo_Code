...
//    }
    ...
    private ModemBasedInboundComPort createSimpleComPort() {
        ...
        comPort.setComPortPool(createComPortPool());
        comPort.setConnectTimeout(new TimeDuration(1000));
        comPort.setAtCommandTimeout(new TimeDuration(1000));
        comPort.setAtCommandTry(BigDecimal.TEN);
        comPort.setSerialPortConfiguration(new SerialPortConfiguration(name, BaudrateValue.BAUDRATE_1200, NrOfDataBits.FIVE, NrOfStopBits.ONE_AND_HALF, Parities.EVEN, FlowControl.NONE));
        comPort.save();
        return comPort;
    }
