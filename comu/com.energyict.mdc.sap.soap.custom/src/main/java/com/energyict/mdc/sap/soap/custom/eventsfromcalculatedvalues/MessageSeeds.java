...
public enum MessageSeeds implements MessageSeed {
    ...
    PERCENTAGE_VALUE_NOT_VALID(3, Keys.PERCENTAGE_VALUE_NOT_VALID, "Percentage value must be less or equal to 100."),

    PROPERTY_IS_NOT_SET(10, "PropertyNotSet", "Property ''{0}'' isn''t set."),
    PROPERTY_VALUE_CANNOT_BE_EMPTY(11, "PropertyValueCannotBeEmpty", "Property value of the device type or reading type cannot be empty for the config parameter ''{0}''."),
    ...
    READING_TYPE_NOT_FOUND(200, "ReadingTypeNotFound", "Reading type {0} not found."),
    UNEXPECTED_UNIT_ON_READING_TYPE(201, "UnexpectedUnitOnReadingType", "Unexpected unit on reading type {0}.");
