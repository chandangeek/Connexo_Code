...
public enum MessageSeeds implements MessageSeed {
    ...
    ITEM_DOES_NOT_HAVE_CREATED_DATA_FOR_EXPORT_WINDOW(1052, "dataexport.created.nodata",
            "Item {0} doesn''t contain created data, profile id isn''t set or device is not registered in SAP for the selected export window.", Level.INFO),
    ITEM_DOES_NOT_HAVE_CHANGED_DATA_FOR_UPDATE_WINDOW(1053, "dataexport.changed.nodata",
            "Item {0} doesn''t contain changed data, profile id isn''t set or device is not registered in SAP for the selected update window.", Level.INFO);
