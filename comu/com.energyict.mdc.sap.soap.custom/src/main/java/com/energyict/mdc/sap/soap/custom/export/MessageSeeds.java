...
public enum MessageSeeds implements MessageSeed {
    ...
    ITEM_DOES_NOT_HAVE_CREATED_DATA_FOR_EXPORT_WINDOW(1052, "dataexport.created.nodata", "Item {0} doesn''t contain created data or profile id isn''t set for the selected export window.", Level.INFO),
    ITEM_DOES_NOT_HAVE_CHANGED_DATA_FOR_UPDATE_WINDOW(1053, "dataexport.changed.nodata", "Item {0} doesn''t contain changed data for the selected update window.", Level.INFO);
