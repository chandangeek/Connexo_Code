...
public class MessageSeedsTest {
    ...
    @Test
    public void testAllSeedsLevel() {
        for (MessageSeeds messageSeed : MessageSeeds.values()) {
            assertThat(messageSeed.getLevel().equals(Level.SEVERE)).as("Level " + messageSeed.getLevel() + " is incorrect").isNotNull();
        }
    }

    @Test
    public void testAllSeedsModule() {
        for (MessageSeeds messageSeed : MessageSeeds.values()) {
            assertThat(messageSeed.getModule().equals(DataExportService.COMPONENTNAME)).as("Module " + messageSeed.getModule() + " is incorrect").isNotNull();
        }
    }
