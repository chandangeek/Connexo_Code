...
public class UnableToConnectEvent extends DataCollectionEvent {

    private long connectionTaskId;
    private final ConnectionTaskService connectionTaskService;

    @Inject
    public UnableToConnectEvent(IssueDataCollectionService issueDataCollectionService, IssueService issueService, MeteringService meteringService, DeviceService deviceService, CommunicationTaskService communicationTaskService, ConnectionTaskService connectionTaskService, Thesaurus thesaurus) {
