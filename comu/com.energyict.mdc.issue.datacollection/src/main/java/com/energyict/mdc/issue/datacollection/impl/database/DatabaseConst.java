...
public final class DatabaseConst {
    ...
    public static final String IDC_ISSUE_HISTORY_FK_TO_COM_SESSION = "IDC_ISS_HIST_FK_TO_COM_SESSN";
    ...
    public static final String IDC_ISSUE_FK_TO_COM_SESSION = "IDC_ISSUE_FK_TO_COM_SESSN";
    ...
    public static final String IDC_ISSUE_OPEN_FK_TO_COM_SESSION = "IDC_ISSUE_OPEN_FK_TO_COM_SESSN";
}
