...
public class CreateIssueViewOperation {
    ...
    protected SqlBuilder buildCreateSQL(){
        ...
        builder.append("CREATE OR REPLACE VIEW " + TableSpecs.IDC_ISSUE_ALL + " AS ");
        builder.append("select * from " + TableSpecs.IDC_ISSUE_OPEN.name() + " union select * from " + TableSpecs.IDC_ISSUE_HISTORY.name());
        return builder;
    }
