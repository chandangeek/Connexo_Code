    ...
    fields: [
        ...
        'discoveryProtocolPluggableClassId',
        {
            ...
            mapping: function (data) {
                ...
                return '<a href="#/administration/comportpools/' + data.id + '/comports">' + comports + ' ' + Uni.I18n.translatePlural('comportpool.preview.communicationPorts', parseInt(comports), 'MDC', 'communication ports') + '</a>';
            }
        },
        {
