        ...
        this.columns = [
            {
                ...
                renderer: function (value, b, record) {
                    return '<a href="#/administration/validation/rulesets/validationrules/' + record.data.ruleSet.id + '/ruleoverview/' + record.getId()  + '">' + value + '</a>';
                },
                flex: 1
            },
            ...
            },
            {
                ...
                flex: 1,
                renderer: function (value, b, record) {
                    return '<a href="#/administration/validation/rulesets/overview/' + record.data.ruleSet.id + '">' + value + '</a>';
                }
            },
            {
