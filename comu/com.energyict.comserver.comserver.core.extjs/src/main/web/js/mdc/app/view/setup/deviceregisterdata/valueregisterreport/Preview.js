Ext.define('Mdc.view.setup.deviceregisterdata.valueregisterreport.Preview', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.devicevalueregisterreportpreview',
    itemId: 'deviceValueRegisterReportPreview',
    title: '',
    frame: true,
    tools: [
        {
