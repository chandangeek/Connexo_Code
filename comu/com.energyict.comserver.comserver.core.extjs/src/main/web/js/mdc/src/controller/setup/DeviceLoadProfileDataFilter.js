Ext.define('Mdc.controller.setup.DeviceLoadProfileDataController', {
    ...
    init: function () {
        if (this.prefix) {
            ...
            control[this.prefix + ' #deviceLoadProfileDataFilterForm side-filter-duration'] = {
    ...
    initFilter: function () {
        ...
        // todo: refactor this
        this.setFilterTimeInterval(router.filter.endOfInterval, 'end', 'endOfInterval');
