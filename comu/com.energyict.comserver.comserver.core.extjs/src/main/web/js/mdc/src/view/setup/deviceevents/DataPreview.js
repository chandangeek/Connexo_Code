        ...
        if (me.eventsView) {
            items.push({
                ...
                renderer: function (value) {
                    ...
                    value.isModel ? res = '<a href="{url}">{logbookName}</a>'.replace('{url}', me.router.getRoute('devices/device/logbooks/logbookoverview').buildUrl({logbookId: value.get('id')})).replace('{logbookName}', value.get('name')) : null;
                    return res
                }
            })
        }
