Ext.define('Mdc.customattributesets.view.EditLevelsWindow', {
    ...
    requires: [
        'Mdc.customattributesets.view.widget.LevelsSelector'
    ],
        ...
        me.items = [
            {
                ...
                border: false,
                width: '100%',
                title: Uni.I18n.translate('customattributesets.editlevelsof', 'MDC', 'Edit levels of \'{0}\'', [Ext.String.htmlEncode(me.record.get('name'))]),
                ui: 'medium',
                items: [
                    {
                        xtype: 'container',
