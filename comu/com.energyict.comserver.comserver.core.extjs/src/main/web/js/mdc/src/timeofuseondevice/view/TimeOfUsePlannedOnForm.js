Ext.define('Mdc.timeofuseondevice.view.TimeOfUsePlannedOnForm', {
    ...
    checkWillNotBePickedUp: function(willBePickedUpByPlannedComtask, willBePickedUpByComtask) {
        ...
        if(!willBePickedUpByPlannedComtask || !willBePickedUpByComtask) {
            ...
            if(!willBePickedUpByPlannedComtask && willBePickedUpByComtask) {
                me.down('#willNotBePickedUpMessage').setText( Uni.I18n.translate('deviceCommands.view.willNotBePickedUpByPlannedComTask', 'MDC', 'The command is part of a communication task that is not planned and will not be picked up'));
            } else {
                me.down('#willNotBePickedUpMessage').setText(Uni.I18n.translate('deviceCommands.view.willBePickedUpByComTask', 'MDC', 'The command is not part of a communication task on this device'));
            }
        }
    }
