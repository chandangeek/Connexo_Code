...
Ext.define('Mdc.usagepointmanagement.view.RegisterDataGraph', {
    extend: 'Uni.view.highstock.GraphView',
    alias: 'widget.register-data-graph',
    register: null,
    zoomLevels: null,
    ...
    createTooltip: function (tooltip) {
        ...
        html += '<br/>' + Uni.I18n.translate('deviceregisters.interval', 'MDC', 'Interval') + ' ' + Uni.DateTime.formatTimeShort(new Date(point.x));
