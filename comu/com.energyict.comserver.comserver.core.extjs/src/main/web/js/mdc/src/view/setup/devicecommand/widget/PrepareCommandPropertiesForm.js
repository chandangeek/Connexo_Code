Ext.define('Mdc.view.setup.devicecommand.widget.PrepareCommandPropertiesForm', {
    extend: 'Uni.property.form.Property',
    alias: 'widget.prepare-command-properties-form',
        ...
        _.each(raw.properties || [], function(firstValue, firstKey){
            if (firstValue instanceof Object) {
                _.each(firstValue, function(secondValue, secondKey){
                    if (secondValue instanceof Object) {
