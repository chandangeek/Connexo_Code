                ...
                renderer: function (value) {
                    var result = '',
                        ...
                        infoIcon = '<span style="margin-left: 10px; display:inline-block; color:#A9A9A9; font-size:16px;" class="icon-info" data-qtip="'
                            + Uni.I18n.translate('usagePointRegister.notAvailableRegisters.qtip', 'MDC', 'This register is not available on the device anymore because device configuration is changed')
                            + '"></span>';
