            ...
            onDependenciesLoad = function () {
                ...
                if (!dependencyCounter) {
                    var widget = Ext.widget('tabbedDeviceChannelsView', {
                        ...
                        mentionDataLoggerSlave: (!Ext.isEmpty(device.get('isDataLogger')) && device.get('isDataLogger')) || (!Ext.isEmpty(device.get('isMultiElementDevice')) && device.get('isMultiElementDevice')),
