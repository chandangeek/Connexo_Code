...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux": "../../../../../target/web/packages/UnifyingJS/packages",
  "Mdc": "app",
  "Mdc.model.field.timeOfUse": "app/model/field/TimeOfUse.js",
  "Uni": "../../../../../target/web/packages/UnifyingJS/src"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Mdc.model.field.UnitOfMeasure": [],
  "Mdc.model.field.timeOfUse": [],
  ...
  "Mdc.store.TimeOfUses": [],
  "Mdc.store.TimeUnits": [],
  "Mdc.store.UnitOfMeasures": [],
  "Mdc.store.UserFileReferences": [],
  "Mdc.view.Main": [],
  "Mdc.view.Viewport": [],
  "Mdc.view.setup.Browse": [],
  "Mdc.view.setup.comport.ComPortEdit": [],
  "Mdc.view.setup.comport.ComPorts": [],
  "Mdc.view.setup.comport.InboundComPortEdit": [],
  "Mdc.view.setup.comport.InboundComPorts": [],
  "Mdc.view.setup.comport.ModemInitStrings": [],
  "Mdc.view.setup.comport.OutboundComPortEdit": [],
  "Mdc.view.setup.comport.OutboundComPortSelectionWindow": [],
  ...
  "Mdc.view.setup.comportpool.ComPortPoolsSetup": [],
  "Mdc.view.setup.comportpool.InboundComPortPoolEdit": [],
  "Mdc.view.setup.comportpool.OutboundComPortPoolEdit": [],
  "Mdc.view.setup.comserver.ComServerEdit": [],
  "Mdc.view.setup.comserver.ComServerPreview": [],
  "Mdc.view.setup.comserver.ComServersGrid": [],
  "Mdc.view.setup.comserver.ComServersSetup": [],
  "Mdc.view.setup.comserver.RemoteComServerEdit": [],
  "Mdc.view.setup.devicecommunicationprotocol.Edit": [],
  "Mdc.view.setup.devicecommunicationprotocol.List": [],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationDetail": [],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationEdit": [],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationPreview": [],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationsGrid": [],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationsSetup": [],
  "Mdc.view.setup.devicetype.DeviceTypeDetail": [],
  "Mdc.view.setup.devicetype.DeviceTypeEdit": [],
  "Mdc.view.setup.devicetype.DeviceTypePreview": [],
  "Mdc.view.setup.devicetype.DeviceTypesGrid": [],
  "Mdc.view.setup.devicetype.DeviceTypesSetup": [],
  "Mdc.view.setup.licensedprotocol.Detail": [],
  "Mdc.view.setup.licensedprotocol.List": [],
  ...
  "Mdc.view.setup.register.ReadingTypeDetails": [],
  ...
  "Mdc.view.setup.registertype.RegisterTypeDetail": [],
  "Mdc.view.setup.registertype.RegisterTypeEdit": [],
  ...
  "Mdc.view.setup.registertype.RegisterTypeSetup": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Mdc.view.setup.comport.InboundComPortEdit": [
    "widget.inboundComPortEdit"
  ],
  "Mdc.view.setup.comport.InboundComPorts": [
    "widget.inboundComPorts"
  ],
  "Mdc.view.setup.comport.ModemInitStrings": [
    "widget.modemInitStrings"
  ],
  "Mdc.view.setup.comport.OutboundComPortEdit": [
    "widget.outboundComPortEdit"
  ],
  "Mdc.view.setup.comport.OutboundComPortSelectionWindow": [
    "widget.outboundComPortSelectionWindow"
  ],
  "Mdc.view.setup.comport.OutboundComPorts": [
    "widget.outboundComPorts"
  ],
  "Mdc.view.setup.comport.PoolInboundComPorts": [
    "widget.poolInboundComPorts"
  ],
  "Mdc.view.setup.comport.PoolOutboundComPorts": [
    "widget.poolOutboundComPorts"
  ],
  "Mdc.view.setup.comportpool.ComPortPoolPreview": [
    "widget.comPortPoolPreview"
  ],
  "Mdc.view.setup.comportpool.ComPortPoolsGrid": [
    "widget.comPortPoolsGrid"
  ],
  "Mdc.view.setup.comportpool.ComPortPoolsSetup": [
    "widget.comPortPoolsSetup"
  ],
  "Mdc.view.setup.comportpool.InboundComPortPoolEdit": [
    "widget.inboundComPortPoolEdit"
  ],
  "Mdc.view.setup.comportpool.OutboundComPortPoolEdit": [
    "widget.outboundComPortPoolEdit"
  ],
  "Mdc.view.setup.comserver.ComServerEdit": [
    "widget.comServerEdit"
  ],
  "Mdc.view.setup.comserver.ComServerPreview": [
    "widget.comServerPreview"
  ],
  "Mdc.view.setup.comserver.ComServersGrid": [
    "widget.comServersGrid"
  ],
  "Mdc.view.setup.comserver.ComServersSetup": [
    "widget.comServersSetup"
  ],
  "Mdc.view.setup.comserver.RemoteComServerEdit": [
    "widget.remoteComServerEdit"
  ],
  "Mdc.view.setup.devicecommunicationprotocol.Edit": [
    "widget.deviceCommunicationProtocolEdit"
  ],
  "Mdc.view.setup.devicecommunicationprotocol.List": [
    "widget.setupDeviceCommunicationProtocols"
  ],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationDetail": [
    "widget.deviceConfigurationDetail"
  ],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationEdit": [
    "widget.deviceConfigurationEdit"
  ],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationPreview": [
    "widget.deviceConfigurationPreview"
  ],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationsGrid": [
    "widget.deviceConfigurationsGrid"
  ],
  "Mdc.view.setup.deviceconfiguration.DeviceConfigurationsSetup": [
    "widget.deviceConfigurationsSetup"
  ],
  "Mdc.view.setup.devicetype.DeviceTypeDetail": [
    "widget.deviceTypeDetail"
  ],
  "Mdc.view.setup.devicetype.DeviceTypeEdit": [
    "widget.deviceTypeEdit"
  ],
  "Mdc.view.setup.devicetype.DeviceTypePreview": [
    "widget.deviceTypePreview"
  ],
  "Mdc.view.setup.devicetype.DeviceTypesGrid": [
    "widget.deviceTypesGrid"
  ],
  "Mdc.view.setup.devicetype.DeviceTypesSetup": [
    "widget.deviceTypesSetup"
  ],
  "Mdc.view.setup.licensedprotocol.Detail": [
    "widget.licensedProtocolDetail"
  ],
  "Mdc.view.setup.licensedprotocol.List": [
    "widget.setupLicensedProtocols"
  ],
  "Mdc.view.setup.property.CodeTable": [
    "widget.codeTableSelectionWindow"
  ],
  "Mdc.view.setup.property.CodeTableSelector": [
    "widget.codeTableSelector"
  ],
  "Mdc.view.setup.property.Edit": [
    "widget.propertyEdit"
  ],
  "Mdc.view.setup.property.LoadProfileType": [
    "widget.loadProfileTypeSelectionWindow"
  ],
  "Mdc.view.setup.property.UserFileReference": [
    "widget.userFileReferenceSelectionWindow"
  ],
  "Mdc.view.setup.protocolfamily.List": [
    "widget.setupProtocolFamilies"
  ],
  "Mdc.view.setup.register.ReadingTypeDetails": [
    "widget.readingTypeDetails"
  ],
  "Mdc.view.setup.register.RegisterMappingAdd": [
    "widget.registerMappingAdd"
  ],
  "Mdc.view.setup.register.RegisterMappingAddGrid": [
    "widget.registerMappingAddGrid"
  ],
  "Mdc.view.setup.register.RegisterMappingPreview": [
    "widget.registerMappingPreview"
  ],
  "Mdc.view.setup.register.RegisterMappingsAddFilter": [
    "widget.registerMappingAddFilter"
  ],
  "Mdc.view.setup.register.RegisterMappingsFilter": [
    "widget.registerMappingFilter"
  ],
  "Mdc.view.setup.register.RegisterMappingsGrid": [
    "widget.registerMappingsGrid"
  ],
  "Mdc.view.setup.register.RegisterMappingsSetup": [
    "widget.registerMappingsSetup"
  ],
  "Mdc.view.setup.registertype.RegisterTypeDetail": [
    "widget.registerTypeDetail"
  ],
  "Mdc.view.setup.registertype.RegisterTypeEdit": [
    "widget.registerTypeEdit"
  ],
  "Mdc.view.setup.registertype.RegisterTypeFilter": [
    "widget.registerTypeFilter"
  ],
  "Mdc.view.setup.registertype.RegisterTypeGrid": [
    "widget.registerTypeGrid"
  ],
  "Mdc.view.setup.registertype.RegisterTypePreview": [
    "widget.registerTypePreview"
  ],
  "Mdc.view.setup.registertype.RegisterTypeSetup": [
    "widget.registerTypeSetup"
  ],
  "Mdc.widget.TimeInfoField": [
    "widget.timeInfoField"
  ],
  "Uni.About": [],
  "Uni.I18n": [],
  "Uni.Loader": [],
...
Ext.setVersion("UnifyingJS", "1.0.0");
