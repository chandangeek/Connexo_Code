...
public class MdcUiInstaller implements TranslationKeyProvider {
   ...
   //   HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "C:\\Development\\jupiterrepo\\comu\\com.energyict.comserver.comserver.core.extjs\\src\\main\\web\\js\\mdc", new FileResolver());
