...
public class MdcUiInstaller implements TranslationKeyProvider {
    ...
    public void activate(BundleContext context) {
        ...
        HttpResource resource = new HttpResource(HTTP_RESOURCE_ALIAS, "C:/Development/Projects/Connexo/repository/connexo/comu/com.energyict.comserver.comserver.core.extjs/src/main/web/js/mdc", new FileResolver());
