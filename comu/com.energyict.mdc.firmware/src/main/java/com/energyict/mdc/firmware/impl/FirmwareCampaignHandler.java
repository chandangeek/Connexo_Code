...
//import com.energyict.mdc.firmware.campaign;
...
//                Optional<campaign> firmwareCampaignOpt = context.getFirmwareService().getFirmwareCampaignById(firmwareCampaignId);
//                if (firmwareCampaignOpt.isPresent()) {
//                    campaign firmwareCampaign = firmwareCampaignOpt.get();
...
//            }
//
//            private void cancelCampaign(FirmwareCampaignHandlerContext context, campaign firmwareCampaign) {
...
//            public void handle(Map<String, Object> properties, FirmwareCampaignHandlerContext context) {
//                long firmwareCampaignId = ((Number) properties.get("id")).longValue();
//                Optional<campaign> firmwareCampaign = context.getFirmwareService().getFirmwareCampaignById(firmwareCampaignId);
...
//                Optional<campaign> firmwareCampaignRef = context.getFirmwareService().getFirmwareCampaignById(firmwareCampaignId);
...
//                    campaign firmwareCampaign = firmwareCampaignRef.get();
//                    try {
...
//                    campaign firmwareCampaignImpl = firmwareCampaign.get();
...
//        }
//
//        DeviceInFirmwareCampaignImpl getDeviceInFirmwareCampaignWrapper(FirmwareCampaignHandlerContext context, campaign firmwareCampaign, Device device) {
...
//        }
//
//        void updateFirmwareStatistics(FirmwareCampaignHandlerContext context, campaign firmwareCampaignImpl) {
//            boolean retry = true;
//            while (retry) {
//                try {
