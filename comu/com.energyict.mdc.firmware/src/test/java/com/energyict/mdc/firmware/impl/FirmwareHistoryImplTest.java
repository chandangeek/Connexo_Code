...
public class FirmwareHistoryImplTest extends PersistenceTest {
    ...
    public void setup() {
        ...
        firmwareVersion1 = firmwareService.newFirmwareVersion(deviceType, "firmwareVersion1", FirmwareStatus.FINAL, FirmwareType.METER,"1").initFirmwareFile(FIRMWARE_FILE).create();
        firmwareVersion2 = firmwareService.newFirmwareVersion(deviceType, "firmwareVersion2", FirmwareStatus.FINAL, FirmwareType.COMMUNICATION,"2").initFirmwareFile(FIRMWARE_FILE).create();
        firmwareVersion3 = firmwareService.newFirmwareVersion(deviceType, "firmwareVersion3", FirmwareStatus.FINAL, FirmwareType.METER,"3").initFirmwareFile(FIRMWARE_FILE).create();
