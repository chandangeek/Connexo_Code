...
public class MinimumLevelFirmwareCheckTest extends AbstractFirmwareCheckTest {
    ...
    public void testOldMeterFirmware() {
        ...
        expectError("Firmwares of the following types are below the minimum level: device firmware.");
    }
    ...
    public void testOldCommFirmware() {
        ...
        expectError("Firmwares of the following types are below the minimum level: communication firmware");
    }
    ...
    public void testOldAuxFirmware() {
        ...
        expectError("Firmwares of the following types are below the minimum level: auxiliary firmware");
    }
