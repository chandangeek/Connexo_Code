...
public class DbpUiInstaller implements TranslationKeyProvider {
    ...
    //   HttpResource resource = new HttpResource(HTTP_RESOURCE_ALIAS, "C:\\Work\\Jupiter\\Connexo\\comu\\com.energyict.mdc.bpm.extjs\\src\\main\\web\\js\\dbp", new FileResolver());
        HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "D:/Work/Jupiter/Sources/comu/com.energyict.mdc.bpm.extjs/src/main/web/js/dbp", new FileResolver());
