...
public class RegisterReadingTypeNameSearchablePropertyTest {
    ...
    public void testGetDomain() {
        RegisterReadingTypeNameSearchableProperty property = this.getTestInstance();
    ...
    private RegisterReadingTypeNameSearchableProperty getTestInstance() {
        return new RegisterReadingTypeNameSearchableProperty(propertySpecService, thesaurus).init(this.domain, registerSearchablePropertyGroup);
    }
}
