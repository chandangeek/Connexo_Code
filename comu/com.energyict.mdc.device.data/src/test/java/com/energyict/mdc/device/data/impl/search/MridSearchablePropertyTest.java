...
/**
 * Tests the {@link MridSearchableProperty} component.
 */
@RunWith(MockitoJUnitRunner.class)
public class MridSearchablePropertyTest {
    ...
    public void testGetDomain() {
        MridSearchableProperty property = this.getTestInstance();
    ...
    private MridSearchableProperty getTestInstance() {
        return new MridSearchableProperty(this.propertySpecService, this.thesaurus).init(this.domain);
    }
}