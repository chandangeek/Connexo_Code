...
/**
 * Tests the {@link ModelVersionSearchableProperty} component.
 *
 */
@RunWith(MockitoJUnitRunner.class)
public class ModelVersionSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        ModelVersionSearchableProperty property = this.getTestInstance();
    ...
    public void testTranslation() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.DEVICE_MODEL_VERSION.getDefaultFormat());
        when(this.thesaurus.getFormat(PropertyTranslationKeys.DEVICE_MODEL_VERSION)).thenReturn(messageFormat);
        ModelVersionSearchableProperty property = this.getTestInstance();
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.DEVICE_MODEL_VERSION);
    }
