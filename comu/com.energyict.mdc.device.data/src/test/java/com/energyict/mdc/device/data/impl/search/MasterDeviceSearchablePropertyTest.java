...
public class MasterDeviceSearchablePropertyTest {
    ...
    public void initializeMocks() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.DEVICE_MASTER_MRID.getDefaultFormat());
    ...
    public void testGetDomain() {
        MasterDeviceSearchableProperty property = this.getTestInstance();
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.DEVICE_MASTER_MRID);
    }
    ...
    private MasterDeviceSearchableProperty getTestInstance() {
        return new MasterDeviceSearchableProperty(propertySpecService, thesaurus).init(this.domain, topologySearchablePropertyGroup);
    }
}
