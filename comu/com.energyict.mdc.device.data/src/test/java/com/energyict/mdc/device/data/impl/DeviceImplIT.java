...
public class DeviceImplIT extends PersistenceIntegrationTest {
    ...
    public void successfulCreateTest() {
        Device device = createSimpleDeviceWithName(DEVICENAME);
    ...
    public void createWithoutNameTest() {
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, null, MRID, Instant.now());
    }
    ...
    public void createWithEmptyNameTest() {
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, "", MRID, Instant.now());
    }
    ...
    public void createWithSerialNumberTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, Instant.now());
    ...
    public void successfulCreationOfTwoDevicesWithSameSerialNumberTest() {
        ...
        Device device1 = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME + "MRIDFirst", MRID + "First", Instant.now());
        device1.setSerialNumber(serialNumber);
        device1.save();

        Device device2 = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME + "MRIDSecond", MRID + "Second", Instant.now());
    ...
    public void uniquenessOfExternalNameTest() {
        ...
        Device device1 = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME + "First", mRID, Instant.now());
        device1.save();
        Device device2 = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME + "Second", mRID, Instant.now());
        device2.save();
    }
    ...
    public void noMRIDTest() {
        Device device1 = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, null, Instant.now());
        device1.save();
    }
    ...
    public void emptyMRIDTest() {
        Device device1 = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, "", Instant.now());
        device1.save();
    }
    ...
    public void getRegisterReadingsShouldReturnResultsTest() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoRegisterSpecs();
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, readingTimeStamp);
    ...
    public void getEventRegisterReadings() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoRegisterSpecs();
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, eventStart);
    ...
    public void createDeviceWithTwoChannelsTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfigurationWithTwoChannelSpecs, "DeviceWithChannels", MRID, Instant.now());
    ...
    public void removeComScheduleThatWasNotAddedToDevice() {
        ...
        Device simpleDevice = this.createSimpleDeviceWithName(DEVICENAME);
    ...
    public void createWithInActiveDeviceConfigurationTest() {
        ...
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, "MySimpleName", "BlaBla", Instant.now());
    }
    ...
    public void testGatewayTypeMethodsForHAN() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "name", "description", Instant.now());
    ...
    public void testGetLoadProfileDataIfRequestIntervalPreceedsActualMeterActivation() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, nineOClock);
        ...
        assertThat(readings).describedAs("There should be no data(holders) for the interval 00:00-> 09:00")
                .hasSize(24 * 4 - 4 * 9);
    ...
    public void testGetChannelDataIfRequestedIntervalHasNoReadingsButDataWasExpected() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, Instant.parse("2014-08-01T00:00:00Z"));
...
//        assertThat(readings).describedAs("There should be 1 data(holders) for the interval 12:05->12:10: 1x15 minute reading overlaps with the interval").hasSize(1);
        assertThat(readings).describedAs("Changed this behavior so we don't create duplicate entries when MeterActivations don't start/end at the interval boundary")
                .hasSize(0);
    }
    ...
    public void testGetLoadProfileDataIfRequestIntervalExceedsLoadProfilesLastReading() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, requestIntervalStart);
        String code = getForwardBulkSecondaryEnergyReadingTypeCodeBuilder()
                .period(TimeAttribute.MINUTE15)
                .code();
        IntervalBlockImpl intervalBlock = IntervalBlockImpl.of(code);
    ...
    public void testGetLoadProfileDataMonthlyMoscowTime() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, meterActivation);
    ...
    public void testGetLoadProfileDataMonthlyMeterActivationNotAlignedWithMidnight() {
        ...
        assertThat(readings.get(12)
                .getRange()
                .upperEndpoint()).isEqualTo(Instant.ofEpochMilli(1385852400000L)); // Sat, 31 Dec 2014 23:00:00 GMT
    }
    ...
    public void testGetLoadProfileDataIfExternalMeterActivationDoesNotAlignWithChannelIntervalBoundary() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, Instant.ofEpochMilli(1420801085000L));
    ...
    public void testGetLoadProfileData() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, dayStart);
    ...
    public void aNewDeviceHasMeterActivation() {
        ...
        // Asserts
        assertThat(device.getCurrentMeterActivation()).isPresent();
        assertThat(device.getCurrentMeterActivation()
                .get()
                .getStart()).isEqualTo(initialStart.truncatedTo(ChronoUnit.MINUTES));
    }
    ...
    public void activateMeterWhenStillActive() {
        ...
        assertThat(device.getCurrentMeterActivation()
                .get()
                .getStart()).isEqualTo(expectedStart.truncatedTo(ChronoUnit.MINUTES));
    }

    @Test
    @Transactional
    public void deactivateNowOnMeterThatWasNotActive() {
        Device device = this.createSimpleDeviceWithName(DEVICENAME);
    ...
    public void newDeviceHasMultiplierOne() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "setMultiplierTest", "setMultiplierTest", Instant.now());
    ...
    public void setMultiplierTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "setMultiplierTest2", "setMultiplierTest2", inMemoryPersistence.getClock()
                        .instant());
    ...
    public void setMultiplierToOneOnNewDevice() {
        ...
        freezeClock(2016, 1, 2);
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "setMultiplierTest3", "setMultiplierTest3", inMemoryPersistence.getClock()
                        .instant());
        freezeClock(2016, 1, 3);
    ...
    public void setSameMultiplierDoesNotCreateNewMeterActivationTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "setMultiplierTest4", "setMultiplierTest4", initialStart);
    ...
    public void setMultiplierOfOneDoesNotCreateMeterActivationTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "setMultiplierOfOneDoesNotCreateMeterActivationTest", "setMultiplierOfOneDoesNotCreateMeterActivationTest", Instant
                        .now());
    ...
    public void settingMultiplierWithValueZeroShouldFailTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "settingMultiplierWithValueZeroShouldFailTest", "settingMultiplierWithValueZeroShouldFailTest", Instant
                        .now());
    ...
    public void createMeterConfigurationForMultipliedRegisterSpecTest() {
        DeviceConfiguration deviceConfiguration = createSetupWithMultiplierRegisterSpec();
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "DeviceWithMultiplierOnRegister", "DeviceWithMultiplierOnRegister", Instant
                        .now());
        device.setMultiplier(BigDecimal.TEN);
        device.save();
    ...
    public void headEndInterfaceCreatesCorrectKoreChannels() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "DeviceWithMultipliers", "DeviceWithMultipliers", inMemoryPersistence.getClock()
                        .instant());
    ...
    public void createMeterConfigurationForMultipliedRegisterSpecWithoutMultiplierSetOnDeviceTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "DeviceWithMultiplierOnRegister2", "DeviceWithMultiplierOnRegister", Instant
                        .now());
    ...
    public void createSingleMeterConfigurationForChannelSpecsAndRegisterSpecsTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "DeviceWithMultipliers", "DeviceWithMultipliers", Instant.now());
        device.setMultiplier(BigDecimal.TEN);
        device.save();
    ...
    public void overruleChannelOverFlowTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "OverruleTest", "OverruleTest", inMemoryPersistence.getClock()
                        .instant());
    ...
    public void noOverflowRequiredOnDeltaUpdateTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "noOverflowRequiredOnDeltaUpdateTest", "noOverflowRequiredOnDeltaUpdateTest", inMemoryPersistence
                        .getClock()
                        .instant());
    ...
    public void overruleOverflowOnDeltaWhenNoOverflowOnConfigTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, "overruleOverflowOnDeltaWhenNoOverflowOnConfigTest", "overruleOverflowOnDeltaWhenNoOverflowOnConfigTest", inMemoryPersistence
                        .getClock()
                        .instant());
    ...
    public void successfulCreateWithAdditionalComTaskExecutionsCreatedTest() {
        ...
        assertThat(reloadedDevice.getComTaskExecutions()
                .get(0)
                .getComTasks()
                .stream()
                .mapToLong(ComTask::getId)
                .toArray()).containsOnly(comTask_2.getId());
    }
    ...
    public void reactivateDeviceOnUsagePoint() {
        ...
        when(inMemoryPersistence.getClock()
                .instant()).thenReturn(expectedStartWithUsagePoint.plus(1, ChronoUnit.MINUTES));
        ...
        assertThat(device.getCurrentMeterActivation()
                .get()
                .getStart()).isEqualTo(expectedStartWithUsagePoint.truncatedTo(ChronoUnit.MINUTES));
        assertThat(device.getCurrentMeterActivation().get().getUsagePoint().get()).isEqualTo(usagePoint);
    }
    ...
    public void activateDeviceOnUsagePointMissingReadingTypeRequirements() {
        ...
        DeviceConfiguration deviceConfigurationWithTwoChannelSpecs = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfigurationWithTwoChannelSpecs, "DeviceWithChannels", MRID, inMemoryPersistence.getClock()
                        .instant());
    ...
    public void testNoStatusInformationTaskAvailable() {
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, DEVICENAME, MRID, inMemoryPersistence.getClock().instant());
        device.save();
