...
public class DeviceImplIT extends PersistenceIntegrationTest {
    ...
    public void createWithoutNameTest() {
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, null, Instant.now());
    }
    ...
    public void createWithEmptyNameTest() {
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "", Instant.now());
    }
    ...
    public void createWithoutShipmentDateTest() {
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER,"MyNameWithoutShipment", null);
    }
    ...
    public void createWithSerialNumberTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, Instant.now());
    ...
    public void successfulCreationOfTwoDevicesWithSameSerialNumberTest() {
        ...
        Device device1 = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER,DEVICE_NAME + "First", Instant.now());
        device1.setSerialNumber(serialNumber);
        device1.save();

        Device device2 = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER,DEVICE_NAME + "Second", Instant.now());
    ...
    public void getRegisterReadingsShouldReturnResultsTest() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoRegisterSpecs();
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, readingTimeStamp);
    ...
    public void getEventRegisterReadings() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoRegisterSpecs();
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, eventStart);
    ...
    public void createDeviceWithTwoChannelsTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfigurationWithTwoChannelSpecs, SERIAL_NUMBER, "DeviceWithChannels", Instant.now());
    ...
    public void createWithInActiveDeviceConfigurationTest() {
        ...
        inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "MySimpleName", Instant.now());
    }
    ...
    public void testGatewayTypeMethodsForHAN() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "name", Instant.now());
    ...
    public void testGetLoadProfileDataIfRequestIntervalPreceedsActualMeterActivation() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, nineOClock);
    ...
    public void testGetChannelDataIfRequestedIntervalHasNoReadingsButDataWasExpected() {
        ...
        localDateTime = localDateTime.withHour(0)
                ...
                .withSecond(0);
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, localDateTime.toInstant(ZoneOffset.UTC));

        String code = getForwardBulkSecondaryEnergyReadingTypeCodeBuilder()
                .period(TimeAttribute.MINUTE15)
                .code();
        IntervalBlockImpl intervalBlock1 = IntervalBlockImpl.of(code);
        intervalBlock1.addIntervalReading(IntervalReadingImpl.of(LocalDateTime.of(localDateTime.getYear(), localDateTime.getMonth().getValue(), localDateTime.getDayOfMonth(), 0, 15, 0)
                .toInstant(ZoneOffset.UTC), readingValue));
        IntervalBlockImpl intervalBlock2 = IntervalBlockImpl.of(code);
        intervalBlock2.addIntervalReading(IntervalReadingImpl.of(LocalDateTime.of(localDateTime.getYear(), localDateTime.getMonth().getValue(), localDateTime.getDayOfMonth(), 0, 30, 0)
                .toInstant(ZoneOffset.UTC), readingValue));
        IntervalBlockImpl intervalBlock3 = IntervalBlockImpl.of(code);
        intervalBlock3.addIntervalReading(IntervalReadingImpl.of(LocalDateTime.of(localDateTime.getYear(), localDateTime.getMonth().getValue(), localDateTime.getDayOfMonth(), 0, 45, 0)
                .toInstant(ZoneOffset.UTC), readingValue));
        IntervalBlockImpl intervalBlock4 = IntervalBlockImpl.of(code);
        intervalBlock4.addIntervalReading(IntervalReadingImpl.of(LocalDateTime.of(localDateTime.getYear(), localDateTime.getMonth().getValue(), localDateTime.getDayOfMonth(), 1, 0, 0)
                .toInstant(ZoneOffset.UTC), readingValue));
        IntervalBlockImpl intervalBlockX = IntervalBlockImpl.of(code);
        intervalBlockX.addIntervalReading(IntervalReadingImpl.of(LocalDateTime.of(localDateTime.getYear(), localDateTime.getMonth().getValue(), localDateTime.getDayOfMonth(), 23, 45, 0)
                .toInstant(ZoneOffset.UTC), readingValue));
        MeterReadingImpl meterReading = MeterReadingImpl.newInstance();
...
//        assertThat(readings).describedAs("There should be 1 data(holders) for the interval 12:05->12:10: 1x15 minute reading overlaps with the interval").hasSize(1);
    ...
    public void testGetLoadProfileDataIfRequestIntervalExceedsLoadProfilesLastReading() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, requestIntervalStart);
        String code = getForwardBulkSecondaryEnergyReadingTypeCodeBuilder()
                .period(TimeAttribute.MINUTE15)
                .code();
        IntervalBlockImpl intervalBlock = IntervalBlockImpl.of(code);
        ...
        meterReading.addIntervalBlock(intervalBlock2);
        device.store(meterReading);
        Instant lastNonNullReading = localDateTime.withHour(21).withMinute(0).withSecond(0).toInstant(ZoneOffset.UTC);
        Instant lastReading = localDateTime.plusDays(1).withHour(0).withMinute(0).withSecond(0).toInstant(ZoneOffset.UTC);
        device.getLoadProfileUpdaterFor(device.getLoadProfiles().get(0)).setLastReading(lastNonNullReading).update();
        ...
        assertThat(readings).describedAs("all of them includding the padding").hasSize(96);
        assertThat(readings.stream().filter(r -> r.getReadingTime() != null).findFirst().get().getRange().upperEndpoint()).isEqualTo(lastNonNullReading);
    ...
    public void testGetLoadProfileDataMonthlyMoscowTime() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, meterActivation);
    ...
    public void testGetLoadProfileDataMonthlyMeterActivationNotAlignedWithMidnight() {
        ...
        List<LoadProfileReading> readings = reloadedDevice.getLoadProfiles().get(0).getChannelData(Ranges.openClosed(requestIntervalStart, requestIntervalEnd));
        assertThat(readings.size()).describedAs("all including the padding").isEqualTo(14);
        assertThat(readings.stream().map(r -> r.getReadingTime()).filter(Objects::nonNull).count()).isEqualTo(13);
        assertThat(readings.get(13).getRange().upperEndpoint()).isEqualTo(Instant.ofEpochMilli(1385852400000L)); // Sat, 31 Dec 2014 23:00:00 GMT
    }
    ...
    public void testGetLoadProfileDataIfExternalMeterActivationDoesNotAlignWithChannelIntervalBoundary() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, Instant.ofEpochMilli(1420801085000L));
        ...
        Device reloadedDevice = getReloadedDevice(device);
        List<LoadProfileReading> readings = reloadedDevice.getLoadProfiles().get(0).getChannelData(Ranges.openClosed(requestIntervalStart, requestIntervalEnd));
        assertThat(readings).describedAs("all including the padding").hasSize(53);
        assertThat(readings.stream().map(r -> r.getReadingTime()).filter(Objects::nonNull).count()).describedAs("There should be only 2 intervals between activation and last reading")
                .isEqualTo(2);
        assertThat(readings.stream().filter(r -> r.getReadingTime() != null).findFirst().get().getRange().upperEndpoint()).isEqualTo(lastReading);
    ...
    public void testGetLoadProfileData() {
        ...
        DeviceConfiguration deviceConfiguration = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, dayStart);
        ...
        Device reloadedDevice = getReloadedDevice(device);
        List<LoadProfileReading> readings = reloadedDevice.getLoadProfiles().get(0).getChannelData(Ranges.openClosed(dayStart, dayEnd));
        assertThat(readings.stream().map(LoadProfileReading::getReadingTime).filter(Objects::nonNull).count()).isEqualTo(1);
        assertThat(readings).hasSize(96);

        LoadProfileReading reading = readings.stream().filter(r -> r.getReadingTime() != null).findFirst().get();
    ...
    public void testGetLoadProfileDataClippedOnLastReading() {
        ...
        assertThat(readings.stream()
                .map(r -> r.getReadingTime()).filter(Objects::nonNull).count())
                .isEqualTo(2);  // only readings from 01:15:00 to 05:00:00, shouldn't have readings for period 05:00:00 - 08:00:00
        assertThat(readings).describedAs("all including padding").hasSize(24);
    }
    ...
    public void testEditLoadProfileDataWithSeveralMeterActivations() {
        ...
        UsagePoint usagePoint = this.createSimpleUsagePoint("UP001", dayStart);
        ...
        usagePoint.apply(mc, dayStart);
        device.activate(dayStart, usagePoint, defaultMeterRole);
        device.deactivate(dayStart.plus(10, ChronoUnit.MINUTES));
        device.activate(dayStart.plus(10, ChronoUnit.MINUTES), usagePoint, defaultMeterRole);
    ...
    public void newDeviceHasMultiplierOne() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "setMultiplierTest", Instant.now());
    ...
    public void setMultiplierTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "setMultiplierTest2", inMemoryPersistence.getClock().instant());
    ...
    public void setMultiplierToOneOnNewDevice() {
        DeviceConfiguration deviceConfiguration = createSetupWithMultiplierRegisterSpec();
        freezeClock(2016, 1, 2);
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "setMultiplierTest3", inMemoryPersistence.getClock().instant());
        freezeClock(2016, 1, 3);
    ...
    public void setSameMultiplierDoesNotCreateNewMeterActivationTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "setMultiplierTest4", initialStart);
    ...
    public void setMultiplierOfOneAlsoCreatesMeterActivationTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, SERIAL_NUMBER, "setMultiplierOfOneAlsoCreatesMeterActivationTest", Instant.now());
    ...
    public void settingMultiplierBackToOneShouldRemovePreviouslyDefinedMultiplierTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, SERIAL_NUMBER, "settingMultiplierBackToOneShouldRemovePreviouslyDefinedMultiplierTest", Instant.now());
    ...
    public void settingMultiplierWithValueZeroShouldFailTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, SERIAL_NUMBER, "settingMultiplierWithValueZeroShouldFailTest", Instant.now());
    ...
    public void settingMultiplierLargerThanMaxIntShouldFailTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, SERIAL_NUMBER, "settingMultiplierLargerThanMaxIntShouleFailTest", Instant.now());
    ...
    public void createMeterConfigurationForMultipliedRegisterSpecTest() {
        DeviceConfiguration deviceConfiguration = createSetupWithMultiplierRegisterSpec();
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "DeviceWithMultiplierOnRegister", Instant.now());
        device.setMultiplier(BigDecimal.TEN);
        device.save();

        Optional<MeterConfiguration> meterConfigurationOptional = inMemoryPersistence.getMeteringService()
                .findMeterById(device.getId())
                .get()
                .getConfiguration(inMemoryPersistence.getClock().instant());
    ...
    public void headEndInterfaceCreatesCorrectKoreChannels() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "DeviceWithMultipliers", inMemoryPersistence.getClock().instant());
    ...
    public void createMeterConfigurationForMultipliedRegisterSpecWithoutMultiplierSetOnDeviceTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "DeviceWithMultiplierOnRegister2", Instant.now());
    ...
    public void createSingleMeterConfigurationForChannelSpecsAndRegisterSpecsWithoutMultiplierOnDeviceTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, "DeviceWithMultipliers", Instant.now());
        ...
        assertThat(meterConfigurationOptional.get().getReadingTypeConfigs()).haveExactly(1, new Condition<MeterReadingTypeConfiguration>() {
            ...
            public boolean matches(MeterReadingTypeConfiguration value) {
                return value.getMeasured().getMRID().equals(getForwardBulkSecondaryEnergyReadingTypeCodeBuilder().period(MacroPeriod.MONTHLY).code()) &&
                        ...
                        .get()
                        .getMRID()
                        .equals(getForwardBulkPrimaryEnergyReadingType().period(MacroPeriod.MONTHLY)
                                .code()) && // we always use the calculated readingtype when the user defined to use it on config level
                        (value.getOverflowValue().isPresent() && value.getOverflowValue().get().compareTo(overflow) == 0) &&
                        value.getNumberOfFractionDigits().getAsInt() == nbrOfFractionDigits;
            }
        });
    ...
    public void overruleChannelOverFlowTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER,"OverruleTest", inMemoryPersistence.getClock().instant());
    ...
    public void noOverflowRequiredOnDeltaUpdateTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, SERIAL_NUMBER, "noOverflowRequiredOnDeltaUpdateTest", inMemoryPersistence.getClock().instant());
    ...
    public void overruleOverflowOnDeltaWhenNoOverflowOnConfigTest() {
        ...
        Device device = inMemoryPersistence.getDeviceService()
                .newDevice(deviceConfiguration, SERIAL_NUMBER, "overruleOverflowOnDeltaWhenNoOverflowOnConfigTest", inMemoryPersistence.getClock().instant());
    ...
    public void activateDeviceOnUsagePointMissingReadingTypeRequirements() {
        freezeClock(2016, 6, 1);
        DeviceConfiguration deviceConfigurationWithTwoChannelSpecs = createDeviceConfigurationWithTwoChannelSpecs(interval);
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfigurationWithTwoChannelSpecs, SERIAL_NUMBER, "DeviceWithChannels", inMemoryPersistence.getClock().instant());
    ...
    private UsagePoint createSimpleUsagePoint(String name, Instant installationTime) {
        return inMemoryPersistence.getMeteringService().getServiceCategory(ServiceKind.ELECTRICITY).get()
                .newUsagePoint(name, installationTime)
                .create();
    }
    ...
    public void testNoStatusInformationTaskAvailable() {
        Device device = inMemoryPersistence.getDeviceService().newDevice(deviceConfiguration, SERIAL_NUMBER, DEVICE_NAME, inMemoryPersistence.getClock().instant());
        device.save();
