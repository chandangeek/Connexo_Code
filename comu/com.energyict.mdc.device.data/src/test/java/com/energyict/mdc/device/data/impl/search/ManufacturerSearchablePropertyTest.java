...
/**
 * Tests the {@link ManufacturerSearchableProperty} component.
 */
@RunWith(MockitoJUnitRunner.class)
public class ManufacturerSearchablePropertyTest {
    @Mock
    ...
    public void testGetDomain() {
        ManufacturerSearchableProperty property = this.getTestInstance();
    ...
    public void testTranslation() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.DEVICE_MANUFACTURER.getDefaultFormat());
        when(this.thesaurus.getFormat(PropertyTranslationKeys.DEVICE_MANUFACTURER)).thenReturn(messageFormat);
        ManufacturerSearchableProperty property = this.getTestInstance();
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.DEVICE_MANUFACTURER);
    }
    ...
    private ManufacturerSearchableProperty getTestInstance() {
        return new ManufacturerSearchableProperty(this.propertySpecService, this.thesaurus).init(this.domain, deviceAttributesGroup);
    }
