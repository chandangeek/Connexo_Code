...
public class ComTaskScheduleTypeSearchablePropertyTest {
    ...
    public void initializeMocks() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.COMTASK_SCHEDULE_TYPE.getDefaultFormat());
        when(this.thesaurus.getFormat(PropertyTranslationKeys.COMTASK_SCHEDULE_TYPE)).thenReturn(messageFormat);
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.COMTASK_SCHEDULE_TYPE);
    }
    ...
    public void specificationIsAReference() {
        ...
        assertThat(specification.getValueFactory().getValueType()).isEqualTo(ComTaskScheduleTypeSearchableProperty.ScheduleType.class);
    }
    ...
    public void propertyHasDefaultValues() {
        ...
        assertThat(allValues).containsExactly(Arrays.stream(ComTaskScheduleTypeSearchableProperty.ScheduleTypeKey.values())
                .map(ComTaskScheduleTypeSearchableProperty.ScheduleType::new)
                .collect(Collectors.toList())
                .toArray(new ComTaskScheduleTypeSearchableProperty.ScheduleType[ComTaskScheduleTypeSearchableProperty.ScheduleTypeKey.values().length]));
        assertThat(specification.getValueFactory().getValueType()).isEqualTo(ComTaskScheduleTypeSearchableProperty.ScheduleType.class);
    }

    private SearchableProperty getTestInstance() {
        return new ComTaskScheduleTypeSearchableProperty(this.propertySpecService, this.thesaurus)
