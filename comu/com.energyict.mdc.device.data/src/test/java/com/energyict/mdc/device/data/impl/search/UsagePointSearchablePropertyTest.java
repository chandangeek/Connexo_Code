...
public class UsagePointSearchablePropertyTest {
    ...
    public void initializeMocks() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.USAGE_POINT.getDefaultFormat());
        when(thesaurus.getFormat(PropertyTranslationKeys.USAGE_POINT)).thenReturn(messageFormat);
    ...
    public void testGetDomain() {
        UsagePointSearchableProperty property = this.getTestInstance();
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.USAGE_POINT);
    }
    ...
    @Test
    public void testDisplayUsagePointValue() {
        UsagePointSearchableProperty property = this.getTestInstance();
        UsagePoint usagePoint = mock(UsagePoint.class);
        when(usagePoint.getName()).thenReturn("UP");

        // Business method
        String displayValue = property.toDisplay(usagePoint);

        // Asserts
        assertThat(displayValue).isEqualTo("UP");
    }

    private UsagePointSearchableProperty getTestInstance() {
        return new UsagePointSearchableProperty(propertySpecService, thesaurus).init(this.domain);
    }
}
