...
public enum EventType {
    ...
    PROTOCOLDIALECTPROPERTIES_CREATED("protdialectprops/CREATED"),
    PROTOCOLDIALECTPROPERTIES_UPDATED("protdialectprops/UPDATED"),
    PROTOCOLDIALECTPROPERTIES_DELETED("protdialectprops/DELETED"),
