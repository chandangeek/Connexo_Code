...
public class LogbookLastReadingSearchableProperty extends AbstractSearchableDeviceProperty {
    ...
    LogbookLastReadingSearchableProperty init(DeviceSearchDomain domain, SearchablePropertyGroup parent) {
        this.domain = domain;
    ...
    public String getDisplayName() {
        return this.thesaurus.getFormat(PropertyTranslationKeys.LOGBOOK_LAST_READING).format();
    }
