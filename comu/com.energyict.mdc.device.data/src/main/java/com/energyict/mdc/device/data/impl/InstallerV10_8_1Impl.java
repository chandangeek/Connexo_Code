...
public class InstallerV10_8_1Impl implements FullInstaller {
    ...
    private String getStoredProcedureScript(String storedProcedureFile) throws IOException {
        StringWriter writer = new StringWriter();
        try(InputStream inputStream = this.getClass().getResourceAsStream("/sql/v10.8.1/"+storedProcedureFile);) {
    ...
    private String getRefreshConTaskDashboardJobStatement() {
        return getRefreshJob("REF_CONTASK_DASHBOARD", "CONNECTION_TASK_STATUS();", 5);
    }

    private String getRefreshComTaskDashboardJobStatement() {
        return getRefreshJob("REF_COMTASK_DASHBOARD", "COMMUNICATION_TASK_STATUS();", 5);
    }
