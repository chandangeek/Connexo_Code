 ...
 * certificate import
 */
@Component(name = "com.energyict.servicecall.ami.import.certificate.handler",
        service = ServiceCallHandler.class,
        immediate = true,
        property = "name=" + ImportCertificateServiceCallHandler.SERVICE_CALL_HANDLER_NAME)
public class ImportCertificateServiceCallHandler extends AbstractOperationServiceCallHandler {

    public static final String VERSION = "v1.0";
    public static final String SERVICE_CALL_HANDLER_NAME = "DeviceImportCertificateServiceCallHandler";

    public ImportCertificateServiceCallHandler() {
        super();
    }

    // Constructor only to be used in JUnit tests
    public ImportCertificateServiceCallHandler(MessageService messageService, Thesaurus thesaurus, CompletionOptionsCallBack completionOptionsCallBack,
