...
public enum SubscriberTranslationKeys implements TranslationKey {
    ...
    DASHBOARD_BREAKDOWN_TASK_SUBSCRIBER_NAME(DashboardBreakdownHandlerFactory.DASHBOARD_BREAKDOWN_TASK_SUBSCRIBER, DashboardBreakdownHandlerFactory.DASHBOARD_BREAKDOWN_TASK_SUBSCRIBER_DISPLAYNAME);
