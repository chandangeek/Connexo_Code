 ...
 * key pair generation
 */
@Component(name = "com.energyict.servicecall.ami.generate.key.pair.handler",
        service = ServiceCallHandler.class,
        immediate = true,
        property = "name=" + GenerateKeyPairServiceCallHandler.SERVICE_CALL_HANDLER_NAME)
public class GenerateKeyPairServiceCallHandler extends AbstractOperationServiceCallHandler {

    public static final String VERSION = "v1.0";
    public static final String SERVICE_CALL_HANDLER_NAME = "DeviceGenerateKeyPairServiceCallHandler";

    public GenerateKeyPairServiceCallHandler() {
        super();
    }

    // Constructor only to be used in JUnit tests
    public GenerateKeyPairServiceCallHandler(MessageService messageService, Thesaurus thesaurus, CompletionOptionsCallBack completionOptionsCallBack,
