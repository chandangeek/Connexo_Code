...
public enum TableSpecs {
    ...
    DDC_COMTASKEXEC {
        ...
        public void addTo(DataModel dataModel, Encrypter encrypter) {
            ...
            table.column("TRACED").number().conversion(NUMBER2BOOLEAN).map(ComTaskExecutionFields.TRACED.fieldName()).since(version(10, 4, 24)).notAudited().installValue("1").add();
    ...
    DDC_DEVICEMESSAGE {
        ...
        void addTo(DataModel dataModel, Encrypter encrypter) {
            ...
            table.index("IX_DDC_DEVICEMESSAGE_ID").on(messageId).add().since(version(10,4,22));
