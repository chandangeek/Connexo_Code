...
public class ConnectionTaskComPortPoolStatusCountSqlBuilder extends AbstractConnectionTaskFilterSqlBuilder {
    ...
    public ConnectionTaskComPortPoolStatusCountSqlBuilder(ServerConnectionTaskStatus taskStatus, Clock clock, List<EndDeviceGroup> deviceGroups, QueryExecutor<Device> deviceQueryExecutor) {
