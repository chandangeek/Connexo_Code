...
public class KeyRenewalCommands extends EndDeviceCommandImpl {

    private List<SecurityAccessorTypeOnDeviceType> securityAccessorTypeOnDeviceTypes;

    public KeyRenewalCommands(EndDevice endDevice, EndDeviceControlType endDeviceControlType, List<DeviceMessageId> possibleDeviceMessageIds, DeviceService deviceService, DeviceMessageSpecificationService deviceMessageSpecificationService, Thesaurus thesaurus) {
