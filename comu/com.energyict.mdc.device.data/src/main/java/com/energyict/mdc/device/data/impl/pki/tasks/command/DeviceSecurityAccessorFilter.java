...
public class DeviceSecurityAccessorFilter implements Command {
    ...
    public void run(SecurityAccessor securityAccessor) throws CommandAbortException {
        ...
        Optional<SecurityAccessorTypeOnDeviceType> securityAccessorsOnDeviceType = securityAccessor.getDevice().getDeviceType().getSecurityAccessor(securityAccessor.getKeyAccessorTypeReference());
