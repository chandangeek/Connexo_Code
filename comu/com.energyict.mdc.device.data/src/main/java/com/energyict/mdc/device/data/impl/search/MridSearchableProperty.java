...
public class MridSearchableProperty extends AbstractSearchableDeviceProperty {

    private DeviceSearchDomain domain;
    private final PropertySpecService propertySpecService;

    @Inject
    public MridSearchableProperty(PropertySpecService propertySpecService, Thesaurus thesaurus) {
        super(thesaurus);
        this.propertySpecService = propertySpecService;
    }

    MridSearchableProperty init(DeviceSearchDomain domain) {
        this.domain = domain;
        return this;
    }
