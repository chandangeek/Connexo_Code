...
public class ConnectionTaskDeviceTypeStatusCountSqlBuilder extends AbstractConnectionTaskFilterSqlBuilder {
    ...
    public ConnectionTaskDeviceTypeStatusCountSqlBuilder(ServerConnectionTaskStatus taskStatus, Clock clock, List<EndDeviceGroup> deviceGroups, QueryExecutor<Device> deviceQueryExecutor) {
