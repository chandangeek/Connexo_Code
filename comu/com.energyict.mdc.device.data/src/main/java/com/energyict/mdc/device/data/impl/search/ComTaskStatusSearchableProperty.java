...
public class ComTaskStatusSearchableProperty extends AbstractSearchableDeviceProperty {
    ...
    public SqlFragment toSqlFragment(Condition condition, Instant now) {
        ...
        SqlFragment devicesWithSuchComTasksSql = comTaskExecutionSqlBuilder.build(new SqlBuilder("select cte.device,cte.comport,cte.obsolete_date,cte.onhold,cte.nextexecutiontimestamp,cte.ignorenextexecspecs,cte.lastexecutiontimestamp,cte.connectiontask,cte.currentretrycount,cte.lastexecutionfailed,cte.lastsuccessfulcompletion from DDC_COMTASKEXEC cte"), "cte").asBuilder();
