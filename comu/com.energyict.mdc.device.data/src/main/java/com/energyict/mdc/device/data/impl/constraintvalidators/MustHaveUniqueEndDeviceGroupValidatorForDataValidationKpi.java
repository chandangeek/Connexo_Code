...
public class MustHaveUniqueEndDeviceGroupValidatorForDataValidationKpi implements ConstraintValidator<MustHaveUniqueEndDeviceGroup, DataValidationKpi> {

    private final DataValidationKpiService dataValidationKpiService;
    private String message;

    @Inject
    public MustHaveUniqueEndDeviceGroupValidatorForDataValidationKpi(DataValidationKpiService dataValidationKpiService) {
