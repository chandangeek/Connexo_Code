...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_COMTASK_FOR_COMMAND(2110, Keys.NO_COMTASK_FOR_COMMAND, "A communication task to execute the device messages can''t be located or is inactive."),
    ...
    NO_STATUS_INFORMATION_COMTASK(2129, Keys.NO_STATUS_INFORMATION_COMTASK, "A communication task to read out the status information can''t be located or is inactive."),
    ...
    NO_SECURITY_ACCESSORS_ON_DEVICE_TYPE_FOR_NAMES(2190, "NoSecurityAccessorsOnDeviceTypeForNames", "No security accessor(s) on device type with name(s): {0}"),
    ...
    CAN_NOT_FIND_FOR_ALLOWED_CALENDAR(2208, Keys.CAN_NOT_FIND_FOR_ALLOWED_CALENDAR, "Could not find an allowed calendar for identifier ''{0}''");
    ...
    public static class Keys {
        ...
        public static final String CAN_NOT_FIND_FOR_ALLOWED_CALENDAR = "allowedCalendar.not.found";
