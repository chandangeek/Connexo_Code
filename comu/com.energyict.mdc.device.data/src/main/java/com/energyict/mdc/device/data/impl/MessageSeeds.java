...
public enum MessageSeeds implements MessageSeed {
    ...
    VETO_CERTIFICATE_MARK_OBSOLETE(2162, "VetoCertificateMarkObsolete", "Could not mark obsolete certificate ''{0}''. Certificate is still in use by device security accessors: {1}");
