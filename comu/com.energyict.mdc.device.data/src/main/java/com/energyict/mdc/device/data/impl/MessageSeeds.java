...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_SERVICE_KEY_RENEWAL_COMMAND_CONFIGURED(2200, "NoServiceKeyRenewalCommandConfigured", "No service key renewal command configured at device type level on security accessor with name {0}"),
    ;
