...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_COMTASK_EXECUTION(2197, Keys.NO_COMTASK_EXECUTION, "A communication task execution for the device messages couldn''t be located or it''s inactive."),
    NO_STATUS_INFORMATION_COMTASK_EXECUTION(2198, Keys.NO_STATUS_INFORMATION_COMTASK_EXECUTION, "A communication task execution to read out the status information couldn''t be located or it''s inactive."),
    ;
