...
public class LoadProfileLastReadingSearchableProperty extends AbstractSearchableDeviceProperty {
    ...
    LoadProfileLastReadingSearchableProperty init(DeviceSearchDomain domain, SearchablePropertyGroup parent) {
        this.domain = domain;
    ...
    public String getDisplayName() {
        return this.thesaurus.getFormat(PropertyTranslationKeys.LOADPROFILE_LAST_READING).format();
    }
