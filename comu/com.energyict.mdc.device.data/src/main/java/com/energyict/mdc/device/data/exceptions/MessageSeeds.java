...
public enum MessageSeeds implements MessageSeed {
    ...
    DUPLICATE_CONNECTION_TASK(2002, Keys.DUPLICATE_CONNECTION_TASK_KEY, "The partial connection task {0} is already used by connection task {1} on device {2} and therefore no other connection task with the same partial connection task can be added", Level.SEVERE),
    ...
    CONNECTION_TASK_PARTIAL_CONNECTION_TASK_NOT_IN_CONFIGURATION(2003, Keys.CONNECTION_TASK_PARTIAL_CONNECTION_TASK_NOT_IN_CONFIGURATION_KEY, "A connection task must be added against a partial connection task (id={0}, configuration id={1}) from the same device configuration (id={2})", Level.SEVERE),
    ...
    DEFAULT_CONNECTION_TASK_IS_INUSE_AND_CANNOT_DELETE(2007, Keys.DEFAULT_CONNECTION_TASK_IS_IN_USE_AND_CANNOT_OBSOLETE_KEY, "The default connection task ''{0}'' on device {1} cannot be removed because it is still in use by communication tasks", Level.SEVERE),
    ...
    DEVICE_PROTOCOL_DIALECT_DEVICE_REQUIRED(2026, Keys.DEVICE_PROTOCOL_DIALECT_DEVICE_REQUIRED_KEY, "Device protocol dialect properties need to be added against a device", Level.SEVERE),
    CONNECTION_TASK_CANNOT_DELETE_IF_NOT_FROM_DEVICE(2027, Keys.CONNECTION_TASK_CANNOT_DELETE_IF_NOT_FROM_DEVICE, "You can not remove connection task {0} because it is not owned by device {1}", Level.SEVERE),
    ...
    VETO_COM_SCHEDULE_DELETION(2039, Keys.VETO_COM_SCHEDULE_DELETION, "The master schedule {0} cannot be removed because it is still used by at least one device", SEVERE),
    ...
    VETO_SECURITY_PROPERTY_SET_DELETION(2043, Keys.VETO_SECURITY_PROPERTY_SET_DELETION, "The security property set {0} of device configuration {1} cannot be removed because at least one device of that configuration still has security property values for it", SEVERE),
    ...
    CAN_NOT_REPLACE_EXISTING_KPI(2065, Keys.CAN_NOT_REPLACE_EXISTING_KPI, "An existing KPI can not be replaced", Level.SEVERE );
