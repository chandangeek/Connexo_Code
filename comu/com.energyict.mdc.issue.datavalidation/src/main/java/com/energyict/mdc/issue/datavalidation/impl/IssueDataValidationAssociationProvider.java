...
public class IssueDataValidationAssociationProvider implements ProcessAssociationProvider {
    ...
    public String getName() {
        return this.thesaurus.getFormat(TranslationKeys.DATA_VALIDATION_ISSUE_ASSOCIATION_PROVIDER).format();
    }
    ...
    public Optional<PropertySpec> getPropertySpec(String name) {
        return (TranslationKeys.DATA_VALIDATION_ISSUE_REASON_TITLE.getKey()
                .equals(name)) ? Optional.of(getIssueReasonPropertySpec()) : Optional.empty();
    }

    private PropertySpec getIssueReasonPropertySpec() {
        IssueType issueType = issueService.findIssueType(IssueDataValidationService.ISSUE_TYPE_NAME).orElse(null);
        ...
        return this.propertySpecService
                ...
                .named(TranslationKeys.DATA_VALIDATION_ISSUE_REASON_TITLE.getKey(), TranslationKeys.DATA_VALIDATION_ISSUE_REASON_TITLE)
