...
public class CloseIssueActionIT extends BaseIT {
    ...
    public void testCreateAndExecuteAction() {
        ...
        properties.put(com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.CLOSE_STATUS, new com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.Status(resolvedStatus));
        properties.put(com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.COMMENT, new com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.Comment("Comment"));
    ...
    public void testExecuteActionWrongClosingStatus() {
        ...
        properties.put(com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.CLOSE_STATUS, new com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.Status(inProgressStatus));
    ...
    public void testExecuteActionIssueIsNotApplicable() {
        Map<String, Object> properties = new HashMap<>();
        IssueStatus resolvedStatus = getIssueService().findStatus(IssueStatus.RESOLVED).get();
        properties.put(com.energyict.mdc.issue.datavalidation.impl.actions.CloseIssueAction.CLOSE_STATUS, new CloseIssueAction.Status(resolvedStatus));
