Ext.define('Dal.view.Section', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.overview-of-alarms-section',
    store: null,
    requires: [
        'Uni.view.widget.Bar'
    ],
    ...
    buttons: [
        {
            text: Uni.I18n.translate('overview.alarms.showMore', 'DAL', 'Show more'),
            hidden: true,
            margin: '0 0 0 10',
            handler: function () {
        ...
        if (store.getRange().length) {
            ...
            if (me.down('button')) {
                ...
                if (me.down('button').isVisible()) {
                    me.down('button').setText(Uni.I18n.translate('overview.alarms.showMore', 'DAL', 'Show more'));
                }
            }
            ...
            Ext.Array.each(store.getRange(), function (record) {
                ...
                if (me.up('overview-of-alarms')) {
                    var href = me.up('overview-of-alarms').router.getRoute('workspace/alarms').buildUrl(null, queryString);
    ...
    moreLess: function () {
        ...
        this.down('button').setText(view.collapsed ?
            Uni.I18n.translate('overview.alarms.showLess', 'DAL', 'Show less') :
            Uni.I18n.translate('overview.alarms.showMore', 'DAL', 'Show more'));
        view.animate({
            duration: 300,
            to: {
