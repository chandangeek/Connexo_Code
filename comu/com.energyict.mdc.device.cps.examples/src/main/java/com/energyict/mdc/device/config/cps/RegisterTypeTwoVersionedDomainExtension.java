...
public class RegisterTypeTwoVersionedDomainExtension extends AbstractVersionedPersistentDomainExtension implements PersistentDomainExtension<RegisterSpec> {
    ...
    public RegisterTypeTwoVersionedDomainExtension() {
        super();
    }
