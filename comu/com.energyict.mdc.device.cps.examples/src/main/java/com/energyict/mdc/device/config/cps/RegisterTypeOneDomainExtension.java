...
public class RegisterTypeOneDomainExtension extends AbstractPersistentDomainExtension implements PersistentDomainExtension<RegisterSpec> {
    ...
    public RegisterTypeOneDomainExtension() {
        super();
    }
