...
public class DeviceTypeTwoVersionedDomainExtension extends AbstractVersionedPersistentDomainExtension implements PersistentDomainExtension<Device> {
    ...
    public DeviceTypeTwoVersionedDomainExtension() {
        super();
    }
