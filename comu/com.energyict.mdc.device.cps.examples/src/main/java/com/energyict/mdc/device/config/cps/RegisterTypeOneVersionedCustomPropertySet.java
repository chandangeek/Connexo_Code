...
public class RegisterTypeOneVersionedCustomPropertySet implements CustomPropertySet<RegisterSpec, RegisterTypeOneVersionedDomainExtension> {
    ...
    public static final String FK_REGISTER_DEVICE_VER = "FK_REGISTER_DEVICE_VER";
    ...
    @Inject
    public RegisterTypeOneVersionedCustomPropertySet(PropertySpecService propertySpecService, DeviceService deviceService, NlsService nlsService ) {
        this();
    ...
    private static class RegisterTypeOneVersionedPeristenceSupport implements PersistenceSupport<RegisterSpec, RegisterTypeOneVersionedDomainExtension> {
        ...
        public List<Column> addCustomPropertyPrimaryKeyColumnsTo(Table table) {
            Column deviceColumn =  table
                    .column(RegisterTypeOneVersionedDomainExtension.FieldNames.DEVICE.databaseName())
                    .number()
                    .map(RegisterTypeOneVersionedDomainExtension.FieldNames.DEVICE.javaName())
                    .notNull()
                    .add();
            table
                    .foreignKey(FK_REGISTER_DEVICE_VER)
                    .on(deviceColumn)
                    .references(getContextClass())
                    .map(RegisterTypeOneVersionedDomainExtension.FieldNames.DEVICE_REF.javaName())
                    .add();
