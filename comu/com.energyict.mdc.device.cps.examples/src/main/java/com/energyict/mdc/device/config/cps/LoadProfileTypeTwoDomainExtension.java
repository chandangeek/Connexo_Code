...
public class LoadProfileTypeTwoDomainExtension extends AbstractPersistentDomainExtension implements PersistentDomainExtension<ChannelSpec> {
    ...
    public LoadProfileTypeTwoDomainExtension() {
        super();
    }
