...
public enum MessageSeeds implements MessageSeed {
    ...
    REGISTER_MAPPING_STILL_USED_BY_REGISTER_GROUP(1512, "registerGroup.registerType.delete", "The register type {0} cannot be removed because it is still in use by the following register group(s): {1}", SEVERE)
    ;
