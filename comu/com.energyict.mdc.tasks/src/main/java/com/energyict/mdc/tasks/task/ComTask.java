...
/**
 * Models a set of {@link com.energyict.mdc.tasks.task.ProtocolTask}s which can be scheduled for a Device.
...
public interface ComTask {
    ...
    /**
     * Create a {@link com.energyict.mdc.tasks.task.LogBooksTask} based on the given shadow for this {@link ComTask}
     *
     * @return the newly created {@link com.energyict.mdc.tasks.task.LogBooksTask}
     * @throws BusinessException if some validation of the {@link com.energyict.mdc.tasks.task.LogBooksTask} failed or another business related error occurred
     * @throws SQLException      if a database related error occurred
     */
