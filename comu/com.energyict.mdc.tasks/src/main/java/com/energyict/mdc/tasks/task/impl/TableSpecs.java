...
import static com.energyict.mdc.tasks.task.impl.BasicCheckTaskImpl.Fields.MAXIMUM_CLOCK_DIFFERENCE;
import static com.energyict.mdc.tasks.task.impl.BasicCheckTaskImpl.Fields.VERIFY_CLOCK_DIFFERENCE;
import static com.energyict.mdc.tasks.task.impl.BasicCheckTaskImpl.Fields.VERIFY_SERIAL_NUMBER;
import static com.energyict.mdc.tasks.task.impl.ClockTaskImpl.Fields.CLOCK_TASK_TYPE;
import static com.energyict.mdc.tasks.task.impl.ClockTaskImpl.Fields.MAXIMUM_CLOCK_DIFF;
import static com.energyict.mdc.tasks.task.impl.ClockTaskImpl.Fields.MAXIMUM_CLOCK_SHIFT;
import static com.energyict.mdc.tasks.task.impl.ClockTaskImpl.Fields.MINIMUM_CLOCK_DIFF;
import static com.energyict.mdc.tasks.task.impl.LoadProfilesTaskImpl.Fields.CREATE_METER_EVENTS_FROM_STATUS_FLAGS;
import static com.energyict.mdc.tasks.task.impl.LoadProfilesTaskImpl.Fields.FAIL_IF_CONFIGURATION_MISMATCH;
import static com.energyict.mdc.tasks.task.impl.LoadProfilesTaskImpl.Fields.MARK_INTERVALS_AS_BAD_TIME;
import static com.energyict.mdc.tasks.task.impl.LoadProfilesTaskImpl.Fields.MIN_CLOCK_DIFF_BEFORE_BAD_TIME;
import static com.energyict.mdc.tasks.task.impl.MessagesTaskImpl.Fields.ALL_CATEGORIES;
import static com.energyict.mdc.tasks.task.impl.TopologyTaskImpl.Fields.TOPOLOGY_ACTION;
