...
import com.energyict.mdc.tasks.task.BasicCheckTask;
import com.energyict.mdc.tasks.task.ClockTask;
import com.energyict.mdc.tasks.task.ClockTaskType;
import com.energyict.mdc.tasks.task.ComTask;
import com.energyict.mdc.tasks.task.EventType;
import com.energyict.mdc.tasks.task.LoadProfilesTask;
import com.energyict.mdc.tasks.task.LogBooksTask;
import com.energyict.mdc.tasks.task.MessagesTask;
import com.energyict.mdc.tasks.task.ProtocolTask;
import com.energyict.mdc.tasks.task.RegistersTask;
import com.energyict.mdc.tasks.task.StatusInformationTask;
import com.energyict.mdc.tasks.task.TopologyTask;
...
/**
 * An implementation for a {@link com.energyict.mdc.tasks.task.ComTask}
 *
 * @author gna
 * @since 2/05/12 - 16:10
 */
