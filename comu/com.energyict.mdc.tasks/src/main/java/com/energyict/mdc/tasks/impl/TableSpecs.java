...
public enum TableSpecs {
    CTS_COMTASK {
        ...
        void addTo(DataModel dataModel) {
            ...
            table.column("MANUALSYSTEMTASK").number().conversion(NUMBER2BOOLEAN).map(ComTaskImpl.Fields.MANUAL_SYSTEM_TASK.fieldName()).since(Version.version(10, 7)).installValue("1").add();
