...
(function (J, ea) {
    ...
    function W(a, b, c) {
        var d, e;
        if (Da(b))t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && fa(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    var u, B = J.document, X = Math, y = X.round, U = X.floor, Fa = X.ceil, s = X.max, E = X.min, Q = X.abs, aa = X.cos, ia = X.sin, Ba = X.PI, oa = Ba * 2 / 360, La = J.navigator && J.navigator.userAgent || "", Vb = J.opera, Ja = /(msie|trident|edge)/i.test(La) && !Vb, sb = B && B.documentMode === 8, tb = !Ja && /AppleWebKit/.test(La), Za = /Firefox/.test(La), lb = /(Mobile|Android|Windows Phone)/.test(La), Qa = "http://www.w3.org/2000/svg", ha = B && B.createElementNS && !!B.createElementNS(Qa, "svg").createSVGRect, $b = Za && parseInt(La.split("Firefox/")[1],
            10) < 4, pa = B && !ha && !Ja && !!B.createElement("canvas").getContext, $a, eb, Wb = {}, Kb = 0, qb, O, la, H, qa = function () {
    }, $ = [], mb = 0, Ya = "div", ac = /^[0-9]+$/, ub = ["plotTop", "marginRight", "marginBottom", "plotLeft"], da, rb, zb, hb, Cb, Db, Eb, ib, jb, kb, Qb, Rb, Sb, Tb, Fb, Gb, Hb, K = {}, z;
    z = J.Highcharts ? ea(16, !0) : {win: J};
    z.seriesTypes = K;
    var Ra = [], wa, ra, n, Sa, Lb, sa, D, R, M, fb, Ta;
    yb.prototype = {
        dSetter: function () {
    ...
    la = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new da(b - gb(b)), e, f = d[Db](), g = d[Eb](), h = d[ib](), i = d[jb](), j = d[kb](), k = O.lang, l = k.weekdays,
            d = w({
                a: l[g].substr(0, 3),
                A: l[g],
                d: Wa(h),
    ...
    z.numberFormat = function (a, b, c, d) {
        var a = +a || 0, e = O.lang, f = (a.toString().split(".")[1] || "").length, g, h, i = Math.abs(a);
    ...
    Lb = function (a) {
        var b =
            B.documentElement, a = a.getBoundingClientRect();
        return {
    ...
    M = function (a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, h, i, c = c || {};
        if (B.createEvent && (a.dispatchEvent || a.fireEvent))e = B.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, w(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e); else if (e) {
            e = e[b] || [];
            f = e.length;
            h = function () {
    ...
    Y.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, j, k, l, m, o, q, r = [], A;
            ...
            if (f) {
                ...
                f === "radialGradient" && o && !t(g.gradientUnits) && (h = g, g = C(g, d.getRadialAttr(o, h), {gradientUnits: "userSpaceOnUse"}));
        ...
        applyTextShadow: function (a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = {}, f = this.renderer.forExport, g = f || b.style.textShadow !== u && !Ja;
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (Ja && !ha)I(this.element, a); else {
                    b = function (a, b) {
        ...
        getBBox: function (a, b) {
            ...
            e = this.textStr;
            var j, k = h.style, l, m = d.cache, o = d.cacheKeys, q;
            f = p(b, this.rotation);
            g = f * oa;
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = W(e, "zIndex"), e !== g && (G(f) > a || !t(a) && t(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    xa.prototype = {
        Element: Y, init: function (a, b, c, d, e, f) {
            ...
            "" && e.pop(), n(e, function (e, f) {
                ...
                n(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var o = {}, r = B.createElementNS(Qa, "tspan"), A;
                        ...
                        if (e !== " ") {
                            ...
                            if (m)o.dx = 0; else if (f && j !== null)o.x =
                                j;
                            W(r, o);
                            b.appendChild(r);
            ...
            return a[0] + a[1] + a[2] > 384 ? "#000000" : "#FFFFFF"
                             ...
                             b, c, d, e, f, g, h, i) {
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, o, q, r, A, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            o = e.style;
            delete e.style;
            f = C(e, {stroke: "#68A", fill: {linearGradient: a, stops: [[0, "#FFF"], [1, "#ACF"]]}}, f);
            q = f.style;
            delete f.style;
            g = C(e, {stroke: "#68A", fill: {linearGradient: a, stops: [[0, "#9BD"], [1, "#CDF"]]}}, g);
            r = g.style;
            delete g.style;
            h = C(e, {style: {color: "#CCC"}},
                h);
            A = h.style;
            delete h.style;
            ...
            arguments.length >
            1 && w(f, {x: b, y: c, width: d, height: e});
            ...
            if (i)h = this.path(i), w(h, {
                ...
                width: d,
                height: e
            }), f && w(h, f); else if (j.test(a))l = function (a, b) {
                ...
                x: b,
                y: c
            }), h.isImg = !0, a ? l(h, a) : (h.attr({width: 0, height: 0}), ca("img", {
                onload: function () {
            ...
            var j = this, k = j.g(i), l = j.text("", 0, 0, g).attr({zIndex: 1}), m, o, q = 0, r = 3, A = 0, p, v, x, N, ja = 0, Ua = {}, s, z, L, E, B;
            L = function () {
                var a, b;
                a = l.element.style;
            ...
            E = function () {
                var a = k.styles, a = a && a.textAlign, b = A + r, c;
                c = h ? 0 : s;
    ...
    w(Y.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var i = this.rotation, k = G(this.textWidth), l = j && j.whiteSpace, m = [i, g, b.innerHTML, this.textWidth, this.textAlign].join(",");
                    if (m !== this.cTT) {
                        ...
                        if (b.offsetWidth > k && /[ \-]/.test(b.textContent || b.innerText))I(b, {
                            ...
                            display: "block",
                            whiteSpace: l || "normal"
                        }), this.hasTextWidth = !0; else if (this.hasTextWidth)I(b, {
                            width: "",
                            display: "",
                            whiteSpace: l || "nowrap"
                        }), this.hasTextWidth = !1;
            ...
            var d = {}, e = Ja ? "-ms-transform" : tb ? "-webkit-transform" : Za ? "MozTransform" : Vb ? "-o-transform" : "";
    ...
    if (!ha && !pa)Z = {
        init: function (a, b) {
            ...
            var a = this.rotation, b = aa(a * oa), c = ia(a * oa);
            I(this.element, {
                filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=",
                    b, ", sizingMethod='auto expand')"].join("") : "none"
            })
        }, getSpanCorrection: function (a, b, c, d, e) {
            var f = d ? aa(d * oa) : 1, g = d ? ia(d * oa) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
            this.xCorr = f < 0 && -a;
            this.yCorr = g < 0 && -h;
            i = f * g < 0;
            this.xCorr += g * b * (i ? 1 - c : c);
            this.yCorr -= f * b * (d ? i ? c : 1 - c : 1);
            e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), I(this.element, {textAlign: e}))
            ...
            a ? (c = a.members, Aa(c, b), c.push(b), b.destroyClip = function () {
                Aa(c, b)
            }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = {clip: sb ? "inherit" : "rect(auto)"});
            return b.css(a)
        ...
        on: function (a, b) {
            ...
            return this
        }, updateShadows: qa, setAttr: function (a, b) {
        ...
        }, opacitySetter: qa, rotationSetter: function (a, b, c) {
            c = c.style;
            this[b] = c[b] = a;
        ...
        Element: Z, isIE8: La.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
            ...
            return w(e, {
                ...
                getCSS: function (a) {
                    var b = a.element,
                        c = b.nodeName, a = a.inverted, d = this.top - (c === "shape" ? b.offsetTop : 0), e = this.left, b = e + this.width, f = d + this.height, d = {clip: "rect(" + y(a ? e : d) + "px," + y(a ? f : b) + "px," + y(a ? b : f) + "px," + y(a ? d : e) + "px)"};
            ...
            if (i) {
                var k, l, m = a.linearGradient || a.radialGradient,
                    o, q, r, A, p, v = "", a = a.stops, x, N = [], ja = function () {
                ...
                if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, v =
                    'angle="' + (90 - X.atan((m - a) / (o - c)) * 180 / Ba) + '"', ja(); else {
                    var j = m.r, Ua = j * 2, t = j * 2, s = m.cx, u = m.cy, y = b.radialReference, w, j = function () {
        ...
        circle: function (a, b, c) {
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = aa(f), i = ia(f), j = aa(g), k = ia(g);
                if (g - f === 0)return ["x"];
    ...
    if (pa)z.CanVGRenderer =
        ...
        return {
            push: function (c, d) {
                if (b.length === 0) {
                    var e = B.getElementsByTagName("head")[0], f = B.createElement("script");
    ...
    db.prototype = {
        addLabel: function () {
            var a = this.axis, b = a.options, c = a.chart, d = a.categories, e = a.names, f = this.pos, g = b.labels, h = a.tickPositions, i = f === h[0], j = f === h[h.length -
                1], e = d ? p(d[f], e[f], f) : f, d = this.label, h = h.info, k;
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, E(b.pos, e[3])), e = p(b.labelRight, s(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                left: 0,
                center: 0.5,
                right: 1
            }[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, l = 1, m, o = {};
            if (h)h < 0 && c - i * j < f ? m = y(c / aa(h * oa) - f) : h > 0 && c + i * j > e && (m = y((d - c) / aa(h * oa))); else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f : d > e && (k = e - a.x + k * i, l = -1), k = E(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x +=
            ...
            if (m && n)x === "inside" && (n = -n), d.opposite && (n = -n), h = this.getMarkPath(y, s, n, m * w, g, f), o ? o.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: v, "stroke-width": m, opacity: c}).add(d.axisGroup);
    ...
    z.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = t(i) && t(h), k = d.value, l = d.dashStyle, m = a.svgElem, o = [], q,
                r = d.color, A = p(d.zIndex, 0), n = d.events, v = {}, x = b.chart.renderer;
            ...
            v.zIndex = A;
            if (m)if (o)m.show(), m.animate({d: o}); else {
                if (m.hide(), f)a.label = f = f.destroy()
            } else if (o && o.length && (a.svgElem = m = x.path(o).attr(v).add(), n))for (q in d = function (b) {
                m.on(b, function (c) {
                    n[b].apply(a,
                        [c])
                })
    ...
    F.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)g = Ka(h, this); else if (c)g = b; else if (d)g = la(d, b); else if (f && a >= 1E3)for (; f-- && g === u;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
        ...
        getLinearTickPositions: function (a, b, c) {
            var d, e = na(U(b / a) * a), f = na(Fa(c / a) * a), g = [];
        ...
        setTickInterval: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, j = d.minPadding, k = d.tickInterval, l = d.tickPixelInterval, m = b.categories, o = b.threshold, q = b.softThreshold, r, A, T, v;
            ...
            if (q && t(b.dataMin))if (o = o || 0, !t(T) && b.min < o && b.dataMin >= o)b.min = o; else if (!t(v) && b.max > o && b.dataMax <= o)b.max = o;
        ...
        getThreshold: function (a) {
            var b = this.isLog, c = b ? za(this.min) : this.min, b = b ? za(this.max) : this.max;
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g,
                h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize, a[0] && a[0].label), j, k = Number.MAX_VALUE, l, m = function (a) {
                    a /= f || 1;
                    a = a > 1 ? Fa(a) : 1;
                    return a * d
                };
        ...
        renderUnsquish: function () {
            ...
            if (this.autoRotation)n(c, function (a) {
                ...
                this.labelRotation = 0; else if (g && (l = {width: i + "px"}, !k)) {
                l.textOverflow = "clip";
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, o = 0, q = d.title, r = d.labels, A = 0, T = a.opposite, v = b.axisOffset, b = b.clipOffset,
                x = [-1, 1, 1, -1][h], N, ja = a.axisParent;
            j = a.hasData();
            a.showAxis = k = j || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && r.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(ja), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(ja), a.labelGroup = c.g("axis-labels").attr({zIndex: r.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(ja);
            if (j || a.isLinked) {
                if (n(e, function (b) {
        ...
        getLinePath: function (a) {
            var b = this.chart, c = this.opposite, d = this.offset, e = this.horiz, f = this.left +
                (c ? this.width : 0) + d, d = b.chartHeight - this.bottom - (c ? this.height : 0) + d;
            c && (a *= -1);
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, l = d.stackLabels, m = d.alternateGridColor, o = a.tickmarkOffset, q = d.lineWidth, r, A = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin), p = a.showAxis, v = c.globalAnimation, x, N;
            ...
            n([i, j, k], function (a) {
                var c, d, e = [], f = v ? v.duration || 500 : 0;
        ...
        drawCrosshair: function (a, b) {
            ...
            if (!this.crosshair || (t(b) || !p(d.snap, !0)) === !1)this.hideCrosshair(); else if (p(d.snap, !0) ? t(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ?
                a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)this.hideCrosshair(); else if (e = this.categories && !this.isRadial, f = p(d.width, e ? this.transA : 1), this.cross)this.cross.attr({
                d: c,
                visibility: "visible",
                "stroke-width": f
            }); else {
    ...
    F.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [], f = {}, g = O.global.useUTC, h, i = new da(b - gb(b)), j = a.unitRange, k = a.count;
        if (t(b)) {
            i[Qb](j >= H.second ? 0 : k *
    ...
    F.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week",
                [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = H[d[0]], f = d[1], g;
    ...
    F.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = y(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = U(b), h,
    ...
    Mb.prototype = {
        init: function (a, b) {
            ...
            c.push(a.tooltipFooterHeaderFormatter(b[0],
                !0));
            return c.join("")
            ...
            }), i = {x: a[0].category, y: a[0].y}, i.points =
                k, this.len = k.length, a = a[0]) : i = a.getLabelConfig();
            j = j.call(i, this);
            i = a.series;
            this.distance = p(i.tooltipOptions.distance, 16);
            j === !1 ? this.hide() : (this.isHidden && (Ta(d), d.attr("opacity", 1).show()), d.attr({text: j}), l = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: l}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow,
            ...
            var c = b ? "footer" : "header", d = a.series, e = d.tooltipOptions, f = e.xDateFormat, g = d.xAxis, h = g && g.options.type === "datetime" && ta(a.key), c = e[c + "Format"];
    ...
    ab.prototype = {
        init: function (a, b) {
            var c = b.chart, d = c.events, e = pa ? "" : c.zoomType, c = a.inverted, f;
            this.options = b;
            this.chart = a;
            ...
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h = [Number.MAX_VALUE, Number.MAX_VALUE], i, j, k = [], l = [], m;
            ...
            if (l[0] && (l[0] !== this.prevKDPoint || d && d.isHidden))if (e && !l[0].series.noSharedTooltip)k.length && d && d.refresh(k, a), n(k, function (b) {
            ...
            var b = this.chart, c =
                b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, m = this.selectionMarker, o = this.mouseDownX, q = this.mouseDownY, r = c.panKey && a[c.panKey + "Key"];
            if (!m || !m.touch)if (d < h ? d = h : d > h + j && (d = h + j), e < i ? e = i : e > i + k && (e = i + k), this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || d)n(c.axes, function (c) {
                    if (c.zoomEnabled &&
                        t(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
        ...
        onContainerMouseDown: function (a) {
            ...
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (M(c.series, "click", w(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (w(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY -
                e) && M(b, "click", a)))
    ...
    w(z.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" +
                k, m = a ? "width" : "height", o = i["plot" + (a ? "Left" : "Top")], q, r, A = h || 1, p = i.inverted, n = i.bounds[a ? "h" : "v"], x = b.length === 1, N = b[0][l], s = c[0][l], t = !x && b[1][l], y = !x && c[1][l], u, c = function () {
            ...
            var b =
                this, c = b.chart, d = b.pinchDown, e = a.touches, f = e.length, g = b.lastValidTouch, h = b.hasZoom, i = b.selectionMarker, j = {}, k = f === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || b.runChartClick), l = {};
            ...
            if (a.type === "touchstart")n(e, function (a, b) {
                ...
                if (a.zoomEnabled) {
                    var b =
                        c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = E(e, f), e = s(e, f);
                    b.min = E(a.pos, g - d);
    ...
    if (J.PointerEvent || J.MSPointerEvent) {
        var Ga = {}, Nb = !!J.PointerEvent, bc = function () {
            ...
            b.push({pageX: Ga[a].pageX, pageY: Ga[a].pageY, target: Ga[a].target});
            return b
        }, Ob = function (a, b, c, d) {
    ...
    vb.prototype = {
        ...
        destroy: function () {
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding,
                h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, o = d.itemMarginBottom || 0, q = this.itemMarginTop, r = this.initialItemX, A = a.legendItem, n = a.series && a.series.drawLegendSymbol ? a.series : a, v = n.options, v = this.createCheckboxForItem && v && v.showCheckbox, x = d.useHTML;
            if (!A) {
            ...
            var b = this,
                c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, m = this.nav, o = this.pages, q = this.padding, r, A = this.allItems, T = function (a) {
                    i.attr({height: a});
            ...
            if (a > f) {
                ...
                this.fullHeight = a;
                n(A, function (a, b) {
                    var c = a._legendItemPos[1], d = y(a.legendItem.getBBox().height), e = o.length;
    ...
    Ca.prototype = {
        callbacks: [], getArgs: function () {
            ...
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, l = k, m = this.renderer, o = m.isHidden(), q = [];
            cb(a, this);
            ...
            d && (d.css({width: (e.width || h) + "px"}).align(w({y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Fa(b + d.getBBox().height)));
        ...
        getMargins: function (a) {
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || wa(d, "width"), f = c.height || wa(d, "height"), c = a ? a.target : J;
            ...
            x ? x.animate({width: s.width, height: s.height}) : this.clipRect =
                b.clipRect(s);
    ...
    Ha.prototype = {
        init: function (a, b, c) {
            ...
            if (typeof a === "number" || a === null)b[e[0]] = a; else if (Ma(a)) {
                if (!d && a.length > f) {
                    c = typeof a[0];
    ...
    P.prototype = {
        ...
        init: function (a, b) {
            var c =
                this, d, e, f = a.series, g = function (a, b) {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l && !!l.categories, o = i.turboThreshold, q = this.xData, r = this.yData, A = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)n(a, function (a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (ta(k)) {
                        ...
                        e.xIncrement = m
                    } else if (Ma(k))if (A)for (c = 0; c < h; c++)k = a[c], q[c] = k[0], r[c] = k.slice(1, A + 1); else for (c = 0; c < h; c++)k = a[c], q[c] = k[0], r[c] = k[1]; else ea(12)
                } else for (c = 0; c < h; c++)if (a[c] !== u && (k = {series: e}, e.pointClass.prototype.applyOptions.apply(k, [a[c]]), e.updateParallelArrays(k,
        ...
        processData: function (a) {
            ...
            var k = this.getExtremesFromAll || j.getExtremesFromAll, l = this.isCartesian,
                j = h && h.val2lin, m = h && h.isLog, o, q;
            if (l && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
            if (h)a = h.getExtremes(), o = a.min, q = a.max;
            if (l && this.sorted && !k && (!i || d > i || this.forceCrop))if (b[d - 1] < o || b[0] > q)b = [], c = []; else if (b[0] < o || b[d - 1] > q)e = this.cropData(this.xData, this.yData, o, q), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        getExtremes: function (a) {
            ...
            for (l = 0; l < d; l++)if (j = c[l], k = a[l], i = k !== null && k !==
                    u && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !== null && (e[f++] = k[i]); else e[f++] = k;
            this.dataMin = Oa(e);
            this.dataMax = Ea(e)
        },
        translate: function () {
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, m = this.pointAttr[""], o,
                q, r, n = this.markerGroup, s = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
        ...
        getAttribs: function () {
            ...
            k = b.turboThreshold;
            var r = a.zones, A = a.zoneAxis || "y", s;
        ...
        destroy: function () {
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(La), d, e = a.data || [], f, g, h;
            M(a, "destroy");
            R(a);
        ...
        drawGraph: function () {
            ...
            this.getGraphPath).call(this), g = this.fillGraph && this.color || "none";
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer,
                d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = s(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m, o = l.reversed, q = b.inverted, r = l.horiz, A, T, v, x = !1;
        ...
        searchKDTree: function (a, b) {
            function c(a, b, j, k) {
                var l = b.point, m = d.kdAxisArray[j % k], o, q, r = l;
    ...
    P.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData,
                c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ? f : 0, h = e.stack, e = e.stacking, i = this.stackKey, j = "-" + i, k = this.negStacks, l = this.yAxis, m = l.stacks, o = l.oldStacks, q, r, n, T, v, x, t;
            l.stacksTouched += 1;
            for (v = 0; v < d; v++) {
                x = a[v];
                t = b[v];
    ...
    P.prototype.setPercentStacks = function () {
        ...
        n([b, "-" + b], function (b) {
            var f;
            for (var g = d.length, h, i; g--;)if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f)i = i.total ? 100 / i.total : 0, h[0] = na(h[0] * i), h[1] = na(h[1] * i), a.stackedYData[g] = h[1]
        })
    };
    ...
    w(Ca.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!d)b.loadingDiv = d = ca(Ya, {className: "highcharts-loading"}, w(e.style, {
                zIndex: 10,
                display: "none"
    ...
    w(P.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names, l = h && h.shift || 0, m = ["graph", "area"], h = f.data, o, q = e.xData;
            cb(d, j);
            if (c) {
            ...
            var c = this, d =
                this.chart, e = this.userOptions, f = this.type, g = K[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
    ...
    var ya = ka(P, {
        type: "area", singleStacks: !1, getStackPoints: function () {
            var a = [], b = [], c = this.xAxis, d = this.yAxis, e = d.stacks[this.stackKey], f = {}, g = this.points, h = this.index, i = d.series, j = i.length, k, l = p(d.options.reversedStacks, !0) ? 1 : -1, m, o;
            if (this.options.stacking) {
                ...
                n(b, function (g, i) {
                    ...
                    if (f[g] && !f[g].isNull)a.push(f[g]), n([-1, 1], function (a) {
                        var c = a === 1 ? "rightNull" : "leftNull", d = 0, o = e[b[i + a]];
                        if (o)for (m = h; m >= 0 && m < j;)p = o.points[m], p || (m === h ? f[g][c] = !0 : k[m] && (v = e[g].points[m]) && (d -= v[1] - v[0])), m += l;
            ...
            var b = P.prototype.getGraphPath, c = this.options, d = c.stacking,
                e = this.yAxis, f, g, h = [], i = [], j = this.index, k, l = e.stacks[this.stackKey], m = c.threshold, o = e.getThreshold(c.threshold), q, c = c.connectNulls || d === "percent", r = function (b, c, f) {
                    var g = a[b], b = d && l[g.x].points[j], q = g[f + "Null"] || 0, f = g[f + "Cliff"] || 0, r, n, g = !0;
    ...
    Ia = ka(P, {
        ...
        getColumnMetrics: function () {
            ...
            var i = E(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = i * b.groupPadding, k = (i - 2 * j) / h, b = E(b.maxPointWidth || c.len, p(b.pointWidth, k * (1 - 2 * b.pointPadding)));
            a.columnMetrics = {
                width: b,
        ...
        translate: function () {
            ...
            n(a.points, function (c) {
                var d = E(p(c.yBottom, f), 9E4), h = 999 + Q(d), h = E(s(-h, c.plotY), e.len + h), q = c.plotX + k, r = j, n = E(h, d), t, v = s(h, d) - n;
        ...
        drawPoints: function () {
            var a =
                this, b = this.chart, c = a.options, d = b.renderer, e = c.animationLimit || 250, f, g;
    ...
    ba = {
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = Ba / 180 * (i - 90), i = (this.endAngleRad = Ba / 180 * (p(c.endAngle, i + 360) - 90)) - j, k =
                this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, o = k.length, q;
        ...
        drawPoints: function () {
            ...
            n(a.points, function (j) {
                if (j.y !== null) {
                    ...
                    f && f.attr(c);
                    if (d)d.setRadialReference(a.center).attr(g).animate(w(h, c)); else {
    ...
    P.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || D(a, "afterAnimate", function () {
            ...
            var h, o = e.dataLabel, q, r, n = e.connector, s = !0, v, x = {};
            ...
            if (o && !h)e.dataLabel = o.destroy(); else if (h) {
                ...
                if (o)if (t(i))o.attr({text: i}), s = !1; else {
    ...
    P.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart,
            g = f.inverted, h = p(a.plotX, -9999), i = p(a.plotY, -9999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, l = c.rotation, m = c.align, o = this.visible && (a.series.forceDL || f.isInsidePlot(h, y(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)), q = p(c.overflow, "justify") === "justify";
        if (o)d = w({
            x: g ? f.plotWidth - i : h,
    ...
    if (K.pie)K.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth,
            1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), m = e.distance, o = a.center, q = o[2] / 2, r = o[1], A = m > 0, t, v, x, u = [[], []], w, z, C, B, L, D = [0, 0, 0, 0], J = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (F) {
                    ...
                    if (m > 0) {
                        ...
                        for (L = 0; L < F; L++) {
                            ...
                            if (H < L && G[L] !== null)H = L; else for (v < F - L + H && G[L] !== null && (H = v - F + L); G[H] === null;)H++;
                            K.push({i: H, y: G[H]});
                            G[H] = null
                        }
                        K.sort(J)
            ...
            A && g && n(this.points, function (b) {
                j = b.connector;
                x = b.labelPos;
                if ((t = b.dataLabel) && t._pos && b.visible)C = t._attr.visibility, w = t.connX, z = t.connY, k = l ? ["M", w + (x[6] === "left" ? 5 : -5), z, "C", w, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", w + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], j ? (j.animate({d: k}), j.attr("visibility", C)) : b.connector = j = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
    ...
    (function (a) {
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            var b = a.length, d, e, j, k, l, m, o, q, r;
            ...
            for (e = 0; e < b; e++) {
                j =
                    a[e];
                for (d = e + 1; d < b; ++d)if (k = a[d], j && k && j.placed && k.placed && j.newOpacity !== 0 && k.newOpacity !== 0 && (l = j.alignAttr, m = k.alignAttr, o = j.parentGroup, q = k.parentGroup, r = 2 * (j.box ? 0 : j.padding), l = !(m.x + q.translateX > l.x + o.translateX + (j.width - r) || m.x + q.translateX + (k.width - r) < l.x + o.translateX || m.y + q.translateY > l.y + o.translateY + (j.height - r) || m.y + q.translateY + (k.height - r) < l.y + o.translateY)))(j.labelrank < k.labelrank ? j : k).newOpacity = 0
            }
            c(a, function (a) {
                var b, c;
                if (a) {
        ...
        showResetZoom: function () {
            ...
            n(b === "xy" ? [1, 0] : [1], function (b) {
                var b = c[b ? "xAxis" : "yAxis"][0], d = b.horiz, h = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", i = c[d], j = (b.pointRange || 0) / 2, k = b.getExtremes(), l = b.toValue(i -
                        h, !0) + j, j = b.toValue(i + b.len - h, !0) - j, i = i > h;
                if (b.series.length && (i || l > E(k.dataMin, k.min)) && (!i || j < s(k.dataMax, k.max)))b.setExtremes(l, j, !1, !1, {trigger: "pan"}), e = !0;
                c[d] = h
            });
            e && c.redraw(!1);
    ...
    w(Ha.prototype, {
        select: function (a, b) {
            ...
            var c = U(this.plotX), d = this.plotY, e = this.series, f = e.options.states, g = V[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, o = e.halo, q, a = a || "";
            q = this.pointAttr[a] ||
                e.pointAttr[a];
    ...
    S(F.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        var i = 0, j, k, l = {}, m, o, q, r = [], n = -Number.MAX_VALUE, p = this.options.tickPixelInterval;
    ...
    w(F.prototype, {
        beforeSetTickPositions: function () {
            ...
            if (c) {
                ...
                if (b)a < 0 ? a = c[0] : a > f ? a = c[f] : (f = U(a), h = a - f); else for (; f--;)if (g = d * f + e, a >= g) {
                    d = d * (f + 1) + e;
                    h = (a - g) / (d - g);
                    break
                }
    ...
    (function (a) {
        ...
        e(i.prototype, "init", function (a, b, c) {
            ...
            if (this.options.breaks) {
                ...
                this.setAxisTranslation = function (a) {
                    ...
                    var b = d.options.breaks, a = [], c = [], e = 0, f, g, k = d.userMin || d.min, j = d.userMax || d.max, m, l;
        ...
        e(j.prototype, "generatePoints", function (a) {
            ...
            var c =
                this.xAxis, d = this.yAxis, e = this.points, f, g = e.length, h = this.options.connectNulls, i;
        ...
        a.Series.prototype.drawBreaks = function () {
            var a = this, b = a.points, c, e, g, i, j;
            f(["y", "x"], function (n) {
                c = a[n + "Axis"];
                e = c.breakArray || [];
                ...
                f(b, function (a) {
                    ...
                    f(e, function (b) {
                        i = !1;
                        if (g < b.from && j > b.to || g > b.from && j < b.from)i = "pointBreak"; else if (g < b.from && j > b.from && j < b.to || g > b.from && j > b.to && j < b.from)i = "pointInBreak";
    ...
    var ga = P.prototype, dc = ga.processData, ec = ga.generatePoints, fc = ga.destroy, gc = {
    ...
    }, Zb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Va = {
        sum: function (a) {
            var b = a.length, c;
            if (!b && a.hasNulls)c = null; else if (b)for (c = 0; b--;)c += a[b];
            return c
        }, average: function (a) {
            var b = a.length, a = Va.sum(a);
            typeof a ===
            "number" && b && (a /= b);
            return a
        }, open: function (a) {
    ...
    ga.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, l = !!b, m = [[], [], [], []], d = typeof d === "function" ? d : Va[d], o = this.pointArrayMap, q = o && o.length, n;
        for (n = 0; n <= i; n++)if (a[n] >= c[0])break;
        for (; n <= i; n++) {
            for (; c[1] !== u && a[n] >= c[1] || n === i;)if (j = c.shift(), k = d.apply(0, m), k !== u && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i)break;
            if (n === i)break;
            if (o) {
                j = this.cropStart + n;
    ...
    ga.processData = function () {
        ...
        if (dc.apply(this, arguments) !== !1 && c) {
            ...
            var e = this.processedXData, f = this.processedYData,
                g = a.plotSizeX, a = this.xAxis, h = a.options.ordinal, i = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth();
            if (i) {
                d = !0;
                this.points = null;
                var j = a.getExtremes(), c = j.min, j = j.max, h = h && a.getGroupIntervalFactor(c, j, this) || 1, g = i * (j - c) / g * h, i = a.getTimeTicks(a.normalizeTimeTickInterval(g, b.units || Zb), Math.min(c, e[0]), Math.max(j, e[e.length - 1]), a.options.startOfWeek, e, this.closestPointRange), f = ga.groupData.apply(this, [e, f, i, b.approximation]), e = f[0], f = f[1];
                if (b.smoothed) {
                    b = e.length - 1;
    ...
    F.prototype.setDataGrouping = function (a, b) {
        ...
        if (this instanceof F)for (c = this.series.length; c--;)this.series[c].update({dataGrouping: a},
    ...
    K.flags = ka(K.column, {
        ...
        translate: function () {
            ...
            e = g && b.get(g);
            var a = a.onKey || "y", g = e && e.options.step, h = e && e.points, i = h && h.length, j = this.xAxis, k = j.getExtremes(), l, m, o;
            if (e && e.visible && i) {
        ...
        drawPoints: function () {
            var a, b = this.pointAttr[""], c = this.points, d = this.chart.renderer, e, f, g = this.options, h = g.y, i, j, k, l, m, o;
            for (j = c.length; j--;)if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX, e > 0 && (e -= p(k.lineWidth, g.lineWidth) % 2), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== u && (f = k.plotY + h - (l !== u && l * g.stackDistance)),
    ...
    var ba = [].concat(Zb), xb = function (a) {
    ...
    Ib.prototype = {
        drawHandle: function (a, b) {
            ...
            var e = this.chart, f = e.renderer, g, h, i, j, k = this.scrollbarGroup, l = this.navigatorGroup, m = this.scrollbar, l = this.xAxis, o = this.scrollbarTrack, n = this.scrollbarHeight, r = this.scrollbarEnabled, A = this.navigatorOptions, u = this.scrollbarOptions, v = u.minWidth, x = this.height, w = this.top, z = this.navigatorEnabled, C = A.outlineWidth, B = C / 2, D = 0, G = this.outlineHeight,
                I = u.barBorderRadius, H = u.barBorderWidth, F = w + B, J;
            if (t(a) && !(isNaN(a) || this.hasDragged && !t(c))) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    a = c - b;
                    if (!this.rendered) {
                        if (z)this.navigatorGroup = l = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: A.maskFill}).add(l), A.maskInside ? this.leftShade.css({cursor: "ew-resize"}) : this.rightShade = f.rect().attr({fill: A.maskFill}).add(l), this.outline = f.path().attr({
                            "stroke-width": C,
                    ...
                    if (z) {
                        ...
                        {x: g + b, y: w, width: c - b, height: x} : {x: g, y: w, width: b, height: x});
                        if (this.rightShade)this.rightShade[e]({x: g + c, y: w, width: h - c, height: x});
                        this.outline[e]({d: ["M", i, F, "L", g + b - B, F, g + b - B, F + G, "L", g + c - B, F + G, "L", g + c - B, F, i + j, F].concat(A.maskInside ? ["M", g + b + B, F, "L", g + c - B, F] : [])});
                    ...
                    if (r && k)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                        translateX: i,
                        translateY: y(F + x)
                    }), o[e]({width: j}), g = n + b, h = a - H, h < v && (D = (v - h) / 2, h = v, g -= D), this.scrollbarPad = D, m[e]({
                        x: U(g) + H %
                        2 / 2, width: h
                    }), v = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({d: ["M", v - 3, n / 4, "L", v - 3, 2 * n / 3, "M", v, n / 4, "L", v, 2 * n / 3, "M", v + 3, n / 4, "L", v + 3, 2 * n / 3]});
                    this.scrollbarPad = D;
                    this.rendered = !0
                }
            }
            ...
            e = [[a, "mousedown", b], [a, "mousemove", c], [B, "mouseup", d]];
            ...
            a.mouseMoveHandler = function (c) {
                var d = a.scrollbarHeight, e = a.navigatorLeft, f = a.navigatorWidth, g = a.scrollerLeft, h = a.scrollerWidth, k = a.range, j, l;
            ...
            n && (i || j) ? isNaN(l) || c.setExtremes(l, k, !0, !1, {trigger: "updatedData"}) : (m && this.chart.redraw(!1), a.render(s(e, g), E(f, d)))
        }, destroy: function () {
            this.removeEvents();
    ...
    S(F.prototype, "zoom", function (a, b, c) {
        ...
        if (this.isXAxis && (g && g.enabled || e && e.enabled))if (f === "x")d.resetZoomButton =
            "blocked"; else if (f === "y")h = !1; else if (f === "xy")d = this.previousZoom, t(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
    ...
    Jb.prototype = {
        clickButton: function (a, b) {
            var c = this,
                d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin, k = i.dataMax, l, m = h && y(E(h.max, p(k, h.max))), o = g.type, q, i = g._range, r, t, w, v = g.dataGrouping;
            if (!(j === null || k === null || a === c.selected)) {
                ...
                if (o === "month" || o === "year")if (h) {
                    ...
                    g; else if (i)l = s(m - i, j), m = E(l + i, k); else if (o === "ytd")if (h) {
        ...
        updateButtonStates: function (a) {
            ...
            n(b.buttonOptions, function (a, e) {
                var m = y(d.max - d.min), o = a._range, n = a.type, p = a.count || 1, t = o > g - f, s = o < d.minRange, v = a.type === "all" && d.max - d.min >= g - f && j[e].state !== 2, u = a.type === "ytd" && la("%Y", f) ===
                    la("%Y", g), w = c.renderer.forExport && e === h, o = o === m, z = !d.hasVisibleSeries;
                if ((n === "month" || n === "year") && m >= {month: 28, year: 365}[n] * 864E5 * p && m <= {
                        month: 31,
                        year: 366
                    }[n] * 864E5 * p)o = !0;
        ...
        drawInput: function (a) {
            ...
            this[a + "Label"] = j = e.label(O.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 2}).css(C(d, f.labelStyle)).add(k);
            k.offset += j.width + 5;
            this[a + "DateBox"] = e = e.label("", k.offset).attr({
                padding: 2, width: f.inputBoxWidth || 90, height: f.inputBoxHeight ||
            ...
            i.onchange = function () {
                var a = i.value, d = (f.inputDateParser || da.parse)(a), e = c.xAxis[0], g = e.dataMin, j = e.dataMax;
                isNaN(d) && (d = a.split("-"), d = da.UTC(G(d[0]), G(d[1]) - 1, G(d[2])));
                isNaN(d) || (O.global.useUTC || (d += (new da).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = u : d < g && (d = g) : d < b.minInput.HCTime ? d = u : d > j && (d = j), d !== u && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, u, u, {trigger: "rangeSelectorInput"}))
            }
        },
        ...
        render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, g = O.lang, k = c.div, k = c.inputGroup, l = i.buttonTheme, m = i.buttonPosition || {}, o = i.inputEnabled, q = l && l.states, r = d.plotLeft, s, u = this.getPosition(), v = c.group, x = c.rendered;
            if (!x && (c.group = v = e.g("range-selector-buttons").add(), c.zoomText = e.text(g.rangeSelectorZoom,
                    ...
                    j[b] = e.button(a.text, s, 0, function () {
                        c.clickButton(b);
                        c.isActive = !0
                    }, l, q && q.hover, q && q.select, q && q.disabled).css({textAlign: "center"}).add(v);
    ...
    F.prototype.minFromRange = function () {
        var a = this.range, b = {month: "Month", year: "FullYear"}[a.type],
            c, d = this.max, e, f, g = function (a, c) {
                var d = new da(a);
                d["set" + b](d["get" + b]() + c);
                return d.getTime() - a
            };
    ...
    z.StockChart = z.stockChart = function (a, b, c) {
        var d = Da(a) || a.nodeName, e = arguments[d ? 1 : 0], f = e.series, g, h = p(e.navigator && e.navigator.enabled, !0) ? {
            startOnTick: !1,
            endOnTick: !1
    ...
    S(F.prototype, "getPlotLinePath", function (a, b, c, d, e, f) {
        var g = this, h = this.isLinked && !this.series ? this.linkedParent.series : this.series, i = g.chart, j = i.renderer, k = g.left, l = g.top, m, o, q, r, u = [], w = [], v, x;
    ...
    S(F.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled) {
            var a = this.chart, f = this.options.crosshair.label,
                g = this.horiz, h = this.opposite, i = this.left, j = this.top, k = this.crossLabel, l, m = f.format, n = "", q = this.options.tickPosition === "inside", r = this.crosshair.snap !== !1;
    ...
    var hc = ga.init, ic = ga.processData, jc = Ha.prototype.tooltipFormatter;
    ga.init = function () {
    ...
    ga.processData = function () {
        ...
        if (this.xAxis && this.processedYData) {
            ...
            for (a = 0; a < e; a++)if (f = b > -1 ? d[a][b] : d[a], typeof f === "number" &&
...
(function (a) {
    ...
    a.seriesTypes.solidgauge = a.extendClass(a.seriesTypes.gauge, {
        type: "solidgauge", pointAttrToOptions: {}, bindAxes: function () {
            ...
            var b = this, e = b.yAxis, i = e.center, c = b.options, g = b.chart.renderer, d = c.overshoot, f = d && typeof d === "number" ? d / 180 * Math.PI : 0;
            a.each(b.points, function (a) {
                var d = a.graphic, j = e.startAngleRad +
                    e.translate(a.y, null, null, null, !0), k = r(s(a.options.radius, c.radius, 100)) * i[2] / 200, m = r(s(a.options.innerRadius, c.innerRadius, 60)) * i[2] / 200, n = e.toColor(a.y, a), o = Math.min(e.startAngleRad, e.endAngleRad), l = Math.max(e.startAngleRad, e.endAngleRad);
    ...
    r.funnel = b.extendClass(r.pie, {
        ...
        translate: function () {
            ...
            B(a.data, function (d) {
                ...
                g = {
                    fill: d.color,
                    stroke: F(c.borderColor, b.borderColor),
                    "stroke-width": F(c.borderWidth, b.borderWidth)
                };
