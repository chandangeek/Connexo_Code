...
//        HttpResource resource = new HttpResource(HTTP_RESOURCE_ALIAS, HTTP_RESOURCE_LOCAL_NAME, new BundleResolver(context));
      ...
      HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "C:\\repository\\connexo\\comu\\com.energyict.mdc.firmware.extjs\\src\\main\\web\\js\\firmware", new FileResolver());
