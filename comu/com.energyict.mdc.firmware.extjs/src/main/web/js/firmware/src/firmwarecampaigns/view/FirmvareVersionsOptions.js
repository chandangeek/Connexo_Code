                        ...
                        items: [
                            {
                                ...
                                boxLabel: '<b>' + Uni.I18n.translate('general.targetFirmwareFinalOption', 'FWC', 'The target firmware version should have a higher rank than the current firmware version on the device with the same type') + '</b>',
                                inputValue: 'COMMON',
                                margin: '10 0',
                                listeners: {
                                    change: function(checkBox, value) {
