...
public enum MessageSeeds implements MessageSeed {
    ...
    FIRMWARE_CHECK_TASK_IS_NOT_ACTIVE(1009, "FirmwareCheckTaskIsNotActive", "The 'Check firmware version' action can't be executed because there is no communication task with the read status information action available on the device configuration"),
