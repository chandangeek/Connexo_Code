...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_SUCH_SECURITY_ACCESSOR(1017, "NoSuchSecurityAccessor", "No such security accessor"),
    SECURITY_ACCESSOR_EXPIRED(1018, "SecurityAccessorExpired", "Security accessor expired"),
    SIGNATURE_VALIDATION_FAILED(1019, "SignatureValidationFailed", "Incorrect signature"),
    ;
