...
public class FirmwareCampaignInfoFactory {
    ...
    public FirmwareCampaignInfo from(FirmwareCampaign campaign) {
        ...
        info.firmwareUploadComTask = campaign.getFirmwareUploadComTaskId() == 0 ? null : new IdWithNameInfo(campaign.getFirmwareUploadComTaskId(), taskService.findComTask(campaign.getFirmwareUploadComTaskId()).get().getName());
        ...
        info.validationComTask = campaign.getValidationComTaskId() == 0 ? null : new IdWithNameInfo(campaign.getValidationComTaskId(), taskService.findComTask(campaign.getValidationComTaskId()).get().getName());
