...
import com.energyict.mdc.issue.devicelifecycle.extjs.IdlUiInstaller;
...
public class IdcUiInstallerTest {
    ...
    public void testPropertyValuesDoNotExceed256Chars() throws Exception {
        ...
        properties.load(IdlUiInstaller.class.getClassLoader().getResourceAsStream("i18n.properties"));
