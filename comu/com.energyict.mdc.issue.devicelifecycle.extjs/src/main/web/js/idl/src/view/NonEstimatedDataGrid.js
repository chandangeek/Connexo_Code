...
Ext.define('Idl.view.NonEstimatedDataGrid', {
    ...
    features: [{
        ...
        '<span class="uni-icon-info-small" style="cursor: pointer; display: inline-block; width: 16px; height: 16px; float: none" data-qtip="' + Uni.I18n.translate('readingType.tooltip', 'IDL', 'Reading type info') + '"></span>', //{rows.length}
    }],
