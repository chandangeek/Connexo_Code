...
public class IdlUiInstaller implements TranslationKeyProvider {
    ...
    public void activate(BundleContext context) {
        ...
        //HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "C:\\git10.6\\connexo\\comu\\com.energyict.mdc.issue.devicelifecycle.extjs\\src\\main\\web\\js\\idl", new FileResolver());
