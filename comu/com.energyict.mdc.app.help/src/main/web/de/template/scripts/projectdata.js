...
rh.consts('DEFAULT_TOPIC', encodeURI("#UGde-DE000031_00_Connexo_MultiSense_10_4_Benutzeranleitung/00_Titelseite/00_Titelseite.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', 'BC45FAF2-86A6-420E-BFF0-CA5F72E00FE5' || 'preview');
