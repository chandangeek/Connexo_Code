...
(function () {
    ...
    rh.consts('DEFAULT_TOPIC', encodeURI("#UGen-GB000016_Connexo_MultiSense_10_5_user_guide/Cover_Page/Cover_Page.htm".substring(1)));
    rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
    rh.consts('HELP_ID', '4AB4FE8E-92B1-4971-ABB1-C4F452639F8F' || 'preview');
