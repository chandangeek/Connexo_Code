...
/**
 * Tests that all {@link TranslationKey}s that are defined in {@link EndDeviceEventMessageHandlerFactory} are acceptable and unique.
 */
public class TranslationKeysTest {
    ...
    public void testTranslationKeys() {
        ...
        for (TranslationKey entry : new EndDeviceEventMessageHandlerFactory().getKeys()) {
