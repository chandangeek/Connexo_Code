 ...
 * @since 28.06.17 - 11:59
 */
public class DummyDeviceProtocolPluggableClassHavingConnectionFunctions implements DeviceProtocol {

    private ConnectionFunction connectionFunction_1, connectionFunction_2, connectionFunction_3;

    public DummyDeviceProtocolPluggableClassHavingConnectionFunctions() {
        connectionFunction_1 = mockConnectionFunction(1, "CF_1", "CF 1");
        connectionFunction_2 = mockConnectionFunction(2, "CF_2", "CF 2");
        connectionFunction_3 = mockConnectionFunction(3, "CF_2", "CF 2");
    }

    @Override
    public List<UPLConnectionFunction> getProvidedConnectionFunctions() {
        return Arrays.asList(connectionFunction_1, connectionFunction_2);
    }

    @Override
    public List<UPLConnectionFunction> getConsumableConnectionFunctions() {
        return Collections.singletonList(connectionFunction_3);
    }
    ...
    @Override
    public String format(com.energyict.mdc.upl.offline.OfflineDevice offlineDevice, OfflineDeviceMessage offlineDeviceMessage, PropertySpec propertySpec, Object messageAttribute) {
        return null;
    }
    ...
    @Override
    public List<com.elster.jupiter.properties.PropertySpec> getPropertySpecs() {
        return Collections.emptyList();
    }
