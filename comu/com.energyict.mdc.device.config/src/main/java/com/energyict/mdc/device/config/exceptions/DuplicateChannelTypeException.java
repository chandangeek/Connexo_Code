...
public class DuplicateChannelTypeException extends LocalizedException {
     ...
     */
    public static DuplicateChannelTypeException forChannelSpecInLoadProfileSpec(ChannelSpec channelSpec, MeasurementType measurementType, LoadProfileSpec loadProfileSpec, Thesaurus thesaurus, MessageSeed messageSeed) {
