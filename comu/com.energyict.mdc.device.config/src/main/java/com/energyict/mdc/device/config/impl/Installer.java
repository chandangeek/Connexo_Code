...
public class Installer {
    ...
    private void createDTCPrivileges() {
        ...
        this.userService.createResourceWithPrivileges("MDC", "deviceConfiguration.deviceConfigurations.legacy", "compatibility.with.EIServer", collect.toArray(new String[collect.size()]));
    }
