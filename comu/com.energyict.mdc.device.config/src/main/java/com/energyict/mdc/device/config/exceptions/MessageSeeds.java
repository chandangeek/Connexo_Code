...
public enum MessageSeeds implements MessageSeed {
    ...
    LOAD_PROFILE_SPEC_LOAD_PROFILE_TYPE_IS_NOT_ON_DEVICE_TYPE(8002, "loadProfileSpec.cannotAddLoadProfileSpecOfTypeXBecauseDeviceTypeYDoesNotContainIt", "The load profile spec contains a load profile type {0} which is not configured on the device type", SEVERE),
    ...
    LOGBOOK_SPEC_LOGBOOK_TYPE_IS_NOT_ON_DEVICE_TYPE(9003, "logBookSpec.cannotAddLogBookSpecOfTypeXBecauseDeviceTypeYDoesNotContainIt", "The logbook specification contains a logbook type {0} which is not configured on the device type", SEVERE),
