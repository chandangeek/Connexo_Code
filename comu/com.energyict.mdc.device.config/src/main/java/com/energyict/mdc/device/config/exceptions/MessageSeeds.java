...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    LOAD_PROFILE_TYPE_STILL_IN_USE_BY_LOAD_PROFILE_SPECS(4011, "loadProfileType.XstillInUseByLoadProfileSpecsY", "The load profile type with reading type {0} cannot be removed because it is still in use by the following load profile spec(s): {1}", SEVERE),
    LOAD_PROFILE_TYPE_STILL_IN_USE_BY_DEVICE_TYPES(4012, "loadProfileType.XstillInUseByDeviceTypesY", "The load profile type with reading type {0} cannot be removed because it is still in use by the following device type(s): {1}", SEVERE),
    ...
    LOG_BOOK_TYPE_STILL_IN_USE_BY_LOG_BOOK_SPECS(5001, "logBookType.XstillInUseByLogBookSpecsY", "The log book type {0} cannot be removed because it is still in use by the following log book spec(s): {1}", SEVERE),
    ...
    DEVICE_LIFE_CYCLE_REQUIRED(7009, Keys.DEVICE_LIFE_CYCLE_REQUIRED, "Device life cycle is required", SEVERE),
    ...
    LOAD_PROFILE_SPEC_CANNOT_DELETE_FROM_ACTIVE_CONFIG(8006, "loadProfileSpec.cannot.delete.active.config", "You can not remove a load profile configuration \"{0}\" from an active device configuration \"{1}\"", SEVERE),
    LOAD_PROFILE_SPEC_CANNOT_DELETE_STILL_LINKED_CHANNEL_SPECS(8007, "loadProfileSpec.cannot.delete.linked.channel.specs", "Cannot remove load profile configuration because there are still channel specs linked", SEVERE),
    ...
    CHANNEL_SPEC_CANNOT_DELETE_FROM_ACTIVE_CONFIG(11005, "channelSpec.cannot.delete.active.config", "You can not remove a channel configuration \"{0}\" from an active device configuration \"{1}\"", SEVERE),
    ...
    DEVICE_CONFIGURATION_IS_ACTIVE_CAN_NOT_DELETE(12003, "deviceConfig.active", "You can not remove an active device configuration", SEVERE),
    DEVICE_CONFIGURATION_DUPLICATE_LOAD_PROFILE_TYPE_IN_SPEC(12004, "deviceConfig.duplicate.loadProfileType", "The device configuration \"{0}\" already contains a load profile configuration with the load profile type \"{1}\"", SEVERE),
    DEVICE_CONFIGURATION_DUPLICATE_OBIS_CODE_FOR_LOAD_PROFILE_SPEC(12005, "deviceConfig.duplicate.obisCode.loadProfileSpec", "The device configuration \"{0}\" already contains a load profile configuration with the OBIS code \"{1}\"", SEVERE),
    DEVICE_CONFIGURATION_DUPLICATE_LOG_BOOK_TYPE_IN_SPEC(12006, "deviceConfig.duplicate.logBookType", "The device configuration \"{0}\" already contains a logbook configuration with the logbook type \"{1}\"", SEVERE),
    DEVICE_CONFIGURATION_DUPLICATE_OBIS_CODE_FOR_LOGBOOK_SPEC(12007, "deviceConfig.duplicate.obisCode.logBookSpec", "The device configuration \"{0}\" already contains a logbook configuration with the OBIS code \"{1}\"", SEVERE),
    ...
    DEVICE_CONFIGURATION_DUPLICATE_OBIS_CODE_FOR_CHANNEL_SPEC_IN_LOAD_PROFILE_SPEC(12009, "deviceConfig.duplicate.obisCode.channelSpec.loadProfileSpec", "Load profile configuration \"{0}\" in device configuration \"{1}\" already contains a channel configuration with the OBIS code \"{2}\"", SEVERE),
    DEVICE_CONFIGURATION_DUPLICATE_OBIS_CODE_FOR_CHANNEL_SPEC(12010, "deviceConfig.duplicate.obisCode.channelSpec", "The device configuration \"{0}\" already contains a channel configuration with the OBIS code \"{1}\"", SEVERE),
    ...
    DEVICE_CONFIGURATION_IS_NOT_DIRECTLY_ADDRESSABLE(12015, Keys.DEVICE_CONFIGURATION_IS_NOT_DIRECTLY_ADDRESSABLE, "It is not allowed to create connection methods because the device configuration is not directly addressable", SEVERE),
    ...
    PROTOCOLDIALECT_CONF_PROPS_CANT_DROP_REQUIRED(13015, "protocolDialectConfigurationProperties.cannotDropRequired", "ProtocolDialectConfigurationProperties {0} cannot drop property {1} since it is required.", SEVERE),
    PROTOCOLDIALECT_CONF_PROPS_IN_USE(13016, "protocolDialectConfigurationProperties.inUse", "ProtocolDialectConfigurationProperties ''{0}'' of device configuration ''{1}'' cannot be removed because they are still in use", SEVERE),
    PROTOCOL_INVALID_NAME(13017,"deviceType.no.such.protocol", "A protocol with name {0} does not exist", SEVERE),
    PROTOCOL_HAS_NO_SUCH_PROPERTY(13018, "protocolConfigurationProperties.noSuchProperty", "The protocol {0} does not have a configuration property with name {1}", SEVERE),
    ...
    UNDER_MINIMUM_RESCHEDULE_DELAY(15009, Keys.UNDER_MINIMUM_RESCHEDULE_DELAY, "Reschedule delay is below minimum.", SEVERE),
    VETO_CONNECTIONTYPE_PLUGGABLECLASS_DELETION(15010, "connectionTypePluggableClass.XstillInUseByY", "ConnectionType Pluggable Class {0} is still in use by {1}", SEVERE),
    VETO_COMPORTPOOL_DELETION(15011, "comPortPoolXstillInUseByY", "ComPortPool {0} is still in use by connection method(s): {1}", SEVERE),
    ORIGIN_CONNECTION_TASK_IS_EMPTY(15012, "originConnectionTaskIsEmpty", "The value of the origin connection task is empty", SEVERE),
    DESTINATION_CONNECTION_TASK_IS_EMPTY(15013, "destinationConnectionTaskIsEmpty", "The value of the destination connection task is empty", SEVERE),
    ORIGIN_SECURITY_PROPERTY_SET_IS_EMPTY(15014, "originSecurityPropertySetIsEmpty", "The value of the origin security property set is empty", SEVERE),
    DESTINATION_SECURITY_PROPERTY_SET_IS_EMPTY(15015, "destinationSecurityPropertySetIsEmpty", "The value of the destination security property set is empty", SEVERE),
    ;
