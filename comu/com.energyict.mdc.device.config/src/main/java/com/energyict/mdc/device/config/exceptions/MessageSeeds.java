...
public enum MessageSeeds implements MessageSeed {
    ...
    PROTOCOLDIALECT_CONF_PROPS_IN_USE(13029, "protocolDialectConfigurationProperties.inUse", "ProtocolDialectConfigurationProperties ''{0}'' of device configuration ''{1}'' cannot be removed because they are still in use", SEVERE),
