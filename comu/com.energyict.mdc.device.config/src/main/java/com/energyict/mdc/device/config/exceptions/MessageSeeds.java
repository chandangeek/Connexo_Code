...
public enum MessageSeeds implements MessageSeed {
    ...
    REGISTER_SPEC_REGISTER_MAPPING_IS_NOT_ON_DEVICE_TYPE(6010, "registerSpec.not.deviceType","The register spec contains a register mapping {0} which is not configured on the device type", Level.SEVERE),
