...
public class VetoDeleteConnectionTypePluggableClassException extends LocalizedException {
    ...
    public VetoDeleteConnectionTypePluggableClassException(Thesaurus thesaurus, List<PartialConnectionTask> clients) {
        super(thesaurus, MessageSeeds.VETO_CONNECTIONTYPE_PLUGGABLECLASS_DELETION, asString(clients));
    }
