...
public enum MessageSeeds implements MessageSeed {
    ...
    public static class Keys {
        ...
        public static final String MAX_FILE_SIZE_EXCEEDED_MB = "MaxFileSizeExceeded";
        public static final String MAX_FILE_SIZE_EXCEEDED_KB = "MaxFileSizeExceededKb";
        ...
        public static final String MULTI_ELEMENT_ENABLED_CANNOT_CHANGE_ON_ACTIVE_CONFIG =  "multi.element.enabled.change.on.active.config";
