...
public enum MessageSeeds implements MessageSeed {
    ...
    MAX_FILE_SIZE_EXCEEDED(1006, Keys.MAX_FILE_SIZE_EXCEEDED, "File size should be less than {max} MB"),
    ...
    DATALOGGER_ENABLED_CANNOT_CHANGE_ON_ACTIVE_CONFIG(7016, Keys.DATALOGGER_ENABLED_CANNOT_CHANGE_ON_ACTIVE_CONFIG, "You can not change the datalogger enabled functionality on an active device configuration"),
