...
package com.energyict.mdc.device.lifecycle.config.extjs;
...
public class DeviceLifeCycleUIInstaller implements TranslationKeyProvider {
    ...
    public static final String HTTP_RESOURCE_LOCAL_NAME = "/js/dlc";
    private static final Logger LOGGER = Logger.getLogger(DeviceLifeCycleUIInstaller.class.getName());
    public static final String COMPONENT_NAME = "DLC";
    private volatile ServiceRegistration<HttpResource> registration;

    public DeviceLifeCycleUIInstaller() {
    }
    ...
    public void activate(BundleContext context) {
      ...
      //  HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "C:\\repository\\connexo\\comu\\com.energyict.mdc.device.lifecycle.config.extjs\\src\\main\\web\\js\\dlc", new FileResolver());
