...
public class RegisteredSearchableProperty extends AbstractSearchableDeviceProperty {

    public static final String PROPERTY_NAME = DeviceSAPInfoDomainExtension.FieldNames.REGISTERED.javaName();
    private final PropertySpecService propertySpecService;
    private final OrmService ormService;
    private SearchablePropertyGroup group;

    @Inject
    public RegisteredSearchableProperty(PropertySpecService propertySpecService, Thesaurus thesaurus, OrmService ormService) {
        super(thesaurus);
        this.propertySpecService = propertySpecService;
        this.ormService = ormService;
    }

    public RegisteredSearchableProperty init(SearchablePropertyGroup group) {
        this.group = group;
        return this;
    }
    ...
    protected TranslationKey getNameTranslationKey() {
        return PropertyTranslationKeys.REGISTERED;
    }
