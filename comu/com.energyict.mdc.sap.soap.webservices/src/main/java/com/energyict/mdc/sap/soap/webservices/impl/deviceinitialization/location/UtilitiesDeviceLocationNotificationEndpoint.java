...
public class UtilitiesDeviceLocationNotificationEndpoint extends AbstractLocationNotificationEndpoint implements UtilitiesDeviceERPSmartMeterLocationNotificationCIn {
    ...
    @Inject
    UtilitiesDeviceLocationNotificationEndpoint(ServiceCallService serviceCallService, Thesaurus thesaurus, ServiceCallCommands serviceCallCommands, SAPCustomPropertySets sapCustomPropertySets) {
