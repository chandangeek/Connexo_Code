...
public class UtilitiesDeviceLocationBulkNotificationEndpoint implements UtilitiesDeviceERPSmartMeterLocationBulkNotificationCIn {
    ...
    @Inject
    UtilitiesDeviceLocationBulkNotificationEndpoint(SAPCustomPropertySets sapCustomPropertySets, ThreadPrincipalService threadPrincipalService, UserService userService, TransactionService transactionService) {
