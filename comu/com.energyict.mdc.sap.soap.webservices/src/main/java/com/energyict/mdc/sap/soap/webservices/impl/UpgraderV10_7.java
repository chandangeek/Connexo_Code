...
public class UpgraderV10_7 implements Upgrader {
    ...
    private List<String> updateColumnFromNumberToChar(String tableName, String oldColumnName, String newColumnName){
            return Arrays.asList("update " + tableName + " set " + newColumnName + " = to_char(" + oldColumnName + ")",
                    "alter table " + tableName + " drop column " + oldColumnName + " cascade constraints");
    }
