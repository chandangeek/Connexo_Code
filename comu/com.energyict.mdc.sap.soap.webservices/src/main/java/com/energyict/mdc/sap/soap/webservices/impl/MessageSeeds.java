...
public enum MessageSeeds implements MessageSeed {
    ...
    SEVERAL_DATA_SOURCES_WITH_KIND(4027, "SeveralDataSourcesWithKind",
            "Multiple data sources with ''{0}'' (''{1}'',''{2}'') period, ''{3}'' (''{4}'') kind and SAP CAS are found. Please check the device configuration or precise the request"),
    SEVERAL_DATA_SOURCES_WITH_OBIS_OR_KIND(4028, "SeveralDataSourcesWithObisAndKind",
            "Multiple data sources with ''{0}'' (''{1}'',''{2}'') period, ''{3}'' (''{4}'') kind or OBIS code ''{5}'', and SAP CAS are found. Please check the device configuration or precise the request"),
    ...
    NO_DATA_SOURCES_WITH_KIND(4030, "NoDataSourcesWithKind",
            "Data sources with ''{0}'' (''{1}'',''{2}'') period, ''{3}'' (''{4}'') kind and SAP CAS aren''t found. Please check the device configuration or precise the request"),
    NO_DATA_SOURCES_WITH_OBIS_OR_KIND(4031, "NoDataSourcesWithObisAndKind",
            "Data sources with ''{0}'' (''{1}'',''{2}'') period, ''{3}'' (''{4}'') kind or OBIS code ''{5}'', and SAP CAS aren''t found. Please check the device configuration or precise the request"),
