...
public enum MessageSeeds implements MessageSeed {
    ...
    SEVERAL_DATA_SOURCES_WITH_OBIS(4026, "SeveralDataSourcesWithObis",
            "Multiple data sources with period ''{0}'' and OBIS code ''{0}'' found. Please check the device configuration or precise the request"),
    SEVERAL_DATA_SOURCES_WITH_KIND(4027, "SeveralDataSourcesWithKind",
            "Multiple data sources with period ''{0}'' and ''{1}'' kind found. Please check the device configuration or precise the request"),
    SEVERAL_DATA_SOURCES_WITH_OBIS_AND_KIND(4028, "SeveralDataSourcesWithObisAndKind",
            "Multiple data sources with period ''{0}'', ''{1}'' kind and OBIS code ''{2}'' found. Please check the device configuration or precise the request"),
    NO_DATA_SOURCES_WITH_OBIS(4029, "NoDataSourcesWithObis",
            "Data sources with period ''{0}'' OBIS code ''{0}'' not found. Please check the device configuration or precise the request"),
    NO_DATA_SOURCES_WITH_KIND(4030, "NoDataSourcesWithKind",
            "Data sources with period ''{0}'' and ''{1}'' kind not found. Please check the device configuration or precise the request"),
    NO_DATA_SOURCES_WITH_OBIS_AND_KIND(4031, "NoDataSourcesWithObisAndKind",
            "Data sources with period ''{0}'', ''{1}'' kind and OBIS code ''{2}'' not found. Please check the device configuration or precise the request"),
