...
public enum MessageSeeds implements MessageSeed {
    ...
    DEVICE_NOT_ACTIVE(4026, "DeviceNotActive", "Device with SAP id {0} isn''t in active state."),
    ...
    ERROR_CANCELLING_STATUS_CHANGE_REQUEST_LOG(5003, "ErrorCancellingStatusChangeRequestLog", "''{0}'' of ''{1}'' status change requests are cancelled. ''{2}'' status change requests are not cancelled."),
    ...
    ERROR_CANCELLING_STATUS_CHANGE_REQUEST_ALREADY_PROCESSED(5005, "ErrorCancellingStatusChangeRequestAlreadyProcessed", "Status change request with id ''{0}'' and category code ''{1}'' is already processed."),
