...
public class RegisterCreateRequestHandler {
    ...
    @Inject
    public RegisterCreateRequestHandler(ServiceCallCommands serviceCallCommands, EndPointConfigurationService endPointConfigurationService,
    ...
    public void handleRequestMessage(UtilitiesDeviceRegisterCreateRequestMessage requestMessage) {
        checkRequiredEndpoints();
        createServiceCallAndTransition(requestMessage);
    }

    public void handleRequestMessage(MeterRegisterBulkChangeRequestMessage requestMessage) {
        checkRequiredEndpoints();
        createServiceCallAndTransition(UtilitiesDeviceRegisterCreateRequestMessage.builder().from(requestMessage).build());
    }

    public void handleRequestMessage(MeterRegisterChangeMessage requestMessage) {
        checkRequiredEndpoints();
        createServiceCallAndTransition(UtilitiesDeviceRegisterCreateRequestMessage.builder().from(requestMessage).build());
    }
    ...
    private void checkRequiredEndpoints() {
