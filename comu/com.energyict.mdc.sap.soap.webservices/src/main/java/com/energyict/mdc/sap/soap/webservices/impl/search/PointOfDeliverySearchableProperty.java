...
public class PointOfDeliverySearchableProperty extends AbstractSearchableDeviceProperty {

    public static final String PROPERTY_NAME = DeviceSAPInfoDomainExtension.FieldNames.POINT_OF_DELIVERY.javaName();
    private final PropertySpecService propertySpecService;
    private final OrmService ormService;
    private SearchablePropertyGroup group;

    @Inject
    public PointOfDeliverySearchableProperty(PropertySpecService propertySpecService, Thesaurus thesaurus, OrmService ormService) {
        super(thesaurus);
        this.propertySpecService = propertySpecService;
        this.ormService = ormService;
    }

    public PointOfDeliverySearchableProperty init(SearchablePropertyGroup group) {
        this.group = group;
        return this;
    }
    ...
    protected TranslationKey getNameTranslationKey() {
        return PropertyTranslationKeys.POINT_OF_DELIVERY;
    }
