...
public class DeviceIdentifierSearchableProperty extends AbstractSearchableDeviceProperty {

    public static final String PROPERTY_NAME = DeviceSAPInfoDomainExtension.FieldNames.DEVICE_IDENTIFIER.javaName();
    private final PropertySpecService propertySpecService;
    private final OrmService ormService;
    private SearchablePropertyGroup group;

    @Inject
    public DeviceIdentifierSearchableProperty(PropertySpecService propertySpecService, Thesaurus thesaurus, OrmService ormService) {
        super(thesaurus);
        this.propertySpecService = propertySpecService;
        this.ormService = ormService;
    }

    public DeviceIdentifierSearchableProperty init(SearchablePropertyGroup group) {
        this.group = group;
        return this;
    }
    ...
    protected TranslationKey getNameTranslationKey() {
        return PropertyTranslationKeys.DEVICE_IDENTIFIER;
    }
