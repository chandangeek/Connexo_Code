...
public class MeterReadingDocumentCreateRequestCustomPropertySet implements CustomPropertySet<ServiceCall, MeterReadingDocumentCreateRequestDomainExtension> {
    ...
    public List<PropertySpec> getPropertySpecs() {
        return Arrays.asList(
                ...
                this.propertySpecService
                        .bigDecimalSpec()
                        .named(MeterReadingDocumentCreateRequestDomainExtension.FieldNames.CHANNEL_ID.javaName(), TranslationKeys.CHANNEL_REGISTER_ID)
                        .describedAs(TranslationKeys.CHANNEL_REGISTER_ID)
                        .fromThesaurus(thesaurus)
                        .finish(),
                this.propertySpecService
                        .stringSpec()
