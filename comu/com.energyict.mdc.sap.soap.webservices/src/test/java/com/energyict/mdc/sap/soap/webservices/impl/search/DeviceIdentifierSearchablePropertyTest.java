...
public class DeviceIdentifierSearchablePropertyTest {
    ...
    public void initializeMocks() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.DEVICE_IDENTIFIER.getDefaultFormat());
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.DEVICE_IDENTIFIER);
    }
    ...
    private SearchableDeviceProperty getTestInstance() {
        return new DeviceIdentifierSearchableProperty(propertySpecService, thesaurus, ormService).init(this.parentGroup);
    }
}
