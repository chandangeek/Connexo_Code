...
/**
 * Tests that all {@link TranslationKey}s that are defined in {@link WebServiceActivator} are acceptable and unique.
 */
public class SAPTranslationKeysTest {

    @Test
    public void testTranslationKeys() {
        Set<String> uniqueKeys = new HashSet<>();
        for (TranslationKey entry : new WebServiceActivator().getKeys()) {
