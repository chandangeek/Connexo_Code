...
public class DeviceLocationSearchablePropertyTest {
    ...
    private SearchableDeviceProperty getTestInstance() {
        return new DeviceLocationSearchableProperty(propertySpecService, thesaurus, ormService).init(this.parentGroup);
    }
}
