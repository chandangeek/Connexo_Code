...
public class UtilitiesTimeSeriesBulkChangeRequestProviderTest extends AbstractOutboundWebserviceTest<UtilitiesTimeSeriesERPItemBulkChangeRequestCOut> {
    ...
    public void setUp() {
        ...
        when(meterReadingData1.getItem().getReadingInterval()).thenReturn(Optional.empty());
        ...
        when(meterReadingData2.getItem().getReadingInterval()).thenReturn(Optional.empty());
