...
public class PointOfDeliverySearchablePropertyTest {
    ...
    public void initializeMocks() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.POINT_OF_DELIVERY.getDefaultFormat());
        when(thesaurus.getFormat(PropertyTranslationKeys.POINT_OF_DELIVERY)).thenReturn(messageFormat);
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.POINT_OF_DELIVERY);
    }
    ...
    private SearchableDeviceProperty getTestInstance() {
        return new PointOfDeliverySearchableProperty(propertySpecService, thesaurus, ormService).init(this.parentGroup);
    }
}
