...
public class ProfileIdSearchablePropertyTest {
    ...
    public void initializeMocks() {
        ...
        when(messageFormat.format(anyVararg())).thenReturn(PropertyTranslationKeys.PROFILE_ID.getDefaultFormat());
        when(thesaurus.getFormat(PropertyTranslationKeys.PROFILE_ID)).thenReturn(messageFormat);
    ...
    public void testTranslation() {
        ...
        // Asserts
        verify(this.thesaurus).getFormat(PropertyTranslationKeys.PROFILE_ID);
    }
    ...
    public void testToSqlFragment() {
        ...
        verify(queryExecutor).asFragment(any(Condition.class), eq(DeviceChannelSAPInfoDomainExtension.FieldNames.DEVICE_ID.javaName()));
    }

    private SearchableDeviceProperty getTestInstance() {
        return new ProfileIdSearchableProperty(propertySpecService, thesaurus, ormService).init(this.parentGroup);
    }
}
