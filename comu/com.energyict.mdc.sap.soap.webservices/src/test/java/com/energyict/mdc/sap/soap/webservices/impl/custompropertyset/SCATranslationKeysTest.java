...
/**
 * Tests that all {@link TranslationKey}s that are defined in {@link SAPCustomPropertySetsImpl} are acceptable and unique.
 */
public class SCATranslationKeysTest {

    @Test
    public void testTranslationKeys() {
        Set<String> uniqueKeys = new HashSet<>();
        for (TranslationKey entry : new SAPCustomPropertySetsImpl().getKeys()) {
