...
public enum MicroActionTranslationKey implements TranslationKey {
    ...
    MICRO_ACTION_NAME_ACTIVATE_ALL_RECURRING_COMMUNICATIONS(Keys.MICRO_ACTION_NAME_TRANSLATE_KEY+ MicroAction.ACTIVATE_ALL_RECURRING_COMMUNICATIONS, "Activate recurring communications"),
    ...
    MICRO_ACTION_DESCRIPTION_ACTIVATE_ALL_RECURRING_COMMUNICATIONS(Keys.MICRO_ACTION_DESCRIPTION_TRANSLATE_KEY + MicroAction.ACTIVATE_ALL_RECURRING_COMMUNICATIONS, "Activate all recurring communication tasks on this device."),
