...
public enum MicroActionTranslationKey implements TranslationKey {
    ...
    MICRO_ACTION_DESCRIPTION_SET_MULTIPLIER(DeviceLifeCycleService.MicroActionPropertyName.MULTIPLIER.key(), "Set the multiplier on the device. The collected data can be multiplied by this value if it is configured on the respective readingtype."),
    ;
