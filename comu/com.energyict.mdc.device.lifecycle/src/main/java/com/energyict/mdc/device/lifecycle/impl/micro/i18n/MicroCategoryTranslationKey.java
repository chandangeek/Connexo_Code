...
public enum MicroCategoryTranslationKey implements TranslationKey {
    ...
    TRANSITION_ACTION_CHECK_CATEGORY_ISSUES(Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.ISSUES, "Issues and alarms"),
    ...
    TRANSITION_ACTION_CHECK_CATEGORY_MONITORING(Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.MONITORING, "Monitoring"),
    TRANSITION_ACTION_CHECK_CATEGORY_DECOMMISSION(Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.DECOMMISSION, "Decommission"),
    TRANSITION_ACTION_CHECK_CATEGORY_MULTIELEMENT(Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.MULTIELEMENT, "Multi-element"),
    TRANSITION_ACTION_CHECK_CATEGORY_ZONES(Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.ZONES, "Zones")
    ;
