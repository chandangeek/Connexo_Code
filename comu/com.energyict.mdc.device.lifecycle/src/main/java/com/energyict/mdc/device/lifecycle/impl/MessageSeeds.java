...
public enum MessageSeeds implements MessageSeed {
    ...
    METROLOGY_CONFIGURATION_IN_CORRECT_STATE_IF_ANY(10017, MicroCheck.METROLOGY_CONFIGURATION_IN_CORRECT_STATE_IF_ANY, "The device is still linked to an operational usage point"),
    // MicroActions
