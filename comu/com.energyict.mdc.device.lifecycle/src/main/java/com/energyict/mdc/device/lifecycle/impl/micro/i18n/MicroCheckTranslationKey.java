...
public enum MicroCheckTranslationKey implements TranslationKey {
    ...
    MICRO_CHECK_NAME_NO_LINKED_MULTI_ELEMENT_SLAVES(Keys.MICRO_CHECK_NAME_TRANSLATE_KEY + MicroCheck.NO_LINKED_MULTI_ELEMENT_SLAVES, "Still multi-element slaves linked to the device."),
    ...
    MICRO_CHECK_DESCRIPTION_NO_LINKED_MULTI_ELEMENT_SLAVES(Keys.MICRO_CHECK_DESCRIPTION_TRANSLATE_KEY + MicroCheck.NO_LINKED_MULTI_ELEMENT_SLAVES, "Check if there are still multi-element slaves linked to the device.")
    ;
