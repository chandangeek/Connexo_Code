...
public class MicroCheckTranslations {
    ...
    public enum Name implements TranslationKey {
        ...
        METROLOGY_CONFIGURATION_IN_CORRECT_STATE_IF_ANY(MetrologyConfigurationInCorrectStateIfAny.class, "This device is linked to an usage point and cannot be moved from its operational life cycle stage. A metrology configuration is active on the usage point at the moment of the life cycle transition."),
    ...
    public enum Message implements MessageSeed {
        ...
        METROLOGY_CONFIGURATION_IN_CORRECT_STATE_IF_ANY(10010, MetrologyConfigurationInCorrectStateIfAny.class, "This device is linked to an usage point and cannot be moved from its operational life cycle stage. A metrology configuration is active on the usage point at the moment of the life cycle transition."),
