...
public class InMemoryPersistence {
    ...
    private DeviceLifeCycleServiceImpl lifeCycleService;
    ...
    public void initializeDatabase(String testName) {
        ...
        try (TransactionContext ctx = this.transactionService.getContext()) {
            ...
            this.lifeCycleService = this.injector.getInstance(DeviceLifeCycleServiceImpl.class);
    ...
    public DeviceLifeCycleServiceImpl getDeviceLifeCycleService() {
