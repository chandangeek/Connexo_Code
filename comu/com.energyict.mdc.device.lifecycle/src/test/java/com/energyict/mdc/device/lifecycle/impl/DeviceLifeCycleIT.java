...
public class DeviceLifeCycleIT {
    ...
    private FinateStateMachine findDefaultFinateStateMachine() {
        return inMemoryPersistence
                ...
                .orElseThrow(() -> new IllegalStateException("Please rerun " + DeviceLifeCycleServiceIT.class.getName() + " to find out why the installer has not created the default finate state machine"));
    }
