...
public class ResponseSecurityDeviceAccessLevelInfoFactory extends SelectableFieldFactory<DeviceAccessLevelInfo, Pair<DeviceProtocolPluggableClass, DeviceAccessLevel>> {

    private final MdcPropertyUtils mdcPropertyUtils;

    @Inject
    public ResponseSecurityDeviceAccessLevelInfoFactory(MdcPropertyUtils mdcPropertyUtils) {
    ...
    protected Map<String, PropertyCopier<DeviceAccessLevelInfo, Pair<DeviceProtocolPluggableClass, DeviceAccessLevel>>> buildFieldMap() {
        ...
        map.put("properties", (deviceAccessLevelInfo, pair, uriInfo) ->
                        deviceAccessLevelInfo.properties = mdcPropertyUtils.convertPropertySpecsToPropertyInfos(pair.getLast().getSecurityProperties(), TypedProperties.empty()));
    ...
    private UriBuilder getUriBuilder(UriInfo uriInfo) {
        return uriInfo.getBaseUriBuilder().
                ...
                path(ResponseSecurityDeviceAccessLevelResource.class, "getResponseSecurityDeviceAccessLevel");
    }
}
