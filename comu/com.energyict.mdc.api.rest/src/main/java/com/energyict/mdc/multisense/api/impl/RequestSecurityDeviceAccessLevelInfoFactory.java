...
public class RequestSecurityDeviceAccessLevelInfoFactory extends SelectableFieldFactory<DeviceAccessLevelInfo, Pair<DeviceProtocolPluggableClass, DeviceAccessLevel>> {

    private final MdcPropertyUtils mdcPropertyUtils;

    @Inject
    public RequestSecurityDeviceAccessLevelInfoFactory(MdcPropertyUtils mdcPropertyUtils) {
    ...
    private UriBuilder getUriBuilder(UriInfo uriInfo) {
        return uriInfo.getBaseUriBuilder().
                ...
                path(RequestSecurityDeviceAccessLevelResource.class, "getRequestSecurityDeviceAccessLevel");
    }
}
