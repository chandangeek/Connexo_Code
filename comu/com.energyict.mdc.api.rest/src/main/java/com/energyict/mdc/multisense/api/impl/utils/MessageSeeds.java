...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_SUCH_KEYACCESSORTYPE_FOR_DEVICE(82, "NoSuchKeyAccessorTypeForDevice", "No such security accessor on this device."),
    NO_SUCH_KEYACCESSOR_FOR_DEVICE(83, "NoSuchKeyAccessorForDevice", "No values defined for such security accessor on this device."),
