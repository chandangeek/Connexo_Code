...
//        when(clientPropertySpec.getName()).thenReturn("Client");
    ...
    public void testDeviceProtocolPluggableClassFields() throws Exception {
        ...
        assertThat(model.<List<String>>get("$")).containsOnly("id", "link", "name", "version", "javaClassName", "client", "securitySuites", "authenticationAccessLevels", "encryptionAccessLevels", "requestSecurityAccessLevels", "responseSecurityAccessLevels");
    }
