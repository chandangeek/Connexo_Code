...
public class DeviceLifeCycleBuilderImpl implements DeviceLifeCycleBuilder {
    ...
    private boolean isStandard(StateTransition stateTransition) {
        /* Standard Transitions rely on non-standard events,
         * i.e. events that are not being generated by the system
         * but were created by this bundle.
         * The finite state machine bundle refers to those as CustomStateTransitionEventType. */
        return stateTransition.getEventType() instanceof CustomStateTransitionEventType
            && TransitionType.from(stateTransition).isPresent();
    }
