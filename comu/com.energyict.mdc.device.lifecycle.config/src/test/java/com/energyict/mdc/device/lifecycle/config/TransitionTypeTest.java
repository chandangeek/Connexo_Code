...
public class TransitionTypeTest {
    ...
    public void testWithStandardTransition() {
        ...
        this.testStandardTransition(DefaultState.DECOMMISSIONED, DefaultState.DELETED, TransitionType.DELETE);
        this.testStandardTransition(DefaultState.DECOMMISSIONED, DefaultState.IN_STOCK, TransitionType.RECYCLE);
        this.testStandardTransition(DefaultState.IN_STOCK, DefaultState.DELETED, TransitionType.REVOKE);
    }
