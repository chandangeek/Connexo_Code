 ...
 * that are defined in {@link DeviceLifeCycleConfigurationServiceImpl} are acceptable and unique.
 */
public class AllTranslationKeysTest {
    ...
    public void testTranslationKeys() {
        ...
        for (TranslationKey entry : new DeviceLifeCycleConfigurationServiceImpl().getKeys()) {
