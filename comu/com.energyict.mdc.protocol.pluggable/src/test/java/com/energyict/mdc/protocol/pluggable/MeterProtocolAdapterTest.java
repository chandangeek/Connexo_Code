...
public class MeterProtocolAdapterTest {
    ...
    public void testGetSecurityPropertiesWhenWrappedProtocolDoesNotImplementDeviceSecuritySupport() {
        ...
        MeterProtocolAdapterImpl adapter = new TestMeterProtocolAdapter(adaptedProtocol, this.propertySpecService, this.protocolPluggableService, this.securitySupportAdapterMappingFactory);
