...
public class TransitionBusinessProcessResourceTest extends DeviceLifeCycleConfigApplicationJerseyTest {
    ...
    private List<StateChangeBusinessProcess> mockProcesses(){
        ...
        processes.add(mockStateChangeBusinessProcess(1L,"deploymentId 1", "processId 1"));
        processes.add(mockStateChangeBusinessProcess(2L,"deploymentId 2", "processId 2"));
        processes.add(mockStateChangeBusinessProcess(3L, "deploymentId 3", "processId 3"));
        return processes;
    }
}
