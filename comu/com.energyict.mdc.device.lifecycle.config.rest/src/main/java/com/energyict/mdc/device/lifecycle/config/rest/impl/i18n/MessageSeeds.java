...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    TRANSITION_ACTION_CHECK_CATEGORY_ISSUES_AND_ALARMS(5005, Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.ISSUES_AND_ALARMS, "Issues and alarms", Level.INFO),
    TRANSITION_ACTION_CHECK_CATEGORY_VALIDATION(5006, Keys.TRANSITION_ACTION_CHECK_CATEGORY_KEY + MicroCategory.INSTALLATION, "Installation", Level.INFO),
    TRANSITION_ACTION_SUB_CATEGORY_ESTIMATION(5007, "conflict_estimation", "Toggle data estimation", Level.INFO),
    TRANSITION_ACTION_SUB_CATEGORY_VALIDATION(5008, "conflict_validation", "Toggle data validation", Level.INFO),
    TRANSITION_ACTION_SUB_CATEGORY_DESCR_ESTIMATION(5009, Keys.TRANSITION_ACTION_SUB_CATEGORY_DESCRIPTION_KEY + "conflict_estimation", "Activate or deactivate the data estimation on this device. This auto action is effective immediately.", Level.INFO),
    TRANSITION_ACTION_SUB_CATEGORY_DESCR_COMMUNICATION(5010, Keys.TRANSITION_ACTION_SUB_CATEGORY_DESCRIPTION_KEY + "conflict_validation", "Activate or deactivate the data validation on this device. This auto action is effective immediately.", Level.INFO),
    ...
    MICRO_CHECK_NAME_AT_LEAST_ONE_SCHEDULED_COMMUNICATION_TASK_AVAILABLE(6003, Keys.MICRO_CHECK_NAME_TRANSLATE_KEY + MicroCheck.AT_LEAST_ONE_SHARED_COMMUNICATION_SCHEDULE_AVAILABLE, "At least one shared communication schedule", Level.INFO),
    MICRO_CHECK_NAME_ALL_DATA_COLLECTED(6004, Keys.MICRO_CHECK_NAME_TRANSLATE_KEY + MicroCheck.ALL_LOAD_PROFILE_DATA_COLLECTED, "All data collected", Level.INFO),
    ...
    MICRO_CHECK_DESCRIPTION_AT_LEAST_ONE_SCHEDULED_COMMUNICATION_TASK_AVAILABLE(7003, Keys.MICRO_CHECK_DESCRIPTION_TRANSLATE_KEY + MicroCheck.AT_LEAST_ONE_SHARED_COMMUNICATION_SCHEDULE_AVAILABLE, "Check if at least one shared communication schedule has been added to the device.", Level.INFO),
    MICRO_CHECK_DESCRIPTION_ALL_DATA_COLLECTED(7004, Keys.MICRO_CHECK_DESCRIPTION_TRANSLATE_KEY + MicroCheck.ALL_LOAD_PROFILE_DATA_COLLECTED, "Check if all the data of this device has been collected.", Level.INFO),
