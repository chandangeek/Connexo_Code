...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    DEVICE_LIFECYCLE_STATE_IS_THE_LATEST_STATE(7, "unable.to.remove.latest.state", "This state cannot be removed from this device life cycle because it is the latest state. Add another state first.", Level.SEVERE),
    DEVICE_LIFECYCLE_STATE_IS_THE_INITIAL_STATE(8, "unable.to.remove.initial.state", "This state cannot be removed from this device life cycle because it is the initial state. Set another state as initial state first.", Level.SEVERE),
    DEVICE_LIFECYCLE_IS_USED_BY_DEVICE_TYPE(9, "device.lifecycle.is.used.by.device.type", "This operation cannot be performed for this device life cycle because one or more device types use this device life cycle.", Level.SEVERE),
