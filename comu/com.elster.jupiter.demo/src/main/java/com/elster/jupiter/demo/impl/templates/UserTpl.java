...
public enum UserTpl implements Template<User, UserBuilder> {
    ...
    STIJN("Stijn", Locale.ENGLISH.toLanguageTag(), UserRoles.METER_OPERATOR),
    JORIS("Joris", Locale.ENGLISH.toLanguageTag(), UserRoles.METER_OPERATOR),
    ROB("Rob", Locale.ENGLISH.toLanguageTag(), UserRoles.METER_OPERATOR),
    PIETER("Pieter", Locale.ENGLISH.toLanguageTag(), UserRoles.METER_OPERATOR),
