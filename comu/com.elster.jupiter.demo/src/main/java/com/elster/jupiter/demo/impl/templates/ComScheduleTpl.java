...
public enum ComScheduleTpl implements Template<ComSchedule, ComScheduleBuilder> {
    DAILY_READ_ALL("Daily read all", Arrays.asList(ComTaskTpl.BASIC_CHECK, ComTaskTpl.READ_REGISTER_DATA, ComTaskTpl.READ_LOAD_PROFILE_DATA, ComTaskTpl.READ_LOG_BOOK_DATA, ComTaskTpl.VERIFY_STATUS_INFO, ComTaskTpl.READ_ALL), TimeDuration.days(1)),
