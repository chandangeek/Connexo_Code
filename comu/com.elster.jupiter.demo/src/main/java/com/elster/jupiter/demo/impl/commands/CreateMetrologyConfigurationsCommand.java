...
public class CreateMetrologyConfigurationsCommand {
    ...
    static final String MONTHLY_A_PLUS_KWH = "13.0.0.4.1.1.12.0.0.0.0.0.0.0.0.3.72.0";
    static final String MONTHLY_A_MINUS_KWH = "13.0.0.4.19.1.12.0.0.0.0.0.0.0.0.3.72.0";
    ...
    static final String DAILY_A_PLUS_KWH = "11.0.0.4.1.1.12.0.0.0.0.0.0.0.0.3.72.0";
    static final String DAILY_A_MINUS_KWH = "11.0.0.4.19.1.12.0.0.0.0.0.0.0.0.3.72.0";
    ...
    static final String MIN15_A_PLUS_KWH = "0.0.2.4.1.1.12.0.0.0.0.0.0.0.0.3.72.0";
    ...
    @Inject
    public CreateMetrologyConfigurationsCommand(MetrologyConfigurationService metrologyConfigurationService, MeteringService meteringService) {
    ...
    private void residentialProsumerWith1Meter() {
        ...
        ReadingType readingTypeDailyAminusWh = meteringService.findReadingTypes(Collections.singletonList(DAILY_A_MINUS_KWH))
                .stream()
                .findFirst()
                .orElseGet(() -> meteringService.createReadingType(DAILY_A_MINUS_KWH, "A-"));
        ReadingType readingType15minAplusWh = meteringService.findReadingTypes(Collections.singletonList(MIN15_A_PLUS_KWH))
                .stream()
                .findFirst()
                .orElseGet(() -> meteringService.createReadingType(MIN15_A_PLUS_KWH, "A+"));
        ReadingType readingType15minAminusWh = meteringService.findReadingTypes(Collections.singletonList(MIN15_A_MINUS_KWH))
                .stream()
                .findFirst()
                .orElseGet(() -> meteringService.createReadingType(MIN15_A_MINUS_KWH, "A-"));
    ...
    private void residentialConsumerWith1Meter() {
        ...
        UsagePointMetrologyConfiguration config = metrologyConfigurationService.newUsagePointMetrologyConfiguration(RESIDENTIAL_CONSUMER_WITH_1_METER
                ...
                .withGapAllowed(RESIDENTIAL_CONSUMER_WITH_1_METER.isGapAllowed())
                .create();
