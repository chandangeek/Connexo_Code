...
public class NTASimToolFactory implements Factory<Void> {
    private static final String NTA_SIM_TOOL_TABLE_NAME = "NTADEVICE";
    private static final String CREATE_NTA_SIM_TOOL_TABLE = "CREATE TABLE "+NTA_SIM_TOOL_TABLE_NAME+" (ID NUMBER(10, 0) NOT NULL PRIMARY KEY, SERIAL_NUMBER VARCHAR2(255) NOT NULL, MASTER_KEY VARCHAR2(40) NOT NULL, SECRET VARCHAR2(16) NOT NULL, AUTHENTICATION_KEY VARCHAR2(40), ENCRYPTION_KEY VARCHAR2(40), CORE_FIRMWARE_VERSION VARCHAR2(48) NOT NULL, CORE_IMAGE_IDENTIFIER VARCHAR2(48) NOT NULL, MODULE_FIRMWARE_VERSION VARCHAR2(48) NOT NULL, MODULE_VERSION_IDENTIFIER VARCHAR2(48) NOT NULL, ACTIVITY_CALENDAR_NAME VARCHAR2(255) DEFAULT 0 NOT NULL, P2_ENCRYPTION_STATUS NUMBER(1, 0) DEFAULT 0 NOT NULL, E_CONTROL_STATE NUMBER(1, 0) DEFAULT 1 NOT NULL, E_CONTROL_MODE NUMBER(1, 0) DEFAULT 0 NOT NULL, NUMBER_OF_MBUS_DEVICES NUMBER(1, 0) DEFAULT 1 NOT NULL, G_CONTROL_STATE NUMBER(1, 0) DEFAULT 1 NOT NULL, G_CONTROL_MODE NUMBER(1, 0) DEFAULT 0 NOT NULL)";
    ...
    private static final String CREATE_NTA_SIM_TOOL_RECORD = "INSERT INTO "+NTA_SIM_TOOL_TABLE_NAME+" (ID, SERIAL_NUMBER, MASTER_KEY, SECRET, CORE_FIRMWARE_VERSION, CORE_IMAGE_IDENTIFIER, MODULE_FIRMWARE_VERSION, MODULE_VERSION_IDENTIFIER, NUMBER_OF_MBUS_DEVICES) VALUES (?,?,'31313232333334343535363637373838','ntaSim','V1.0.0.1','V1.0.0.2','V1.0.0.3','V1.0.0.4','0')";
    ...
    @Inject
    public NTASimToolFactory(DataModel dataModel, DeviceService deviceService) {
