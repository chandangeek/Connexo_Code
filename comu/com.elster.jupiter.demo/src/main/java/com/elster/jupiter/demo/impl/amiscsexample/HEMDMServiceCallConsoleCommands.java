...
@Component(name = "com.elster.jupiter.demo.impl.amiscsexample.servicecall.examples", service = HEMDMServiceCallConsoleCommands.class,
        property = {"osgi.command.scope=demo",
