...
public enum DeviceConfigurationTpl implements Template<DeviceConfiguration, DeviceConfigurationBuilder> {
    ...
    DEFAULT_AM540("Default", GatewayType.NONE,
            ...
            ImmutableMap.of(ComTaskTpl.READ_LOAD_PROFILE_DATA, SecurityPropertySetTpl.PASSWORD_ONLY, ComTaskTpl.READ_REGISTER_DATA, SecurityPropertySetTpl.PASSWORD_ONLY),
            false)
    ;
