...
public enum CreationRuleTpl implements Template<CreationRule, IssueRuleBuilder> {
    ...
    CANOT_ESTIMATE_USAGEPOINTDATA("Create issue when usage point data suspects can't be estimated","CANNOT_ESTIMATE_USAGEPOINT_DATA", "reason.cant.estimate.usagepoint.data", DueInType.DAY, 0L, IssueRuleBuilder.USAGE_POINT_DATA_VALIDATION_RULE_TEMPLATE, Priority.DEFAULT, true),
