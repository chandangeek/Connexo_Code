...
public enum CreationRuleTpl implements Template<CreationRule, IssueRuleBuilder> {
    ...
    CANNOT_ESTIMATE_SUSPTECTS("Create issue when suspects can't be estimated","CANNOT_ESTIMATE_DATA", "reason.cant.estimate.data", DueInType.MONTH, IssueRuleBuilder.BASIC_DATA_VALIDATION_RULE_TEMPLATE )
    ;
