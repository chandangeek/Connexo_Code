...
public class ChildGetMeterReadingsCustomPropertySet implements CustomPropertySet<ServiceCall, ChildGetMeterReadingsDomainExtension> {
    ...
    @Inject
    public ChildGetMeterReadingsCustomPropertySet(PropertySpecService propertySpecService, Thesaurus thesaurus) {
        this();
    ...
    public String getName() {
        return this.thesaurus.getFormat(TranslationKeys.CGMR_CPS).format();
    }
