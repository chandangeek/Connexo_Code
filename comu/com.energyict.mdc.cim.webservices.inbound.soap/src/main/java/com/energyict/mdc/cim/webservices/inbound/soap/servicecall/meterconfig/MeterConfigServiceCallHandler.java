...
import com.energyict.mdc.cim.webservices.inbound.soap.impl.CustomPropertySetHelper;
...
/**
 * Implementation of {@link ServiceCallHandler} interface which handles the
 * different steps for CIM WS MeterConfig
 */
...
public class MeterConfigServiceCallHandler implements ServiceCallHandler {
	...
	/**
	 * Sets values for CustomPropertySets on specific device logging detailed error
