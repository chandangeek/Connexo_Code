...
public enum MessageSeeds implements MessageSeed {
    ...
    WRONG_TIME_PERIOD_COMBINATION(7015, "WrongTimePeriodCombination", "Can''t construct a valid time period with provided start ''{0}'' and the end ''{1}''.", Level.WARNING),
    DIFFERENT_DATA_SOURCES(7016, "DifferentDataSources", "The request contains data sources of different types under element ''{0}''."),
    SCHEDULE_STRATEGY_NOT_SUPPORTED(7017, "ScheduleStrategyNotSupported", "Schedule strategy ''{0}'' is not supported. The possible values are: ''Run now'' and ''Use schedule''"),
    NO_CONNECTION_TASK(7018, "NoConnectionTask", "No connection task has been found for communication task execution of communication task ''{0}''."),
