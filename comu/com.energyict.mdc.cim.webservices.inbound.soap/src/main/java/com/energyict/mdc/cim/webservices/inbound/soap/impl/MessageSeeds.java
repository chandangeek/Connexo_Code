...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_COM_TASK_EXECUTION_FOR_LOAD_PROFILE_NAMES(6039, "NoComTaskExecutionForLoadProfileNames", "No communication task execution has been found on device ''{0}'' for loadProfiles ''{1}''.", Level.WARNING),
    NO_COM_TASK_EXECUTION_FOR_REGISTER_GROUP(6040, "NoComTaskExecutionForRegisterGroup", "No communication task execution has been found on device ''{0}'' for registerGroups ''{1}''.", Level.WARNING),
    ;
