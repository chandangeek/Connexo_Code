...
public enum MessageSeeds implements MessageSeed {
    ...
    CONNECTION_METHOD_NOT_FOUND_FOR_COM_TASK(7020, "ConnectionMethodNotFoundForComTask", "The required connection method ''{0}'' wasn''t found for communication task ''{0}''.", Level.WARNING),
    DATA_SOURCE_NAME_TYPE_NOT_FOUND(7021, "DataSourceNameTypeNotFound", "Data source name type ''{0}'' is not found in the element ''{1}''. Possible values: Load Profile or Register Group."),
    NO_DATA_SOURCES(7022, "NoDataSources", "At least one correct ''GetMeterReadings.ReadingType'' or ''GetMeterReadings.Reading.dataSource'' must be specified in the request under element ''{0}''", Level.WARNING),
    REGISTER_GROUP_NOT_FOUND(7023, "RegisterGroupNotFound", "Couldn''t find register group with name ''{0}'' under element ''{1}''.", Level.WARNING),
    LOAD_PROFILE_NOT_FOUND(7024, "LoadProfileNotFound", "Couldn''t find load profile with name ''{0}'' under element ''{1}''.", Level.WARNING),
    NO_COM_TASK_EXECUTION(7025, "NoComTaskExecution", "The required communication task execution of type {0} wasn't found on the device {1}.", Level.WARNING),
    REGISTER_GROUP_WRONG_TIME_PERIOD(7026, "RegisterGroupWrongTimePeriod", "Wrong time period for register group data source is provided under element ''{0}'': start ''{1}'', end ''{2}''.", Level.WARNING),
    REGISTER_GROUP_EMPTY_TIME_PERIOD(7027, "RegisterGroupEmptyTimePeriod", "Empty time period for register group data source is provided under element ''{0}''.", Level.WARNING),
    REGISTER_EMPTY_TIME_PERIOD(7028, "RegisterEmptyTimePeriod", "Empty time period for register is provided under element ''{0}''.", Level.WARNING),
    SYSTEM_SOURCE_EMPTY_TIME_PERIOD(7029, "SystemSourceEmptyTimePeriod", "Empty time period for ''System'' source is provided.", Level.WARNING),
    ...
    NO_COM_TASK_EXECUTION_FOR_PROTOCOL_TASK(7031, "NoComTaskExecutionForProtocolTask", "No communication task execution have been found for protocol task ''{0}''."),
    LOAD_PROFILES_NOT_FOUND_ON_DEVICE(7032, "LoadProfilesNotFoundOnDevice", "LoadProfile(s) is(are) not found on device ''{0}'': ''{1}''.", Level.WARNING),
    NO_READINGS_TO_READ(7033, "NoReadingsToRead", "Couldn''t find any correct  ''GetMeterReadings.Reading'' to read."),
    READING_NOT_APPLICABLE(7034, "ReadingNotApplicable", "''{0}'' will be skipped due to issue in the element ''{1}''.", Level.WARNING),
