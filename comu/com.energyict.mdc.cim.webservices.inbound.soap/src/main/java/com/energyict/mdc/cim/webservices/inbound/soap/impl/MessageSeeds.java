...
public enum MessageSeeds implements MessageSeed {
    ...
    NO_COM_TASK_EXECUTION_FOR_READING_TYPES(6031, "NoComTaskExecutionForReadingTypes", "No communication task execution has been found on device ''{0}'' for readingTypes ''{1}'' with start period ''{2}'' and end period ''{3}''.", Level.WARNING),
    NO_COM_TASK_EXECUTION_FOR_LOAD_PROFILES(6032, "NoComTaskExecutionForLoadProfiles", "No communication task execution has been found for load profile device messages on device ''{0}'' with mRID ''{1}''.", Level.WARNING),
