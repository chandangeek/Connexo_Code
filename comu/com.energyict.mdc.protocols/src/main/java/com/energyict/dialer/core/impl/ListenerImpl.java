 ...
 * @author Koen
 */
public abstract class ListenerImpl extends LinkImpl implements Listener {

    protected abstract void doAccept(int iTimeout, int nrOfRings) throws IOException, LinkException;

    protected abstract void doDisConnect() throws IOException, LinkException;

    protected abstract void doDisConnectServer() throws IOException, LinkException;

    protected abstract void doConnect() throws IOException, LinkException;
