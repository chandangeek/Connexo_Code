...
public class InboundProximusConnectionPropertiesPersistenceSupport implements PersistenceSupport<ConnectionType, InboundProximusConnectionProperties> {
    ...
    public String domainFieldName() {
        return InboundProximusConnectionProperties.FieldNames.CONNECTION_TYPE.javaName();
    }

    @Override
    public String domainColumnName() {
        return InboundProximusConnectionProperties.FieldNames.CONNECTION_TYPE.databaseName();
    }
    ...
    public void addCustomPropertyColumnsTo(Table table) {
        Stream
            .of(InboundProximusConnectionProperties.FieldNames.values())
            .forEach(fieldName -> this.addCustomPropertyColumnTo(table, fieldName));
    }

    private void addCustomPropertyColumnTo(Table table, InboundProximusConnectionProperties.FieldNames fieldName) {
        table
