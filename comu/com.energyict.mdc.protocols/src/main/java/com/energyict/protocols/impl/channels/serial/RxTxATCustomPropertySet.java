...
public class RxTxATCustomPropertySet extends AbstractConnectionTypeCustomPropertySet implements CustomPropertySet<ConnectionProvider, SioSerialConnectionProperties> {

    @Inject
    public RxTxATCustomPropertySet(Thesaurus thesaurus, PropertySpecService propertySpecService) {
        super(thesaurus, propertySpecService);
    }

    @Override
    public String getName() {
        return this.thesaurus.getFormat(CustomPropertySetTranslationKeys.RX_TX_AT_CUSTOM_PROPERTY_SET_NAME).format();
    }
    ...
    public ConnectionType getConnectionTypeSupport() {
        return new RxTxAtModemConnectionType(propertySpecService);
    }
}