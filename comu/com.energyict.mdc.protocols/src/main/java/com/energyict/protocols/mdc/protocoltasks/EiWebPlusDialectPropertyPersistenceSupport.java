...
/**
 * Provides an implementation for the {@link PersistenceSupport} interface for {@link EiWebPlusDialect}.
 *
...
public class EiWebPlusDialectPropertyPersistenceSupport implements PersistenceSupport<DeviceProtocolDialectPropertyProvider, EiWebPlusDialectProperties> {
    ...
    public String tableName() {
        return DeviceProtocolService.COMPONENT_NAME + "_EIWEBPLUS_DIALECT";
    }

    @Override
    public String domainForeignKeyName() {
        return "FK_EIWEBPLUS_DIALECT_PROPS";
    }

    @Override
    public String componentName() {
        return CustomPropertySetComponentName.P10.name();
    }
    ...
    @Override
    public Class<EiWebPlusDialectProperties> persistenceClass() {
        return EiWebPlusDialectProperties.class;
    }
