...
import com.energyict.protocols.mdc.channels.serial.modem.postdial.AtDelayCommand;
import com.energyict.protocols.mdc.channels.serial.modem.postdial.AtFlushCommand;
import com.energyict.protocols.mdc.channels.serial.modem.postdial.AtSerialCommunicationSettingsCommand;
import com.energyict.protocols.mdc.channels.serial.modem.postdial.AtWriteCommand;
...
public abstract class AbstractAtModemProperties extends AbstractModemProperties {
     ...
     */
    protected abstract List<AbstractAtPostDialCommand> getPostDialCommands();
     ...
     */
    protected List<AbstractAtPostDialCommand> parseAndValidatePostDialCommands(String commands) {
