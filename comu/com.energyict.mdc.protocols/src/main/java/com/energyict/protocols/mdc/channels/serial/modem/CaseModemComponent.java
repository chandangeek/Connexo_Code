...
public class CaseModemComponent {
    ...
    public void disconnectModem(ComChannel comChannel) {
        ...
        toggleDTR((SerialComChannel) comChannel, modemProperties.getLineToggleDelay().getMilliSeconds());
    }
    ...
    public enum ExceptionAnswers {
        ERROR_CALL_ABORTED(CALL_ABORTED, ProtocolExceptionReferences.MODEM_CALL_ABORTED);
