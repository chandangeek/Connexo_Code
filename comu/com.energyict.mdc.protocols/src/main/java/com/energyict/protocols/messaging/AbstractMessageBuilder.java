...
public abstract class AbstractMessageBuilder implements MessageBuilder {
     ...
     */
    protected abstract String getMessageContent() throws ParserConfigurationException, IOException;
     ...
     *         if the given string is wrong xml or is not the correct message
     */
    ...
    public abstract static class AdvancedMessageHandler extends DefaultHandler {
