...
public class AbntSerialDeviceProtocolDialectCustomPropertySet extends AbstractDialectCustomPropertySet implements CustomPropertySet<DeviceProtocolDialectPropertyProvider, AbntDeviceProtocolDialectProperties> {
    ...
    @Inject
    public AbntSerialDeviceProtocolDialectCustomPropertySet(Thesaurus thesaurus, PropertySpecService propertySpecService, CustomPropertySetService customPropertySetService) {
    ...
    public DeviceProtocolDialect getDeviceProtocolDialect() {
        return new AbntSerialDeviceProtocolDialect(propertySpecService, getUplThesaurus());
    }
}