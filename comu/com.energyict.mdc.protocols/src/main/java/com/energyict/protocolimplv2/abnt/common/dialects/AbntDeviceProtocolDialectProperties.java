    ...
    enum ActualFields {
        RETRIES("retries", DlmsProtocolProperties.RETRIES, "RETRIES") {
            ...
            public PropertySpec propertySpec(PropertySpecService propertySpecService) {
                return this.propertySpec(propertySpecService, AbstractDeviceProtocolDialect.DEFAULT_RETRIES);
            }
        },
        TIMEOUT_PROPERTY("timeoutMillis", DlmsProtocolProperties.TIMEOUT, "TIMEOUTMILLIS") {
            ...
            @Override
            public PropertySpec propertySpec(PropertySpecService propertySpecService) {
                return this.propertySpec(propertySpecService, AbstractDeviceProtocolDialect.DEFAULT_TIMEOUT);
            }
        },
        FORCED_DELAY("forcedDelay", DlmsProtocolProperties.FORCED_DELAY, "FORCED_DELAY") {
            ...
            @Override
            public PropertySpec propertySpec(PropertySpecService propertySpecService) {
                return this.propertySpec(propertySpecService, AbstractDeviceProtocolDialect.DEFAULT_FORCED_DELAY);
            }
        },
        DELAY_AFTER_ERROR("delayAfterError", DlmsProtocolProperties.DELAY_AFTER_ERROR, "DELAY_AFTER_ERROR") {
            ...
            @Override
            public PropertySpec propertySpec(PropertySpecService propertySpecService) {
                return this.propertySpec(propertySpecService, AbstractDeviceProtocolDialect.DEFAULT_DELAY_AFTER_ERROR);
            }
        };
