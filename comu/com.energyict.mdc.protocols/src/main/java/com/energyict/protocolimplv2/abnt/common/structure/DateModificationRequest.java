 ...
 */
public class DateModificationRequest extends Data<DateModificationRequest> {
    ...
    public DateModificationRequest(TimeZone timeZone) {
    ...
    public DateModificationRequest(TimeZone timeZone, Calendar calendar) {
        super(RequestFrame.REQUEST_DATA_LENGTH, timeZone);
    ...
    @Override
    public DateModificationRequest parse(byte[] rawData, int offset) throws ParsingException {
        int ptr = offset;
    ...
    public void applyCalendar(Calendar calendar) {
        ...
        this.month = new BcdEncodedField(Integer.toString(calendar.get(Calendar.MONTH) + 1));   // Java Calendar month is 0-based
