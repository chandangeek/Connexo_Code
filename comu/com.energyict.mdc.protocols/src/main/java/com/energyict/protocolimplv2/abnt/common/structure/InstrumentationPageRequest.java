 ...
 */
public class InstrumentationPageRequest extends Data<InstrumentationPageRequest> {

    public InstrumentationPageRequest(TimeZone timeZone) {
        super(RequestFrame.REQUEST_DATA_LENGTH, timeZone);
    }

    @Override
    public InstrumentationPageRequest parse(byte[] rawData, int offset) throws ParsingException {
