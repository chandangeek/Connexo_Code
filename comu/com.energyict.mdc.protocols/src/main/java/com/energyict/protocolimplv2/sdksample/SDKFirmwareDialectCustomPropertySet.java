...
/**
 * Provides an implementation for the {@link CustomPropertySet} interface for {@link SDKFirmwareProtocolDialect}.
 *
 * @author Rudi Vankeirsbilck (rudi)
 * @since 2015-11-27 (09:37)
 */
class SDKFirmwareDialectCustomPropertySet implements CustomPropertySet<DeviceProtocolDialectPropertyProvider, SDKFirmwareDialectProperties> {

    private final Thesaurus thesaurus;
    private final PropertySpecService propertySpecService;

    SDKFirmwareDialectCustomPropertySet(Thesaurus thesaurus, PropertySpecService propertySpecService) {
        super();
    ...
    @Override
    public String getId() {
        return SDKFirmwareProtocolDialect.class.getName();
    }

    @Override
    public String getName() {
        return this.thesaurus.getFormat(DeviceProtocolDialectName.SDK_SAMPLE_FIRMWARE).format();
    }
