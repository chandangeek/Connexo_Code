...
public class SDKTopologyTaskProtocolDialect extends AbstractDeviceProtocolDialect {
    ...
    public SDKTopologyTaskProtocolDialect(Thesaurus thesaurus, PropertySpecService propertySpecService) {
    ...
    public Optional<CustomPropertySet<DeviceProtocolDialectPropertyProvider, ? extends PersistentDomainExtension<DeviceProtocolDialectPropertyProvider>>> getCustomPropertySet() {
        return Optional.of(new SDKTopologyTaskDialectCustomPropertySet(this.getThesaurus(), this.getPropertySpecService()));
    }
