...
public class AbntTransparentTCPDeviceProtocolDialectCustomPropertySet extends AbstractDialectCustomPropertySet implements CustomPropertySet<DeviceProtocolDialectPropertyProvider, AbntDeviceProtocolDialectProperties> {
    ...
    @Inject
    public AbntTransparentTCPDeviceProtocolDialectCustomPropertySet(Thesaurus thesaurus, PropertySpecService propertySpecService, CustomPropertySetService customPropertySetService) {
    ...
    public DeviceProtocolDialect getDeviceProtocolDialect() {
        return new AbntTransparentTCPDeviceProtocolDialect(propertySpecService, getUplThesaurus());
    }
}