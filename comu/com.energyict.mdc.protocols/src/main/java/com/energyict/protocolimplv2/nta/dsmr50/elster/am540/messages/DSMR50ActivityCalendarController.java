 ...
 */
public class DSMR50ActivityCalendarController extends DSMR40ActivityCalendarController {

    public DSMR50ActivityCalendarController(CosemObjectFactory cosemObjectFactory, TimeZone timeZone) {
        super(cosemObjectFactory, timeZone);
    }

    public DSMR50ActivityCalendarController(CosemObjectFactory cosemObjectFactory, TimeZone timeZone, ObisCode activityCalendarObisCode, ObisCode specialDaysCalendarObisCode) {
        super(cosemObjectFactory, timeZone, activityCalendarObisCode, specialDaysCalendarObisCode);
    }

    public DSMR50ActivityCalendarController(CosemObjectFactory cosemObjectFactory, TimeZone timeZone, boolean contentBase64Encoded) {
