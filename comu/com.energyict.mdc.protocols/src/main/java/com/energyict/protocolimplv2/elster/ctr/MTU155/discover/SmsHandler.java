...
import com.energyict.mdc.protocol.api.device.data.DeviceLoadProfile;
import com.energyict.mdc.protocol.api.device.data.DeviceLogBook;
import com.energyict.mdc.protocol.api.device.data.DeviceProtocolMessageAcknowledgement;
import com.energyict.mdc.protocol.api.device.data.identifiers.DeviceMessageIdentifierByDeviceAndProtocolInfoParts;
import com.energyict.mdc.protocol.api.device.data.identifiers.LogBookIdentifierByDeviceAndObisCode;
