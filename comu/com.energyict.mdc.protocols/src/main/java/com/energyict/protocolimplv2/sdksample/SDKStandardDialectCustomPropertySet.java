...
/**
 * Provides an implementation for the {@link CustomPropertySet} interface for {@link SDKStandardProtocolDialect}.
 *
...
class SDKStandardDialectCustomPropertySet implements CustomPropertySet<DeviceProtocolDialectPropertyProvider, SDKStandardDialectProperties> {
    ...
    @Override
    public String getId() {
        return SDKStandardProtocolDialect.class.getName();
    }

    @Override
    public String getName() {
        return this.thesaurus.getFormat(DeviceProtocolDialectName.SDK_SAMPLE_STANDARD_DEVICE_PROTOCOL).format();
    }
