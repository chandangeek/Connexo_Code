...
public class DlmsSecurityPerClientCustomPropertySet extends SecurityCustomPropertySet<DlmsSecurityPerClientProperties> {
    ...
    @Inject
    public DlmsSecurityPerClientCustomPropertySet(PropertySpecService propertySpecService, Thesaurus thesaurus) {
        super();
    ...
    public List<PropertySpec> getPropertySpecs() {
        ...
        DeviceProtocolSecurityCapabilities securitySupport = new com.energyict.protocolimplv2.security.DlmsSecuritySupportPerClient(propertySpecService);
