 ...
 * @author Koen
 */
public class CurrentDemandTimeOfOccurenceDataRead extends AbstractDataRead {
    ...
    public CurrentDemandTimeOfOccurenceDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("CurrentDemandTimeOfOccurenceDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_DEMAND_TOO_RATE_G").getId()};
