...
public class Class32ModemAlarmCallConfiguration extends AbstractClass {
    ...
    protected void parse(byte[] data) throws IOException {
        ...
        int offset = 0;
        setDialString(new String(ProtocolUtils.getSubArray(data,offset, 34)));
        offset += 36;
    ...
    public int getSYSMSK() {
        return SYSMSK;
    }

    private void setSYSMSK(int SYSMSK) {
        this.SYSMSK = SYSMSK;
    }

    public int getWARNMSK() {
        return WARNMSK;
    }

    private void setWARNMSK(int WARNMSK) {
        this.WARNMSK = WARNMSK;
    }

    public int getEVENMSK() {
        return EVENMSK;
    }

    private void setEVENMSK(int EVENMSK) {
        this.EVENMSK = EVENMSK;
    }
