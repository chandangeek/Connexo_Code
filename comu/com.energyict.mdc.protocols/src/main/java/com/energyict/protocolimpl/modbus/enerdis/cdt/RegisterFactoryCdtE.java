...
class RegisterFactoryCdtE extends RegisterFactory {
    ...
    public RegisterFactoryCdtE(Modbus modBus) {
        super(modBus);
    ...
    protected void init() {
        ...
        d = "Active energy meter time tariff 0";
        o = "1.1.1.8.1.255";
        active_energy_tou_0 = add( o, 0x0332, d, kWh, Type.LONG_DOUBLE_WORD);
        d = "Active energy meter time tariff 1";
        o = "1.1.1.8.2.255";
