 ...
 * @author Koen
 */
public class LastSeasonDemandDataRead extends AbstractDataRead {
    ...
    public LastSeasonDemandDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("LastSeasonDemandDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_SEC_DEMANDS_RATE_G").getId()};
