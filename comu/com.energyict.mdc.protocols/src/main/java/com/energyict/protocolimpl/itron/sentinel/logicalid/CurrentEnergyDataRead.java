...
public class CurrentEnergyDataRead extends AbstractDataRead {
    ...
    public String toString() {
        ...
        strBuff.append("CurrentEnergyDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_ENERGIES_RATE_G").getId()};
