...
public class A1440Registry extends AbstractVDEWRegistry {
	...
	protected void initRegisters() {
		...
		this.registers.put(CONTACTOR_STATUS, new VDEWRegister("C.3.0", VDEWRegisterDataParse.VDEW_STRING, 0, 1, null, VDEWRegister.NOT_WRITEABLE, VDEWRegister.NOT_CACHED, FlagIEC1107Connection.READ1));
