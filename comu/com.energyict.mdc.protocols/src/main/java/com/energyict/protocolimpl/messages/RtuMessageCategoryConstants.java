...
/**
 * Constants class for naming the Device message CATEGORIES
 * <p/>
...
public class RtuMessageCategoryConstants {
    ...
    public static final String LOADLIMIT_DESCRIPTION = "Load limit";
    ...
    public static final String MBUSMESSAGES_DESCRIPTION = "MBus messages";
