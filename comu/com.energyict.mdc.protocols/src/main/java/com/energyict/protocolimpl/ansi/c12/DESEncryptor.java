...
public class DESEncryptor {
    ...
    static public DESEncryptor getInstance(byte[] pass) throws IOException {
    ...
    public byte[] encrypt(byte[] data) throws IOException {
        try {
            ...
            if (DEBUG>=1) System.out.println("KV_DEBUG> encrypted data: " + ProtocolUtils.outputHexString(result));  
            return result;
        } catch(Exception e) {
    ...
    public byte[] decrypt(byte[] data) throws IOException {
        try {
            ...
            byte[] result = cipher.doFinal(data);
            if (DEBUG>=1) System.out.println("KV_DEBUG> decrypted data: " + ProtocolUtils.outputHexString(result));  
            return result;
        } catch(Exception e) {
