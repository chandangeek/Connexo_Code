...
public class OperatingMode extends AbstractParameter {
    ...
    OperatingMode(WaveTherm waveTherm) {
        super(waveTherm);
    }

    public OperatingMode(WaveTherm waveTherm, int opMode) {
        super(waveTherm);
    ...
    public void setSuccessiveThresholdDetectionMode() {
        operationMode = (operationMode | 0x40);       //Set b6 to 1
    }

    public void setCumulativeThresholdDetectionMode() {
        operationMode = (operationMode & 0xBF);       //Set b6 to 0
    }
    ...
    public void setHighThresholdDetection(int enable) {
        operationMode = operationMode & 0xEF;
        operationMode = operationMode | (enable << 5);
    }

    public void setLowThresholdDetection(int enable) {
        operationMode = operationMode & 0xDF;
