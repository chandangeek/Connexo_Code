 ...
 * it is replaced by MK10InboundDeviceProtocol (doing the inbound discovery),
 * combined with the regular MK10 protocol.
...
//            getMeter().store(meterProfileData);
    ...
    public String getVersion() {
        return "$Date: 2013-02-20 16:16:48 +0100 (Mit, 20 Feb 2013) $";
    }
