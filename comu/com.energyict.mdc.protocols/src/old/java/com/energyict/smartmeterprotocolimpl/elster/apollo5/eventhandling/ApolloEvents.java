...
public enum ApolloEvents {
     ...
     * ************************************ Group 1 Events **************************************
     */
    EventLogCleared(255, MeterEvent.CLEAR_DATA, 1, "Boots and Power Fails", "Group 1 event log has been cleared"),
    ...
    ClockFailure(10, MeterEvent.FATAL_ERROR, 1, "Boots and Power Fails", "Clock failure"),
    ...
    ManufacturingPasswordChanged(200, MeterEvent.CONFIGURATIONCHANGE, 1, "Contract Power", "Manufacturing password changed"),
    Contract1CalendarActivation(246, MeterEvent.CONFIGURATIONCHANGE, 1, "Contract Power", "Contract 1 calendar activation"),
     ...
     * ************************************ Group 2 Events **************************************
     */
    DisconnectorEventsLogCleared(255, MeterEvent.CLEAR_DATA, 2, "Disconnector control", "Disconnector control event log has been cleared"),
    ...
    ContactorOpeningOverVoltage(246, MeterEvent.OTHER, 2, "Disconnector control", "Contactor opening due to over voltage"),

    /**
     * ************************************ Group 3 Events **************************************
     */
    PowerQualityEventsLogCleared(255, MeterEvent.CLEAR_DATA, 3, "Quality non finished events", "Non finished power quality event log has been cleared"),
     ...
     * ************************************ Group 4 Events **************************************
     */
    FraudEventsLogCleared(255, MeterEvent.CLEAR_DATA, 4, "Fraud", "Fraud event log has been cleared"),
    ...
    NoStrongDCFieldAnymore(4, MeterEvent.NO_STRONG_DC_FIELD_ANYMORE, 4, "Fraud", "No strong DC field anymore"),
    CurrentWithoutVoltage(5, MeterEvent.OTHER, 4, "Fraud", "Current without voltage"),
    IntrusionDetection(6, MeterEvent.TAMPER, 4, "Fraud", "Intruderness detection"),

    /**
     * ************************************ Group 5 Events **************************************
     */
    DemandEventsLogCleared(255, MeterEvent.CLEAR_DATA, 5, "Demand management", "Demand event log has been cleared"),
    ...
    DemandCloseToContractPower(20, MeterEvent.OTHER, 5, "Demand management", "Demand close to Contract Power"),
    DemandOverContractPowerLimit(21, MeterEvent.OTHER, 5, "Demand management", "Demand over Contract Power limit"),

    /**
     * ************************************ Group 6 Events **************************************
     */
    CommonEventsLogCleared(255, MeterEvent.CLEAR_DATA, 6, "Frequent occurrence-Common", "Common event log has been cleared"),
    BeginCommunicationPLCPort(1, MeterEvent.OTHER, 6, "Frequent occurrence-Common", "Begin communication IF2 (PLC Port)"),
    EndCommunicationPLCPort(2, MeterEvent.OTHER, 6, "Frequent occurrence-Common", "End communication IF2 (PLC Port)"),
    ...
    /**
     * Find an {@link com.energyict.smartmeterprotocolimpl.elster.apollo5.eventhandling.ApolloEvents} in the enumeration based on the given parameters
     *
