...
public class IDISMeterTopology extends AbstractMeterTopology {
    ...
    public CollectedTopology getDeviceTopology() {
        CollectedTopology deviceTopology = protocol.getCollectedDataFactory().createCollectedTopology(protocol.getOfflineDevice().getDeviceIdentifier());
        for (DeviceMapping mapping : getDeviceMapping()) {
            deviceTopology.addSlaveDevice(protocol.getIdentificationService().createDeviceIdentifierBySerialNumber(mapping.getSerialNumber()));
        }
