 ...
 */
public class HistoryLogRequest extends Data<HistoryLogRequest> {

    public HistoryLogRequest(TimeZone timeZone) {
        super(RequestFrame.REQUEST_DATA_LENGTH, timeZone);
    }

    @Override
    public HistoryLogRequest parse(byte[] rawData, int offset) throws ParsingException {
