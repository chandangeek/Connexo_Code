 ...
 */
public class ContactorOperationViaSerialNumberEvent extends AbstractField<ContactorOperationViaSerialNumberEvent> implements  LogBookEvent{
    ...
    public ContactorOperationViaSerialNumberEvent() {
    ...
    public ContactorOperationViaSerialNumberEvent(MeterSerialNumber meterSerialNumber, BitMapCollection<ContactorStatus> contactorStatusMask, ContactorMode contactorMode, BitMapCollection<MeterInstallationStatusBitMaskField> meterInstallationStatusMask) {
    ...
    @Override
    public ContactorOperationViaSerialNumberEvent parse(byte[] rawData, int offset) throws ParsingException {
        int ptr = offset;
    ...
    public String getEventDescription() {
        String response = contactorMode.getContactorModeCode() == 1
                ? "Contactor reconnect initiated via serial number"
                : "Contactor disconnect initiated via serial number";
        response += ": ";
