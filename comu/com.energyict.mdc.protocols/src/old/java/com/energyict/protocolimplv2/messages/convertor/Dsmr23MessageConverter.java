...
public class Dsmr23MessageConverter extends AbstractMessageConverter {
    ...
    protected void initializeRegistry(Map<DeviceMessageId, MessageEntryCreator> registry) {
        ...
        registry.put(DeviceMessageId.ACTIVITY_CALENDAR_SPECIAL_DAY_CALENDAR_SEND, new SpecialDayTableMessageEntry(specialDaysAttributeName));
        ...
        registry.put(DeviceMessageId.SECURITY_CHANGE_ENCRYPTION_KEY_WITH_NEW_KEY, new ChangeNTADataTransportEncryptionKeyMessageEntry());
