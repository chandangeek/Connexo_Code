 ...
 * @author Koen
 */
public class LastSelfReadEnergyDataRead extends AbstractDataRead {

    private RegisterData[] registerTotalDatas;
    private RegisterData[][] registerRateDatas;

    /** Creates a new instance of ConstantsDataRead */
    public LastSelfReadEnergyDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("LastSelfReadEnergyDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SR_ALL_SEC_ENERGIES_RATE_G").getId()};
