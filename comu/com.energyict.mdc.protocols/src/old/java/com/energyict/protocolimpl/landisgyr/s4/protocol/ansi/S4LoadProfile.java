...
public class S4LoadProfile {
    ...
    private void buildHistoryLog(ProfileData profileData, Date lastReading, Date to) throws IOException {
       ...
       if (DEBUG>=1) {
           System.out.println("KV_DEBUG> " + s4.getStandardTableFactory().getHistoryLogControlTable());
       }
       if (DEBUG>=1) {
           System.out.println("KV_DEBUG> " + s4.getStandardTableFactory().getActualLogTable());
       }
       ...
       while(!leaveLoop) {
           ...
           if (futurelogcheck) {
               ...
               for (int i=0;i<historyEntries.length;i++) {
                   ...
                   if (DEBUG>=1) {
                       System.out.println("KV_DEBUG>(1) historys " + historyEntries[i].getHistoryTime() + " is before " + lastReading + " ?");
                   }
               }
           }
           ...
           if (!futurelogcheck) {
               ...
               for (int i=0;i<historyEntries.length;i++) {
                   if (DEBUG>=1) {
                       System.out.println("KV_DEBUG>(2) historys " + historyEntries[i].getHistoryTime() + " is before " + lastReading + " ?");
                   }
                   ...
                   if (DEBUG>=1) {
                       System.out.println("KV_DEBUG>(3) historys " + historyEntries[i].getHistoryTime() + " is before " + lastReading + " ?");
                   }
               }
    ...
    private void buildEventLog(ProfileData profileData, Date lastReading, Date to) throws IOException {
       ...
       if (DEBUG>=1) {
           System.out.println("KV_DEBUG> " + s4.getStandardTableFactory().getEventLogControlTable());
       }
       if (DEBUG>=1) {
           System.out.println("KV_DEBUG> " + s4.getStandardTableFactory().getActualLogTable());
       }
       ...
       while(!leaveLoop) {
           ...
           if (futurelogcheck) {
               ...
               for (int i=0;i<eventEntries.length;i++) {
                   ...
                   if (DEBUG>=1) {
                       System.out.println("KV_DEBUG>(1) historys " + eventEntries[i].getEventTime() + " is before " + lastReading + " ?");
                   }
               }
           } // if (futurelogcheck)
           ...
           if (!futurelogcheck) {
               ...
               for (int i=0;i<eventEntries.length;i++) {
                   if (DEBUG>=1) {
                       System.out.println("KV_DEBUG>(2) historys " + eventEntries[i].getEventTime() + " is before " + lastReading + " ?");
                   }
...
//                   }
                   ...
                   if (DEBUG>=1) {
                       System.out.println("KV_DEBUG>(3) historys " + eventEntries[i].getEventTime() + " is before " + lastReading + " ?");
                   }
               }
    ...
    private void buildIntervalData(ProfileData profileData, Date lastReading, Date to) throws IOException {
        ...
        if (DEBUG>=3) {
            System.out.println("KV_DEBUG> " + s4.getStandardTableFactory().getLoadProfileStatusTable());
        }
        if (DEBUG>=3) {
            System.out.println("KV_DEBUG> " + s4.getStandardTableFactory().getActualLoadProfileTable());
        }
        ...
        if (DEBUG>=3) {
            System.out.println("KV_DEBUG> lastReading=" + lastReading + ", block2read " + block2read + ", 2 lpbd.getBlockEndTime()=" + lpbd.getBlockEndTime());
        }

            if ((validBlockCount++ >=(nrOfValidBlocks-1)) || (lpbd.getBlockEndTime().before(lastReading))) {
                break;
            }
        ...
        while(it.hasNext()) {
            ...
            if (DEBUG>=3) {
                System.out.println("KV_DEBUG> cal=" + cal.getTime());
            }
            ...
            if (DEBUG>=3) {
                System.out.println("KV_DEBUG> nrOfIntervals=" + nrOfIntervals + ", startInterval=" + startInterval + ", nrOfIntervalsPerBlock=" + nrOfIntervalsPerBlock + ", nrOfValidIntervals=" + nrOfValidIntervals);
            }
            ...
            for (int i=startInterval;i<nrOfIntervalsPerBlock;i++) {
                ...
                if (DEBUG>=3) {
                    System.out.println("KV_DEBUG> cal interval=" + cal.getTime());
                }
    ...
    private void buildChannelInfo(ProfileData profileData) throws IOException {
        ...
        for (int channel=0;channel<s4.getNumberOfChannels();channel++) {
            ...
            ChannelInfo channelInfo = new ChannelInfo(channel, "S4_channel_"+channel, uom.getUnit());
