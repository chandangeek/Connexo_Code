 ...
 * @author Koen
 */
public class CurrentCumulativeDemandDataRead extends AbstractDataRead {
    ...
    public CurrentCumulativeDemandDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("CurrentCumulativeDemandDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("ALL_SEC_CUMS_RATE_G").getId()};
