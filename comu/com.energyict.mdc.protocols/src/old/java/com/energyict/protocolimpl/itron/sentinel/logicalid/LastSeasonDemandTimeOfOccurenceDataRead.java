 ...
 * @author Koen
 */
public class LastSeasonDemandTimeOfOccurenceDataRead extends AbstractDataRead {
    ...
    public LastSeasonDemandTimeOfOccurenceDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("LastSeasonDemandTimeOfOccurenceDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_SEAS_ALL_DEMAND_TOO_RATE_G").getId()};
