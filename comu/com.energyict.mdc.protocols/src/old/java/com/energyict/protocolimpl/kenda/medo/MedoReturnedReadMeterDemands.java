...
public class MedoReturnedReadMeterDemands extends Parsers{
		private short[] meter;
		MedoReturnedReadMeterDemands(){}
		MedoReturnedReadMeterDemands(byte[] b){
			processReturn(parseBArraytoCArray(b));			
		}
		
		MedoReturnedReadMeterDemands(char[] c){
			processReturn(c);
		}
