 ...
 * @author Koen
 */
public class LastBillingPeriodDemandDataRead extends AbstractDataRead {
    ...
    public LastBillingPeriodDemandDataRead(DataReadFactory dataReadFactory) {
    ...
    public String toString() {
        ...
        strBuff.append("LastBillingPeriodDemandDataRead:\n");
    ...
    protected void prepareBuild() throws IOException {
        ...
        long[] lids = new long[]{LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_TOTAL").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_A").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_B").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_C").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_D").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_E").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_F").getId(),
                                 LogicalIDFactory.findLogicalId("LAST_BP_ALL_SEC_DEMANDS_RATE_G").getId()};
