...
public class IEC870Connection extends Connection {
    ...
    protected IEC870Frame sendFrame(int type,int function,int address, int length, boolean response) throws NestedIOException, IEC870ConnectionException, ConnectionException {
        return sendFrame(type,function,address,length,null,response);
    }
    protected IEC870Frame sendFrame(int type,int function,int address, ApplicationData asdu, boolean response) throws NestedIOException, IEC870ConnectionException, ConnectionException {
