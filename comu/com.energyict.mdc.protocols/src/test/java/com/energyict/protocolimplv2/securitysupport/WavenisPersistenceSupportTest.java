...
/**
 * Tests the {@link WavenisPersistenceSupport} component.
 */
public class WavenisPersistenceSupportTest extends CustomPropertiesPersistenceSupportTest {

    private WavenisPersistenceSupport getInstance() {
