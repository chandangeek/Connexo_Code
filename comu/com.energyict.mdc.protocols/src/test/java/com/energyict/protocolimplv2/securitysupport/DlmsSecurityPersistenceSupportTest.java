...
/**
 * Tests the {@link DlmsSecurityPersistenceSupport} component.
 */
public class DlmsSecurityPersistenceSupportTest extends CustomPropertiesPersistenceSupportTest {

    private DlmsSecurityPersistenceSupport getInstance() {
