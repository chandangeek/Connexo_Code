...
/**
 * Tests the {@link BasicAuthenticationPersistenceSupport} component.
 */
public class BasicAuthenticationPersistenceSupportTest extends CustomPropertiesPersistenceSupportTest {

    private BasicAuthenticationPersistenceSupport getInstance() {
