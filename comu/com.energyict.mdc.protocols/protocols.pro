...
-keep interface *
-keepnames class * implements com.energyict.mdc.protocol.api.legacy.SmartMeterProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.legacy.MeterProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.DeviceProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.inbound.InboundDeviceProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.inbound.BinaryInboundDeviceProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.inbound.ServletBasedInboundDeviceProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.MessageProtocol
-keepnames class * implements com.energyict.mdc.protocol.api.ConnectionType
