...
public class CreateIssueViewOperation {
    ...
    protected SqlBuilder buildCreateSQL() {
        ...
        builder.append("CREATE OR REPLACE VIEW " + TableSpecs.IDL_ISSUE_ALL + " AS ");
        builder.append("select * from " + TableSpecs.IDL_ISSUE_OPEN.name() + " union select * from " + TableSpecs.IDL_ISSUE_HISTORY.name());
        return builder;
    }
