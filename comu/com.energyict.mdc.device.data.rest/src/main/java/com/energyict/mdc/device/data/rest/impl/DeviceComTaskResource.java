...
public class DeviceComTaskResource {
    ...
    public PagedInfoList getComTaskExecutionSessions(@PathParam("mRID") String mrid,
        ...
        List<ComTaskExecutionSession> comTaskExecutionSessions = communicationTaskService.findSessionsByComTaskExecution(comTaskExecution).from(queryParameters).find();
