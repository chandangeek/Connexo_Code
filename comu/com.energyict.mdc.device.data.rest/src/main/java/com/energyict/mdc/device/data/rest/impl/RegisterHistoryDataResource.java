...
public class RegisterHistoryDataResource {
    ...
    @Inject
    public RegisterHistoryDataResource(ResourceHelper resourceHelper, ExceptionFactory exceptionFactory, Clock clock, DeviceDataInfoFactory deviceDataInfoFactory, TopologyService topologyService) {
    ...
    public PagedInfoList getRegisterData(
        ...
        Range<Instant> changed = Range.openClosed(filter.getInstant("changedStart"), filter.getInstant("changedEnd"));
        ...
        List<ReadingInfo> readingInfos = registerTimeLine.stream().
                flatMap(registerRangePair -> {
                    ...
                    List<? extends Reading> readings = register1.getHistoryReadings(Interval.of(registerRangePair.getLast()), changed);
