...
public enum MessageSeeds implements MessageSeed {
    ...
    VERIFY_CALENDAR_TASK_IS_NOT_ACTIVE(275, "VerifyCalendarTaskNotActive", "It is impossible to verify the active calendar because the communication task is not available on the device configuration");
