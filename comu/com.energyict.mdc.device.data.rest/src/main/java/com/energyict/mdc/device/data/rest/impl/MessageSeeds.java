...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    BAD_ACTION(241, "BadAction", "Expected action to be either 'add' or 'remove'"), NO_SUCH_COM_SCHEDULE(242, "NoSuchSchedule", "No communication schedule with id {0}"),
    CANT_ADD_READINGS_FOR_STATE(242, "cantAddReadingForState", "The state of the device at {0} does not allow adding readings."),
    ;
