...
public class DeviceValidationResourceTest extends DeviceDataRestApplicationJerseyTest {
    ...
    private void doModelStubbing() {
        ...
        when(channel3.getChannelsContainer()).thenReturn(meterActivation1);
        when(meterActivation2.getChannels()).thenReturn(Arrays.asList(channel4, channel5, channel6));
        when(channel4.getChannelsContainer()).thenReturn(meterActivation2);
        when(channel5.getChannelsContainer()).thenReturn(meterActivation2);
        when(channel6.getChannelsContainer()).thenReturn(meterActivation2);
        when(meterActivation3.getChannels()).thenReturn(Arrays.asList(channel7, channel8, channel9));
        when(channel7.getChannelsContainer()).thenReturn(meterActivation3);
        when(channel8.getChannelsContainer()).thenReturn(meterActivation3);
        when(channel9.getChannelsContainer()).thenReturn(meterActivation3);
