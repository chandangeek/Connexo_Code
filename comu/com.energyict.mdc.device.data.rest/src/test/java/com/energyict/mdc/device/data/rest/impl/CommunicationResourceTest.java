...
public class CommunicationResourceTest extends DeviceDataRestApplicationJerseyTest {
    ...
    Date nextCommunicationTime = new Date();
    ...
    public void testGetDeviceCommunications() {
        ...
        assertThat(jsonModel.<Long>get("$.communications[0].startTime")).isEqualTo(startTime.getTime());
        assertThat(jsonModel.<Long>get("$.communications[0].successfulFinishTime")).isEqualTo(endTime.getTime());
        assertThat(jsonModel.<Long>get("$.communications[0].nextCommunication")).isEqualTo(nextCommunicationTime.getTime());
        assertThat(jsonModel.<Long>get("$.communications[0].plannedDate")).isEqualTo(plannedDate.getTime());
