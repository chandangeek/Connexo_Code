...
public final class ModemException extends CommunicationException {
    ...
    public static ModemException couldNotHangup(final String name) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_COULD_NOT_HANG_UP), name);
    }
    ...
    public static ModemException commandTimeoutExceeded(String name, long milliSeconds, String command) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_READ_TIMEOUT), name, milliSeconds, command);
    }
    ...
    public static ModemException couldNotRestoreProfile(String name, String lastCommandSend, String lastResponseReceived) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_COULD_NOT_RESTORE_DEFAULT_PROFILE), name, lastCommandSend, lastResponseReceived);
    }
    ...
    public static ModemException failedToInitializeCommandStateString(String comPortName, String lastResponseReceived) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_COULD_NOT_INITIALIZE_COMMAND_STATE), comPortName, lastResponseReceived);
    }
    ...
    public static ModemException failedToWriteInitString(String comPortName, String lastCommandSend, String lastResponseReceived) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_COULD_NOT_SEND_INIT_STRING), comPortName, lastCommandSend, lastResponseReceived);
    }
     ...
     * <ul>
     * <li>{@link ProtocolExceptionReferences#AT_MODEM_BUSY}</li>
     * <li>{@link ProtocolExceptionReferences#AT_MODEM_ERROR}</li>
     * <li>{@link ProtocolExceptionReferences#AT_MODEM_NO_ANSWER}</li>
     * <li>{@link ProtocolExceptionReferences#AT_MODEM_NO_CARRIER}</li>
     * <li>{@link ProtocolExceptionReferences#AT_MODEM_NO_DIALTONE}</li>
     * </ul>
     *
     ...
     * @return the newly created exception
     */
    public static ModemException dialingError(String comPortName, ProtocolExceptionReferences exceptionReferences, String lastCommandSend) {
    ...
    public static ModemException connectTimeOutException(String comPortName, long milliSeconds) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_CONNECT_TIMEOUT), comPortName, milliSeconds);
    }
    ...
    public static ModemException couldNotEstablishConnection(String comPortName, long milliSeconds) {
        return new ModemException(newExceptionCodeByReference(ProtocolExceptionReferences.MODEM_COULD_NOT_ESTABLISH_CONNECTION), comPortName, milliSeconds);
    }
     ...
     */
    private static ExceptionCode newExceptionCodeByReference(ProtocolExceptionReferences reference) {
