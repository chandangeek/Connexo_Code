...
public interface OfflineDevice extends Offline {
    ...
    /**
     * Get all the properties of an device and his {@link com.energyict.mdc.protocol.DeviceProtocolPluggableClass}.
     *
    ...
    /**
     * Get the list of all {@link com.energyict.mdc.protocol.device.messages.DeviceMessageStatus#PENDING pending} {@link OfflineDeviceMessage}s.
     *
    ...
    /**
     * Get the list of all {@link com.energyict.mdc.protocol.device.messages.DeviceMessageStatus#SENT sent} {@link OfflineDeviceMessage}s.
     *
