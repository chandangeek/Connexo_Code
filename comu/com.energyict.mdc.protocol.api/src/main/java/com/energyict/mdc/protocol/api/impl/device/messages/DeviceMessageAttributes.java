...
public enum DeviceMessageAttributes implements TranslationKey {
    ...
    activityCalendarCodeTableAttributeName(DeviceMessageConstants.activityCalendarCodeTableAttributeName, "Activity calendar code table"),
    specialDaysCodeTableAttributeName(DeviceMessageConstants.specialDaysCodeTableAttributeName, "Special days code table"),
    ...
    whiteListPhoneNumbersAttributeName(DeviceMessageConstants.whiteListPhoneNumbersAttributeName, "whitelist phonenumbers"),
    ...
    managedWhiteListPhoneNumbersAttributeName(DeviceMessageConstants.managedWhiteListPhoneNumbersAttributeName, "Managed phonenumber whitelist"),
    smsCenterPhoneNumberAttributeName(DeviceMessageConstants.smsCenterPhoneNumberAttributeName, "smscenter phonenumber"),
    devicePhoneNumberAttributeName(DeviceMessageConstants.devicePhoneNumberAttributeName, "device phonenumber"),
    ...
    alarmFilterAttributeName(DeviceMessageConstants.alarmFilterAttributeName, "Alarm filter"),
    configUserFileAttributeName(DeviceMessageConstants.configUserFileAttributeName, "Configuration user file"),
