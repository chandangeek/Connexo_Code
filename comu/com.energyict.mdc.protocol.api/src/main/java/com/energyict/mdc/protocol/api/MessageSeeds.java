...
public enum MessageSeeds implements MessageSeed, TranslationKey {
    ...
    COULD_NOT_READOUT_LOGBOOK_DATA(105, "issue.couldNotReadoutLogBookData", "Could not correctly read the logbook data"),
    COULD_NOT_PARSE_LOGBOOK_DATA(106, "issue.couldNotParseLogBookData", "Could not correctly parse the logbook data"),
    ...
    COULD_NOT_PARSE_LOADPROFILE_DATA(108, "issue.couldNotParseLoadProfileData", "Could not correctly parse the load profile data"),
