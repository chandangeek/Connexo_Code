...
public enum DeviceMessageAttributes implements TranslationKey {
    ...
    maxCredit(DeviceMessageConstants.maxCredit, "Maximum credit"),
    ...
    ConfigurationChangeDeviceMessageDay("ConfigurationChangeDeviceMessage." + DeviceMessageConstants.day, "Day"),
    ConfigurationChangeDeviceMessageHour("ConfigurationChangeDeviceMessage." + DeviceMessageConstants.hour, "Hour"),
