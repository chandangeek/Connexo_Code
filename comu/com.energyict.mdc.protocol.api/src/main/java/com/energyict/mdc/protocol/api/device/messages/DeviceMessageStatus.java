...
/**
 * Models the status of a message that is sent to a physical device.
 * Each status is actually an element of the lifecycle of a device message.
 * The normal lifecycle of a device message is described by the DeviceMessage class.
 *
...
public enum DeviceMessageStatus {
    ...
    /**
     * Applies to a device message that was created with a release date in the future
    ...
    /**
     * Applies to a device message whose release date has expired
    ...
    /**
     * Applies to a device message that was sent succesfully to the device
    ...
    /**
     * Applies to a device message that was executed succesfully by the device.
     */
    CONFIRMED {
        @Override
        Set<DeviceMessageStatus> predecessors() {
    ...
    /**
     * Applies to a device message whose execution by the device failed.
     */
    FAILED {
        @Override
        Set<DeviceMessageStatus> predecessors() {
    ...
    /**
     * Applies to a device message whose execution result cannot be retrieved
