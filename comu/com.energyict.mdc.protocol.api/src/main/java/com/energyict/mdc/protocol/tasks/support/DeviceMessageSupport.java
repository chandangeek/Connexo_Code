...
public interface DeviceMessageSupport {
     ...
     * {@link com.energyict.mdc.protocol.device.data.CollectedMessage#getNewDeviceMessageStatus()
     * CollectedMessage#getNewDeviceMessageStatus()} returns the proper new status (ex. failure).
     * If possible also return a proper {@link com.energyict.mdc.protocol.device.data.CollectedMessage#getDeviceProtocolInformation()
     ...
     * by the {@link com.energyict.mdc.protocol.DeviceProtocol deviceProtocol}.
