...
public enum TableSpecs {
    DAL_ALARM_HISTORY {
        ...
        public void addTo(DataModel dataModel) {
            ...
            TableSpecs.TableBuilder.buildAlarmTable(table, idColumn, "ISU_ALARM_HISTORY", DAL_ALARM_HISTORY_PK,
                    // Foreign keys
    ...
    DAL_ALARM_OPEN {
        ...
        public void addTo(DataModel dataModel) {
            ...
            TableSpecs.TableBuilder.buildAlarmTable(table, idColumn, "ISU_ALARM_OPEN", DAL_ALARM_OPEN_PK,
                    // Foreign key
    ...
    DAL_ALARM_ALL {
        ...
        public void addTo(DataModel dataModel) {
            ...
            Column idColumn = table.column(DAL_ID).map("id").number().conversion(NUMBER2LONG).notNull().add();
            TableSpecs.TableBuilder.buildAlarmTable(table, idColumn, "ISU_ALARM_ALL", DAL_ALARM_PK,
                    // Foreign key
    ...
    private static class TableBuilder{
        ...
        static void buildAlarmTable(Table<?> table, Column idColumn, String alarmTable, String pkKey, String... fkKeys){
            ...
            table.foreignKey(fkKeysIter.next())
                    .map("baseAlarm").on(alarmColRef).references(IssueService.class).add();
        }
    }
}