...
public class CloseDeviceAlarmAction extends AbstractIssueAction {

    private static final String NAME = "CloseDeviceAlarmAction";
    ...
    @Inject
    protected CloseDeviceAlarmAction(DataModel dataModel, Thesaurus thesaurus, PropertySpecService propertySpecService, IssueService issueService, ThreadPrincipalService threadPrincipalService) {
