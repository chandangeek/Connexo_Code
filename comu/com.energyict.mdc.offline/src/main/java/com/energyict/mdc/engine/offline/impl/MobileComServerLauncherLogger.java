 ...
 */
public interface MobileComServerLauncherLogger {
    ...
    @Configuration(format = "The OfflineComServerLauncher is configured to start an online ComServer. This is a {0}", logLevel = LogLevel.ERROR)
    void notAnOnlineComeServer(String comServerClassName);

    @Configuration(format = "The OfflineComServerLauncher is configured to start an remote ComServer. This is a {0}", logLevel = LogLevel.ERROR)
