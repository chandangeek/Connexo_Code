...
public class NoIdPropertiesTableModel extends javax.swing.table.AbstractTableModel {
    ...
    public NoIdPropertiesTableModel(TypedPropertiesOwner model) {
        this.model = model;
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        Association association = associations.get(rowIndex);
        switch (columnIndex) {
            case 0:
