 ...
 * @author Karel
 */
public class SerialCommunicationSettings implements java.io.Serializable {

    private final static long serialVersionUID = 7830830557365505498L;
     ...
     */
    static public SerialCommunicationSettings getDefault() {
        return DEFAULT;
    }
     ...
     */
    static public SerialCommunicationSettings getMultiEditDefault() {
