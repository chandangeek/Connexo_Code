...
public class ImtUiInstaller implements TranslationKeyProvider {
    ...
    public void activate(BundleContext context) {
        ...
        // HttpResource resource =  new HttpResource(HTTP_RESOURCE_ALIAS, "c:\\git10.4\\DavidConnexo\\coin\\com.elster.insight.metering.extjs\\src\\main\\web\\js\\imt", new FileResolver());
