...
Ext.define('Imt.purpose.view.summary.validation.RuleSetVersionsGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.validationConfigurationRuleSetVersionsGrid',
    itemId: 'validationConfigurationRuleSetVersionsGrid',
    rulesSetId: null,
    title: '',
    requires: [
    ...
    initComponent: function () {
        ...
        me.dockedItems = [
            ...
            },
            {
                ...
                store: me.store,
                itemsPerPageMsg: Uni.I18n.translate('validation.version.pagingtoolbarbottom.itemsPerPageMsg', 'IMT', 'Versions per page'),
                dock: 'bottom',
