...
Ext.define('Imt.datavalidation.view.Detail', {
    extend: 'Uni.view.container.ContentContainer',
    alias: 'widget.data-validation-issue-detail',
    requires: [
        'Isu.view.issues.DetailTop',
        'Imt.datavalidation.view.DetailForm',
    ...
    initComponent: function () {
        ...
        me.content = [
            ...
            {
                xtype: 'usagepoint-issue-detail-top',
            ...
            },
            {
                ...
                title: Uni.I18n.translate('issues.NonEstimatedDataGrid.title', 'IMT', 'Non estimated data'),
                router: me.router
            },
            {
