...
//            btn.setDisabled(!(me.service.searchDomain && me.service.searchDomain.getId() === "com.energyict.mdc.device.data.Device" && items && items.length));
    ...
    showOverview: function () {
        ...
        grid.down('pagingtoolbartop').insert(1, {
            ...
            text: Uni.I18n.translate('general.overview.informationMessage', 'IMT', "Attention: the search result only allows to sort the columns on the active page. All subsequent pages will not be sorted."),
            margin: '0 10 5 0',
            iconCmp: {
                xtype: 'component',
