Ext.define('Imt.dashboard.view.widget.FlaggedUsagePointGroups', {
    ...
    clickToAddText: Uni.I18n.translate('overview.widget.flaggedUsagePointGroups.flag', 'IMT', 'Click to flag the usage group'),
    ...
    tooltipTpl: new Ext.XTemplate(
        '<table>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePointGroups.usagePointGroup.name', 'IMT', 'Name') + '</td>',
        '<td>{[Ext.htmlEncode(values.name)]}</td>',
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePointGroups.usagePointGroup.type', 'IMT', 'Type') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePointGroups.usagePointGroup.flaggedDate', 'IMT', 'Flagged date') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePointGroups.usagePointGroup.comment', 'IMT', 'Comment') + '</td>',
