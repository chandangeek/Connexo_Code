        ...
        me.dockedItems = [
            {
                ...
                dock: 'top',
                store: me.store,
                displayMsg: Uni.I18n.translate('metrologyConfigOutputs.pagingtoolbartop.displayMsg', 'IMT', '{0} - {1} of {2} outputs'),
                displayMoreMsg: Uni.I18n.translate('metrologyConfigOutputs.pagingtoolbartop.displayMoreMsg', 'IMT', '{0} - {1} of more than {2} outputs'),
