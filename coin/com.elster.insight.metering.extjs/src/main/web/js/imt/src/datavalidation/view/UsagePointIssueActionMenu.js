...
Ext.define('Imt.datavalidation.view.UsagePointIssueActionMenu', {
    extend: 'Isu.view.issues.ActionMenu',
    alias: 'widget.usagepoint-issue-action-menu',
        ...
        me.store.each(function (record) {
            ...
            switch (record.get('name')) {
                ...
                case 'Close issue':
                    ...
                    break;
                case 'Set priority ':
                    privileges = Isu.privileges.Issue.canDoAction() && Isu.privileges.Issue.setPriority;
                    section = this.SECTION_REMOVE;
                    break;
                case 'Snooze':
    ...
    onCheck: function (getConfirmationWindow) {
        ...
        me.doOperation(confWindow, Uni.I18n.translate('snooze.acknowledgment.snoozed', 'IMT', 'Issue snoozed'), 'snooze');
    },
    ...
    snoozeCheck: function (item) {
        if (item.action === "snooze") {
            ...
            confirmationWindow = Ext.create('Uni.view.window.Confirmation', {
                ...
                confirmText: Uni.I18n.translate('issue.snooze', 'IMT', 'Snooze'),
                closeAction: 'destroy',
                green: true,
            ...
            confirmationWindow.show({
                title: Uni.I18n.translate('issue.snoozeNow', 'IMT', "Snooze '{0}'?",
    ...
    addPredefinedActions: function () {
        var me = this,
            itemId = me.record.getId(),
            detail = Ext.ComponentQuery.query('usagepoint-issue-detail-top')[0],
    ...
    getPredefinedItems: function () {
        ...
        return [
            {
                text: Uni.I18n.translate('issues.actionMenu.assignToMe', 'IMT', 'Assign to me'),
                privileges: Isu.privileges.Issue.assign,
                action: 'assignIssueToMe',
                itemId: 'assign-valid-issue-to-me',
                section: me.SECTION_ACTION,
                hidden: true
            },
            {
                text: Uni.I18n.translate('issues.actionMenu.unassign', 'IMT', 'Unassign'),
                privileges: Isu.privileges.Issue.assign,
                action: 'unassign',
                itemId: 'unassign-valid-issue',
                section: me.SECTION_ACTION,
                hidden: true
            },
            {
                text: Uni.I18n.translate('issues.actionMenu.snooze', 'IMT', 'Snooze'),
            ...
            {
                text: Uni.I18n.translate('issues.actionMenu.addComment', 'IMT', 'Add comment'),
                privileges: Isu.privileges.Issue.comment,
                section: me.SECTION_ACTION,
                action: 'addComment'
            },
            {
                text: Uni.I18n.translate('issues.actionMenu.setPriority', 'IMT', 'Set priority'),
                privileges: Isu.privileges.Issue.viewAdminAlarm,
