Ext.define('Imt.dashboard.view.widget.FlaggedUsagePoints', {
    ...
    tooltipTpl: new Ext.XTemplate(
        '<table>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.mrid', 'IMT', 'MRID') + '</td>',
        '<td>{[Ext.htmlEncode(values.name)]}</td>',
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.serviceCategory', 'IMT', 'Service category') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.metrologyConfiguration', 'IMT', 'Metrology configuration') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.type', 'IMT', 'Type') + '</td>',
        '<td>{[Ext.htmlEncode(values.displayType)]}</td>',
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.connectionState', 'IMT', 'Connection state') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.creationDate', 'IMT', 'Creation date') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.flaggedDate', 'IMT', 'Flagged date') + '</td>',
        ...
        '</tr>',
        '<tr>',
        '<td style="text-align: right; padding-right: 10px; white-space: nowrap">' + Uni.I18n.translate('overview.widget.flaggedUsagePoints.usagePoint.comment', 'IMT', 'Comment') + '</td>',
