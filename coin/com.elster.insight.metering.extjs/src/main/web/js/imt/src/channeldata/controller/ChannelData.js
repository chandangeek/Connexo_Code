Ext.define('Imt.channeldata.controller.ChannelData', {
    ...
    views: [
        'Imt.channeldata.view.TabbedChannelsView',
        'Imt.channeldata.view.Overview',
        'Imt.channeldata.view.ReadingEstimationWindow',
//        'Imt.channeldata.view.EditCustomAttributes'
    ],
...
//        'Imt.customattributesonvaluesobjects.store.ChannelCustomAttributeSets',
    ...
    refs: [
        {
            ref: 'channelGraphView',
            selector: '#channelGraphView'
        },
        {
            ref: 'tabbedChannelsView',
            selector: '#tabbedChannelsView'
        },
        {
            ref: 'page',
        ...
        },
        {
            ...
            selector: 'readingEstimationWindow'
        },
//        {
//            ref: 'editPropertyForm',
//            selector: '#channelsEditCustomAttributes property-form'
//        },
//        {
//            ref: 'editCustomAttributesPanel',
//            selector: '#channelsEditCustomAttributes'
//        },
//        {
...
//            },
//            '#channelsEditCustomAttributes #channel-custom-attributes-property-form': {
...
//            }
    ...
    showValidationBlocks: function (mRID, channelId, issueId) {
        var me = this,
            validationBlocksStore = me.getStore('Imt.store.ValidationBlocks');
...
//        });
    ...
    onTabChange: function (tabPanel, newTab) {
        ...
        if (newTab.itemId === 'channelData') {
            ...
            route = 'usagepoints/view/channels/channel';
            route && (route = router.getRoute(route));
            route && route.forward(routeParams, filterParams);
        }
    },
    ...
    showPreview: function (selectionModel, record) {
        ...
        if (selectionModel.getSelection().length === 1) {
            previewPanel = me.getChannelDataPreview();
    ...
    chooseAction: function (menu, item) {
        var me = this,
            point,
            grid = me.getPage().down('channelDataGrid'),
            chart = me.getPage().down('#channelGraphView').chart;

        switch (item.action) {
            case 'editValue':
                me.getPage().down('#channelDataGrid').getPlugin('cellplugin').startEdit(menu.record, 1);
                break;
            case 'removeReading':
    ...
    saveChannelDataChanges: function () {
        ...
        if (!Ext.isEmpty(changedData)) {
            Ext.Ajax.request({
                url: Ext.String.format('/api/udr/usagepoints/{0}/channels/{1}/data', encodeURIComponent(router.arguments.mRID), router.arguments.channelId),
                method: 'PUT',
    ...
    estimateValue: function (record) {
        ...
        me.getStore('Imt.store.Estimators').load(function () {
            me.getPage().setLoading(false);
            Ext.widget('readingEstimationWindow', {
                record: record,
    ...
    chooseBulkAction: function (menu, item) {
        var me = this,
            records = me.getPage().down('channelDataGrid').getSelectionModel().getSelection();
...
//        var me = this,
//            viewport = Ext.ComponentQuery.query('viewport')[0],
//            model = Ext.ModelManager.getModel('Imt.customattributesonvaluesobjects.model.AttributeSetOnChannel'),
...
//            success: function () {
//                me.getApplication().fireEvent('acknowledge', Uni.I18n.translate('channelAttributes.saved', 'IMT', 'Channel attributes saved'));
//                me.toPreviousPage();
//            },
//            callback: function () {
