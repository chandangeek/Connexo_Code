Ext.define('Imt.usagepointmanagement.view.forms.fields.meteractivations.MeterActivationsField', {
            ...
            data = _.map(meterRoles,
                function (meterRole) {
                    return {
                        ...
                        activationTime: meterRole.activationTime ? meterRole.activationTime : usagePointCreationDate ? usagePointCreationDate : new Date().getTime()
                    }
                }
            );
    ...
    hasMetrologyConfiguration: function () {
        var usagePoint = this.usagePoint;
        return (usagePoint && usagePoint.get('metrologyConfiguration') != null) ||
            (usagePoint && (usagePoint.get('id') == 0));
    }
});