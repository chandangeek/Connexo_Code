...
@Component(name = "com.energyict.mdm.issue.datavalidation.rest", service = {Application.class}, immediate = true, property = {"alias=/iuv", "app=INS", "name=" + IssueDataValidationApplication.ISSUEDATAVALIDATION_REST_COMPONENT})
