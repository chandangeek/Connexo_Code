        ...
        dviIssue.getNotEstimatedBlocks().forEach(block -> {
            ...
            if (meter.isPresent()) {
                ...
                if (meterActivation.isPresent()) {
                    EstimationReport estimationReport = estimationService.previewEstimate(QualityCodeSystem.MDM,
                    ...
                    channel.editReadings(QualityCodeSystem.MDM, editedBulkReadings);
                }
            }
        });
