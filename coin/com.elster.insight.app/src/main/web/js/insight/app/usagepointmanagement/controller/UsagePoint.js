Ext.define('InsightApp.usagepointmanagement.controller.UsagePoint', {
    extend: 'Ext.app.Controller',
    requires: [
        'InsightApp.usagepointmanagement.model.UsagePointComplete',
        'Ext.container.Container'
    ],
    stores: [
        'InsightApp.usagepointmanagement.store.MeterActivations'
    ],
    views: [
        'InsightApp.usagepointmanagement.view.Setup'
    ],
    refs: [
    ...
    showUsagePoints: function(mRID) {
    	this.showUsagePoint(mRID);
    },
    ...
    showUsagePoint: function (mRID) {
        ...
        var me = this,
            ...
            usagePointModel = me.getModel('InsightApp.usagepointmanagement.model.UsagePointComplete'),
        ...
        usagePointModel.load(mRID, {
            success: function (record) {
                ...
                switch (record.get('serviceCategory')) {
                    case('ELECTRICITY'):
                    {
                        actualForm = Ext.create('InsightApp.usagepointmanagement.view.UsagePointAttributesFormTechnicalElectricity');
                        actualModel = Ext.create('InsightApp.usagepointmanagement.model.UsagePointElectricity', record.data);
                    }
                        break;
                    default:
                    {
                        actualForm = Ext.create('InsightApp.usagepointmanagement.view.UsagePointAttributesFormMain');
                        actualModel = Ext.create('InsightApp.usagepointmanagement.model.UsagePoint', record.data);
                    }
                }
                ...
                var store = me.getStore('InsightApp.usagepointmanagement.store.MeterActivations'),
