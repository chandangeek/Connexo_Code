...
public enum ReadingModificationFlag {
    ...
    public static Pair<ReadingModificationFlag, ReadingQualityRecord> getModificationFlag(BaseReadingRecord reading, Optional<? extends BaseReadingRecord> calculatedReading) {
        return getModificationFlag(reading, reading.getReadingQualities(), calculatedReading);
    }

    public static Pair<ReadingModificationFlag, ReadingQualityRecord> getModificationFlag(BaseReadingRecord reading, Collection<? extends ReadingQualityRecord> readingQualities, Optional<? extends BaseReadingRecord> calculatedReading) {
