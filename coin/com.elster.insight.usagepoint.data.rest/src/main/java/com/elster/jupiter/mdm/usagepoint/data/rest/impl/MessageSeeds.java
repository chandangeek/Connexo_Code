...
public enum MessageSeeds implements MessageSeed {
    ...
    SEARCHABLE_PROPERTY_INVALID_VALUE(44, "SearchablePropertyInvalidValue", "Invalid value"),
    NO_SUCH_CALENDAR(45, "NoSuchCalendar", "No such calendar."),
    NO_APPSERVER(46, "usagepoint.bulk.no.appserver.to.serve", "There is currently no active application server that can handle this request"),
    NO_SUCH_MESSAGE_QUEUE(47, "usagepoint.bulk.no.such.messagequeue", "Unable to queue command: no message queue was found"),
    BAD_ACTION(48, "usagepoint.bulk.no.such.action", "Unexpected or non existing action : {0}");
