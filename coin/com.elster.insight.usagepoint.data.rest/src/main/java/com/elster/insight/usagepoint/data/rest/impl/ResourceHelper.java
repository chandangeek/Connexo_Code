...
public class ResourceHelper {
    ...
    @Inject
    public ResourceHelper(MeteringService meteringService, ExceptionFactory exceptionFactory, ConcurrentModificationExceptionFactory conflictFactory, UsagePointConfigurationService usagePointConfigurationService) {
        super();
