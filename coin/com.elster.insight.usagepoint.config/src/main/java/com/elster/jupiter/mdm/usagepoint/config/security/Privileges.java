...
public enum Privileges implements TranslationKey {
    ...
    ADMINISTER_VALIDATION_ON_METROLOGY_CONFIGURATION(Constants.ADMINISTER_VALIDATION_ON_METROLOGY_CONFIGURATION, "Administrate validation on metrology configuration"),
    ...
    ADMINISTER_ESTIMATION_ON_METROLOGY_CONFIGURATION(Constants.ADMINISTER_ESTIMATION_ON_METROLOGY_CONFIGURATION, "Administrate estimation on metrology configuration");
