...
!function (a) {
    ...
    if (b !== c) {
        ...
        b.toss = function (a, e) {
            b.intercept();
            var f, g, h = 0, i = a.scrollLeft, j = a.scrollTop, k = {top: "+0", left: "+0", duration: 50, easing: b.easing};
            ...
            return "string" == typeof k.left ? (k.left = parseFloat(k.left), f = k.left + i) : (f = k.left, k.left = k.left - i), "string" == typeof k.top ? (k.top = parseFloat(k.top), g = k.top + j) : (g = k.top, k.top = k.top - j), b.tossing = !0, d = setInterval(function () {
                h++ < k.duration ? (a.scrollLeft = k.easing(h, i, k.left, k.duration), a.scrollTop = k.easing(h, j, k.top, k.duration)) : (f !== a.scrollLeft && (a.scrollLeft = f), g !== a.scrollTop && (a.scrollTop = g), b.intercept())
    ...
    function c(b, c, d, e) {
        if (document.createEvent) {
            ...
            f.initEvent(c, !0, !0), f.overthrow = d, b.dispatchEvent(f)
        } else a.document.documentElement[e][c] = {e: c, overthrow: d}, a.document.documentElement[c]++
    }

    !b || !1 in a.document || (b.sidescroller = function (d, e) {
        for (var f = d, g = "overthrow", h = g + "-next", i = g + "-prev", j = e && e.snapScroll, k = e && e.rewind, l = e && void 0 !== e.snapTolerance ? e.snapTolerance : 30, m = 0; m < f.length; m++)!function () {
            function d() {
                for (var a = s.querySelectorAll("li"), b = 100 / a.length + "%", c = 0; c < a.length; c++)a[c].style.width = b
            }

            function e(a) {
                var b = s.querySelectorAll("li"), c = b.length, d = s.offsetWidth, e = b[0].offsetWidth, f = void 0 !== a ? a : s.scrollLeft, g = Math.round(f / e), h = !0, i = [];
                g = Math.max(0, g), g = Math.min(c, g), i[0] = g;
                for (var j = 1; c > j; j++)d > g + j * e ? i.push(g + j) : h = !1;
                return u = g, i
            }

            function g(d) {
                var f = d || a.event;
                if (f.preventDefault ? f.preventDefault() : f.returnValue = !1, "keydown" === f.type || w === !1 || w === f.type) {
                    w = f.type, b.intercept();
                    var g = s.querySelectorAll("li"), j = f.target || f.srcElement, l = s.offsetWidth, m = g[0].offsetWidth, n = s.scrollLeft, o = Math.round(n / m), p = "keydown" !== f.type && j.className.indexOf("next") > -1 || 39 === f.keyCode, q = o + (p ? 1 : -1), t = m * q, u = s.scrollWidth - l;
                    k ? 0 > t ? t = u : t > u && (t = 0) : 0 > t ? t = 0 : t > u && (t = u);
                    var x = e(t);
                    x[0] !== o && (b.toss(s, {left: t}), c(r, p ? h : i, {active: x, originalEvent: f}, v)), setTimeout(function () {
                        w = !1
                    }, 900)
                }
            }
            ...
            function n(a) {
                b.intercept();
                var d = s.querySelector("li").offsetWidth, f = s.scrollLeft, g = Math.round(f / d);
                if (z !== !1) {
                    var j = f - z;
                    Math.abs(j) > l && (g = u + (j > 0 ? 1 : -1))
                }
                var k = d * g;
                b.toss(s, {left: k, duration: 20}), u !== g && (c(r, g > u ? h : i, {active: e(k), originalEvent: a}, v), u = g)
            }
            ...
            function p(a) {
                overthrow.tossing || (z === !1 && (z = s.scrollLeft), clearTimeout(y), y = setTimeout(function () {
                    n(a), z = !1
                }, 200))
            }

            function q(a) {
                (39 === a.keyCode || 37 === a.keyCode) && g(a)
            }

            var r = f[m], s = f[m].querySelector(".overthrow"), t = a.document.createElement("div"), u = 0, v = "overthrow" + (new Date).getTime(), w = !1;
            if (!r.initialized) {
                r.initialized = !0, r.setAttribute("tabindex", "0"), a.document.attachEvent && (a.document.documentElement[i] = 0, a.document.documentElement[h] = 0, a.document.documentElement[v] = {}, a.document.documentElement[v][i] = {}, a.document.documentElement[v][h] = {}, r.ieID = v), t.className = "sidescroll-nextprev-links", t.innerHTML = "<a href='#' class='sidescroll-prev'>Previous</a><a href='#' class='sidescroll-next'>Next</a>", r.getActiveSlides = e;
                var x, y, z = !1;
                a.document.addEventListener ? (t.addEventListener("click", g, !1), t.addEventListener("touchend", g, !1), a.addEventListener("resize", o, !1), f[m].addEventListener("keydown", q, !1), j && s.addEventListener("scroll", p, !1)) : a.document.attachEvent && (t.attachEvent("onclick", g, !1), a.attachEvent("onresize", o, !1), f[m].attachEvent("onkeydown", q, !1), j && s.attachEvent("onscroll", p, !1)), r.insertBefore(t, s), d()
            }
        }()
    }, b.sidescroller.onEvent = function (b, c, d) {
        function e(a) {
            var e = {type: b, target: c, overthrow: a.overthrow};
            d(e)
        }

        a.document.addEventListener ? c.addEventListener(b, e) : a.document.attachEvent && a.document.documentElement.attachEvent("onpropertychange", function (d) {
            d.propertyName === b && e(a.document.documentElement[c.ieID][b])
        })
    })
}(this, this.overthrow);