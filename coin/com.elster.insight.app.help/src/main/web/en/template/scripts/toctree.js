...
function Tree(rootRelPath, dataFolder, rootFile, commonRootRelPath) {
    ...
    Tree.prototype.init = function () {
        ...
        if (this.rootHtmlNode.attachEvent) {
            this.rootHtmlNode.attachEvent("onkeydown", function () {
                onKeyPress(event);
            });
            this.rootHtmlNode.attachEvent("onblur", function () {
                onTreeBlur();
            });
            this.rootHtmlNode.attachEvent("onfocus", function () {
                onTreeFocus();
            });
        }
        else {
    ...
    Tree.prototype.addEventsToNode = function (htmlNode, classNormal, classHover, classClick, url) {
        if (htmlNode.attachEvent) {
            if (isTouchDevice()) {
                htmlNode.attachEvent('ontouchstart', function () {
                    onNodeHover(htmlNode, classHover);
                });
                htmlNode.attachEvent('ontouchend', function () {
                    onNodeHoverOut(htmlNode, classHover);
                });
                htmlNode.attachEvent('ontouchmove', function () {
                    onNodeHoverOut(htmlNode, classHover);
                });
            }
            else {
                htmlNode.attachEvent('onmouseout', function () {
                    onNodeHoverOut(htmlNode, classNormal);
                });
                htmlNode.attachEvent('onmouseover', function () {
                    onNodeHover(htmlNode, classHover);
                });
            }
        }
    ...
    Tree.prototype.addBookEventsToNode = function (htmlNode, itemType) {
        if (htmlNode.attachEvent) {
            if (itemType == ITEMTYPEBOOKCLOSED)
                htmlNode.attachEvent('onclick', function () {
                    onNodeExpand(event, htmlNode);
                });
            else if (itemType == ITEMTYPEBOOKOPEN)
                htmlNode.attachEvent('onclick', function () {
                    onNodeCollapse(event, htmlNode);
                });
        }
        else {
            if (itemType == ITEMTYPEBOOKCLOSED)
