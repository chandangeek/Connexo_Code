        ...
        if (htmlNode.attachEvent) {
            if (isTouchDevice()) {
                htmlNode.attachEvent('ontouchstart', function () {
                    onGloNodeHover(htmlNode, classHover);
                });
                htmlNode.attachEvent('ontouchend', function () {
                    onGloNodeHoverOut(htmlNode, classHover);
                });
                ...
                htmlNode.attachEvent('onmouseout', function () {
                    onGloNodeHoverOut(htmlNode, classNormal);
                });
...
function callbackGloCSHModeRead(cshmode) {
    if (cshmode == CSHMODE) {
        ...
        if (filterBox != null)
            patchInputForSubmit(filterBox, function () {
                filterGlo(event);
            });
    }
}