...
package com.elster.jupiter.mdm.demo.customtask;
...
import com.elster.jupiter.mdm.demo.customtask.impl.DemoCustomTaskFactory;
import com.elster.jupiter.mdm.demo.customtask.impl.TranslationKeys;
...
@Component(name = "com.elster.jupiter.mdm.demo.customtask",
...
public class DemoCustomTaskInstaller implements FullInstaller, PrivilegesProvider, DynamicPrivilegesRegister, TranslationKeyProvider {
    ...
    public void activate() {
        ...
        upgradeService.register(InstallIdentifier.identifier("Insight", "ICT"), dataModel, DemoCustomTaskInstaller.class, Collections.emptyMap());
    }
    ...
    public List<ResourceDefinition> getModuleResources() {
        ...
        resources.add(userService.createModuleResourceWithPrivileges(getModuleName(),
                ...
                Arrays.asList(Privileges.Constants.ADMINISTRATE_MDM_DEMO_CUSTOM_TASK,
                        Privileges.Constants.VIEW_MDM_DEMO_CUSTOM_TASK,
                        Privileges.Constants.RUN_MDM_DEMO_CUSTOM_TASK)));
        return resources;
    }
    ...
    public List<String> getPrivileges(String application){
        switch (application) {
            case "INS":
                return Arrays.asList(Privileges.Constants.ADMINISTRATE_MDM_DEMO_CUSTOM_TASK,
                        Privileges.Constants.VIEW_MDM_DEMO_CUSTOM_TASK,
                        Privileges.Constants.RUN_MDM_DEMO_CUSTOM_TASK);
            default:
